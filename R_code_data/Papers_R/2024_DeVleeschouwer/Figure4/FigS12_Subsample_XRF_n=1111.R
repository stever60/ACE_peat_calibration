# Figure S12: Subsample - XRF dataset matching & correlation

# n = 1111 for DM dataset,
# n = 1097 for LOI & C_org dataset (no PB1 LOI data)
...
# Import qc and element filtered XRF cps data -------------------------------------------------------------
...
head(ACE_Subsample)
tail(ACE_Subsample)
write.csv(ACE_Subsample,"Papers_R/2024_DeVleeschouwer/Figure4/Data/Output/FigS12/ACE/ACE_Subsample.csv", 
          row.names = FALSE)
# Match Subsample - XRF data -----------------------------------------------
# BI10 ----------------------------------------------------------------

BI10_Subsample <- ACE_Subsample %>% 
  filter(Site == "BI10") %>% 
  print()
write.csv(BI10_Subsample,"Papers_R/2024_DeVleeschouwer/Figure4/Data/Output/FigS12/BI10/BI10_Subsample.csv", 
          row.names = FALSE)

# Rename datasets to use for matching
...
write.csv(BI10_Subsample_xrf_matched,"Papers_R/2024_DeVleeschouwer/Figure4/Data/Output/FigS12/BI10/BI10_Subsample_xrf_matched.csv", 
          row.names = FALSE)
...
HER42PB_Subsample <- ACE_Subsample %>% 
  filter(Site == "HER42PB") %>% 
  print()
write.csv(HER42PB_Subsample,"Papers_R/2024_DeVleeschouwer/Figure4/Data/Output/FigS12/HER42PB/HER42PB_Subsample.csv", 
          row.names = FALSE)
...
write.csv(HER42PB_Subsample_xrf_matched,"Papers_R/2024_DeVleeschouwer/Figure4/Data/Output/FigS12/HER42PB/HER42PB_Subsample_xrf_matched.csv", 
          row.names = FALSE)
...
KER1_Subsample <- ACE_Subsample %>% 
  filter(Site == "KER1") %>% 
  print()
write.csv(KER1_Subsample,"Papers_R/2024_DeVleeschouwer/Figure4/Data/Output/FigS12/KER1/KER1_Subsample.csv", 
          row.names = FALSE)
KER1_Subsample
# Choose and rename datasets to use for matching
ACE_Subsample_KER1 <- KER1_Subsample
ACE_Subsample_KER1
...
write.csv(KER1_Subsample_xrf_matched,"Papers_R/2024_DeVleeschouwer/Figure4/Data/Output/FigS12/KER1/KER1_Subsample_xrf_matched.csv", 
          row.names = FALSE)
...
KER3_Subsample <- ACE_Subsample %>% 
  filter(Site == "KER3") %>% 
  print()
write.csv(KER3_Subsample,"Papers_R/2024_DeVleeschouwer/Figure4/Data/Output/FigS12/KER3/KER3_Subsample.csv", 
          row.names = FALSE)

# Choose and rename datasets to use for matching
ACE_Subsample_KER3 <- KER3_Subsample
ACE_Subsample_KER3
...
write.csv(KER3_Subsample_xrf_matched,"Papers_R/2024_DeVleeschouwer/Figure4/Data/Output/FigS12/KER3/KER3_Subsample_xrf_matched.csv", 
          row.names = FALSE)
...
PB1_Subsample <- ACE_Subsample %>% 
  filter(Site == "PB1") %>% 
  print()
write.csv(PB1_Subsample,"Papers_R/2024_DeVleeschouwer/Figure4/Data/Output/FigS12/PB1/PB1_Subsample.csv", 
          row.names = FALSE)

# Choose and rename datasets to use for matching
ACE_Subsample_PB1 <- PB1_Subsample
ACE_Subsample_PB1
...
write.csv(PB1_Subsample_xrf_matched,"Papers_R/2024_DeVleeschouwer/Figure4/Data/Output/FigS12/PB1/PB1_Subsample_xrf_matched.csv", 
          row.names = FALSE)
...
write.csv(ACE_Subsample_xrf_matched,"Papers_R/2024_DeVleeschouwer/Figure4/Data/Output/FigS12/ACE/ACE_Subsample_xrf_matched.csv", 
          row.names = FALSE)
...
# Correlation - Dry Mass vs coh/inc --------------------------------------------
# ACE OLS & WLS ------------------------------------------------
...
ggsave("Papers_R/2024_DeVleeschouwer/Figure4/Data/Output/FigS12/OLS_WLS/ACE/DM_OLS_performance.pdf", 
       height = c(30), width = c(30), dpi = 600, units = "cm")
# Write summary stats/checks to txt file
sink(file = "Papers_R/2024_DeVleeschouwer/Figure4/Data/Output/FigS12/OLS_WLS/ACE/DM_OLS_summary.txt")
summary(ACE_DM_lm)
glance(ACE_DM_lm)
model_performance(ACE_DM_lm) # AIC - Akaike information criterion; BIC Bayesian IC: lower = better fit for both
...
ggsave("Papers_R/2024_DeVleeschouwer/Figure4/Data/Output/FigS12/OLS_WLS/ACE/DM_OLS_wt_performance.pdf", 
       height = c(30), width = c(30), dpi = 600, units = "cm")
# Write summary stats/checks to txt file
sink(file = "Papers_R/2024_DeVleeschouwer/Figure4/Data/Output/FigS12/OLS_WLS/ACE/DM_OLS_wt_summary.txt")
summary(ACE_wlm)
glance(ACE_wlm)
model_performance(ACE_wlm) # AIC - Akaike information criterion; BIC Bayesian IC: lower = better fit for both
...
ggsave("Papers_R/2024_DeVleeschouwer/Figure4/Data/Output/FigS12/OLS_WLS/ACE/DM_WLS_performance.pdf", 
       height = c(30), width = c(30), dpi = 600, units = "cm")
# Write summary stats/checks to txt file
sink(file = "Papers_R/2024_DeVleeschouwer/Figure4/Data/Output/FigS12/OLS_WLS/ACE/DM_WLS_summary.txt")
summary(ACE_wls)
glance(ACE_wls)
model_performance(ACE_wls) # AIC - Akaike information criterion; BIC Bayesian IC: lower = better fit for both
...
ggsave("Papers_R/2024_DeVleeschouwer/Figure4/Data/Output/FigS12/OLS_WLS/ACE/DM_WLS_wt_performance.pdf", 
       height = c(30), width = c(30), dpi = 600, units = "cm")
# Write summary stats/checks to txt file
sink(file = "Papers_R/2024_DeVleeschouwer/Figure4/Data/Output/FigS12/OLS_WLS/ACE/DM_WLS_wt_summary.txt")
summary(ACE_wls_wt)
glance(ACE_wls_wt)
model_performance(ACE_wls_wt) # AIC - Akaike information criterion; BIC Bayesian IC: lower = better fit for both
...
write.csv(ACE_DM_lm_no_outliers,"Papers_R/2024_DeVleeschouwer/Figure4/Data/Output/FigS12/OLS_WLS/ACE/DM_OLS_no_outliers.csv", row.names = FALSE)

#Summary Leverage & Cooks distnce plots - write to file 
pdf(file = "Papers_R/2024_DeVleeschouwer/Figure4/Data/Output/FigS12/OLS_WLS/ACE/DM_DM_lm_lev_bar.pdf")
barplot(hatvalues(ACE_DM_lm), 
        col = "aquamarine3")
dev.off()
pdf(file = "Papers_R/2024_DeVleeschouwer/Figure4/Data/Output/FigS12/OLS_WLS/ACE/DM_DM_lm_lev.pdf")
leveragePlots(ACE_DM_lm,layout=c(2,2)) 
dev.off()
pdf(file = "Papers_R/2024_DeVleeschouwer/Figure4/Data/Output/FigS12/OLS_WLS/ACE/DM_DM_lm_lev_cooks.pdf")
par(mfrow = c(2, 2))
plot(ACE_DM_lm)
dev.off()
...
write.csv(ACE_wlm_no_outliers,"Papers_R/2024_DeVleeschouwer/Figure4/Data/Output/FigS12/OLS_WLS/ACE/DM_OLS_wt_no_outliers.csv", row.names = FALSE)

#Summary Leverage & Cooks distnce plots - write to file 
pdf(file = "Papers_R/2024_DeVleeschouwer/Figure4/Data/Output/FigS12/OLS_WLS/ACE/DM_wlm_lev_bar.pdf")
barplot(hatvalues(ACE_wlm), 
        col = "red")
dev.off()
pdf(file = "Papers_R/2024_DeVleeschouwer/Figure4/Data/Output/FigS12/OLS_WLS/ACE/DM_wlm_lev.pdf")
leveragePlots(ACE_wlm,layout=c(2,2)) 
dev.off()
pdf(file = "Papers_R/2024_DeVleeschouwer/Figure4/Data/Output/FigS12/OLS_WLS/ACE/DM_wlm_lev_cooks.pdf")
par(mfrow = c(2, 2))
plot(ACE_wlm)
dev.off()
...
write.csv(ACE_wls_no_outliers,"Papers_R/2024_DeVleeschouwer/Figure4/Data/Output/FigS12/OLS_WLS/ACE/DM_WLS_no_outliers.csv", row.names = FALSE)

#Summary Leverage & Cooks distnce plots - write to file 
pdf(file = "Papers_R/2024_DeVleeschouwer/Figure4/Data/Output/FigS12/OLS_WLS/ACE/DM_wls_lev_bar.pdf")
barplot(hatvalues(ACE_wls), 
        col = "blue")
dev.off()
pdf(file = "Papers_R/2024_DeVleeschouwer/Figure4/Data/Output/FigS12/OLS_WLS/ACE/DM_wls_lev.pdf")
leveragePlots(ACE_wls,layout=c(2,2)) 
dev.off()
pdf(file = "Papers_R/2024_DeVleeschouwer/Figure4/Data/Output/FigS12/OLS_WLS/ACE/DM_wls_lev_cooks.pdf")
par(mfrow = c(2, 2))
plot(ACE_wls)
dev.off()
...
write.csv(ACE_wls_wt_no_outliers,"Papers_R/2024_DeVleeschouwer/Figure4/Data/Output/FigS12/OLS_WLS/ACE/DM_WLS_wt_no_outliers.csv", row.names = FALSE)

#Summary Leverage & Cooks distnce plots - write to file 
pdf(file = "Papers_R/2024_DeVleeschouwer/Figure4/Data/Output/FigS12/OLS_WLS/ACE/DM_wls_wt_lev_bar.pdf")
barplot(hatvalues(ACE_wls_wt), 
        col = "green")
dev.off()
pdf(file = "Papers_R/2024_DeVleeschouwer/Figure4/Data/Output/FigS12/OLS_WLS/ACE/DM_wls_wt_lev.pdf")
leveragePlots(ACE_wls_wt,layout=c(2,2)) 
dev.off()
pdf(file = "Papers_R/2024_DeVleeschouwer/Figure4/Data/Output/FigS12/OLS_WLS/ACE/DM_wls_wt_lev_cooks.pdf")
par(mfrow = c(2, 2))
plot(ACE_wls_wt)
dev.off()
...
ACE_final
ggsave("Papers_R/2024_DeVleeschouwer/Figure4/Data/Output/FigS12/OLS_WLS/ACE/FigS12_ACE_DM_OLS_WLS_summary.pdf", 
...
ggsave("Papers_R/2024_DeVleeschouwer/Figure4/Data/Output/FigS12/OLS_WLS/BI10/DM_OLS_performance.pdf", 
       height = c(30), width = c(30), dpi = 600, units = "cm")
# Write summary stats/checks to txt file
sink(file = "Papers_R/2024_DeVleeschouwer/Figure4/Data/Output/FigS12/OLS_WLS/BI10/DM_OLS_summary.txt")
summary(BI10_DM_lm)
glance(BI10_DM_lm)
model_performance(BI10_DM_lm) # AIC - Akaike information criterion; BIC Bayesian IC: lower = better fit for both
...
ggsave("Papers_R/2024_DeVleeschouwer/Figure4/Data/Output/FigS12/OLS_WLS/BI10/DM_OLS_wt_performance.pdf", 
       height = c(30), width = c(30), dpi = 600, units = "cm")
# Write summary stats/checks to txt file
sink(file = "Papers_R/2024_DeVleeschouwer/Figure4/Data/Output/FigS12/OLS_WLS/BI10/DM_OLS_wt_summary.txt")
summary(BI10_wlm)
glance(BI10_wlm)
model_performance(BI10_wlm) # AIC - Akaike information criterion; BIC Bayesian IC: lower = better fit for both
...
ggsave("Papers_R/2024_DeVleeschouwer/Figure4/Data/Output/FigS12/OLS_WLS/BI10/DM_WLS_performance.pdf", 
       height = c(30), width = c(30), dpi = 600, units = "cm")
# Write summary stats/checks to txt file
sink(file = "Papers_R/2024_DeVleeschouwer/Figure4/Data/Output/FigS12/OLS_WLS/BI10/DM_WLS_summary.txt")
summary(BI10_wls)
glance(BI10_wls)
model_performance(BI10_wls) # AIC - Akaike information criterion; BIC Bayesian IC: lower = better fit for both
...
ggsave("Papers_R/2024_DeVleeschouwer/Figure4/Data/Output/FigS12/OLS_WLS/BI10/DM_WLS_wt_performance.pdf", 
       height = c(30), width = c(30), dpi = 600, units = "cm")
# Write summary stats/checks to txt file
sink(file = "Papers_R/2024_DeVleeschouwer/Figure4/Data/Output/FigS12/OLS_WLS/BI10/DM_WLS_wt_summary.txt")
summary(BI10_wls_wt)
glance(BI10_wls_wt)
model_performance(BI10_wls_wt) # AIC - Akaike information criterion; BIC Bayesian IC: lower = better fit for both
...
write.csv(BI10_DM_lm_no_outliers,"Papers_R/2024_DeVleeschouwer/Figure4/Data/Output/FigS12/OLS_WLS/BI10/DM_OLS_no_outliers.csv", row.names = FALSE)

#Summary Leverage & Cooks distnce plots - write to file 
pdf(file = "Papers_R/2024_DeVleeschouwer/Figure4/Data/Output/FigS12/OLS_WLS/BI10/DM_DM_lm_lev_bar.pdf")
barplot(hatvalues(BI10_DM_lm), 
        col = "aquamarine3")
dev.off()
pdf(file = "Papers_R/2024_DeVleeschouwer/Figure4/Data/Output/FigS12/OLS_WLS/BI10/DM_DM_lm_lev.pdf")
leveragePlots(BI10_DM_lm,layout=c(2,2)) 
dev.off()
pdf(file = "Papers_R/2024_DeVleeschouwer/Figure4/Data/Output/FigS12/OLS_WLS/BI10/DM_DM_lm_lev_cooks.pdf")
par(mfrow = c(2, 2))
plot(BI10_DM_lm)
dev.off()
...
write.csv(BI10_wlm_no_outliers,"Papers_R/2024_DeVleeschouwer/Figure4/Data/Output/FigS12/OLS_WLS/BI10/DM_OLS_wt_no_outliers.csv", row.names = FALSE)

#Summary Leverage & Cooks distnce plots - write to file 
pdf(file = "Papers_R/2024_DeVleeschouwer/Figure4/Data/Output/FigS12/OLS_WLS/BI10/DM_wlm_lev_bar.pdf")
barplot(hatvalues(BI10_wlm), 
        col = "red")
dev.off()
pdf(file = "Papers_R/2024_DeVleeschouwer/Figure4/Data/Output/FigS12/OLS_WLS/BI10/DM_wlm_lev.pdf")
leveragePlots(BI10_wlm,layout=c(2,2)) 
dev.off()
pdf(file = "Papers_R/2024_DeVleeschouwer/Figure4/Data/Output/FigS12/OLS_WLS/BI10/DM_wlm_lev_cooks.pdf")
par(mfrow = c(2, 2))
plot(BI10_wlm)
dev.off()
...
write.csv(BI10_wls_no_outliers,"Papers_R/2024_DeVleeschouwer/Figure4/Data/Output/FigS12/OLS_WLS/BI10/DM_WLS_no_outliers.csv", row.names = FALSE)

#Summary Leverage & Cooks distnce plots - write to file 
pdf(file = "Papers_R/2024_DeVleeschouwer/Figure4/Data/Output/FigS12/OLS_WLS/BI10/DM_wls_lev_bar.pdf")
barplot(hatvalues(BI10_wls), 
        col = "blue")
dev.off()
pdf(file = "Papers_R/2024_DeVleeschouwer/Figure4/Data/Output/FigS12/OLS_WLS/BI10/DM_wls_lev.pdf")
leveragePlots(BI10_wls,layout=c(2,2)) 
dev.off()
pdf(file = "Papers_R/2024_DeVleeschouwer/Figure4/Data/Output/FigS12/OLS_WLS/BI10/DM_wls_lev_cooks.pdf")
par(mfrow = c(2, 2))
plot(BI10_wls)
dev.off()
...
write.csv(BI10_wls_wt_no_outliers,"Papers_R/2024_DeVleeschouwer/Figure4/Data/Output/FigS12/OLS_WLS/BI10/DM_WLS_wt_no_outliers.csv", row.names = FALSE)

#Summary Leverage & Cooks distnce plots - write to file 
pdf(file = "Papers_R/2024_DeVleeschouwer/Figure4/Data/Output/FigS12/OLS_WLS/BI10/DM_wls_wt_lev_bar.pdf")
barplot(hatvalues(BI10_wls_wt), 
        col = "green")
dev.off()
pdf(file = "Papers_R/2024_DeVleeschouwer/Figure4/Data/Output/FigS12/OLS_WLS/BI10/DM_wls_wt_lev.pdf")
leveragePlots(BI10_wls_wt,layout=c(2,2)) 
dev.off()
pdf(file = "Papers_R/2024_DeVleeschouwer/Figure4/Data/Output/FigS12/OLS_WLS/BI10/DM_wls_wt_lev_cooks.pdf")
par(mfrow = c(2, 2))
plot(BI10_wls_wt)
dev.off()
...
BI10_final <- BI10 + 
  ...
  geom_text(data=data.frame(), aes(label=paste("OLS: ", BI10_DM_lm_eqn(df)), x = -Inf, y = Inf),
            parse = TRUE, colour = "blue", hjust = -0.15, vjust = 5, size = 3)
BI10_final
ggsave("Papers_R/2024_DeVleeschouwer/Figure4/Data/Output/FigS12/OLS_WLS/BI10/FigS12_BI10_DM_OLS_WLS_summary.pdf", 
       height = c(20), width = c(20), dpi = 600, units = "cm")
...
ggsave("Papers_R/2024_DeVleeschouwer/Figure4/Data/Output/FigS12/OLS_WLS/HER42PB/DM_OLS_performance.pdf", 
       height = c(30), width = c(30), dpi = 600, units = "cm")
# Write summary stats/checks to txt file
sink(file = "Papers_R/2024_DeVleeschouwer/Figure4/Data/Output/FigS12/OLS_WLS/HER42PB/DM_OLS_summary.txt")
summary(HER42PB_DM_lm)
glance(HER42PB_DM_lm)
model_performance(HER42PB_DM_lm) # AIC - Akaike information criterion; BIC Bayesian IC: lower = better fit for both
...
ggsave("Papers_R/2024_DeVleeschouwer/Figure4/Data/Output/FigS12/OLS_WLS/HER42PB/DM_OLS_wt_performance.pdf", 
       height = c(30), width = c(30), dpi = 600, units = "cm")
# Write summary stats/checks to txt file
sink(file = "Papers_R/2024_DeVleeschouwer/Figure4/Data/Output/FigS12/OLS_WLS/HER42PB/DM_OLS_wt_summary.txt")
summary(HER42PB_wlm)
glance(HER42PB_wlm)
model_performance(HER42PB_wlm) # AIC - Akaike information criterion; BIC Bayesian IC: lower = better fit for both
...
ggsave("Papers_R/2024_DeVleeschouwer/Figure4/Data/Output/FigS12/OLS_WLS/HER42PB/DM_WLS_performance.pdf", 
       height = c(30), width = c(30), dpi = 600, units = "cm")
# Write summary stats/checks to txt file
sink(file = "Papers_R/2024_DeVleeschouwer/Figure4/Data/Output/FigS12/OLS_WLS/HER42PB/DM_WLS_summary.txt")
summary(HER42PB_wls)
glance(HER42PB_wls)
model_performance(HER42PB_wls) # AIC - Akaike information criterion; BIC Bayesian IC: lower = better fit for both
...
ggsave("Papers_R/2024_DeVleeschouwer/Figure4/Data/Output/FigS12/OLS_WLS/HER42PB/DM_WLS_wt_performance.pdf", 
       height = c(30), width = c(30), dpi = 600, units = "cm")
# Write summary stats/checks to txt file
sink(file = "Papers_R/2024_DeVleeschouwer/Figure4/Data/Output/FigS12/OLS_WLS/HER42PB/DM_WLS_wt_summary.txt")
...
write.csv(HER42PB_DM_lm_no_outliers,"Papers_R/2024_DeVleeschouwer/Figure4/Data/Output/FigS12/OLS_WLS/HER42PB/DM_OLS_no_outliers.csv", row.names = FALSE)

#Summary Leverage & Cooks distnce plots - write to file 
pdf(file = "Papers_R/2024_DeVleeschouwer/Figure4/Data/Output/FigS12/OLS_WLS/HER42PB/DM_DM_lm_lev_bar.pdf")
barplot(hatvalues(HER42PB_DM_lm), 
        col = "aquamarine3")
dev.off()
pdf(file = "Papers_R/2024_DeVleeschouwer/Figure4/Data/Output/FigS12/OLS_WLS/HER42PB/DM_DM_lm_lev.pdf")
leveragePlots(HER42PB_DM_lm,layout=c(2,2)) 
dev.off()
pdf(file = "Papers_R/2024_DeVleeschouwer/Figure4/Data/Output/FigS12/OLS_WLS/HER42PB/DM_DM_lm_lev_cooks.pdf")
par(mfrow = c(2, 2))
plot(HER42PB_DM_lm)
dev.off()
...
write.csv(HER42PB_wlm_no_outliers,"Papers_R/2024_DeVleeschouwer/Figure4/Data/Output/FigS12/OLS_WLS/HER42PB/DM_OLS_wt_no_outliers.csv", row.names = FALSE)

#Summary Leverage & Cooks distnce plots - write to file 
pdf(file = "Papers_R/2024_DeVleeschouwer/Figure4/Data/Output/FigS12/OLS_WLS/HER42PB/DM_wlm_lev_bar.pdf")
barplot(hatvalues(HER42PB_wlm), 
        col = "red")
dev.off()
pdf(file = "Papers_R/2024_DeVleeschouwer/Figure4/Data/Output/FigS12/OLS_WLS/HER42PB/DM_wlm_lev.pdf")
leveragePlots(HER42PB_wlm,layout=c(2,2)) 
dev.off()
pdf(file = "Papers_R/2024_DeVleeschouwer/Figure4/Data/Output/FigS12/OLS_WLS/HER42PB/DM_wlm_lev_cooks.pdf")
par(mfrow = c(2, 2))
plot(HER42PB_wlm)
dev.off()
...
write.csv(HER42PB_wls_no_outliers,"Papers_R/2024_DeVleeschouwer/Figure4/Data/Output/FigS12/OLS_WLS/HER42PB/DM_WLS_no_outliers.csv", row.names = FALSE)

#Summary Leverage & Cooks distnce plots - write to file 
pdf(file = "Papers_R/2024_DeVleeschouwer/Figure4/Data/Output/FigS12/OLS_WLS/HER42PB/DM_wls_lev_bar.pdf")
barplot(hatvalues(HER42PB_wls), 
        col = "blue")
dev.off()
pdf(file = "Papers_R/2024_DeVleeschouwer/Figure4/Data/Output/FigS12/OLS_WLS/HER42PB/DM_wls_lev.pdf")
leveragePlots(HER42PB_wls,layout=c(2,2)) 
dev.off()
pdf(file = "Papers_R/2024_DeVleeschouwer/Figure4/Data/Output/FigS12/OLS_WLS/HER42PB/DM_wls_lev_cooks.pdf")
par(mfrow = c(2, 2))
plot(HER42PB_wls)
dev.off()
...
write.csv(HER42PB_wls_wt_no_outliers,"Papers_R/2024_DeVleeschouwer/Figure4/Data/Output/FigS12/OLS_WLS/HER42PB/DM_WLS_wt_no_outliers.csv", row.names = FALSE)

#Summary Leverage & Cooks distnce plots - write to file 
pdf(file = "Papers_R/2024_DeVleeschouwer/Figure4/Data/Output/FigS12/OLS_WLS/HER42PB/DM_wls_wt_lev_bar.pdf")
barplot(hatvalues(HER42PB_wls_wt), 
        col = "green")
dev.off()
pdf(file = "Papers_R/2024_DeVleeschouwer/Figure4/Data/Output/FigS12/OLS_WLS/HER42PB/DM_wls_wt_lev.pdf")
leveragePlots(HER42PB_wls_wt,layout=c(2,2)) 
dev.off()
pdf(file = "Papers_R/2024_DeVleeschouwer/Figure4/Data/Output/FigS12/OLS_WLS/HER42PB/DM_wls_wt_lev_cooks.pdf")
par(mfrow = c(2, 2))
plot(HER42PB_wls_wt)
dev.off()
...
HER42PB_final <- HER42PB + 
  ...
  geom_text(data=data.frame(), aes(label=paste("OLS: ", HER42PB_DM_lm_eqn(df)), x = -Inf, y = Inf),
            parse = TRUE, colour = "blue", hjust = -0.15, vjust = 5, size = 3)
HER42PB_final
ggsave("Papers_R/2024_DeVleeschouwer/Figure4/Data/Output/FigS12/OLS_WLS/HER42PB/FigS12_HER42PB_DM_OLS_WLS_summary.pdf", 
       height = c(20), width = c(20), dpi = 600, units = "cm")
...
ggsave("Papers_R/2024_DeVleeschouwer/Figure4/Data/Output/FigS12/OLS_WLS/KER1/DM_OLS_performance.pdf", 
       height = c(30), width = c(30), dpi = 600, units = "cm")
# Write summary stats/checks to txt file
sink(file = "Papers_R/2024_DeVleeschouwer/Figure4/Data/Output/FigS12/OLS_WLS/KER1/DM_OLS_summary.txt")
summary(KER1_DM_lm)
glance(KER1_DM_lm)
model_performance(KER1_DM_lm) # AIC - Akaike information criterion; BIC Bayesian IC: lower = better fit for both
...
ggsave("Papers_R/2024_DeVleeschouwer/Figure4/Data/Output/FigS12/OLS_WLS/KER1/DM_OLS_wt_performance.pdf", 
       height = c(30), width = c(30), dpi = 600, units = "cm")
# Write summary stats/checks to txt file
sink(file = "Papers_R/2024_DeVleeschouwer/Figure4/Data/Output/FigS12/OLS_WLS/KER1/DM_OLS_wt_summary.txt")
summary(KER1_wlm)
glance(KER1_wlm)
model_performance(KER1_wlm) # AIC - Akaike information criterion; BIC Bayesian IC: lower = better fit for both
...
ggsave("Papers_R/2024_DeVleeschouwer/Figure4/Data/Output/FigS12/OLS_WLS/KER1/DM_WLS_performance.pdf", 
       height = c(30), width = c(30), dpi = 600, units = "cm")
# Write summary stats/checks to txt file
sink(file = "Papers_R/2024_DeVleeschouwer/Figure4/Data/Output/FigS12/OLS_WLS/KER1/DM_WLS_summary.txt")
summary(KER1_wls)
glance(KER1_wls)
model_performance(KER1_wls) # AIC - Akaike information criterion; BIC Bayesian IC: lower = better fit for both
...
ggsave("Papers_R/2024_DeVleeschouwer/Figure4/Data/Output/FigS12/OLS_WLS/KER1/DM_WLS_wt_performance.pdf", 
       height = c(30), width = c(30), dpi = 600, units = "cm")
# Write summary stats/checks to txt file
sink(file = "Papers_R/2024_DeVleeschouwer/Figure4/Data/Output/FigS12/OLS_WLS/KER1/DM_WLS_wt_summary.txt")
summary(KER1_wls_wt)
glance(KER1_wls_wt)
model_performance(KER1_wls_wt) # AIC - Akaike information criterion; BIC Bayesian IC: lower = better fit for both
...
write.csv(KER1_DM_lm_no_outliers,"Papers_R/2024_DeVleeschouwer/Figure4/Data/Output/FigS12/OLS_WLS/KER1/DM_OLS_no_outliers.csv", row.names = FALSE)

#Summary Leverage & Cooks distnce plots - write to file 
pdf(file = "Papers_R/2024_DeVleeschouwer/Figure4/Data/Output/FigS12/OLS_WLS/KER1/DM_DM_lm_lev_bar.pdf")
barplot(hatvalues(KER1_DM_lm), 
        col = "aquamarine3")
dev.off()
pdf(file = "Papers_R/2024_DeVleeschouwer/Figure4/Data/Output/FigS12/OLS_WLS/KER1/DM_DM_lm_lev.pdf")
leveragePlots(KER1_DM_lm,layout=c(2,2)) 
dev.off()
pdf(file = "Papers_R/2024_DeVleeschouwer/Figure4/Data/Output/FigS12/OLS_WLS/KER1/DM_DM_lm_lev_cooks.pdf")
par(mfrow = c(2, 2))
plot(KER1_DM_lm)
dev.off()
...
write.csv(KER1_wlm_no_outliers,"Papers_R/2024_DeVleeschouwer/Figure4/Data/Output/FigS12/OLS_WLS/KER1/DM_OLS_wt_no_outliers.csv", row.names = FALSE)

#Summary Leverage & Cooks distnce plots - write to file 
pdf(file = "Papers_R/2024_DeVleeschouwer/Figure4/Data/Output/FigS12/OLS_WLS/KER1/DM_wlm_lev_bar.pdf")
barplot(hatvalues(KER1_wlm), 
        col = "red")
dev.off()
pdf(file = "Papers_R/2024_DeVleeschouwer/Figure4/Data/Output/FigS12/OLS_WLS/KER1/DM_wlm_lev.pdf")
leveragePlots(KER1_wlm,layout=c(2,2)) 
dev.off()
pdf(file = "Papers_R/2024_DeVleeschouwer/Figure4/Data/Output/FigS12/OLS_WLS/KER1/DM_wlm_lev_cooks.pdf")
par(mfrow = c(2, 2))
plot(KER1_wlm)
dev.off()
...
write.csv(KER1_wls_no_outliers,"Papers_R/2024_DeVleeschouwer/Figure4/Data/Output/FigS12/OLS_WLS/KER1/DM_WLS_no_outliers.csv", row.names = FALSE)

#Summary Leverage & Cooks distnce plots - write to file 
pdf(file = "Papers_R/2024_DeVleeschouwer/Figure4/Data/Output/FigS12/OLS_WLS/KER1/DM_wls_lev_bar.pdf")
barplot(hatvalues(KER1_wls), 
        col = "blue")
dev.off()
pdf(file = "Papers_R/2024_DeVleeschouwer/Figure4/Data/Output/FigS12/OLS_WLS/KER1/DM_wls_lev.pdf")
leveragePlots(KER1_wls,layout=c(2,2)) 
dev.off()
pdf(file = "Papers_R/2024_DeVleeschouwer/Figure4/Data/Output/FigS12/OLS_WLS/KER1/DM_wls_lev_cooks.pdf")
par(mfrow = c(2, 2))
plot(KER1_wls)
dev.off()
...
write.csv(KER1_wls_wt_no_outliers,"Papers_R/2024_DeVleeschouwer/Figure4/Data/Output/FigS12/OLS_WLS/KER1/DM_WLS_wt_no_outliers.csv", row.names = FALSE)

#Summary Leverage & Cooks distnce plots - write to file 
pdf(file = "Papers_R/2024_DeVleeschouwer/Figure4/Data/Output/FigS12/OLS_WLS/KER1/DM_wls_wt_lev_bar.pdf")
barplot(hatvalues(KER1_wls_wt), 
        col = "green")
dev.off()
pdf(file = "Papers_R/2024_DeVleeschouwer/Figure4/Data/Output/FigS12/OLS_WLS/KER1/DM_wls_wt_lev.pdf")
leveragePlots(KER1_wls_wt,layout=c(2,2)) 
dev.off()
pdf(file = "Papers_R/2024_DeVleeschouwer/Figure4/Data/Output/FigS12/OLS_WLS/KER1/DM_wls_wt_lev_cooks.pdf")
par(mfrow = c(2, 2))
plot(KER1_wls_wt)
dev.off()
...
KER1_final <- KER1 + 
  ...
  geom_text(data=data.frame(), aes(label=paste("OLS: ", KER1_DM_lm_eqn(df)), x = -Inf, y = Inf),
            parse = TRUE, colour = "blue", hjust = -0.15, vjust = 5, size = 3)
KER1_final
ggsave("Papers_R/2024_DeVleeschouwer/Figure4/Data/Output/FigS12/OLS_WLS/KER1/FigS12_KER1_DM_OLS_WLS_summary.pdf", 
       height = c(20), width = c(20), dpi = 600, units = "cm")
...
ggsave("Papers_R/2024_DeVleeschouwer/Figure4/Data/Output/FigS12/OLS_WLS/KER3/DM_OLS_performance.pdf", 
       height = c(30), width = c(30), dpi = 600, units = "cm")
# Write summary stats/checks to txt file
sink(file = "Papers_R/2024_DeVleeschouwer/Figure4/Data/Output/FigS12/OLS_WLS/KER3/DM_OLS_summary.txt")
summary(KER3_DM_lm)
glance(KER3_DM_lm)
model_performance(KER3_DM_lm) # AIC - Akaike information criterion; BIC Bayesian IC: lower = better fit for both
...
ggsave("Papers_R/2024_DeVleeschouwer/Figure4/Data/Output/FigS12/OLS_WLS/KER3/DM_OLS_wt_performance.pdf", 
       height = c(30), width = c(30), dpi = 600, units = "cm")
# Write summary stats/checks to txt file
sink(file = "Papers_R/2024_DeVleeschouwer/Figure4/Data/Output/FigS12/OLS_WLS/KER3/DM_OLS_wt_summary.txt")
summary(KER3_wlm)
glance(KER3_wlm)
model_performance(KER3_wlm) # AIC - Akaike information criterion; BIC Bayesian IC: lower = better fit for both
...
ggsave("Papers_R/2024_DeVleeschouwer/Figure4/Data/Output/FigS12/OLS_WLS/KER3/DM_WLS_performance.pdf", 
       height = c(30), width = c(30), dpi = 600, units = "cm")
# Write summary stats/checks to txt file
sink(file = "Papers_R/2024_DeVleeschouwer/Figure4/Data/Output/FigS12/OLS_WLS/KER3/DM_WLS_summary.txt")
summary(KER3_wls)
glance(KER3_wls)
model_performance(KER3_wls) # AIC - Akaike information criterion; BIC Bayesian IC: lower = better fit for both
...
ggsave("Papers_R/2024_DeVleeschouwer/Figure4/Data/Output/FigS12/OLS_WLS/KER3/DM_WLS_wt_performance.pdf", 
       height = c(30), width = c(30), dpi = 600, units = "cm")
# Write summary stats/checks to txt file
sink(file = "Papers_R/2024_DeVleeschouwer/Figure4/Data/Output/FigS12/OLS_WLS/KER3/DM_WLS_wt_summary.txt")
summary(KER3_wls_wt)
glance(KER3_wls_wt)
model_performance(KER3_wls_wt) # AIC - Akaike information criterion; BIC Bayesian IC: lower = better fit for both
...
write.csv(KER3_DM_lm_no_outliers,"Papers_R/2024_DeVleeschouwer/Figure4/Data/Output/FigS12/OLS_WLS/KER3/DM_OLS_no_outliers.csv", row.names = FALSE)

#Summary Leverage & Cooks distnce plots - write to file 
pdf(file = "Papers_R/2024_DeVleeschouwer/Figure4/Data/Output/FigS12/OLS_WLS/KER3/DM_DM_lm_lev_bar.pdf")
barplot(hatvalues(KER3_DM_lm), 
        col = "aquamarine3")
dev.off()
pdf(file = "Papers_R/2024_DeVleeschouwer/Figure4/Data/Output/FigS12/OLS_WLS/KER3/DM_DM_lm_lev.pdf")
leveragePlots(KER3_DM_lm,layout=c(2,2)) 
dev.off()
pdf(file = "Papers_R/2024_DeVleeschouwer/Figure4/Data/Output/FigS12/OLS_WLS/KER3/DM_DM_lm_lev_cooks.pdf")
par(mfrow = c(2, 2))
plot(KER3_DM_lm)
dev.off()
...
write.csv(KER3_wlm_no_outliers,"Papers_R/2024_DeVleeschouwer/Figure4/Data/Output/FigS12/OLS_WLS/KER3/DM_OLS_wt_no_outliers.csv", row.names = FALSE)

#Summary Leverage & Cooks distnce plots - write to file 
pdf(file = "Papers_R/2024_DeVleeschouwer/Figure4/Data/Output/FigS12/OLS_WLS/KER3/DM_wlm_lev_bar.pdf")
barplot(hatvalues(KER3_wlm), 
        col = "red")
dev.off()
pdf(file = "Papers_R/2024_DeVleeschouwer/Figure4/Data/Output/FigS12/OLS_WLS/KER3/DM_wlm_lev.pdf")
leveragePlots(KER3_wlm,layout=c(2,2)) 
dev.off()
pdf(file = "Papers_R/2024_DeVleeschouwer/Figure4/Data/Output/FigS12/OLS_WLS/KER3/DM_wlm_lev_cooks.pdf")
par(mfrow = c(2, 2))
plot(KER3_wlm)
dev.off()
...
write.csv(KER3_wls_no_outliers,"Papers_R/2024_DeVleeschouwer/Figure4/Data/Output/FigS12/OLS_WLS/KER3/DM_WLS_no_outliers.csv", row.names = FALSE)

#Summary Leverage & Cooks distnce plots - write to file 
pdf(file = "Papers_R/2024_DeVleeschouwer/Figure4/Data/Output/FigS12/OLS_WLS/KER3/DM_wls_lev_bar.pdf")
barplot(hatvalues(KER3_wls), 
        col = "blue")
dev.off()
pdf(file = "Papers_R/2024_DeVleeschouwer/Figure4/Data/Output/FigS12/OLS_WLS/KER3/DM_wls_lev.pdf")
leveragePlots(KER3_wls,layout=c(2,2)) 
dev.off()
pdf(file = "Papers_R/2024_DeVleeschouwer/Figure4/Data/Output/FigS12/OLS_WLS/KER3/DM_wls_lev_cooks.pdf")
par(mfrow = c(2, 2))
plot(KER3_wls)
dev.off()
...
write.csv(KER3_wls_wt_no_outliers,"Papers_R/2024_DeVleeschouwer/Figure4/Data/Output/FigS12/OLS_WLS/KER3/DM_WLS_wt_no_outliers.csv", row.names = FALSE)

#Summary Leverage & Cooks distnce plots - write to file 
pdf(file = "Papers_R/2024_DeVleeschouwer/Figure4/Data/Output/FigS12/OLS_WLS/KER3/DM_wls_wt_lev_bar.pdf")
barplot(hatvalues(KER3_wls_wt), 
        col = "green")
dev.off()
pdf(file = "Papers_R/2024_DeVleeschouwer/Figure4/Data/Output/FigS12/OLS_WLS/KER3/DM_wls_wt_lev.pdf")
leveragePlots(KER3_wls_wt,layout=c(2,2)) 
dev.off()
pdf(file = "Papers_R/2024_DeVleeschouwer/Figure4/Data/Output/FigS12/OLS_WLS/KER3/DM_wls_wt_lev_cooks.pdf")
par(mfrow = c(2, 2))
plot(KER3_wls_wt)
dev.off()
...
KER3_final <- KER3 + 
  ...
  geom_text(data=data.frame(), aes(label=paste("OLS: ", KER3_DM_lm_eqn(df)), x = -Inf, y = Inf),
            parse = TRUE, colour = "blue", hjust = -0.15, vjust = 5, size = 3)
KER3_final
ggsave("Papers_R/2024_DeVleeschouwer/Figure4/Data/Output/FigS12/OLS_WLS/KER3/FigS12_KER3_DM_OLS_WLS_summary.pdf", 
       height = c(20), width = c(20), dpi = 600, units = "cm")
...
ggsave("Papers_R/2024_DeVleeschouwer/Figure4/Data/Output/FigS12/OLS_WLS/PB1/DM_OLS_performance.pdf", 
       height = c(30), width = c(30), dpi = 600, units = "cm")
# Write summary stats/checks to txt file
sink(file = "Papers_R/2024_DeVleeschouwer/Figure4/Data/Output/FigS12/OLS_WLS/PB1/DM_OLS_summary.txt")
summary(PB1_DM_lm)
glance(PB1_DM_lm)
model_performance(PB1_DM_lm) # AIC - Akaike information criterion; BIC Bayesian IC: lower = better fit for both
...
ggsave("Papers_R/2024_DeVleeschouwer/Figure4/Data/Output/FigS12/OLS_WLS/PB1/DM_OLS_wt_performance.pdf", 
       height = c(30), width = c(30), dpi = 600, units = "cm")
# Write summary stats/checks to txt file
sink(file = "Papers_R/2024_DeVleeschouwer/Figure4/Data/Output/FigS12/OLS_WLS/PB1/DM_OLS_wt_summary.txt")
summary(PB1_wlm)
glance(PB1_wlm)
model_performance(PB1_wlm) # AIC - Akaike information criterion; BIC Bayesian IC: lower = better fit for both
...
ggsave("Papers_R/2024_DeVleeschouwer/Figure4/Data/Output/FigS12/OLS_WLS/PB1/DM_WLS_performance.pdf", 
       height = c(30), width = c(30), dpi = 600, units = "cm")
# Write summary stats/checks to txt file
sink(file = "Papers_R/2024_DeVleeschouwer/Figure4/Data/Output/FigS12/OLS_WLS/PB1/DM_WLS_summary.txt")
summary(PB1_wls)
glance(PB1_wls)
model_performance(PB1_wls) # AIC - Akaike information criterion; BIC Bayesian IC: lower = better fit for both
...
ggsave("Papers_R/2024_DeVleeschouwer/Figure4/Data/Output/FigS12/OLS_WLS/PB1/DM_WLS_wt_performance.pdf", 
       height = c(30), width = c(30), dpi = 600, units = "cm")
# Write summary stats/checks to txt file
sink(file = "Papers_R/2024_DeVleeschouwer/Figure4/Data/Output/FigS12/OLS_WLS/PB1/DM_WLS_wt_summary.txt")
summary(PB1_wls_wt)
glance(PB1_wls_wt)
model_performance(PB1_wls_wt) # AIC - Akaike information criterion; BIC Bayesian IC: lower = better fit for both
...
write.csv(PB1_DM_lm_no_outliers,"Papers_R/2024_DeVleeschouwer/Figure4/Data/Output/FigS12/OLS_WLS/PB1/DM_OLS_no_outliers.csv", row.names = FALSE)

#Summary Leverage & Cooks distnce plots - write to file 
pdf(file = "Papers_R/2024_DeVleeschouwer/Figure4/Data/Output/FigS12/OLS_WLS/PB1/DM_DM_lm_lev_bar.pdf")
barplot(hatvalues(PB1_DM_lm), 
        col = "aquamarine3")
dev.off()
pdf(file = "Papers_R/2024_DeVleeschouwer/Figure4/Data/Output/FigS12/OLS_WLS/PB1/DM_DM_lm_lev.pdf")
leveragePlots(PB1_DM_lm,layout=c(2,2)) 
dev.off()
pdf(file = "Papers_R/2024_DeVleeschouwer/Figure4/Data/Output/FigS12/OLS_WLS/PB1/DM_DM_lm_lev_cooks.pdf")
par(mfrow = c(2, 2))
plot(PB1_DM_lm)
dev.off()
...
write.csv(PB1_wlm_no_outliers,"Papers_R/2024_DeVleeschouwer/Figure4/Data/Output/FigS12/OLS_WLS/PB1/DM_OLS_wt_no_outliers.csv", row.names = FALSE)

#Summary Leverage & Cooks distnce plots - write to file 
pdf(file = "Papers_R/2024_DeVleeschouwer/Figure4/Data/Output/FigS12/OLS_WLS/PB1/DM_wlm_lev_bar.pdf")
barplot(hatvalues(PB1_wlm), 
        col = "red")
dev.off()
pdf(file = "Papers_R/2024_DeVleeschouwer/Figure4/Data/Output/FigS12/OLS_WLS/PB1/DM_wlm_lev.pdf")
leveragePlots(PB1_wlm,layout=c(2,2)) 
dev.off()
pdf(file = "Papers_R/2024_DeVleeschouwer/Figure4/Data/Output/FigS12/OLS_WLS/PB1/DM_wlm_lev_cooks.pdf")
par(mfrow = c(2, 2))
plot(PB1_wlm)
dev.off()
...
write.csv(PB1_wls_no_outliers,"Papers_R/2024_DeVleeschouwer/Figure4/Data/Output/FigS12/OLS_WLS/PB1/DM_WLS_no_outliers.csv", row.names = FALSE)

#Summary Leverage & Cooks distnce plots - write to file 
pdf(file = "Papers_R/2024_DeVleeschouwer/Figure4/Data/Output/FigS12/OLS_WLS/PB1/DM_wls_lev_bar.pdf")
barplot(hatvalues(PB1_wls), 
        col = "blue")
dev.off()
pdf(file = "Papers_R/2024_DeVleeschouwer/Figure4/Data/Output/FigS12/OLS_WLS/PB1/DM_wls_lev.pdf")
leveragePlots(PB1_wls,layout=c(2,2)) 
dev.off()
pdf(file = "Papers_R/2024_DeVleeschouwer/Figure4/Data/Output/FigS12/OLS_WLS/PB1/DM_wls_lev_cooks.pdf")
par(mfrow = c(2, 2))
plot(PB1_wls)
dev.off()
...
write.csv(PB1_wls_wt_no_outliers,"Papers_R/2024_DeVleeschouwer/Figure4/Data/Output/FigS12/OLS_WLS/PB1/DM_WLS_wt_no_outliers.csv", row.names = FALSE)

#Summary Leverage & Cooks distnce plots - write to file 
pdf(file = "Papers_R/2024_DeVleeschouwer/Figure4/Data/Output/FigS12/OLS_WLS/PB1/DM_wls_wt_lev_bar.pdf")
barplot(hatvalues(PB1_wls_wt), 
        col = "green")
dev.off()
pdf(file = "Papers_R/2024_DeVleeschouwer/Figure4/Data/Output/FigS12/OLS_WLS/PB1/DM_wls_wt_lev.pdf")
leveragePlots(PB1_wls_wt,layout=c(2,2)) 
dev.off()
pdf(file = "Papers_R/2024_DeVleeschouwer/Figure4/Data/Output/FigS12/OLS_WLS/PB1/DM_wls_wt_lev_cooks.pdf")
par(mfrow = c(2, 2))
plot(PB1_wls_wt)
dev.off()
...
PB1_final <- PB1 + 
  ...
  geom_text(data=data.frame(), aes(label=paste("OLS: ", PB1_DM_lm_eqn(df)), x = -Inf, y = Inf),
            parse = TRUE, colour = "blue", hjust = -0.15, vjust = 5, size = 3)
PB1_final
ggsave("Papers_R/2024_DeVleeschouwer/Figure4/Data/Output/FigS12/OLS_WLS/PB1/FigS12_PB1_DM_OLS_WLS_summary.pdf", 
       height = c(20), width = c(20), dpi = 600, units = "cm")
...
# Correlation - LOI & Corg vs inc/coh --------------------------
# Remove PB1 from ACE matched dataset - no PB1 LOI550 data available
ACE_Subsample_xrf_matched1<- bind_rows(BI10_Subsample_xrf_matched,
                                      HER42PB_Subsample_xrf_matched,
                                      KER1_Subsample_xrf_matched,
                                      KER3_Subsample_xrf_matched)
ACE_Subsample_xrf_matched1

write.csv(ACE_Subsample_xrf_matched1,"Papers_R/2024_DeVleeschouwer/Figure4/Data/Output/FigS12/ACE/ACE_Subsample_xrf_matched1.csv", 
          row.names = FALSE)

# ACE LOI550 OLS & WLS ------------------------------------------------

# 1) Unweighted OLS (Ordinary Least Squares) - linear model & checks
ACE_LOI_lm <- lm(LOI550 ~ inc_coh, data = ACE_Subsample_xrf_matched1)
summary(ACE_LOI_lm)
glance(ACE_LOI_lm)
...
ggsave("Papers_R/2024_DeVleeschouwer/Figure4/Data/Output/FigS12/OLS_WLS/ACE/LOI550_OLS_performance.pdf", 
       height = c(30), width = c(30), dpi = 600, units = "cm")
# Write summary stats/checks to txt file
sink(file = "Papers_R/2024_DeVleeschouwer/Figure4/Data/Output/FigS12/OLS_WLS/ACE/LOI550_OLS_summary.txt")
summary(ACE_LOI_lm)
glance(ACE_LOI_lm)
model_performance(ACE_LOI_lm) # AIC - Akaike information criterion; BIC Bayesian IC: lower = better fit for both
...
# 2) Weighted OLS linear model & checks
ACE_wlm <- lm(LOI550 ~ inc_coh, data = ACE_Subsample_xrf_matched1, weight = 1/(LOI550_err)^2)
summary(ACE_wlm)
glance(ACE_wlm)
model_performance(ACE_wlm) # AIC - Akaike information criterion; BIC Bayesian IC: lower = better fit for both
check_model(ACE_wlm) # summary check plots
ggsave("Papers_R/2024_DeVleeschouwer/Figure4/Data/Output/FigS12/OLS_WLS/ACE/LOI550_OLS_wt_performance.pdf", 
       height = c(30), width = c(30), dpi = 600, units = "cm")
# Write summary stats/checks to txt file
sink(file = "Papers_R/2024_DeVleeschouwer/Figure4/Data/Output/FigS12/OLS_WLS/ACE/LOI550_OLS_wt_summary.txt")
summary(ACE_wlm)
glance(ACE_wlm)
model_performance(ACE_wlm) # AIC - Akaike information criterion; BIC Bayesian IC: lower = better fit for both
bptest(ACE_wlm) # lmtest package check for heteroscedasticity - p <0.05 = reject null hypothesis - heteroscedasticity present
...
# 3) Unweighted Linear Regression (WLS) model
ACE_model <- lm(LOI550 ~ inc_coh, data = ACE_Subsample_xrf_matched1) # define model
ACE_wt <- 1 / lm(abs(ACE_model$residuals) ~ ACE_model$fitted.values)$fitted.values^2 #define weights to use
ACE_wls <- lm(LOI550 ~ inc_coh, data = ACE_Subsample_xrf_matched1, weights=ACE_wt) #perform weighted least squares regression
# Checks
summary(ACE_wls) # summary stats
glance(ACE_wls) # summary stats including AIC
model_performance(ACE_wls) # AIC - Akaike information criterion; BIC Bayesian IC: lower = better fit for both
check_model(ACE_wls) # summary check plots
ggsave("Papers_R/2024_DeVleeschouwer/Figure4/Data/Output/FigS12/OLS_WLS/ACE/LOI550_WLS_performance.pdf", 
       height = c(30), width = c(30), dpi = 600, units = "cm")
# Write summary stats/checks to txt file
sink(file = "Papers_R/2024_DeVleeschouwer/Figure4/Data/Output/FigS12/OLS_WLS/ACE/LOI550_WLS_summary.txt")
summary(ACE_wls)
glance(ACE_wls)
model_performance(ACE_wls) # AIC - Akaike information criterion; BIC Bayesian IC: lower = better fit for both
bptest(ACE_wls) # lmtest package check for heteroscedasticity - p <0.05 = reject null hypothesis - heteroscedasticity present
...
# 4) Weighted Linear Regression (WLS) - ICPMS error weighted  - model
ACE_model_wt <- lm(LOI550 ~ inc_coh, data = ACE_Subsample_xrf_matched1, weight = 1/LOI550_err^2) # define model
ACE_wt_wt <- 1 / lm(abs(ACE_model_wt$residuals) ~ ACE_model_wt$fitted.values)$fitted.values^2 #define weights to use
ACE_wls_wt <- lm(LOI550 ~ inc_coh, data = ACE_Subsample_xrf_matched1, weights=ACE_wt_wt) #perform weighted least squares regression
# Checks
summary(ACE_wls_wt) # summary stats
glance(ACE_wls_wt) # summary stats including AIC
model_performance(ACE_wls_wt) # AIC - Akaike information criterion; BIC Bayesian IC: lower = better fit for both
check_model(ACE_wls_wt) # summary check plots
ggsave("Papers_R/2024_DeVleeschouwer/Figure4/Data/Output/FigS12/OLS_WLS/ACE/LOI550_WLS_wt_performance.pdf", 
       height = c(30), width = c(30), dpi = 600, units = "cm")
# Write summary stats/checks to txt file
sink(file = "Papers_R/2024_DeVleeschouwer/Figure4/Data/Output/FigS12/OLS_WLS/ACE/LOI550_WLS_wt_summary.txt")
summary(ACE_wls_wt)
glance(ACE_wls_wt)
model_performance(ACE_wls_wt) # AIC - Akaike information criterion; BIC Bayesian IC: lower = better fit for both
bptest(ACE_wls_wt) # lmtest package check for heteroscedasticity - p <0.05 = reject null hypothesis - heteroscedasticity present
...
ACE_LOI_lm_outliers <- ACE_Subsample_xrf_matched1[ACE_LOI_lm_influential_names,] # outliers only using of index values
ACE_LOI_lm_no_outliers <- ACE_Subsample_xrf_matched1 %>% anti_join(ACE_LOI_lm_outliers) # generates a new dataset with outliers removed
write.csv(ACE_LOI_lm_no_outliers,"Papers_R/2024_DeVleeschouwer/Figure4/Data/Output/FigS12/OLS_WLS/ACE/LOI550_OLS_no_outliers.csv", row.names = FALSE)

#Summary Leverage & Cooks distnce plots - write to file 
pdf(file = "Papers_R/2024_DeVleeschouwer/Figure4/Data/Output/FigS12/OLS_WLS/ACE/LOI550_DM_lm_lev_bar.pdf")
barplot(hatvalues(ACE_LOI_lm), 
        col = "aquamarine3")
dev.off()
pdf(file = "Papers_R/2024_DeVleeschouwer/Figure4/Data/Output/FigS12/OLS_WLS/ACE/LOI550_DM_lm_lev.pdf")
leveragePlots(ACE_LOI_lm,layout=c(2,2)) 
dev.off()
pdf(file = "Papers_R/2024_DeVleeschouwer/Figure4/Data/Output/FigS12/OLS_WLS/ACE/LOI550_DM_lm_lev_cooks.pdf")
par(mfrow = c(2, 2))
plot(ACE_LOI_lm)
dev.off()
...
ACE_wlm_influential
ACE_wlm_influential_names <- names(ACE_wlm_influential)
ACE_wlm_outliers <- ACE_Subsample_xrf_matched1[ACE_wlm_influential_names,] # outliers only using of index values
ACE_wlm_no_outliers <- ACE_Subsample_xrf_matched1 %>% anti_join(ACE_wlm_outliers) # generates a new dataset with outliers removed
write.csv(ACE_wlm_no_outliers,"Papers_R/2024_DeVleeschouwer/Figure4/Data/Output/FigS12/OLS_WLS/ACE/LOI550_OLS_wt_no_outliers.csv", row.names = FALSE)

#Summary Leverage & Cooks distnce plots - write to file 
pdf(file = "Papers_R/2024_DeVleeschouwer/Figure4/Data/Output/FigS12/OLS_WLS/ACE/LOI550_wlm_lev_bar.pdf")
barplot(hatvalues(ACE_wlm), 
        col = "red")
dev.off()
pdf(file = "Papers_R/2024_DeVleeschouwer/Figure4/Data/Output/FigS12/OLS_WLS/ACE/LOI550_wlm_lev.pdf")
leveragePlots(ACE_wlm,layout=c(2,2)) 
dev.off()
pdf(file = "Papers_R/2024_DeVleeschouwer/Figure4/Data/Output/FigS12/OLS_WLS/ACE/LOI550_wlm_lev_cooks.pdf")
par(mfrow = c(2, 2))
plot(ACE_wlm)
dev.off()
...
ACE_wls_influential
ACE_wls_influential_names <- names(ACE_wls_influential)
ACE_wls_outliers <- ACE_Subsample_xrf_matched1[ACE_wls_influential_names,] # outliers only using of index values
ACE_wls_no_outliers <- ACE_Subsample_xrf_matched1 %>% anti_join(ACE_wls_outliers) # generates a new dataset with outliers removed
write.csv(ACE_wls_no_outliers,"Papers_R/2024_DeVleeschouwer/Figure4/Data/Output/FigS12/OLS_WLS/ACE/LOI550_WLS_no_outliers.csv", row.names = FALSE)

#Summary Leverage & Cooks distnce plots - write to file 
pdf(file = "Papers_R/2024_DeVleeschouwer/Figure4/Data/Output/FigS12/OLS_WLS/ACE/LOI550_wls_lev_bar.pdf")
barplot(hatvalues(ACE_wls), 
        col = "blue")
dev.off()
pdf(file = "Papers_R/2024_DeVleeschouwer/Figure4/Data/Output/FigS12/OLS_WLS/ACE/LOI550_wls_lev.pdf")
leveragePlots(ACE_wls,layout=c(2,2)) 
dev.off()
pdf(file = "Papers_R/2024_DeVleeschouwer/Figure4/Data/Output/FigS12/OLS_WLS/ACE/LOI550_wls_lev_cooks.pdf")
par(mfrow = c(2, 2))
plot(ACE_wls)
dev.off()
...
ACE_wls_wt_influential
ACE_wls_wt_influential_names <- names(ACE_wls_wt_influential)
ACE_wls_wt_outliers <- ACE_Subsample_xrf_matched1[ACE_wls_wt_influential_names,] # outliers only using of index values
ACE_wls_wt_no_outliers <- ACE_Subsample_xrf_matched1 %>% anti_join(ACE_wls_wt_outliers) # generates a new dataset with outliers removed
write.csv(ACE_wls_wt_no_outliers,"Papers_R/2024_DeVleeschouwer/Figure4/Data/Output/FigS12/OLS_WLS/ACE/LOI550_WLS_wt_no_outliers.csv", row.names = FALSE)

#Summary Leverage & Cooks distnce plots - write to file 
pdf(file = "Papers_R/2024_DeVleeschouwer/Figure4/Data/Output/FigS12/OLS_WLS/ACE/LOI550_wls_wt_lev_bar.pdf")
barplot(hatvalues(ACE_wls_wt), 
        col = "green")
dev.off()
pdf(file = "Papers_R/2024_DeVleeschouwer/Figure4/Data/Output/FigS12/OLS_WLS/ACE/LOI550_wls_wt_lev.pdf")
leveragePlots(ACE_wls_wt,layout=c(2,2)) 
dev.off()
pdf(file = "Papers_R/2024_DeVleeschouwer/Figure4/Data/Output/FigS12/OLS_WLS/ACE/LOI550_wls_wt_lev_cooks.pdf")
par(mfrow = c(2, 2))
plot(ACE_wls_wt)
dev.off()
...
theme_set(theme_classic(10))
ACE <- ggplot(ACE_Subsample_xrf_matched1, aes(x = inc_coh, y = LOI550)) +
...
ACE_LOI_lm_eqn <- function(df){
  m <- lm(LOI550 ~ inc_coh, data = ACE_Subsample_xrf_matched1);
  eq <- substitute(italic(y) == a + b %.% italic(x)*","~~italic(R)^2~"="~r2*","~~italic(P)~"="~p, 
                   list(a = format(unname(coef(m)[1]), digits = 2),
                        b = format(unname(coef(m)[2]), digits = 2),
                        r2 = format(summary(m)$r.squared, digits = 3),
...
ACE_wlm_eqn <- function(df){
  m <- lm(LOI550 ~ inc_coh, data = ACE_Subsample_xrf_matched1, weight = 1/(LOI550_err)^2);
  eq <- substitute(italic(y) == a + b %.% italic(x)*","~~italic(R)^2~"="~r2*","~~italic(P)~"="~p, 
                   list(a = format(unname(coef(m)[1]), digits = 2),
                        b = format(unname(coef(m)[2]), digits = 2),
                        r2 = format(summary(m)$r.squared, digits = 3),
...
ACE_final <- ACE + 
  ...
  geom_text(data=data.frame(), aes(label=paste("OLS: ", ACE_LOI_lm_eqn(df)), x = -Inf, y = Inf),
            parse = TRUE, colour = "blue", hjust = -0.15, vjust = 5, size = 3)
ACE_final
ggsave("Papers_R/2024_DeVleeschouwer/Figure4/Data/Output/FigS12/OLS_WLS/ACE/FigS12_ACE_LOI_OLS_WLS_summary.pdf", 
       height = c(20), width = c(20), dpi = 600, units = "cm")

# ACE %Carbon OLS & WLS ------------------------------------------------

# 1) Unweighted OLS (Ordinary Least Squares) - linear model & checks
ACE_C_lm <- lm(C_org_pc ~ inc_coh, data = ACE_Subsample_xrf_matched1)
summary(ACE_C_lm)
glance(ACE_C_lm)
...
ggsave("Papers_R/2024_DeVleeschouwer/Figure4/Data/Output/FigS12/OLS_WLS/ACE/Carbon_OLS_performance.pdf", 
       height = c(30), width = c(30), dpi = 600, units = "cm")
# Write summary stats/checks to txt file
sink(file = "Papers_R/2024_DeVleeschouwer/Figure4/Data/Output/FigS12/OLS_WLS/ACE/Carbon_OLS_summary.txt")
summary(ACE_C_lm)
glance(ACE_C_lm)
model_performance(ACE_C_lm) # AIC - Akaike information criterion; BIC Bayesian IC: lower = better fit for both
...
# 2) Weighted OLS linear model & checks
ACE_wlm <- lm(C_org_pc ~ inc_coh, data = ACE_Subsample_xrf_matched1, weight = 1/(C_org_pc_err)^2)
summary(ACE_wlm)
glance(ACE_wlm)
model_performance(ACE_wlm) # AIC - Akaike information criterion; BIC Bayesian IC: lower = better fit for both
check_model(ACE_wlm) # summary check plots
ggsave("Papers_R/2024_DeVleeschouwer/Figure4/Data/Output/FigS12/OLS_WLS/ACE/Carbon_OLS_wt_performance.pdf", 
       height = c(30), width = c(30), dpi = 600, units = "cm")
# Write summary stats/checks to txt file
sink(file = "Papers_R/2024_DeVleeschouwer/Figure4/Data/Output/FigS12/OLS_WLS/ACE/Carbon_OLS_wt_summary.txt")
summary(ACE_wlm)
glance(ACE_wlm)
model_performance(ACE_wlm) # AIC - Akaike information criterion; BIC Bayesian IC: lower = better fit for both
bptest(ACE_wlm) # lmtest package check for heteroscedasticity - p <0.05 = reject null hypothesis - heteroscedasticity present
...
# 3) Unweighted Linear Regression (WLS) model
ACE_model <- lm(C_org_pc ~ inc_coh, data = ACE_Subsample_xrf_matched1) # define model
ACE_wt <- 1 / lm(abs(ACE_model$residuals) ~ ACE_model$fitted.values)$fitted.values^2 #define weights to use
ACE_wls <- lm(C_org_pc ~ inc_coh, data = ACE_Subsample_xrf_matched1, weights=ACE_wt) #perform weighted least squares regression
# Checks
summary(ACE_wls) # summary stats
glance(ACE_wls) # summary stats including AIC
model_performance(ACE_wls) # AIC - Akaike information criterion; BIC Bayesian IC: lower = better fit for both
check_model(ACE_wls) # summary check plots
ggsave("Papers_R/2024_DeVleeschouwer/Figure4/Data/Output/FigS12/OLS_WLS/ACE/Carbon_WLS_performance.pdf", 
       height = c(30), width = c(30), dpi = 600, units = "cm")
# Write summary stats/checks to txt file
sink(file = "Papers_R/2024_DeVleeschouwer/Figure4/Data/Output/FigS12/OLS_WLS/ACE/Carbon_WLS_summary.txt")
summary(ACE_wls)
glance(ACE_wls)
model_performance(ACE_wls) # AIC - Akaike information criterion; BIC Bayesian IC: lower = better fit for both
bptest(ACE_wls) # lmtest package check for heteroscedasticity - p <0.05 = reject null hypothesis - heteroscedasticity present
...
# 4) Weighted Linear Regression (WLS) - ICPMS error weighted  - model
ACE_model_wt <- lm(C_org_pc ~ inc_coh, data = ACE_Subsample_xrf_matched1, weight = 1/C_org_pc_err^2) # define model
ACE_wt_wt <- 1 / lm(abs(ACE_model_wt$residuals) ~ ACE_model_wt$fitted.values)$fitted.values^2 #define weights to use
ACE_wls_wt <- lm(C_org_pc ~ inc_coh, data = ACE_Subsample_xrf_matched1, weights=ACE_wt_wt) #perform weighted least squares regression
# Checks
summary(ACE_wls_wt) # summary stats
glance(ACE_wls_wt) # summary stats including AIC
model_performance(ACE_wls_wt) # AIC - Akaike information criterion; BIC Bayesian IC: lower = better fit for both
check_model(ACE_wls_wt) # summary check plots
ggsave("Papers_R/2024_DeVleeschouwer/Figure4/Data/Output/FigS12/OLS_WLS/ACE/Carbon_WLS_wt_performance.pdf", 
       height = c(30), width = c(30), dpi = 600, units = "cm")
# Write summary stats/checks to txt file
sink(file = "Papers_R/2024_DeVleeschouwer/Figure4/Data/Output/FigS12/OLS_WLS/ACE/Carbon_WLS_wt_summary.txt")
summary(ACE_wls_wt)
glance(ACE_wls_wt)
model_performance(ACE_wls_wt) # AIC - Akaike information criterion; BIC Bayesian IC: lower = better fit for both
bptest(ACE_wls_wt) # lmtest package check for heteroscedasticity - p <0.05 = reject null hypothesis - heteroscedasticity present
...
ACE_C_lm_outliers <- ACE_Subsample_xrf_matched1[ACE_C_lm_influential_names,] # outliers only using of index values
ACE_C_lm_no_outliers <- ACE_Subsample_xrf_matched1 %>% anti_join(ACE_C_lm_outliers) # generates a new dataset with outliers removed
write.csv(ACE_C_lm_no_outliers,"Papers_R/2024_DeVleeschouwer/Figure4/Data/Output/FigS12/OLS_WLS/ACE/Carbon_OLS_no_outliers.csv", row.names = FALSE)

#Summary Leverage & Cooks distnce plots - write to file 
pdf(file = "Papers_R/2024_DeVleeschouwer/Figure4/Data/Output/FigS12/OLS_WLS/ACE/Carbon_DM_lm_lev_bar.pdf")
barplot(hatvalues(ACE_C_lm), 
        col = "aquamarine3")
dev.off()
pdf(file = "Papers_R/2024_DeVleeschouwer/Figure4/Data/Output/FigS12/OLS_WLS/ACE/Carbon_DM_lm_lev.pdf")
leveragePlots(ACE_C_lm,layout=c(2,2)) 
dev.off()
pdf(file = "Papers_R/2024_DeVleeschouwer/Figure4/Data/Output/FigS12/OLS_WLS/ACE/Carbon_DM_lm_lev_cooks.pdf")
par(mfrow = c(2, 2))
plot(ACE_C_lm)
dev.off()
...
ACE_wlm_outliers <- ACE_Subsample_xrf_matched1[ACE_wlm_influential_names,] # outliers only using of index values
ACE_wlm_no_outliers <- ACE_Subsample_xrf_matched1 %>% anti_join(ACE_wlm_outliers) # generates a new dataset with outliers removed
write.csv(ACE_wlm_no_outliers,"Papers_R/2024_DeVleeschouwer/Figure4/Data/Output/FigS12/OLS_WLS/ACE/Carbon_OLS_wt_no_outliers.csv", row.names = FALSE)

#Summary Leverage & Cooks distnce plots - write to file 
pdf(file = "Papers_R/2024_DeVleeschouwer/Figure4/Data/Output/FigS12/OLS_WLS/ACE/Carbon_wlm_lev_bar.pdf")
barplot(hatvalues(ACE_wlm), 
        col = "red")
dev.off()
pdf(file = "Papers_R/2024_DeVleeschouwer/Figure4/Data/Output/FigS12/OLS_WLS/ACE/Carbon_wlm_lev.pdf")
leveragePlots(ACE_wlm,layout=c(2,2)) 
dev.off()
pdf(file = "Papers_R/2024_DeVleeschouwer/Figure4/Data/Output/FigS12/OLS_WLS/ACE/Carbon_wlm_lev_cooks.pdf")
par(mfrow = c(2, 2))
plot(ACE_wlm)
dev.off()
...
ACE_wls_outliers <- ACE_Subsample_xrf_matched1[ACE_wls_influential_names,] # outliers only using of index values
ACE_wls_no_outliers <- ACE_Subsample_xrf_matched1 %>% anti_join(ACE_wls_outliers) # generates a new dataset with outliers removed
write.csv(ACE_wls_no_outliers,"Papers_R/2024_DeVleeschouwer/Figure4/Data/Output/FigS12/OLS_WLS/ACE/Carbon_WLS_no_outliers.csv", row.names = FALSE)

#Summary Leverage & Cooks distnce plots - write to file 
pdf(file = "Papers_R/2024_DeVleeschouwer/Figure4/Data/Output/FigS12/OLS_WLS/ACE/Carbon_wls_lev_bar.pdf")
barplot(hatvalues(ACE_wls), 
        col = "blue")
dev.off()
pdf(file = "Papers_R/2024_DeVleeschouwer/Figure4/Data/Output/FigS12/OLS_WLS/ACE/Carbon_wls_lev.pdf")
leveragePlots(ACE_wls,layout=c(2,2)) 
dev.off()
pdf(file = "Papers_R/2024_DeVleeschouwer/Figure4/Data/Output/FigS12/OLS_WLS/ACE/Carbon_wls_lev_cooks.pdf")
par(mfrow = c(2, 2))
plot(ACE_wls)
dev.off()
...
ACE_wls_wt_outliers <- ACE_Subsample_xrf_matched1[ACE_wls_wt_influential_names,] # outliers only using of index values
ACE_wls_wt_no_outliers <- ACE_Subsample_xrf_matched1 %>% anti_join(ACE_wls_wt_outliers) # generates a new dataset with outliers removed
write.csv(ACE_wls_wt_no_outliers,"Papers_R/2024_DeVleeschouwer/Figure4/Data/Output/FigS12/OLS_WLS/ACE/Carbon_WLS_wt_no_outliers.csv", row.names = FALSE)

#Summary Leverage & Cooks distnce plots - write to file 
pdf(file = "Papers_R/2024_DeVleeschouwer/Figure4/Data/Output/FigS12/OLS_WLS/ACE/Carbon_wls_wt_lev_bar.pdf")
barplot(hatvalues(ACE_wls_wt), 
        col = "green")
dev.off()
pdf(file = "Papers_R/2024_DeVleeschouwer/Figure4/Data/Output/FigS12/OLS_WLS/ACE/Carbon_wls_wt_lev.pdf")
leveragePlots(ACE_wls_wt,layout=c(2,2)) 
dev.off()
pdf(file = "Papers_R/2024_DeVleeschouwer/Figure4/Data/Output/FigS12/OLS_WLS/ACE/Carbon_wls_wt_lev_cooks.pdf")
par(mfrow = c(2, 2))
plot(ACE_wls_wt)
dev.off()
...
element_title <- "inc_coh"
theme_set(theme_classic(10))
ACE <- ggplot(ACE_Subsample_xrf_matched1, aes(x = inc_coh, y = C_org_pc)) +
...
ACE_C_lm_eqn <- function(df){
  m <- lm(C_org_pc ~ inc_coh, data = ACE_Subsample_xrf_matched1);
  eq <- substitute(italic(y) == a + b %.% italic(x)*","~~italic(R)^2~"="~r2*","~~italic(P)~"="~p, 
                   list(a = format(unname(coef(m)[1]), digits = 2),
                        b = format(unname(coef(m)[2]), digits = 2),
                        r2 = format(summary(m)$r.squared, digits = 3),
...
ACE_wlm_eqn <- function(df){
  m <- lm(C_org_pc ~ inc_coh, data = ACE_Subsample_xrf_matched1, weight = 1/(C_org_pc_err)^2);
  eq <- substitute(italic(y) == a + b %.% italic(x)*","~~italic(R)^2~"="~r2*","~~italic(P)~"="~p, 
                   list(a = format(unname(coef(m)[1]), digits = 2),
                        b = format(unname(coef(m)[2]), digits = 2),
                        r2 = format(summary(m)$r.squared, digits = 3),
...
ACE_final <- ACE + 
  ...
  geom_text(data=data.frame(), aes(label=paste("OLS: ", ACE_C_lm_eqn(df)), x = -Inf, y = Inf),
            parse = TRUE, colour = "blue", hjust = -0.15, vjust = 5, size = 3)
ACE_final
ggsave("Papers_R/2024_DeVleeschouwer/Figure4/Data/Output/FigS12/OLS_WLS/ACE/FigS12_ACE_Corg_pc_OLS_WLS_summary.pdf", 
       height = c(20), width = c(20), dpi = 600, units = "cm")
