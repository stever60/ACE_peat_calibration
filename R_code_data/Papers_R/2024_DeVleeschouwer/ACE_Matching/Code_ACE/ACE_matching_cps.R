...
# ITRAX-ICPMS Data Matching, Correlation & Regression
...
write.csv(ACE_xrf_icp_matched,"Papers_R/2024_DeVleeschouwer/ACE_Matching/Output/itrax_Composite/Matching_mean/ACE/cps/ACE_xrf_icp_matched_cps.csv", row.names = FALSE)
...
ACE_xrf_icp_matched <-read_csv("Papers_R/2024_DeVleeschouwer/ACE_Matching/Output/itrax_Composite/Matching_mean/ACE/cps/ACE_xrf_icp_matched.csv")
...
ACE_all <- ACE_xrf_icp_matched %>% 
  ...
  print()
write.csv(ACE_all,"Papers_R/2024_DeVleeschouwer/ACE_Matching/Output/itrax_Composite/Matching_mean/ACE/cps/ACE_all.csv", row.names = FALSE)
write.csv(ACE_all,"Papers_R/2024_DeVleeschouwer/ACE_Matching/Output/itrax_Composite/Matching_mean/ACE/cps/ACE_xrf_icp_matched_cps.csv", row.names = FALSE)

# ACE matched - POB4 removed for regression analysis
ACE_no_POB4 <- ACE_all %>% 
  filter(!Site =="POB4") %>% 
  print()
write.csv(ACE_no_POB4,"Papers_R/2024_DeVleeschouwer/ACE_Matching/Output/itrax_Composite/Matching_mean/ACE/cps/ACE_no_POB4.csv", row.names = FALSE)
...
ACE_no_POB4_PB1 <- ACE_all %>% 
  ...
  filter(!Site =="PB1") %>% 
  print()
write.csv(ACE_no_POB4_PB1,"Papers_R/2024_DeVleeschouwer/ACE_Matching/Output/itrax_Composite/Matching_mean/ACE/cps/ACE_no_POB4_PB1.csv", row.names = FALSE)

ACE_no_PB1 <- ACE_all %>% # inc and %cps only - dont use 
  filter(!Site =="PB1") %>% 
  print()
write.csv(ACE_no_PB1,"Papers_R/2024_DeVleeschouwer/ACE_Matching/Output/itrax_Composite/Matching_mean/ACE/cps/ACE_no_PB1.csv", row.names = FALSE)
...
ACE_all_stats <- ACE_all %>%
  ...
  print()
write.csv(ACE_all_stats,"Papers_R/2024_DeVleeschouwer/ACE_Matching/Output/itrax_Composite/Matching_mean/ACE/cps/ACE_all_stats.csv", row.names = FALSE)

ACE_no_POB4_stats <- ACE_no_POB4 %>%
  psych::describe(quant=c(.25,.75)) %>%
  as_tibble(rownames="rowname")  %>%
  print()
write.csv(ACE_no_POB4_stats,"Papers_R/2024_DeVleeschouwer/ACE_Matching/Output/itrax_Composite/Matching_mean/ACE/cps/ACE_no_POB4_stats.csv", row.names = FALSE)

ACE_no_POB4_PB1_stats <- ACE_no_POB4_PB1 %>%
  psych::describe(quant=c(.25,.75)) %>%
  as_tibble(rownames="rowname")  %>%
  print()
write.csv(ACE_no_POB4_PB1_stats,"Papers_R/2024_DeVleeschouwer/ACE_Matching/Output/itrax_Composite/Matching_mean/ACE/cps/ACE_no_POB4_PB1_stats.csv", row.names = FALSE)

ACE_no_PB1_stats <- ACE_no_PB1 %>%
  psych::describe(quant=c(.25,.75)) %>%
  as_tibble(rownames="rowname")  %>%
  print()
write.csv(ACE_no_PB1_stats,"Papers_R/2024_DeVleeschouwer/ACE_Matching/Output/itrax_Composite/Matching_mean/ACE/cps/ACE_no_PB1_stats.csv", row.names = FALSE)
...
ggsave("Papers_R/2024_DeVleeschouwer/ACE_Matching/Output/itrax_Composite/Matching_mean/ACE/cps/ACE_Correlation_cps/ACE_itrax_Corr_matrix.pdf", 
...
ggcorr(ACE_LM1[,icp_Elements_min], method = c("everything", "pearson"), 
       size = 3, label = TRUE, label_alpha = FALSE, label_round=2, label_size= 3)
ggsave("Papers_R/2024_DeVleeschouwer/ACE_Matching/Output/itrax_Composite/Matching_mean/ACE/cps/ACE_Correlation_cps/ACE_ICP_Corr_matrix.pdf", 
       height = c(30), width = c(30), dpi = 600, units = "cm")

# ITRAX & ICP - all elements correlations
theme_set(theme_bw(base_size=2))
ggcorr(ACE_LM1[,xrf_icp_Elements_min], method = c("everything", "pearson"), # use xrf_icp_Elements_min for all matched elements
       size = 3, label = TRUE, label_alpha = FALSE, label_round=2, label_size= 3)
ggsave("Papers_R/2024_DeVleeschouwer/ACE_Matching/Output/itrax_Composite/Matching_mean/ACE/cps/ACE_Correlation_cps/ACE_itrax_ICP_Corr_matrix.pdf", 
       height = c(30), width = c(30), dpi = 600, units = "cm")
...
ggsave("Papers_R/2024_DeVleeschouwer/ACE_Matching/Output/itrax_Composite/Matching_mean/ACE/cps/ACE_Correlation_cps/ACE_itrax_ICP_Corr_matrix_key.pdf", 
       height = c(30), width = c(30), dpi = 600, units = "cm")
...
ggsave("Papers_R/2024_DeVleeschouwer/ACE_Matching/Output/itrax_Composite/Matching_mean/ACE/cps/ACE_Correlation_cps/ACE_itrax_ICP_Corr_matrix_key_reduced.pdf", 
       height = c(30), width = c(30), dpi = 600, units = "cm")
...
ggsave("Papers_R/2024_DeVleeschouwer/ACE_Matching/Output/itrax_Composite/Matching_mean/ACE/cps/ACE_Correlation_cps/ACE_itrax_Corr-den_matrix.pdf", 
       height = c(30), width = c(30), dpi = 600, units = "cm")
...
ggsave("Papers_R/2024_DeVleeschouwer/ACE_Matching/Output/itrax_Composite/Matching_mean/ACE/cps/ACE_Correlation_cps/ACE_ICP_Corr-den_matrix.pdf", 
       height = c(30), width = c(30), dpi = 600, units = "cm")
...
ggsave("Papers_R/2024_DeVleeschouwer/ACE_Matching/Output/itrax_Composite/Matching_mean/ACE/cps/ACE_Correlation_cps/ACE_itrax_ICP_Corr-den_matrix.pdf", 
...
ggpairs(ACE_LM1, columns = xrf_icp_Elements_key, upper = list(continuous = wrap("cor", size = 4)),
        lower = list(continuous = wrap("points", alpha = 0.5, size=0.2)),
        title="ACE XRF-CS & ICPMS: Correlation-density plot - cps")
ggsave("Papers_R/2024_DeVleeschouwer/ACE_Matching/Output/itrax_Composite/Matching_mean/ACE/cps/ACE_Correlation_cps/ACE_itrax_ICP_Corr-den_matrix_key.pdf", 
       height = c(15), width = c(15), dpi = 600, units = "cm")

theme_set(theme_bw(base_size=8))
ggpairs(ACE_LM1, columns = xrf_icp_Elements_key_reduced, upper = list(continuous = wrap("cor", size = 4)),
        lower = list(continuous = wrap("points", alpha = 0.5, size=0.2)),
        title="ACE XRF-CS & ICPMS: Correlation-density plot - cps")
ggsave("Papers_R/2024_DeVleeschouwer/ACE_Matching/Output/itrax_Composite/Matching_mean/ACE/cps/ACE_Correlation_cps/ACE_itrax_ICP_Corr-den_matrix_key_reduced.pdf", 
       height = c(15), width = c(15), dpi = 600, units = "cm")


# ITRAX & ICP - key elements correlations and regressions
# Function to plot each site as different colour using jco scheme
theme_set(theme_bw(base_size=8))
...
ggsave("Papers_R/2024_DeVleeschouwer/ACE_Matching/Output/itrax_Composite/Matching_mean/ACE/cps/ACE_Correlation_cps/ACE_itrax_ICP_Corr-den_matrix_key_reg1.pdf", 
       height = c(30), width = c(30), dpi = 600, units = "cm")
...
ggsave("Papers_R/2024_DeVleeschouwer/ACE_Matching/Output/itrax_Composite/Matching_mean/ACE/cps/ACE_Correlation_cps/ACE_itrax_ICP_Corr-den_matrix_key_reg2.pdf", 
       height = c(30), width = c(30), dpi = 600, units = "cm")
...
ggsave("Papers_R/2024_DeVleeschouwer/ACE_Matching/Output/itrax_Composite/Matching_mean/ACE/cps/ACE_Correlation_cps/ACE_itrax_ICP_Corr-den_matrix_key_reduced_reg2.pdf", 
       height = c(30), width = c(30), dpi = 600, units = "cm")
...
ggpairs(ACE_LM1, columns = xrf_icp_Elements_key, upper = list(continuous = wrap("cor", size = 3)),
        ...
        title="ACE XRF-CS & ICPMS: Correlation-density plot - cps")
ggsave("Papers_R/2024_DeVleeschouwer/ACE_Matching/Output/itrax_Composite/Matching_mean/ACE/cps/ACE_Correlation_cps/ACE_itrax_ICP_Corr-den_matrix_key_reg3.pdf", 
       height = c(30), width = c(30), dpi = 600, units = "cm")
...
ggpairs(ACE_LM1, columns = xrf_icp_Elements_key, upper = list(continuous = wrap("cor", size = 3)),
        ...
        aes(color = Site,  # Color by group (cat. variable)
            alpha = 0.5),     # Transparency
        title="ACE XRF-CS & ICPMS: Correlation-density plot - cps")
ggsave("Papers_R/2024_DeVleeschouwer/ACE_Matching/Output/itrax_Composite/Matching_mean/ACE/cps/ACE_Correlation_cps/ACE_itrax_ICP_Corr-den_matrix_site_key_plots.pdf", 
       height = c(30), width = c(30), dpi = 600, units = "cm")
...
K_corr1
ggsave("Papers_R/2024_DeVleeschouwer/ACE_Matching/Output/itrax_Composite/Matching_mean/ACE/cps/ACE_Correlation_cps/K/K_Fig1_Correlation_all_sites.pdf", 
...
ggdraw(K_corr2)
ggsave("Papers_R/2024_DeVleeschouwer/ACE_Matching/Output/itrax_Composite/Matching_mean/ACE/cps/ACE_Correlation_cps/K/K_Fig2c_Scatterplot_all_sites.pdf", 
       height = c(16), width = c(16), dpi = 600, units = "cm")
...
K_corr3 <- ggscatter(ACE_all, x = "K", y = "K_ICP", size = 1,
  ...
  ggtitle(paste("ACE: ", element_title, ICP_title ,"vs", XRF_title))
K_corr3
ggsave("Papers_R/2024_DeVleeschouwer/ACE_Matching/Output/itrax_Composite/Matching_mean/ACE/cps/ACE_Correlation_cps/K/K_Fig2d_Correlation_per_site.pdf", 
       height = c(16), width = c(16), dpi = 600, units = "cm")
# Figure 2: 4-part plot 
ggarrange(K_XRF_violin_boxplot, K_ICP_violin_boxplot, K_corr2, K_corr3, ncol = 2, 
          nrow = 2, labels = c("a", "b", "c", "d"))
ggsave("Papers_R/2024_DeVleeschouwer/ACE_Matching/Output/itrax_Composite/Matching_mean/ACE/cps/ACE_Correlation_cps/K/K_Fig2_Correlation_Sites.pdf", 
       height = c(30), width = c(30), dpi = 600, units = "cm")
...
data_1_out <- bind_cols(ACE_LM1, pred.int1) %>%
  ...
  print()
write.csv(data_1_out,"Papers_R/2024_DeVleeschouwer/ACE_Matching/Output/itrax_Composite/Matching_mean/ACE/cps/ACE_Correlation_cps/K/K_Model_predict.csv", row.names = FALSE)
...
K_predict
ggsave("Papers_R/2024_DeVleeschouwer/ACE_Matching/Output/itrax_Composite/Matching_mean/ACE/cps/ACE_Correlation_cps/K/K_Fig3a_Correlation_predict.pdf", 
       height = c(16), width = c(16), dpi = 600, units = "cm")
#Figure 3c, d
theme_set(theme_classic(base_size=10))
...
ggsave("Papers_R/2024_DeVleeschouwer/ACE_Matching/Output/itrax_Composite/Matching_mean/ACE/cps/ACE_Correlation_cps/K/K_Fig3_Correlation_Sites.pdf", 
       height = c(30), width = c(30), dpi = 600, units = "cm")
...
sink(file = "Papers_R/2024_DeVleeschouwer/ACE_Matching/Output/itrax_Composite/Matching_mean/ACE/cps/ACE_Correlation_cps/K/K_Summary_stats.txt")
print(correlate_ALL)
print(ctest_all)
print(ctest_LM1)
print(ctest_LM2)
...
Ca_corr1 <- ggscatter(ACE_LM1, x = "Ca", y = "Ca_ICP",
  ...
  theme(axis.text = element_text(size=10), axis.title = element_text(size=10), plot.title = element_text(size=10, face="bold"))
Ca_corr1
ggsave("Papers_R/2024_DeVleeschouwer/ACE_Matching/Output/itrax_Composite/Matching_mean/ACE/cps/ACE_Correlation_cps/Ca/Ca_Fig1_Correlation_all_sites.pdf", 
       height = c(16), width = c(16), dpi = 600, units = "cm")
...
ggdraw(Ca_corr2)
ggsave("Papers_R/2024_DeVleeschouwer/ACE_Matching/Output/itrax_Composite/Matching_mean/ACE/cps/ACE_Correlation_cps/Ca/Ca_Fig2c_Scatterplot_all_sites.pdf", 
       height = c(16), width = c(16), dpi = 600, units = "cm")
# d) Correlation per site
theme_set(theme_classic(10))
Ca_corr3 <- ggscatter(ACE_all, x = "Ca", y = "Ca_ICP", size = 1,
  ...
  ggtitle(paste("ACE: ", element_title, ICP_title ,"vs", XRF_title))
Ca_corr3
ggsave("Papers_R/2024_DeVleeschouwer/ACE_Matching/Output/itrax_Composite/Matching_mean/ACE/cps/ACE_Correlation_cps/Ca/Ca_Fig2d_Correlation_per_site.pdf", 
       height = c(16), width = c(16), dpi = 600, units = "cm")
# Figure 2: 4-part plot 
ggarrange(Ca_XRF_violin_boxplot, Ca_ICP_violin_boxplot, Ca_corr2, Ca_corr3, ncol = 2, 
          nrow = 2, labels = c("a", "b", "c", "d"))
ggsave("Papers_R/2024_DeVleeschouwer/ACE_Matching/Output/itrax_Composite/Matching_mean/ACE/cps/ACE_Correlation_cps/Ca/Ca_Fig2_Correlation_Sites.pdf", 
       height = c(30), width = c(30), dpi = 600, units = "cm")
...
write.csv(data_1_out,"Papers_R/2024_DeVleeschouwer/ACE_Matching/Output/itrax_Composite/Matching_mean/ACE/cps/ACE_Correlation_cps/Ca/Ca_Model_predict.csv", row.names = FALSE)
...
Ca_predict <- Ca_p1 + geom_line(aes(y = lwr), color = "blue", linetype = "dashed") +
  ...
  theme(plot.title = element_text(color="black", size=12, face="bold"),
        ...
        axis.text.y = element_text(size=10))
Ca_predict
ggsave("Papers_R/2024_DeVleeschouwer/ACE_Matching/Output/itrax_Composite/Matching_mean/ACE/cps/ACE_Correlation_cps/Ca/Ca_Fig3a_Correlation_predict.pdf", 
       height = c(16), width = c(16), dpi = 600, units = "cm")
#Figure 3c, d
theme_set(theme_classic(base_size=10))
...
ggarrange(Ca_predict,  Ca_qq.x1, Ca_res, Ca_qq.y1,
          ncol = 2, nrow = 2, labels = c("a", "b", "c", "d"))
ggsave("Papers_R/2024_DeVleeschouwer/ACE_Matching/Output/itrax_Composite/Matching_mean/ACE/cps/ACE_Correlation_cps/Ca/Ca_Fig3_Correlation_Sites.pdf", 
       height = c(30), width = c(30), dpi = 600, units = "cm")
...
# Write summary stats/normality & residual checks output to txt file
sink(file = "Papers_R/2024_DeVleeschouwer/ACE_Matching/Output/itrax_Composite/Matching_mean/ACE/cps/ACE_Correlation_cps/Ca/Ca_Summary_stats.txt")
print(correlate_ALL)
print(ctest_all)
print(ctest_LM1)
print(ctest_LM2)
...
Ti_corr1 <- ggscatter(ACE_LM1, x = "Ti", y = "Ti_ICP",
  ...
  theme(axis.text = element_text(size=10), axis.title = element_text(size=10), plot.title = element_text(size=10, face="bold"))
Ti_corr1
ggsave("Papers_R/2024_DeVleeschouwer/ACE_Matching/Output/itrax_Composite/Matching_mean/ACE/cps/ACE_Correlation_cps/Ti/Ti_Fig1_Correlation_all_sites.pdf", 
       height = c(16), width = c(16), dpi = 600, units = "cm")
...
ggdraw(Ti_corr2)
ggsave("Papers_R/2024_DeVleeschouwer/ACE_Matching/Output/itrax_Composite/Matching_mean/ACE/cps/ACE_Correlation_cps/Ti/Ti_Fig2c_Scatterplot_all_sites.pdf", 
       height = c(16), width = c(16), dpi = 600, units = "cm")
# d) Correlation per site
theme_set(theme_classic(10))
Ti_corr3 <- ggscatter(ACE_all, x = "Ti", y = "Ti_ICP", size = 1,
  ...
  ggtitle(paste("ACE: ", element_title, ICP_title ,"vs", XRF_title))
Ti_corr3
ggsave("Papers_R/2024_DeVleeschouwer/ACE_Matching/Output/itrax_Composite/Matching_mean/ACE/cps/ACE_Correlation_cps/Ti/Ti_Fig2d_Correlation_per_site.pdf", 
       height = c(16), width = c(16), dpi = 600, units = "cm")
# Figure 2: 4-part plot 
ggarrange(Ti_XRF_violin_boxplot, Ti_ICP_violin_boxplot, Ti_corr2, Ti_corr3, ncol = 2, 
          nrow = 2, labels = c("a", "b", "c", "d"))
ggsave("Papers_R/2024_DeVleeschouwer/ACE_Matching/Output/itrax_Composite/Matching_mean/ACE/cps/ACE_Correlation_cps/Ti/Ti_Fig2_Correlation_Sites.pdf", 
       height = c(30), width = c(30), dpi = 600, units = "cm")
...
write.csv(data_1_out,"Papers_R/2024_DeVleeschouwer/ACE_Matching/Output/itrax_Composite/Matching_mean/ACE/cps/ACE_Correlation_cps/Ti/Ti_Model_predict.csv", row.names = FALSE)
...
Ti_predict <- Ti_p1 + geom_line(aes(y = lwr), color = "blue", linetype = "dashed") +
  ...
  theme(plot.title = element_text(color="black", size=12, face="bold"),
        ...
        axis.text.y = element_text(size=10))
Ti_predict
ggsave("Papers_R/2024_DeVleeschouwer/ACE_Matching/Output/itrax_Composite/Matching_mean/ACE/cps/ACE_Correlation_cps/Ti/Ti_Fig3a_Correlation_predict.pdf", 
       height = c(16), width = c(16), dpi = 600, units = "cm")
#Figure 3c, d
theme_set(theme_classic(base_size=10))
...
ggarrange(Ti_predict,  Ti_qq.x1, Ti_res, Ti_qq.y1,
          ncol = 2, nrow = 2, labels = c("a", "b", "c", "d"))
ggsave("Papers_R/2024_DeVleeschouwer/ACE_Matching/Output/itrax_Composite/Matching_mean/ACE/cps/ACE_Correlation_cps/Ti/Ti_Fig3_Correlation_Sites.pdf", 
       height = c(30), width = c(30), dpi = 600, units = "cm")
...
# Write summary stats/normality & residual checks output to txt file
sink(file = "Papers_R/2024_DeVleeschouwer/ACE_Matching/Output/itrax_Composite/Matching_mean/ACE/cps/ACE_Correlation_cps/Ti/Ti_Summary_stats.txt")
print(correlate_ALL)
print(ctest_all)
print(ctest_LM1)
print(ctest_LM2)
...
Mn_corr1 <- ggscatter(ACE_LM1, x = "Mn", y = "Mn_ICP",
  ...
  theme(axis.text = element_text(size=10), axis.title = element_text(size=10), plot.title = element_text(size=10, face="bold"))
Mn_corr1
ggsave("Papers_R/2024_DeVleeschouwer/ACE_Matching/Output/itrax_Composite/Matching_mean/ACE/cps/ACE_Correlation_cps/Mn/Mn_Fig1_Correlation_all_sites.pdf", 
       height = c(16), width = c(16), dpi = 600, units = "cm")
...
ggdraw(Mn_corr2)
ggsave("Papers_R/2024_DeVleeschouwer/ACE_Matching/Output/itrax_Composite/Matching_mean/ACE/cps/ACE_Correlation_cps/Mn/Mn_Fig2c_Scatterplot_all_sites.pdf", 
       height = c(16), width = c(16), dpi = 600, units = "cm")
# d) Correlation per site
theme_set(theme_classic(10))
Mn_corr3 <- ggscatter(ACE_all, x = "Mn", y = "Mn_ICP", size = 1,
  ...
  ggtitle(paste("ACE: ", element_title, ICP_title ,"vs", XRF_title))
Mn_corr3
ggsave("Papers_R/2024_DeVleeschouwer/ACE_Matching/Output/itrax_Composite/Matching_mean/ACE/cps/ACE_Correlation_cps/Mn/Mn_Fig2d_Correlation_per_site.pdf", 
       height = c(16), width = c(16), dpi = 600, units = "cm")
# Figure 2: 4-part plot 
ggarrange(Mn_XRF_violin_boxplot, Mn_ICP_violin_boxplot, Mn_corr2, Mn_corr3, ncol = 2, 
          nrow = 2, labels = c("a", "b", "c", "d"))
ggsave("Papers_R/2024_DeVleeschouwer/ACE_Matching/Output/itrax_Composite/Matching_mean/ACE/cps/ACE_Correlation_cps/Mn/Mn_Fig2_Correlation_Sites.pdf", 
       height = c(30), width = c(30), dpi = 600, units = "cm")
...
write.csv(data_1_out,"Papers_R/2024_DeVleeschouwer/ACE_Matching/Output/itrax_Composite/Matching_mean/ACE/cps/ACE_Correlation_cps/Mn/Mn_Model_predict.csv", row.names = FALSE)
...
Mn_predict <- Mn_p1 + geom_line(aes(y = lwr), color = "blue", linetype = "dashed") +
  ...
  theme(plot.title = element_text(color="black", size=12, face="bold"),
        ...
        axis.text.y = element_text(size=10))
Mn_predict
ggsave("Papers_R/2024_DeVleeschouwer/ACE_Matching/Output/itrax_Composite/Matching_mean/ACE/cps/ACE_Correlation_cps/Mn/Mn_Fig3a_Correlation_predict.pdf", 
       height = c(16), width = c(16), dpi = 600, units = "cm")
#Figure 3c, d
theme_set(theme_classic(base_size=10))
...
ggarrange(Mn_predict,  Mn_qq.x1, Mn_res, Mn_qq.y1,
          ncol = 2, nrow = 2, labels = c("a", "b", "c", "d"))
ggsave("Papers_R/2024_DeVleeschouwer/ACE_Matching/Output/itrax_Composite/Matching_mean/ACE/cps/ACE_Correlation_cps/Mn/Mn_Fig3_Correlation_Sites.pdf", 
       height = c(30), width = c(30), dpi = 600, units = "cm")
...
# Write summary stats/normality & residual checks output to txt file
sink(file = "Papers_R/2024_DeVleeschouwer/ACE_Matching/Output/itrax_Composite/Matching_mean/ACE/cps/ACE_Correlation_cps/Mn/Mn_Summary_stats.txt")
print(correlate_ALL)
print(ctest_all)
print(ctest_LM1)
print(ctest_LM2)
...
Fe_corr1 <- ggscatter(ACE_LM1, x = "Fe", y = "Fe_ICP",
  ...
  theme(axis.text = element_text(size=10), axis.title = element_text(size=10), plot.title = element_text(size=10, face="bold"))
Fe_corr1
ggsave("Papers_R/2024_DeVleeschouwer/ACE_Matching/Output/itrax_Composite/Matching_mean/ACE/cps/ACE_Correlation_cps/Fe/Fe_Fig1_Correlation_all_sites.pdf", 
       height = c(16), width = c(16), dpi = 600, units = "cm")
...
ggdraw(Fe_corr2)
ggsave("Papers_R/2024_DeVleeschouwer/ACE_Matching/Output/itrax_Composite/Matching_mean/ACE/cps/ACE_Correlation_cps/Fe/Fe_Fig2c_Scatterplot_all_sites.pdf", 
       height = c(16), width = c(16), dpi = 600, units = "cm")
# d) Correlation per site
theme_set(theme_classic(10))
Fe_corr3 <- ggscatter(ACE_all, x = "Fe", y = "Fe_ICP", size = 1,
  ...
  ggtitle(paste("ACE: ", element_title, ICP_title ,"vs", XRF_title))
Fe_corr3
ggsave("Papers_R/2024_DeVleeschouwer/ACE_Matching/Output/itrax_Composite/Matching_mean/ACE/cps/ACE_Correlation_cps/Fe/Fe_Fig2d_Correlation_per_site.pdf", 
       height = c(16), width = c(16), dpi = 600, units = "cm")
# Figure 2: 4-part plot 
ggarrange(Fe_XRF_violin_boxplot, Fe_ICP_violin_boxplot, Fe_corr2, Fe_corr3, ncol = 2, 
          nrow = 2, labels = c("a", "b", "c", "d"))
ggsave("Papers_R/2024_DeVleeschouwer/ACE_Matching/Output/itrax_Composite/Matching_mean/ACE/cps/ACE_Correlation_cps/Fe/Fe_Fig2_Correlation_Sites.pdf", 
       height = c(30), width = c(30), dpi = 600, units = "cm")
...
write.csv(data_1_out,"Papers_R/2024_DeVleeschouwer/ACE_Matching/Output/itrax_Composite/Matching_mean/ACE/cps/ACE_Correlation_cps/Fe/Fe_Model_predict.csv", row.names = FALSE)
...
Fe_predict <- Fe_p1 + geom_line(aes(y = lwr), color = "blue", linetype = "dashed") +
  ...
  theme(plot.title = element_text(color="black", size=12, face="bold"),
        ...
        axis.text.y = element_text(size=10))
Fe_predict
ggsave("Papers_R/2024_DeVleeschouwer/ACE_Matching/Output/itrax_Composite/Matching_mean/ACE/cps/ACE_Correlation_cps/Fe/Fe_Fig3a_Correlation_predict.pdf", 
       height = c(16), width = c(16), dpi = 600, units = "cm")
#Figure 3c, d
theme_set(theme_classic(base_size=10))
...
ggarrange(Fe_predict,  Fe_qq.x1, Fe_res, Fe_qq.y1,
          ncol = 2, nrow = 2, labels = c("a", "b", "c", "d"))
ggsave("Papers_R/2024_DeVleeschouwer/ACE_Matching/Output/itrax_Composite/Matching_mean/ACE/cps/ACE_Correlation_cps/Fe/Fe_Fig3_Correlation_Sites.pdf", 
       height = c(30), width = c(30), dpi = 600, units = "cm")
...
# Write summary stats/normality & residual checks output to txt file
sink(file = "Papers_R/2024_DeVleeschouwer/ACE_Matching/Output/itrax_Composite/Matching_mean/ACE/cps/ACE_Correlation_cps/Fe/Fe_Summary_stats.txt")
print(correlate_ALL)
print(ctest_all)
print(ctest_LM1)
print(ctest_LM2)
...
Co_corr1 <- ggscatter(ACE_LM1, x = "Co", y = "Co_ICP",
  ...
  theme(axis.text = element_text(size=10), axis.title = element_text(size=10), plot.title = element_text(size=10, face="bold"))
Co_corr1
ggsave("Papers_R/2024_DeVleeschouwer/ACE_Matching/Output/itrax_Composite/Matching_mean/ACE/cps/ACE_Correlation_cps/Co/Co_Fig1_Correlation_all_sites.pdf", 
       height = c(16), width = c(16), dpi = 600, units = "cm")
...
ggdraw(Co_corr2)
ggsave("Papers_R/2024_DeVleeschouwer/ACE_Matching/Output/itrax_Composite/Matching_mean/ACE/cps/ACE_Correlation_cps/Co/Co_Fig2c_Scatterplot_all_sites.pdf", 
       height = c(16), width = c(16), dpi = 600, units = "cm")
# d) Correlation per site
theme_set(theme_classic(10))
Co_corr3 <- ggscatter(ACE_all, x = "Co", y = "Co_ICP", size = 1,
  ...
  ggtitle(paste("ACE: ", element_title, ICP_title ,"vs", XRF_title))
Co_corr3
ggsave("Papers_R/2024_DeVleeschouwer/ACE_Matching/Output/itrax_Composite/Matching_mean/ACE/cps/ACE_Correlation_cps/Co/Co_Fig2d_Correlation_per_site.pdf", 
       height = c(16), width = c(16), dpi = 600, units = "cm")
# Figure 2: 4-part plot 
ggarrange(Co_XRF_violin_boxplot, Co_ICP_violin_boxplot, Co_corr2, Co_corr3, ncol = 2, 
          nrow = 2, labels = c("a", "b", "c", "d"))
ggsave("Papers_R/2024_DeVleeschouwer/ACE_Matching/Output/itrax_Composite/Matching_mean/ACE/cps/ACE_Correlation_cps/Co/Co_Fig2_Correlation_Sites.pdf", 
       height = c(30), width = c(30), dpi = 600, units = "cm")
...
write.csv(data_1_out,"Papers_R/2024_DeVleeschouwer/ACE_Matching/Output/itrax_Composite/Matching_mean/ACE/cps/ACE_Correlation_cps/Co/Co_Model_predict.csv", row.names = FALSE)
...
Co_predict <- Co_p1 + geom_line(aes(y = lwr), color = "blue", linetype = "dashed") +
  ...
  theme(plot.title = element_text(color="black", size=12, face="bold"),
        ...
        axis.text.y = element_text(size=10))
Co_predict
ggsave("Papers_R/2024_DeVleeschouwer/ACE_Matching/Output/itrax_Composite/Matching_mean/ACE/cps/ACE_Correlation_cps/Co/Co_Fig3a_Correlation_predict.pdf", 
       height = c(16), width = c(16), dpi = 600, units = "cm")
#Figure 3c, d
theme_set(theme_classic(base_size=10))
...
ggarrange(Co_predict,  Co_qq.x1, Co_res, Co_qq.y1,
          ncol = 2, nrow = 2, labels = c("a", "b", "c", "d"))
ggsave("Papers_R/2024_DeVleeschouwer/ACE_Matching/Output/itrax_Composite/Matching_mean/ACE/cps/ACE_Correlation_cps/Co/Co_Fig3_Correlation_Sites.pdf", 
       height = c(30), width = c(30), dpi = 600, units = "cm")
...
# Write summary stats/normality & residual checks output to txt file
sink(file = "Papers_R/2024_DeVleeschouwer/ACE_Matching/Output/itrax_Composite/Matching_mean/ACE/cps/ACE_Correlation_cps/Co/Co_Summary_stats.txt")
print(correlate_ALL)
print(ctest_all)
print(ctest_LM1)
print(ctest_LM2)
...
Ni_corr1 <- ggscatter(ACE_LM1, x = "Ni", y = "Ni_ICP",
  ...
  theme(axis.text = element_text(size=10), axis.title = element_text(size=10), plot.title = element_text(size=10, face="bold"))
Ni_corr1
ggsave("Papers_R/2024_DeVleeschouwer/ACE_Matching/Output/itrax_Composite/Matching_mean/ACE/cps/ACE_Correlation_cps/Ni/Ni_Fig1_Correlation_all_sites.pdf", 
       height = c(16), width = c(16), dpi = 600, units = "cm")
...
ggdraw(Ni_corr2)
ggsave("Papers_R/2024_DeVleeschouwer/ACE_Matching/Output/itrax_Composite/Matching_mean/ACE/cps/ACE_Correlation_cps/Ni/Ni_Fig2c_Scatterplot_all_sites.pdf", 
       height = c(16), width = c(16), dpi = 600, units = "cm")
# d) Correlation per site
theme_set(theme_classic(10))
Ni_corr3 <- ggscatter(ACE_all, x = "Ni", y = "Ni_ICP", size = 1,
  ...
  ggtitle(paste("ACE: ", element_title, ICP_title ,"vs", XRF_title))
Ni_corr3
ggsave("Papers_R/2024_DeVleeschouwer/ACE_Matching/Output/itrax_Composite/Matching_mean/ACE/cps/ACE_Correlation_cps/Ni/Ni_Fig2d_Correlation_per_site.pdf", 
       height = c(16), width = c(16), dpi = 600, units = "cm")
# Figure 2: 4-part plot 
ggarrange(Ni_XRF_violin_boxplot, Ni_ICP_violin_boxplot, Ni_corr2, Ni_corr3, ncol = 2, 
          nrow = 2, labels = c("a", "b", "c", "d"))
ggsave("Papers_R/2024_DeVleeschouwer/ACE_Matching/Output/itrax_Composite/Matching_mean/ACE/cps/ACE_Correlation_cps/Ni/Ni_Fig2_Correlation_Sites.pdf", 
       height = c(30), width = c(30), dpi = 600, units = "cm")
...
write.csv(data_1_out,"Papers_R/2024_DeVleeschouwer/ACE_Matching/Output/itrax_Composite/Matching_mean/ACE/cps/ACE_Correlation_cps/Ni/Ni_Model_predict.csv", row.names = FALSE)
...
Ni_predict <- Ni_p1 + geom_line(aes(y = lwr), color = "blue", linetype = "dashed") +
  ...
  theme(plot.title = element_text(color="black", size=12, face="bold"),
        ...
        axis.text.y = element_text(size=10))
Ni_predict
ggsave("Papers_R/2024_DeVleeschouwer/ACE_Matching/Output/itrax_Composite/Matching_mean/ACE/cps/ACE_Correlation_cps/Ni/Ni_Fig3a_Correlation_predict.pdf", 
       height = c(16), width = c(16), dpi = 600, units = "cm")
#Figure 3c, d
theme_set(theme_classic(base_size=10))
...
ggarrange(Ni_predict,  Ni_qq.x1, Ni_res, Ni_qq.y1,
          ncol = 2, nrow = 2, labels = c("a", "b", "c", "d"))
ggsave("Papers_R/2024_DeVleeschouwer/ACE_Matching/Output/itrax_Composite/Matching_mean/ACE/cps/ACE_Correlation_cps/Ni/Ni_Fig3_Correlation_Sites.pdf", 
       height = c(30), width = c(30), dpi = 600, units = "cm")
...
# Write summary stats/normality & residual checks output to txt file
sink(file = "Papers_R/2024_DeVleeschouwer/ACE_Matching/Output/itrax_Composite/Matching_mean/ACE/cps/ACE_Correlation_cps/Ni/Ni_Summary_stats.txt")
print(correlate_ALL)
print(ctest_all)
print(ctest_LM1)
print(ctest_LM2)
...
Cu_corr1 <- ggscatter(ACE_LM1, x = "Cu", y = "Cu_ICP",
  ...
  theme(axis.text = element_text(size=10), axis.title = element_text(size=10), plot.title = element_text(size=10, face="bold"))
Cu_corr1
ggsave("Papers_R/2024_DeVleeschouwer/ACE_Matching/Output/itrax_Composite/Matching_mean/ACE/cps/ACE_Correlation_cps/Cu/Cu_Fig1_Correlation_all_sites.pdf", 
       height = c(16), width = c(16), dpi = 600, units = "cm")
...
ggdraw(Cu_corr2)
ggsave("Papers_R/2024_DeVleeschouwer/ACE_Matching/Output/itrax_Composite/Matching_mean/ACE/cps/ACE_Correlation_cps/Cu/Cu_Fig2c_Scatterplot_all_sites.pdf", 
       height = c(16), width = c(16), dpi = 600, units = "cm")
# d) Correlation per site
theme_set(theme_classic(10))
Cu_corr3 <- ggscatter(ACE_all, x = "Cu", y = "Cu_ICP", size = 1,
  ...
  ggtitle(paste("ACE: ", element_title, ICP_title ,"vs", XRF_title))
Cu_corr3
ggsave("Papers_R/2024_DeVleeschouwer/ACE_Matching/Output/itrax_Composite/Matching_mean/ACE/cps/ACE_Correlation_cps/Cu/Cu_Fig2d_Correlation_per_site.pdf", 
       height = c(16), width = c(16), dpi = 600, units = "cm")
# Figure 2: 4-part plot 
ggarrange(Cu_XRF_violin_boxplot, Cu_ICP_violin_boxplot, Cu_corr2, Cu_corr3, ncol = 2, 
          nrow = 2, labels = c("a", "b", "c", "d"))
ggsave("Papers_R/2024_DeVleeschouwer/ACE_Matching/Output/itrax_Composite/Matching_mean/ACE/cps/ACE_Correlation_cps/Cu/Cu_Fig2_Correlation_Sites.pdf", 
       height = c(30), width = c(30), dpi = 600, units = "cm")
...
write.csv(data_1_out,"Papers_R/2024_DeVleeschouwer/ACE_Matching/Output/itrax_Composite/Matching_mean/ACE/cps/ACE_Correlation_cps/Cu/Cu_Model_predict.csv", row.names = FALSE)
...
Cu_predict <- Cu_p1 + geom_line(aes(y = lwr), color = "blue", linetype = "dashed") +
  ...
  theme(plot.title = element_text(color="black", size=12, face="bold"),
        ...
        axis.text.y = element_text(size=10))
Cu_predict
ggsave("Papers_R/2024_DeVleeschouwer/ACE_Matching/Output/itrax_Composite/Matching_mean/ACE/cps/ACE_Correlation_cps/Cu/Cu_Fig3a_Correlation_predict.pdf", 
       height = c(16), width = c(16), dpi = 600, units = "cm")
#Figure 3c, d
theme_set(theme_classic(base_size=10))
...
ggarrange(Cu_predict,  Cu_qq.x1, Cu_res, Cu_qq.y1,
          ncol = 2, nrow = 2, labels = c("a", "b", "c", "d"))
ggsave("Papers_R/2024_DeVleeschouwer/ACE_Matching/Output/itrax_Composite/Matching_mean/ACE/cps/ACE_Correlation_cps/Cu/Cu_Fig3_Correlation_Sites.pdf", 
       height = c(30), width = c(30), dpi = 600, units = "cm")
...
# Write summary stats/normality & residual checks output to txt file
sink(file = "Papers_R/2024_DeVleeschouwer/ACE_Matching/Output/itrax_Composite/Matching_mean/ACE/cps/ACE_Correlation_cps/Cu/Cu_Summary_stats.txt")
print(correlate_ALL)
print(ctest_all)
print(ctest_LM1)
print(ctest_LM2)
...
Zn_corr1 <- ggscatter(ACE_LM1, x = "Zn", y = "Zn_ICP",
  ...
  theme(axis.text = element_text(size=10), axis.title = element_text(size=10), plot.title = element_text(size=10, face="bold"))
Zn_corr1
ggsave("Papers_R/2024_DeVleeschouwer/ACE_Matching/Output/itrax_Composite/Matching_mean/ACE/cps/ACE_Correlation_cps/Zn/Zn_Fig1_Correlation_all_sites.pdf", 
       height = c(16), width = c(16), dpi = 600, units = "cm")
...
ggdraw(Zn_corr2)
ggsave("Papers_R/2024_DeVleeschouwer/ACE_Matching/Output/itrax_Composite/Matching_mean/ACE/cps/ACE_Correlation_cps/Zn/Zn_Fig2c_Scatterplot_all_sites.pdf", 
       height = c(16), width = c(16), dpi = 600, units = "cm")
# d) Correlation per site
theme_set(theme_classic(10))
Zn_corr3 <- ggscatter(ACE_all, x = "Zn", y = "Zn_ICP", size = 1,
  ...
  ggtitle(paste("ACE: ", element_title, ICP_title ,"vs", XRF_title))
Zn_corr3
ggsave("Papers_R/2024_DeVleeschouwer/ACE_Matching/Output/itrax_Composite/Matching_mean/ACE/cps/ACE_Correlation_cps/Zn/Zn_Fig2d_Correlation_per_site.pdf", 
       height = c(16), width = c(16), dpi = 600, units = "cm")
# Figure 2: 4-part plot 
ggarrange(Zn_XRF_violin_boxplot, Zn_ICP_violin_boxplot, Zn_corr2, Zn_corr3, ncol = 2, 
          nrow = 2, labels = c("a", "b", "c", "d"))
ggsave("Papers_R/2024_DeVleeschouwer/ACE_Matching/Output/itrax_Composite/Matching_mean/ACE/cps/ACE_Correlation_cps/Zn/Zn_Fig2_Correlation_Sites.pdf", 
       height = c(30), width = c(30), dpi = 600, units = "cm")
...
write.csv(data_1_out,"Papers_R/2024_DeVleeschouwer/ACE_Matching/Output/itrax_Composite/Matching_mean/ACE/cps/ACE_Correlation_cps/Zn/Zn_Model_predict.csv", row.names = FALSE)
...
Zn_predict <- Zn_p1 + geom_line(aes(y = lwr), color = "blue", linetype = "dashed") +
  ...
  theme(plot.title = element_text(color="black", size=12, face="bold"),
        ...
        axis.text.y = element_text(size=10))
Zn_predict
ggsave("Papers_R/2024_DeVleeschouwer/ACE_Matching/Output/itrax_Composite/Matching_mean/ACE/cps/ACE_Correlation_cps/Zn/Zn_Fig3a_Correlation_predict.pdf", 
       height = c(16), width = c(16), dpi = 600, units = "cm")
#Figure 3c, d
theme_set(theme_classic(base_size=10))
...
ggarrange(Zn_predict,  Zn_qq.x1, Zn_res, Zn_qq.y1,
          ncol = 2, nrow = 2, labels = c("a", "b", "c", "d"))
ggsave("Papers_R/2024_DeVleeschouwer/ACE_Matching/Output/itrax_Composite/Matching_mean/ACE/cps/ACE_Correlation_cps/Zn/Zn_Fig3_Correlation_Sites.pdf", 
       height = c(30), width = c(30), dpi = 600, units = "cm")
...
# Write summary stats/normality & residual checks output to txt file
sink(file = "Papers_R/2024_DeVleeschouwer/ACE_Matching/Output/itrax_Composite/Matching_mean/ACE/cps/ACE_Correlation_cps/Zn/Zn_Summary_stats.txt")
print(correlate_ALL)
print(ctest_all)
print(ctest_LM1)
print(ctest_LM2)
...
Rb_corr1 <- ggscatter(ACE_LM1, x = "Rb", y = "Rb_ICP",
  ...
  theme(axis.text = element_text(size=10), axis.title = element_text(size=10), plot.title = element_text(size=10, face="bold"))
Rb_corr1
ggsave("Papers_R/2024_DeVleeschouwer/ACE_Matching/Output/itrax_Composite/Matching_mean/ACE/cps/ACE_Correlation_cps/Rb/Rb_Fig1_Correlation_all_sites.pdf", 
       height = c(16), width = c(16), dpi = 600, units = "cm")
...
ggdraw(Rb_corr2)
ggsave("Papers_R/2024_DeVleeschouwer/ACE_Matching/Output/itrax_Composite/Matching_mean/ACE/cps/ACE_Correlation_cps/Rb/Rb_Fig2c_Scatterplot_all_sites.pdf", 
       height = c(16), width = c(16), dpi = 600, units = "cm")
# d) Correlation per site
theme_set(theme_classic(10))
Rb_corr3 <- ggscatter(ACE_all, x = "Rb", y = "Rb_ICP", size = 1,
  ...
  ggtitle(paste("ACE: ", element_title, ICP_title ,"vs", XRF_title))
Rb_corr3
ggsave("Papers_R/2024_DeVleeschouwer/ACE_Matching/Output/itrax_Composite/Matching_mean/ACE/cps/ACE_Correlation_cps/Rb/Rb_Fig2d_Correlation_per_site.pdf", 
       height = c(16), width = c(16), dpi = 600, units = "cm")
# Figure 2: 4-part plot 
ggarrange(Rb_XRF_violin_boxplot, Rb_ICP_violin_boxplot, Rb_corr2, Rb_corr3, ncol = 2, 
          nrow = 2, labels = c("a", "b", "c", "d"))
ggsave("Papers_R/2024_DeVleeschouwer/ACE_Matching/Output/itrax_Composite/Matching_mean/ACE/cps/ACE_Correlation_cps/Rb/Rb_Fig2_Correlation_Sites.pdf", 
       height = c(30), width = c(30), dpi = 600, units = "cm")
...
write.csv(data_1_out,"Papers_R/2024_DeVleeschouwer/ACE_Matching/Output/itrax_Composite/Matching_mean/ACE/cps/ACE_Correlation_cps/Rb/Rb_Model_predict.csv", row.names = FALSE)
...
Rb_predict <- Rb_p1 + geom_line(aes(y = lwr), color = "blue", linetype = "dashed") +
  ...
  theme(plot.title = element_text(color="black", size=12, face="bold"),
        ...
        axis.text.y = element_text(size=10))
Rb_predict
ggsave("Papers_R/2024_DeVleeschouwer/ACE_Matching/Output/itrax_Composite/Matching_mean/ACE/cps/ACE_Correlation_cps/Rb/Rb_Fig3a_Correlation_predict.pdf", 
       height = c(16), width = c(16), dpi = 600, units = "cm")
#Figure 3c, d
theme_set(theme_classic(base_size=10))
...
ggarrange(Rb_predict,  Rb_qq.x1, Rb_res, Rb_qq.y1,
          ncol = 2, nrow = 2, labels = c("a", "b", "c", "d"))
ggsave("Papers_R/2024_DeVleeschouwer/ACE_Matching/Output/itrax_Composite/Matching_mean/ACE/cps/ACE_Correlation_cps/Rb/Rb_Fig3_Correlation_Sites.pdf", 
       height = c(30), width = c(30), dpi = 600, units = "cm")
...
# Write summary stats/normality & residual checks output to txt file
sink(file = "Papers_R/2024_DeVleeschouwer/ACE_Matching/Output/itrax_Composite/Matching_mean/ACE/cps/ACE_Correlation_cps/Rb/Rb_Summary_stats.txt")
print(correlate_ALL)
print(ctest_all)
print(ctest_LM1)
print(ctest_LM2)
...
Sr_corr1 <- ggscatter(ACE_LM1, x = "Sr", y = "Sr_ICP",
  ...
  theme(axis.text = element_text(size=10), axis.title = element_text(size=10), plot.title = element_text(size=10, face="bold"))
Sr_corr1
ggsave("Papers_R/2024_DeVleeschouwer/ACE_Matching/Output/itrax_Composite/Matching_mean/ACE/cps/ACE_Correlation_cps/Sr/Sr_Fig1_Correlation_all_sites.pdf", 
       height = c(16), width = c(16), dpi = 600, units = "cm")
...
ggdraw(Sr_corr2)
ggsave("Papers_R/2024_DeVleeschouwer/ACE_Matching/Output/itrax_Composite/Matching_mean/ACE/cps/ACE_Correlation_cps/Sr/Sr_Fig2c_Scatterplot_all_sites.pdf", 
       height = c(16), width = c(16), dpi = 600, units = "cm")
# d) Correlation per site
theme_set(theme_classic(10))
Sr_corr3 <- ggscatter(ACE_all, x = "Sr", y = "Sr_ICP", size = 1,
  ...
  ggtitle(paste("ACE: ", element_title, ICP_title ,"vs", XRF_title))
Sr_corr3
ggsave("Papers_R/2024_DeVleeschouwer/ACE_Matching/Output/itrax_Composite/Matching_mean/ACE/cps/ACE_Correlation_cps/Sr/Sr_Fig2d_Correlation_per_site.pdf", 
       height = c(16), width = c(16), dpi = 600, units = "cm")
# Figure 2: 4-part plot 
ggarrange(Sr_XRF_violin_boxplot, Sr_ICP_violin_boxplot, Sr_corr2, Sr_corr3, ncol = 2, 
          nrow = 2, labels = c("a", "b", "c", "d"))
ggsave("Papers_R/2024_DeVleeschouwer/ACE_Matching/Output/itrax_Composite/Matching_mean/ACE/cps/ACE_Correlation_cps/Sr/Sr_Fig2_Correlation_Sites.pdf", 
       height = c(30), width = c(30), dpi = 600, units = "cm")
...
write.csv(data_1_out,"Papers_R/2024_DeVleeschouwer/ACE_Matching/Output/itrax_Composite/Matching_mean/ACE/cps/ACE_Correlation_cps/Sr/Sr_Model_predict.csv", row.names = FALSE)
...
Sr_predict <- Sr_p1 + geom_line(aes(y = lwr), color = "blue", linetype = "dashed") +
  ...
  theme(plot.title = element_text(color="black", size=12, face="bold"),
        ...
        axis.text.y = element_text(size=10))
Sr_predict
ggsave("Papers_R/2024_DeVleeschouwer/ACE_Matching/Output/itrax_Composite/Matching_mean/ACE/cps/ACE_Correlation_cps/Sr/Sr_Fig3a_Correlation_predict.pdf", 
       height = c(16), width = c(16), dpi = 600, units = "cm")
#Figure 3c, d
theme_set(theme_classic(base_size=10))
...
ggarrange(Sr_predict,  Sr_qq.x1, Sr_res, Sr_qq.y1,
          ncol = 2, nrow = 2, labels = c("a", "b", "c", "d"))
ggsave("Papers_R/2024_DeVleeschouwer/ACE_Matching/Output/itrax_Composite/Matching_mean/ACE/cps/ACE_Correlation_cps/Sr/Sr_Fig3_Correlation_Sites.pdf", 
       height = c(30), width = c(30), dpi = 600, units = "cm")
...
# Write summary stats/normality & residual checks output to txt file
sink(file = "Papers_R/2024_DeVleeschouwer/ACE_Matching/Output/itrax_Composite/Matching_mean/ACE/cps/ACE_Correlation_cps/Sr/Sr_Summary_stats.txt")
print(correlate_ALL)
print(ctest_all)
print(ctest_LM1)
print(ctest_LM2)
...
Zr_corr1 <- ggscatter(ACE_LM1, x = "Zr", y = "Zr_ICP",
  ...
  theme(axis.text = element_text(size=10), axis.title = element_text(size=10), plot.title = element_text(size=10, face="bold"))
Zr_corr1
ggsave("Papers_R/2024_DeVleeschouwer/ACE_Matching/Output/itrax_Composite/Matching_mean/ACE/cps/ACE_Correlation_cps/Zr/Zr_Fig1_Correlation_all_sites.pdf", 
       height = c(16), width = c(16), dpi = 600, units = "cm")
...
ggdraw(Zr_corr2)
ggsave("Papers_R/2024_DeVleeschouwer/ACE_Matching/Output/itrax_Composite/Matching_mean/ACE/cps/ACE_Correlation_cps/Zr/Zr_Fig2c_Scatterplot_all_sites.pdf", 
       height = c(16), width = c(16), dpi = 600, units = "cm")
# d) Correlation per site
theme_set(theme_classic(10))
Zr_corr3 <- ggscatter(ACE_all, x = "Zr", y = "Zr_ICP", size = 1,
  ...
  ggtitle(paste("ACE: ", element_title, ICP_title ,"vs", XRF_title))
Zr_corr3
ggsave("Papers_R/2024_DeVleeschouwer/ACE_Matching/Output/itrax_Composite/Matching_mean/ACE/cps/ACE_Correlation_cps/Zr/Zr_Fig2d_Correlation_per_site.pdf", 
       height = c(16), width = c(16), dpi = 600, units = "cm")
# Figure 2: 4-part plot 
ggarrange(Zr_XRF_violin_boxplot, Zr_ICP_violin_boxplot, Zr_corr2, Zr_corr3, ncol = 2, 
          nrow = 2, labels = c("a", "b", "c", "d"))
ggsave("Papers_R/2024_DeVleeschouwer/ACE_Matching/Output/itrax_Composite/Matching_mean/ACE/cps/ACE_Correlation_cps/Zr/Zr_Fig2_Correlation_Sites.pdf", 
       height = c(30), width = c(30), dpi = 600, units = "cm")
...
write.csv(data_1_out,"Papers_R/2024_DeVleeschouwer/ACE_Matching/Output/itrax_Composite/Matching_mean/ACE/cps/ACE_Correlation_cps/Zr/Zr_Model_predict.csv", row.names = FALSE)
...
Zr_predict <- Zr_p1 + geom_line(aes(y = lwr), color = "blue", linetype = "dashed") +
  ...
  theme(plot.title = element_text(color="black", size=12, face="bold"),
        ...
        axis.text.y = element_text(size=10))
Rb_predict
ggsave("Papers_R/2024_DeVleeschouwer/ACE_Matching/Output/itrax_Composite/Matching_mean/ACE/cps/ACE_Correlation_cps/Zr/Zr_Fig3a_Correlation_predict.pdf", 
       height = c(16), width = c(16), dpi = 600, units = "cm")
#Figure 3c, d
theme_set(theme_classic(base_size=10))
...
ggarrange(Zr_predict,  Zr_qq.x1, Zr_res, Zr_qq.y1,
          ncol = 2, nrow = 2, labels = c("a", "b", "c", "d"))
ggsave("Papers_R/2024_DeVleeschouwer/ACE_Matching/Output/itrax_Composite/Matching_mean/ACE/cps/ACE_Correlation_cps/Zr/Zr_Fig3_Correlation_Sites.pdf", 
       height = c(30), width = c(30), dpi = 600, units = "cm")
...
# Write summary stats/normality & residual checks output to txt file
sink(file = "Papers_R/2024_DeVleeschouwer/ACE_Matching/Output/itrax_Composite/Matching_mean/ACE/cps/ACE_Correlation_cps/Zr/Zr_Summary_stats.txt")
print(correlate_ALL)
print(ctest_all)
print(ctest_LM1)
print(ctest_LM2)
...
DM_corr1 <- ggscatter(ACE_LM1, x = "coh_inc", y = "dry_mass_pc",
  ...
  theme(axis.text = element_text(size=10), axis.title = element_text(size=10), plot.title = element_text(size=10, face="bold"))
DM_corr1
ggsave("Papers_R/2024_DeVleeschouwer/ACE_Matching/Output/itrax_Composite/Matching_mean/ACE/cps/ACE_Correlation_cps/DM/DM_Fig1_Correlation_all_sites.pdf", 
       height = c(16), width = c(16), dpi = 600, units = "cm")
...
ggdraw(DM_corr2)
ggsave("Papers_R/2024_DeVleeschouwer/ACE_Matching/Output/itrax_Composite/Matching_mean/ACE/cps/ACE_Correlation_cps/DM/DM_Fig2c_Scatterplot_all_sites.pdf", 
       height = c(16), width = c(16), dpi = 600, units = "cm")
# d) Correlation per site
theme_set(theme_classic(10))
DM_corr3 <- ggscatter(ACE_all, x = "coh_inc", y = "dry_mass_pc", size = 1,
  ...
  ggtitle(paste("ACE: ", element_title, ICP_title ,"vs", XRF_title))
DM_corr3
ggsave("Papers_R/2024_DeVleeschouwer/ACE_Matching/Output/itrax_Composite/Matching_mean/ACE/cps/ACE_Correlation_cps/DM/DM_Fig2d_Correlation_per_site.pdf", 
       height = c(16), width = c(16), dpi = 600, units = "cm")
# Figure 2: 4-part plot 
ggarrange(DM_XRF_violin_boxplot, dry_mass_pc_violin_boxplot, DM_corr2, DM_corr3, ncol = 2, 
          nrow = 2, labels = c("a", "b", "c", "d"))
ggsave("Papers_R/2024_DeVleeschouwer/ACE_Matching/Output/itrax_Composite/Matching_mean/ACE/cps/ACE_Correlation_cps/DM/DM_Fig2_Correlation_Sites.pdf", 
       height = c(30), width = c(30), dpi = 600, units = "cm")
...
write.csv(data_1_out,"Papers_R/2024_DeVleeschouwer/ACE_Matching/Output/itrax_Composite/Matching_mean/ACE/cps/ACE_Correlation_cps/DM/DM_Model_predict.csv", row.names = FALSE)
...
DM_predict <- DM_p1 + geom_line(aes(y = lwr), color = "blue", linetype = "dashed") +
  ...
  theme(plot.title = element_text(color="black", size=12, face="bold"),
        ...
        axis.text.y = element_text(size=10))
DM_predict
ggsave("Papers_R/2024_DeVleeschouwer/ACE_Matching/Output/itrax_Composite/Matching_mean/ACE/cps/ACE_Correlation_cps/DM/DM_Fig3a_Correlation_predict.pdf", 
       height = c(16), width = c(16), dpi = 600, units = "cm")
#Figure 3c, d
theme_set(theme_classic(base_size=10))
...
ggarrange(DM_predict,  DM_qq.x1, DM_res, DM_qq.y1,
          ncol = 2, nrow = 2, labels = c("a", "b", "c", "d"))
ggsave("Papers_R/2024_DeVleeschouwer/ACE_Matching/Output/itrax_Composite/Matching_mean/ACE/cps/ACE_Correlation_cps/DM/DM_Fig3_Correlation_Sites.pdf", 
       height = c(30), width = c(30), dpi = 600, units = "cm")
...
# Write summary stats/normality & residual checks output to txt file
sink(file = "Papers_R/2024_DeVleeschouwer/ACE_Matching/Output/itrax_Composite/Matching_mean/ACE/cps/ACE_Correlation_cps/DM/DM_Summary_stats.txt")
print(correlate_ALL)
print(ctest_all)
print(ctest_LM1)
print(ctest_LM2)
...
ggsave("Papers_R/2024_DeVleeschouwer/ACE_Matching/Output/itrax_Composite/Matching_mean/ACE/cps/ACE_Correlation_cps/ACE_Correlation_Summary.pdf", 
...
plot_grid(K_corr2, Ca_corr2, Ti_corr2, Mn_corr2, Fe_corr2, Co_corr2,
          ...
          nrow = 3, ncol = 4, common.legend = TRUE)
ggsave("Papers_R/2024_DeVleeschouwer/ACE_Matching/Output/itrax_Composite/Matching_mean/ACE/cps/ACE_Correlation_cps/ACE_Scatterplot_Summary.pdf", 
...
ACE_mv0 <- read_csv("Papers_R/2024_DeVleeschouwer/ACE_Matching/Output/itrax_Composite/Matching_mean/ACE/cps/ACE_xrf_icp_matched_cps.csv") %>% #import original cps data to convert to clr 
...
ACE_mv <- bind_rows(BI10_mv, HER42PB_mv, KER1_mv, 
  ...
  print()
tail(ACE_mv)
write.csv(ACE_mv,"Papers_R/2024_DeVleeschouwer/ACE_Matching/Output/itrax_Composite/Matching_mean/ACE/cps/ACE_multivariate_cps.csv", row.names = FALSE)
...
ggsave("Papers_R/2024_DeVleeschouwer/ACE_Matching/Output/itrax_Composite/Matching_mean/ACE/cps/ACE_Correlation_cps/ACE_Elements_min_PCA_key.pdf", 
       height = c(30), width = c(30), dpi = 600, units = "cm")
...
ggsave("Papers_R/2024_DeVleeschouwer/ACE_Matching/Output/itrax_Composite/Matching_mean/ACE/cps/OLS_WLS_cps/K/K_OLS_performance.pdf", 
       height = c(30), width = c(30), dpi = 600, units = "cm")
# Write summary stats/checks to txt file
sink(file = "Papers_R/2024_DeVleeschouwer/ACE_Matching/Output/itrax_Composite/Matching_mean/ACE/cps/OLS_WLS_cps/K/K_OLS_summary.txt")
summary(ACE_K_lm)
glance(ACE_K_lm)
model_performance(ACE_K_lm) # AIC - Akaike information criterion; BIC Bayesian IC: lower = better fit for both
...
ggsave("Papers_R/2024_DeVleeschouwer/ACE_Matching/Output/itrax_Composite/Matching_mean/ACE/cps/OLS_WLS_cps/K/K_OLS_wt_performance.pdf", 
       height = c(30), width = c(30), dpi = 600, units = "cm")
# Write summary stats/checks to txt file
sink(file = "Papers_R/2024_DeVleeschouwer/ACE_Matching/Output/itrax_Composite/Matching_mean/ACE/cps/OLS_WLS_cps/K/K_OLS_wt_summary.txt")
summary(ACE_K_wlm)
glance(ACE_K_wlm)
model_performance(ACE_K_wlm) # AIC - Akaike information criterion; BIC Bayesian IC: lower = better fit for both
...
ggsave("Papers_R/2024_DeVleeschouwer/ACE_Matching/Output/itrax_Composite/Matching_mean/ACE/cps/OLS_WLS_cps/K/K_WLS_performance.pdf", 
       height = c(30), width = c(30), dpi = 600, units = "cm")
# Write summary stats/checks to txt file
sink(file = "Papers_R/2024_DeVleeschouwer/ACE_Matching/Output/itrax_Composite/Matching_mean/ACE/cps/OLS_WLS_cps/K/K_WLS_summary.txt")
summary(ACE_K_wls)
glance(ACE_K_wls)
model_performance(ACE_K_wls) # AIC - Akaike information criterion; BIC Bayesian IC: lower = better fit for both
...
ggsave("Papers_R/2024_DeVleeschouwer/ACE_Matching/Output/itrax_Composite/Matching_mean/ACE/cps/OLS_WLS_cps/K/K_WLS_wt_performance.pdf", 
       height = c(30), width = c(30), dpi = 600, units = "cm")
# Write summary stats/checks to txt file
sink(file = "Papers_R/2024_DeVleeschouwer/ACE_Matching/Output/itrax_Composite/Matching_mean/ACE/cps/OLS_WLS_cps/K/K_WLS_wt_summary.txt")
...
ACE_K_final
ggsave("Papers_R/2024_DeVleeschouwer/ACE_Matching/Output/itrax_Composite/Matching_mean/ACE/cps/OLS_WLS_cps/K/K_OLS_WLS_summary.pdf", 
...
ggsave("Papers_R/2024_DeVleeschouwer/ACE_Matching/Output/itrax_Composite/Matching_mean/ACE/cps/OLS_WLS_cps/Ca/Ca_OLS_performance.pdf", 
       height = c(30), width = c(30), dpi = 600, units = "cm")
# Write summary stats/checks to txt file
sink(file = "Papers_R/2024_DeVleeschouwer/ACE_Matching/Output/itrax_Composite/Matching_mean/ACE/cps/OLS_WLS_cps/Ca/Ca_OLS_summary.txt")
summary(ACE_Ca_lm)
glance(ACE_Ca_lm)
model_performance(ACE_Ca_lm) # AIC - Akaike information criterion; BIC Bayesian IC: lower = better fit for both
...
ggsave("Papers_R/2024_DeVleeschouwer/ACE_Matching/Output/itrax_Composite/Matching_mean/ACE/cps/OLS_WLS_cps/Ca/Ca_OLS_wt_performance.pdf", 
       height = c(30), width = c(30), dpi = 600, units = "cm")
# Write summary stats/checks to txt file
sink(file = "Papers_R/2024_DeVleeschouwer/ACE_Matching/Output/itrax_Composite/Matching_mean/ACE/cps/OLS_WLS_cps/Ca/Ca_OLS_wt_summary.txt")
summary(ACE_Ca_wlm)
glance(ACE_Ca_wlm)
model_performance(ACE_Ca_wlm) # AIC - Akaike information criterion; BIC Bayesian IC: lower = better fit for both
...
ggsave("Papers_R/2024_DeVleeschouwer/ACE_Matching/Output/itrax_Composite/Matching_mean/ACE/cps/OLS_WLS_cps/Ca/Ca_WLS_performance.pdf", 
       height = c(30), width = c(30), dpi = 600, units = "cm")
# Write summary stats/checks to txt file
sink(file = "Papers_R/2024_DeVleeschouwer/ACE_Matching/Output/itrax_Composite/Matching_mean/ACE/cps/OLS_WLS_cps/Ca/Ca_WLS_summary.txt")
summary(ACE_Ca_wls)
glance(ACE_Ca_wls)
model_performance(ACE_Ca_wls) # AIC - Akaike information criterion; BIC Bayesian IC: lower = better fit for both
...
ggsave("Papers_R/2024_DeVleeschouwer/ACE_Matching/Output/itrax_Composite/Matching_mean/ACE/cps/OLS_WLS_cps/Ca/Ca_WLS_wt_performance.pdf", 
       height = c(30), width = c(30), dpi = 600, units = "cm")
# Write summary stats/checks to txt file
sink(file = "Papers_R/2024_DeVleeschouwer/ACE_Matching/Output/itrax_Composite/Matching_mean/ACE/cps/OLS_WLS_cps/Ca/Ca_WLS_wt_summary.txt")
...
ACE_Ca_final <- ACE_Ca + 
  ...
  geom_text(data=data.frame(), aes(label=paste("OLS: ", ACE_Ca_lm_eqn(df)), x = -Inf, y = Inf),
            parse = TRUE, colour = "lightblue", hjust = -0.15, vjust = 5, size = 3)
ACE_Ca_final
ggsave("Papers_R/2024_DeVleeschouwer/ACE_Matching/Output/itrax_Composite/Matching_mean/ACE/cps/OLS_WLS_cps/Ca/Ca_OLS_WLS_summary.pdf", 
       height = c(20), width = c(20), dpi = 600, units = "cm")
...
ggsave("Papers_R/2024_DeVleeschouwer/ACE_Matching/Output/itrax_Composite/Matching_mean/ACE/cps/OLS_WLS_cps/Ti/Ti_OLS_performance.pdf", 
       height = c(30), width = c(30), dpi = 600, units = "cm")
# Write summary stats/checks to txt file
sink(file = "Papers_R/2024_DeVleeschouwer/ACE_Matching/Output/itrax_Composite/Matching_mean/ACE/cps/OLS_WLS_cps/Ti/Ti_OLS_summary.txt")
summary(ACE_Ti_lm)
glance(ACE_Ti_lm)
model_performance(ACE_Ti_lm) # AIC - Akaike information criterion; BIC Bayesian IC: lower = better fit for both
...
ggsave("Papers_R/2024_DeVleeschouwer/ACE_Matching/Output/itrax_Composite/Matching_mean/ACE/cps/OLS_WLS_cps/Ti/Ti_OLS_wt_performance.pdf", 
       height = c(30), width = c(30), dpi = 600, units = "cm")
# Write summary stats/checks to txt file
sink(file = "Papers_R/2024_DeVleeschouwer/ACE_Matching/Output/itrax_Composite/Matching_mean/ACE/cps/OLS_WLS_cps/Ti/Ti_OLS_wt_summary.txt")
summary(ACE_Ti_wlm)
glance(ACE_Ti_wlm)
model_performance(ACE_Ti_wlm) # AIC - Akaike information criterion; BIC Bayesian IC: lower = better fit for both
...
ggsave("Papers_R/2024_DeVleeschouwer/ACE_Matching/Output/itrax_Composite/Matching_mean/ACE/cps/OLS_WLS_cps/Ti/Ti_WLS_performance.pdf", 
       height = c(30), width = c(30), dpi = 600, units = "cm")
# Write summary stats/checks to txt file
sink(file = "Papers_R/2024_DeVleeschouwer/ACE_Matching/Output/itrax_Composite/Matching_mean/ACE/cps/OLS_WLS_cps/Ti/Ti_WLS_summary.txt")
summary(ACE_Ti_wls)
glance(ACE_Ti_wls)
model_performance(ACE_Ti_wls) # AIC - Akaike information criterion; BIC Bayesian IC: lower = better fit for both
...
ggsave("Papers_R/2024_DeVleeschouwer/ACE_Matching/Output/itrax_Composite/Matching_mean/ACE/cps/OLS_WLS_cps/Ti/Ti_WLS_wt_performance.pdf", 
       height = c(30), width = c(30), dpi = 600, units = "cm")
# Write summary stats/checks to txt file
sink(file = "Papers_R/2024_DeVleeschouwer/ACE_Matching/Output/itrax_Composite/Matching_mean/ACE/cps/OLS_WLS_cps/Ti/Ti_WLS_wt_summary.txt")
...
ACE_Ti_final <- ACE_Ti + 
  ...
  geom_text(data=data.frame(), aes(label=paste("OLS: ", ACE_Ti_lm_eqn(df)), x = -Inf, y = Inf),
            parse = TRUE, colour = "lightblue", hjust = -0.15, vjust = 5, size = 3)
ACE_Ti_final
ggsave("Papers_R/2024_DeVleeschouwer/ACE_Matching/Output/itrax_Composite/Matching_mean/ACE/cps/OLS_WLS_cps/Ti/Ti_OLS_WLS_summary.pdf", 
       height = c(20), width = c(20), dpi = 600, units = "cm")
...
ggsave("Papers_R/2024_DeVleeschouwer/ACE_Matching/Output/itrax_Composite/Matching_mean/ACE/cps/OLS_WLS_cps/Mn/Mn_OLS_performance.pdf", 
       height = c(30), width = c(30), dpi = 600, units = "cm")
# Write summary stats/checks to txt file
sink(file = "Papers_R/2024_DeVleeschouwer/ACE_Matching/Output/itrax_Composite/Matching_mean/ACE/cps/OLS_WLS_cps/Mn/Mn_OLS_summary.txt")
summary(ACE_Mn_lm)
glance(ACE_Mn_lm)
model_performance(ACE_Mn_lm) # AIC - Akaike information criterion; BIC Bayesian IC: lower = better fit for both
...
ggsave("Papers_R/2024_DeVleeschouwer/ACE_Matching/Output/itrax_Composite/Matching_mean/ACE/cps/OLS_WLS_cps/Mn/Mn_OLS_wt_performance.pdf", 
       height = c(30), width = c(30), dpi = 600, units = "cm")
# Write summary stats/checks to txt file
sink(file = "Papers_R/2024_DeVleeschouwer/ACE_Matching/Output/itrax_Composite/Matching_mean/ACE/cps/OLS_WLS_cps/Mn/Mn_OLS_wt_summary.txt")
summary(ACE_Mn_wlm)
glance(ACE_Mn_wlm)
model_performance(ACE_Mn_wlm) # AIC - Akaike information criterion; BIC Bayesian IC: lower = better fit for both
...
ggsave("Papers_R/2024_DeVleeschouwer/ACE_Matching/Output/itrax_Composite/Matching_mean/ACE/cps/OLS_WLS_cps/Mn/Mn_WLS_performance.pdf", 
       height = c(30), width = c(30), dpi = 600, units = "cm")
# Write summary stats/checks to txt file
sink(file = "Papers_R/2024_DeVleeschouwer/ACE_Matching/Output/itrax_Composite/Matching_mean/ACE/cps/OLS_WLS_cps/Mn/Mn_WLS_summary.txt")
summary(ACE_Mn_wls)
glance(ACE_Mn_wls)
model_performance(ACE_Mn_wls) # AIC - Akaike information criterion; BIC Bayesian IC: lower = better fit for both
...
ggsave("Papers_R/2024_DeVleeschouwer/ACE_Matching/Output/itrax_Composite/Matching_mean/ACE/cps/OLS_WLS_cps/Mn/Mn_WLS_wt_performance.pdf", 
       height = c(30), width = c(30), dpi = 600, units = "cm")
# Write summary stats/checks to txt file
sink(file = "Papers_R/2024_DeVleeschouwer/ACE_Matching/Output/itrax_Composite/Matching_mean/ACE/cps/OLS_WLS_cps/Mn/Mn_WLS_wt_summary.txt")
...
ACE_Mn_final <- ACE_Mn + 
  ...
  geom_text(data=data.frame(), aes(label=paste("OLS: ", ACE_Mn_lm_eqn(df)), x = -Inf, y = Inf),
            parse = TRUE, colour = "lightblue", hjust = -0.15, vjust = 5, size = 3)
ACE_Mn_final
ggsave("Papers_R/2024_DeVleeschouwer/ACE_Matching/Output/itrax_Composite/Matching_mean/ACE/cps/OLS_WLS_cps/Mn/Mn_OLS_WLS_summary.pdf", 
       height = c(20), width = c(20), dpi = 600, units = "cm")
...
ggsave("Papers_R/2024_DeVleeschouwer/ACE_Matching/Output/itrax_Composite/Matching_mean/ACE/cps/OLS_WLS_cps/Fe/Fe_OLS_performance.pdf", 
       height = c(30), width = c(30), dpi = 600, units = "cm")
# Write summary stats/checks to txt file
sink(file = "Papers_R/2024_DeVleeschouwer/ACE_Matching/Output/itrax_Composite/Matching_mean/ACE/cps/OLS_WLS_cps/Fe/Fe_OLS_summary.txt")
summary(ACE_Fe_lm)
glance(ACE_Fe_lm)
model_performance(ACE_Fe_lm) # AIC - Akaike information criterion; BIC Bayesian IC: lower = better fit for both
...
ggsave("Papers_R/2024_DeVleeschouwer/ACE_Matching/Output/itrax_Composite/Matching_mean/ACE/cps/OLS_WLS_cps/Fe/Fe_OLS_wt_performance.pdf", 
       height = c(30), width = c(30), dpi = 600, units = "cm")
# Write summary stats/checks to txt file
sink(file = "Papers_R/2024_DeVleeschouwer/ACE_Matching/Output/itrax_Composite/Matching_mean/ACE/cps/OLS_WLS_cps/Fe/Fe_OLS_wt_summary.txt")
summary(ACE_Fe_wlm)
glance(ACE_Fe_wlm)
model_performance(ACE_Fe_wlm) # AIC - Akaike information criterion; BIC Bayesian IC: lower = better fit for both
...
ggsave("Papers_R/2024_DeVleeschouwer/ACE_Matching/Output/itrax_Composite/Matching_mean/ACE/cps/OLS_WLS_cps/Fe/Fe_WLS_performance.pdf", 
       height = c(30), width = c(30), dpi = 600, units = "cm")
# Write summary stats/checks to txt file
sink(file = "Papers_R/2024_DeVleeschouwer/ACE_Matching/Output/itrax_Composite/Matching_mean/ACE/cps/OLS_WLS_cps/Fe/Fe_WLS_summary.txt")
summary(ACE_Fe_wls)
glance(ACE_Fe_wls)
model_performance(ACE_Fe_wls) # AIC - Akaike information criterion; BIC Bayesian IC: lower = better fit for both
...
ggsave("Papers_R/2024_DeVleeschouwer/ACE_Matching/Output/itrax_Composite/Matching_mean/ACE/cps/OLS_WLS_cps/Fe/Fe_WLS_wt_performance.pdf", 
       height = c(30), width = c(30), dpi = 600, units = "cm")
# Write summary stats/checks to txt file
sink(file = "Papers_R/2024_DeVleeschouwer/ACE_Matching/Output/itrax_Composite/Matching_mean/ACE/cps/OLS_WLS_cps/Fe/Fe_WLS_wt_summary.txt")
...
ACE_Fe_final <- ACE_Fe + 
  ...
  geom_text(data=data.frame(), aes(label=paste("OLS: ", ACE_Fe_lm_eqn(df)), x = -Inf, y = Inf),
            parse = TRUE, colour = "lightblue", hjust = -0.15, vjust = 5, size = 3)
ACE_Fe_final
ggsave("Papers_R/2024_DeVleeschouwer/ACE_Matching/Output/itrax_Composite/Matching_mean/ACE/cps/OLS_WLS_cps/Fe/Fe_OLS_WLS_summary.pdf", 
       height = c(20), width = c(20), dpi = 600, units = "cm")
...
ggsave("Papers_R/2024_DeVleeschouwer/ACE_Matching/Output/itrax_Composite/Matching_mean/ACE/cps/OLS_WLS_cps/Co/Co_OLS_performance.pdf", 
       height = c(30), width = c(30), dpi = 600, units = "cm")
# Write summary stats/checks to txt file
sink(file = "Papers_R/2024_DeVleeschouwer/ACE_Matching/Output/itrax_Composite/Matching_mean/ACE/cps/OLS_WLS_cps/Co/Co_OLS_summary.txt")
summary(ACE_Co_lm)
glance(ACE_Co_lm)
model_performance(ACE_Co_lm) # AIC - Akaike information criterion; BIC Bayesian IC: lower = better fit for both
...
ggsave("Papers_R/2024_DeVleeschouwer/ACE_Matching/Output/itrax_Composite/Matching_mean/ACE/cps/OLS_WLS_cps/Co/Co_OLS_wt_performance.pdf", 
       height = c(30), width = c(30), dpi = 600, units = "cm")
# Write summary stats/checks to txt file
sink(file = "Papers_R/2024_DeVleeschouwer/ACE_Matching/Output/itrax_Composite/Matching_mean/ACE/cps/OLS_WLS_cps/Co/Co_OLS_wt_summary.txt")
summary(ACE_Co_wlm)
glance(ACE_Co_wlm)
model_performance(ACE_Co_wlm) # AIC - Akaike information criterion; BIC Bayesian IC: lower = better fit for both
...
ggsave("Papers_R/2024_DeVleeschouwer/ACE_Matching/Output/itrax_Composite/Matching_mean/ACE/cps/OLS_WLS_cps/Co/Co_WLS_performance.pdf", 
       height = c(30), width = c(30), dpi = 600, units = "cm")
# Write summary stats/checks to txt file
sink(file = "Papers_R/2024_DeVleeschouwer/ACE_Matching/Output/itrax_Composite/Matching_mean/ACE/cps/OLS_WLS_cps/Co/Co_WLS_summary.txt")
summary(ACE_Co_wls)
glance(ACE_Co_wls)
model_performance(ACE_Co_wls) # AIC - Akaike information criterion; BIC Bayesian IC: lower = better fit for both
...
ggsave("Papers_R/2024_DeVleeschouwer/ACE_Matching/Output/itrax_Composite/Matching_mean/ACE/cps/OLS_WLS_cps/Co/Co_WLS_wt_performance.pdf", 
       height = c(30), width = c(30), dpi = 600, units = "cm")
# Write summary stats/checks to txt file
sink(file = "Papers_R/2024_DeVleeschouwer/ACE_Matching/Output/itrax_Composite/Matching_mean/ACE/cps/OLS_WLS_cps/Co/Co_WLS_wt_summary.txt")
...
ACE_Co_final <- ACE_Co + 
  ...
  geom_text(data=data.frame(), aes(label=paste("OLS: ", ACE_Co_lm_eqn(df)), x = -Inf, y = Inf),
            parse = TRUE, colour = "lightblue", hjust = -0.15, vjust = 5, size = 3)
ACE_Co_final
ggsave("Papers_R/2024_DeVleeschouwer/ACE_Matching/Output/itrax_Composite/Matching_mean/ACE/cps/OLS_WLS_cps/Co/Co_OLS_WLS_summary.pdf", 
       height = c(20), width = c(20), dpi = 600, units = "cm")
...
ggsave("Papers_R/2024_DeVleeschouwer/ACE_Matching/Output/itrax_Composite/Matching_mean/ACE/cps/OLS_WLS_cps/Ni/Ni_OLS_performance.pdf", 
       height = c(30), width = c(30), dpi = 600, units = "cm")
# Write summary stats/checks to txt file
sink(file = "Papers_R/2024_DeVleeschouwer/ACE_Matching/Output/itrax_Composite/Matching_mean/ACE/cps/OLS_WLS_cps/Ni/Ni_OLS_summary.txt")
summary(ACE_Ni_lm)
glance(ACE_Ni_lm)
model_performance(ACE_Ni_lm) # AIC - Akaike information criterion; BIC Bayesian IC: lower = better fit for both
...
ggsave("Papers_R/2024_DeVleeschouwer/ACE_Matching/Output/itrax_Composite/Matching_mean/ACE/cps/OLS_WLS_cps/Ni/Ni_OLS_wt_performance.pdf", 
       height = c(30), width = c(30), dpi = 600, units = "cm")
# Write summary stats/checks to txt file
sink(file = "Papers_R/2024_DeVleeschouwer/ACE_Matching/Output/itrax_Composite/Matching_mean/ACE/cps/OLS_WLS_cps/Ni/Ni_OLS_wt_summary.txt")
summary(ACE_Ni_wlm)
glance(ACE_Ni_wlm)
model_performance(ACE_Ni_wlm) # AIC - Akaike information criterion; BIC Bayesian IC: lower = better fit for both
...
ggsave("Papers_R/2024_DeVleeschouwer/ACE_Matching/Output/itrax_Composite/Matching_mean/ACE/cps/OLS_WLS_cps/Ni/Ni_WLS_performance.pdf", 
       height = c(30), width = c(30), dpi = 600, units = "cm")
# Write summary stats/checks to txt file
sink(file = "Papers_R/2024_DeVleeschouwer/ACE_Matching/Output/itrax_Composite/Matching_mean/ACE/cps/OLS_WLS_cps/Ni/Ni_WLS_summary.txt")
summary(ACE_Ni_wls)
glance(ACE_Ni_wls)
model_performance(ACE_Ni_wls) # AIC - Akaike information criterion; BIC Bayesian IC: lower = better fit for both
...
ggsave("Papers_R/2024_DeVleeschouwer/ACE_Matching/Output/itrax_Composite/Matching_mean/ACE/cps/OLS_WLS_cps/Ni/Ni_WLS_wt_performance.pdf", 
       height = c(30), width = c(30), dpi = 600, units = "cm")
# Write summary stats/checks to txt file
sink(file = "Papers_R/2024_DeVleeschouwer/ACE_Matching/Output/itrax_Composite/Matching_mean/ACE/cps/OLS_WLS_cps/Ni/Ni_WLS_wt_summary.txt")
...
ACE_Ni_final <- ACE_Ni + 
  ...
  geom_text(data=data.frame(), aes(label=paste("OLS: ", ACE_Ni_lm_eqn(df)), x = -Inf, y = Inf),
            parse = TRUE, colour = "lightblue", hjust = -0.15, vjust = 5, size = 3)
ACE_Ni_final
ggsave("Papers_R/2024_DeVleeschouwer/ACE_Matching/Output/itrax_Composite/Matching_mean/ACE/cps/OLS_WLS_cps/Ni/Ni_OLS_WLS_summary.pdf", 
       height = c(20), width = c(20), dpi = 600, units = "cm")
...
ggsave("Papers_R/2024_DeVleeschouwer/ACE_Matching/Output/itrax_Composite/Matching_mean/ACE/cps/OLS_WLS_cps/Cu/Cu_OLS_performance.pdf", 
       height = c(30), width = c(30), dpi = 600, units = "cm")
# Write summary stats/checks to txt file
sink(file = "Papers_R/2024_DeVleeschouwer/ACE_Matching/Output/itrax_Composite/Matching_mean/ACE/cps/OLS_WLS_cps/Cu/Cu_OLS_summary.txt")
summary(ACE_Cu_lm)
glance(ACE_Cu_lm)
model_performance(ACE_Cu_lm) # AIC - Akaike information criterion; BIC Bayesian IC: lower = better fit for both
...
ggsave("Papers_R/2024_DeVleeschouwer/ACE_Matching/Output/itrax_Composite/Matching_mean/ACE/cps/OLS_WLS_cps/Cu/Cu_OLS_wt_performance.pdf", 
       height = c(30), width = c(30), dpi = 600, units = "cm")
# Write summary stats/checks to txt file
sink(file = "Papers_R/2024_DeVleeschouwer/ACE_Matching/Output/itrax_Composite/Matching_mean/ACE/cps/OLS_WLS_cps/Cu/Cu_OLS_wt_summary.txt")
summary(ACE_Cu_wlm)
glance(ACE_Cu_wlm)
model_performance(ACE_Cu_wlm) # AIC - Akaike information criterion; BIC Bayesian IC: lower = better fit for both
...
ggsave("Papers_R/2024_DeVleeschouwer/ACE_Matching/Output/itrax_Composite/Matching_mean/ACE/cps/OLS_WLS_cps/Cu/Cu_WLS_performance.pdf", 
       height = c(30), width = c(30), dpi = 600, units = "cm")
# Write summary stats/checks to txt file
sink(file = "Papers_R/2024_DeVleeschouwer/ACE_Matching/Output/itrax_Composite/Matching_mean/ACE/cps/OLS_WLS_cps/Cu/Cu_WLS_summary.txt")
summary(ACE_Cu_wls)
glance(ACE_Cu_wls)
model_performance(ACE_Cu_wls) # AIC - Akaike information criterion; BIC Bayesian IC: lower = better fit for both
...
ggsave("Papers_R/2024_DeVleeschouwer/ACE_Matching/Output/itrax_Composite/Matching_mean/ACE/cps/OLS_WLS_cps/Cu/Cu_WLS_wt_performance.pdf", 
       height = c(30), width = c(30), dpi = 600, units = "cm")
# Write summary stats/checks to txt file
sink(file = "Papers_R/2024_DeVleeschouwer/ACE_Matching/Output/itrax_Composite/Matching_mean/ACE/cps/OLS_WLS_cps/Cu/Cu_WLS_wt_summary.txt")
...
ACE_Cu_final <- ACE_Cu + 
  ...
  geom_text(data=data.frame(), aes(label=paste("OLS: ", ACE_Cu_lm_eqn(df)), x = -Inf, y = Inf),
            parse = TRUE, colour = "lightblue", hjust = -0.15, vjust = 5, size = 3)
ACE_Cu_final
ggsave("Papers_R/2024_DeVleeschouwer/ACE_Matching/Output/itrax_Composite/Matching_mean/ACE/cps/OLS_WLS_cps/Cu/Cu_OLS_WLS_summary.pdf", 
       height = c(20), width = c(20), dpi = 600, units = "cm")
...
ggsave("Papers_R/2024_DeVleeschouwer/ACE_Matching/Output/itrax_Composite/Matching_mean/ACE/cps/OLS_WLS_cps/Zn/Zn_OLS_performance.pdf", 
       height = c(30), width = c(30), dpi = 600, units = "cm")
# Write summary stats/checks to txt file
sink(file = "Papers_R/2024_DeVleeschouwer/ACE_Matching/Output/itrax_Composite/Matching_mean/ACE/cps/OLS_WLS_cps/Zn/Zn_OLS_summary.txt")
summary(ACE_Zn_lm)
glance(ACE_Zn_lm)
model_performance(ACE_Zn_lm) # AIC - Akaike information criterion; BIC Bayesian IC: lower = better fit for both
...
ggsave("Papers_R/2024_DeVleeschouwer/ACE_Matching/Output/itrax_Composite/Matching_mean/ACE/cps/OLS_WLS_cps/Zn/Zn_OLS_wt_performance.pdf", 
       height = c(30), width = c(30), dpi = 600, units = "cm")
# Write summary stats/checks to txt file
sink(file = "Papers_R/2024_DeVleeschouwer/ACE_Matching/Output/itrax_Composite/Matching_mean/ACE/cps/OLS_WLS_cps/Zn/Zn_OLS_wt_summary.txt")
summary(ACE_Zn_wlm)
glance(ACE_Zn_wlm)
model_performance(ACE_Zn_wlm) # AIC - Akaike information criterion; BIC Bayesian IC: lower = better fit for both
...
ggsave("Papers_R/2024_DeVleeschouwer/ACE_Matching/Output/itrax_Composite/Matching_mean/ACE/cps/OLS_WLS_cps/Zn/Zn_WLS_performance.pdf", 
       height = c(30), width = c(30), dpi = 600, units = "cm")
# Write summary stats/checks to txt file
sink(file = "Papers_R/2024_DeVleeschouwer/ACE_Matching/Output/itrax_Composite/Matching_mean/ACE/cps/OLS_WLS_cps/Zn/Zn_WLS_summary.txt")
summary(ACE_Zn_wls)
glance(ACE_Zn_wls)
model_performance(ACE_Zn_wls) # AIC - Akaike information criterion; BIC Bayesian IC: lower = better fit for both
...
ggsave("Papers_R/2024_DeVleeschouwer/ACE_Matching/Output/itrax_Composite/Matching_mean/ACE/cps/OLS_WLS_cps/Zn/Zn_WLS_wt_performance.pdf", 
       height = c(30), width = c(30), dpi = 600, units = "cm")
# Write summary stats/checks to txt file
sink(file = "Papers_R/2024_DeVleeschouwer/ACE_Matching/Output/itrax_Composite/Matching_mean/ACE/cps/OLS_WLS_cps/Zn/Zn_WLS_wt_summary.txt")
...
ACE_Zn_final <- ACE_Zn + 
  ...
  geom_text(data=data.frame(), aes(label=paste("OLS: ", ACE_Zn_lm_eqn(df)), x = -Inf, y = Inf),
            parse = TRUE, colour = "lightblue", hjust = -0.15, vjust = 5, size = 3)
ACE_Zn_final
ggsave("Papers_R/2024_DeVleeschouwer/ACE_Matching/Output/itrax_Composite/Matching_mean/ACE/cps/OLS_WLS_cps/Zn/Zn_OLS_WLS_summary.pdf", 
       height = c(20), width = c(20), dpi = 600, units = "cm")
...
ggsave("Papers_R/2024_DeVleeschouwer/ACE_Matching/Output/itrax_Composite/Matching_mean/ACE/cps/OLS_WLS_cps/Rb/Rb_OLS_performance.pdf", 
       height = c(30), width = c(30), dpi = 600, units = "cm")
# Write summary stats/checks to txt file
sink(file = "Papers_R/2024_DeVleeschouwer/ACE_Matching/Output/itrax_Composite/Matching_mean/ACE/cps/OLS_WLS_cps/Rb/Rb_OLS_summary.txt")
summary(ACE_Rb_lm)
glance(ACE_Rb_lm)
model_performance(ACE_Rb_lm) # AIC - Akaike information criterion; BIC Bayesian IC: lower = better fit for both
...
ggsave("Papers_R/2024_DeVleeschouwer/ACE_Matching/Output/itrax_Composite/Matching_mean/ACE/cps/OLS_WLS_cps/Rb/Rb_OLS_wt_performance.pdf", 
       height = c(30), width = c(30), dpi = 600, units = "cm")
# Write summary stats/checks to txt file
sink(file = "Papers_R/2024_DeVleeschouwer/ACE_Matching/Output/itrax_Composite/Matching_mean/ACE/cps/OLS_WLS_cps/Rb/Rb_OLS_wt_summary.txt")
summary(ACE_Rb_wlm)
glance(ACE_Rb_wlm)
model_performance(ACE_Rb_wlm) # AIC - Akaike information criterion; BIC Bayesian IC: lower = better fit for both
...
ggsave("Papers_R/2024_DeVleeschouwer/ACE_Matching/Output/itrax_Composite/Matching_mean/ACE/cps/OLS_WLS_cps/Rb/Rb_WLS_performance.pdf", 
       height = c(30), width = c(30), dpi = 600, units = "cm")
# Write summary stats/checks to txt file
sink(file = "Papers_R/2024_DeVleeschouwer/ACE_Matching/Output/itrax_Composite/Matching_mean/ACE/cps/OLS_WLS_cps/Rb/Rb_WLS_summary.txt")
summary(ACE_Rb_wls)
glance(ACE_Rb_wls)
model_performance(ACE_Rb_wls) # AIC - Akaike information criterion; BIC Bayesian IC: lower = better fit for both
...
ggsave("Papers_R/2024_DeVleeschouwer/ACE_Matching/Output/itrax_Composite/Matching_mean/ACE/cps/OLS_WLS_cps/Rb/Rb_WLS_wt_performance.pdf", 
       height = c(30), width = c(30), dpi = 600, units = "cm")
# Write summary stats/checks to txt file
sink(file = "Papers_R/2024_DeVleeschouwer/ACE_Matching/Output/itrax_Composite/Matching_mean/ACE/cps/OLS_WLS_cps/Rb/Rb_WLS_wt_summary.txt")
...
ACE_Rb_final <- ACE_Rb + 
  ...
  geom_text(data=data.frame(), aes(label=paste("OLS: ", ACE_Rb_lm_eqn(df)), x = -Inf, y = Inf),
            parse = TRUE, colour = "lightblue", hjust = -0.15, vjust = 5, size = 3)
ACE_Rb_final
ggsave("Papers_R/2024_DeVleeschouwer/ACE_Matching/Output/itrax_Composite/Matching_mean/ACE/cps/OLS_WLS_cps/Rb/Rb_OLS_WLS_summary.pdf", 
       height = c(20), width = c(20), dpi = 600, units = "cm")
# ACE_Sr -----------------------------------------------------------------------
...
ggsave("Papers_R/2024_DeVleeschouwer/ACE_Matching/Output/itrax_Composite/Matching_mean/ACE/cps/OLS_WLS_cps/Sr/Sr_OLS_performance.pdf", 
       height = c(30), width = c(30), dpi = 600, units = "cm")
# Write summary stats/checks to txt file
sink(file = "Papers_R/2024_DeVleeschouwer/ACE_Matching/Output/itrax_Composite/Matching_mean/ACE/cps/OLS_WLS_cps/Sr/Sr_OLS_summary.txt")
summary(ACE_Sr_lm)
glance(ACE_Sr_lm)
model_performance(ACE_Sr_lm) # AIC - Akaike information criterion; BIC Bayesian IC: lower = better fit for both
...
ggsave("Papers_R/2024_DeVleeschouwer/ACE_Matching/Output/itrax_Composite/Matching_mean/ACE/cps/OLS_WLS_cps/Sr/Sr_OLS_wt_performance.pdf", 
       height = c(30), width = c(30), dpi = 600, units = "cm")
# Write summary stats/checks to txt file
sink(file = "Papers_R/2024_DeVleeschouwer/ACE_Matching/Output/itrax_Composite/Matching_mean/ACE/cps/OLS_WLS_cps/Sr/Sr_OLS_wt_summary.txt")
summary(ACE_Sr_wlm)
glance(ACE_Sr_wlm)
model_performance(ACE_Sr_wlm) # AIC - Akaike information criterion; BIC Bayesian IC: lower = better fit for both
...
ggsave("Papers_R/2024_DeVleeschouwer/ACE_Matching/Output/itrax_Composite/Matching_mean/ACE/cps/OLS_WLS_cps/Sr/Sr_WLS_performance.pdf", 
       height = c(30), width = c(30), dpi = 600, units = "cm")
# Write summary stats/checks to txt file
sink(file = "Papers_R/2024_DeVleeschouwer/ACE_Matching/Output/itrax_Composite/Matching_mean/ACE/cps/OLS_WLS_cps/Sr/Sr_WLS_summary.txt")
summary(ACE_Sr_wls)
glance(ACE_Sr_wls)
model_performance(ACE_Sr_wls) # AIC - Akaike information criterion; BIC Bayesian IC: lower = better fit for both
...
ggsave("Papers_R/2024_DeVleeschouwer/ACE_Matching/Output/itrax_Composite/Matching_mean/ACE/cps/OLS_WLS_cps/Sr/Sr_WLS_wt_performance.pdf", 
       height = c(30), width = c(30), dpi = 600, units = "cm")
# Write summary stats/checks to txt file
sink(file = "Papers_R/2024_DeVleeschouwer/ACE_Matching/Output/itrax_Composite/Matching_mean/ACE/cps/OLS_WLS_cps/Sr/Sr_WLS_wt_summary.txt")
...
ACE_Sr_final <- ACE_Sr + 
  ...
  geom_text(data=data.frame(), aes(label=paste("OLS: ", ACE_Sr_lm_eqn(df)), x = -Inf, y = Inf),
            parse = TRUE, colour = "lightblue", hjust = -0.15, vjust = 5, size = 3)
ACE_Sr_final
ggsave("Papers_R/2024_DeVleeschouwer/ACE_Matching/Output/itrax_Composite/Matching_mean/ACE/cps/OLS_WLS_cps/Sr/Sr_OLS_WLS_summary.pdf", 
       height = c(20), width = c(20), dpi = 600, units = "cm")
...
ggsave("Papers_R/2024_DeVleeschouwer/ACE_Matching/Output/itrax_Composite/Matching_mean/ACE/cps/OLS_WLS_cps/Zr/Zr_OLS_performance.pdf", 
       height = c(30), width = c(30), dpi = 600, units = "cm")
# Write summary stats/checks to txt file
sink(file = "Papers_R/2024_DeVleeschouwer/ACE_Matching/Output/itrax_Composite/Matching_mean/ACE/cps/OLS_WLS_cps/Zr/Zr_OLS_summary.txt")
summary(ACE_Zr_lm)
glance(ACE_Zr_lm)
model_performance(ACE_Zr_lm) # AIC - Akaike information criterion; BIC Bayesian IC: lower = better fit for both
...
ggsave("Papers_R/2024_DeVleeschouwer/ACE_Matching/Output/itrax_Composite/Matching_mean/ACE/cps/OLS_WLS_cps/Zr/Zr_OLS_wt_performance.pdf", 
       height = c(30), width = c(30), dpi = 600, units = "cm")
# Write summary stats/checks to txt file
sink(file = "Papers_R/2024_DeVleeschouwer/ACE_Matching/Output/itrax_Composite/Matching_mean/ACE/cps/OLS_WLS_cps/Zr/Zr_OLS_wt_summary.txt")
summary(ACE_Zr_wlm)
glance(ACE_Zr_wlm)
model_performance(ACE_Zr_wlm) # AIC - Akaike information criterion; BIC Bayesian IC: lower = better fit for both
...
ggsave("Papers_R/2024_DeVleeschouwer/ACE_Matching/Output/itrax_Composite/Matching_mean/ACE/cps/OLS_WLS_cps/Zr/Zr_WLS_performance.pdf", 
       height = c(30), width = c(30), dpi = 600, units = "cm")
# Write summary stats/checks to txt file
sink(file = "Papers_R/2024_DeVleeschouwer/ACE_Matching/Output/itrax_Composite/Matching_mean/ACE/cps/OLS_WLS_cps/Zr/Zr_WLS_summary.txt")
summary(ACE_Zr_wls)
glance(ACE_Zr_wls)
model_performance(ACE_Zr_wls) # AIC - Akaike information criterion; BIC Bayesian IC: lower = better fit for both
...
ggsave("Papers_R/2024_DeVleeschouwer/ACE_Matching/Output/itrax_Composite/Matching_mean/ACE/cps/OLS_WLS_cps/Zr/Zr_WLS_wt_performance.pdf", 
       height = c(30), width = c(30), dpi = 600, units = "cm")
# Write summary stats/checks to txt file
sink(file = "Papers_R/2024_DeVleeschouwer/ACE_Matching/Output/itrax_Composite/Matching_mean/ACE/cps/OLS_WLS_cps/Zr/Zr_WLS_wt_summary.txt")
...
ACE_Zr_final <- ACE_Zr + 
  ...
  geom_text(data=data.frame(), aes(label=paste("OLS: ", ACE_Zr_lm_eqn(df)), x = -Inf, y = Inf),
            parse = TRUE, colour = "lightblue", hjust = -0.15, vjust = 5, size = 3)
ACE_Zr_final
ggsave("Papers_R/2024_DeVleeschouwer/ACE_Matching/Output/itrax_Composite/Matching_mean/ACE/cps/OLS_WLS_cps/Zr/Zr_OLS_WLS_summary.pdf", 
       height = c(20), width = c(20), dpi = 600, units = "cm")
...
ggsave("Papers_R/2024_DeVleeschouwer/ACE_Matching/Output/itrax_Composite/Matching_mean/ACE/cps/OLS_WLS_cps/DM/DM_OLS_performance.pdf", 
       height = c(30), width = c(30), dpi = 600, units = "cm")
# Write summary stats/checks to txt file
sink(file = "Papers_R/2024_DeVleeschouwer/ACE_Matching/Output/itrax_Composite/Matching_mean/ACE/cps/OLS_WLS_cps/DM/DM_OLS_summary.txt")
summary(ACE_DM_lm)
glance(ACE_DM_lm)
model_performance(ACE_DM_lm) # AIC - Akaike information criterion; BIC Bayesian IC: lower = better fit for both
...
ggsave("Papers_R/2024_DeVleeschouwer/ACE_Matching/Output/itrax_Composite/Matching_mean/ACE/cps/OLS_WLS_cps/DM/DM_OLS_wt_performance.pdf", 
       height = c(30), width = c(30), dpi = 600, units = "cm")
# Write summary stats/checks to txt file
sink(file = "Papers_R/2024_DeVleeschouwer/ACE_Matching/Output/itrax_Composite/Matching_mean/ACE/cps/OLS_WLS_cps/DM/DM_OLS_wt_summary.txt")
summary(ACE_DM_wlm)
glance(ACE_DM_wlm)
model_performance(ACE_DM_wlm) # AIC - Akaike information criterion; BIC Bayesian IC: lower = better fit for both
...
ggsave("Papers_R/2024_DeVleeschouwer/ACE_Matching/Output/itrax_Composite/Matching_mean/ACE/cps/OLS_WLS_cps/DM/DM_WLS_performance.pdf", 
       height = c(30), width = c(30), dpi = 600, units = "cm")
# Write summary stats/checks to txt file
sink(file = "Papers_R/2024_DeVleeschouwer/ACE_Matching/Output/itrax_Composite/Matching_mean/ACE/cps/OLS_WLS_cps/DM/DM_WLS_summary.txt")
summary(ACE_DM_wls)
glance(ACE_DM_wls)
model_performance(ACE_DM_wls) # AIC - Akaike information criterion; BIC Bayesian IC: lower = better fit for both
...
ggsave("Papers_R/2024_DeVleeschouwer/ACE_Matching/Output/itrax_Composite/Matching_mean/ACE/cps/OLS_WLS_cps/DM/DM_WLS_wt_performance.pdf", 
       height = c(30), width = c(30), dpi = 600, units = "cm")
# Write summary stats/checks to txt file
sink(file = "Papers_R/2024_DeVleeschouwer/ACE_Matching/Output/itrax_Composite/Matching_mean/ACE/cps/OLS_WLS_cps/DM/DM_WLS_wt_summary.txt")
...
ACE_DM_final <- ACE_DM + 
  ...
  geom_text(data=data.frame(), aes(label=paste("OLS: ", ACE_DM_lm_eqn(df)), x = -Inf, y = Inf),
            parse = TRUE, colour = "lightblue", hjust = -0.15, vjust = 5, size = 3)
ACE_DM_final
ggsave("Papers_R/2024_DeVleeschouwer/ACE_Matching/Output/itrax_Composite/Matching_mean/ACE/cps/OLS_WLS_cps/DM/DM_OLS_WLS_summary.pdf", 
       height = c(20), width = c(20), dpi = 600, units = "cm")
# -------------------------------------------------------------------------
...
ggsave("Papers_R/2024_DeVleeschouwer/ACE_Matching/Output/itrax_Composite/Matching_mean/ACE/cps/OLS_WLS_cps/ACE_OLS_WLS_Summary.pdf",
...
ACE_K_origin
ggsave("Papers_R/2024_DeVleeschouwer/ACE_Matching/Output/itrax_Composite/Matching_mean/ACE/cps/origin/K_origin_lm_wlm.pdf", 
       height = c(20), width = c(20), dpi = 600, units = "cm")
# Mn unweighted ---------------------------
...
ACE_Mn_origin
ggsave("Papers_R/2024_DeVleeschouwer/ACE_Matching/Output/itrax_Composite/Matching_mean/ACE/cps/origin/Mn_origin_lm_wlm.pdf", 
       height = c(20), width = c(20), dpi = 600, units = "cm")
...
ACE_Ti_origin
ggsave("Papers_R/2024_DeVleeschouwer/ACE_Matching/Output/itrax_Composite/Matching_mean/ACE/cps/origin/Ti_origin_lm_wlm.pdf", 
       height = c(20), width = c(20), dpi = 600, units = "cm")
...
ACE_Fe_origin
ggsave("Papers_R/2024_DeVleeschouwer/ACE_Matching/Output/itrax_Composite/Matching_mean/ACE/cps/origin/Fe_origin_lm_wlm.pdf", 
       height = c(20), width = c(20), dpi = 600, units = "cm")
...
ACE_Co_origin
ggsave("Papers_R/2024_DeVleeschouwer/ACE_Matching/Output/itrax_Composite/Matching_mean/ACE/cps/origin/Co_origin_lm_wlm.pdf", 
       height = c(20), width = c(20), dpi = 600, units = "cm")
...
ACE_Ni_origin
ggsave("Papers_R/2024_DeVleeschouwer/ACE_Matching/Output/itrax_Composite/Matching_mean/ACE/cps/origin/Ni_origin_lm_wlm.pdf", 
       height = c(20), width = c(20), dpi = 600, units = "cm")
...
ACE_Cu_origin
ggsave("Papers_R/2024_DeVleeschouwer/ACE_Matching/Output/itrax_Composite/Matching_mean/ACE/cps/origin/Cu_origin_lm_wlm.pdf", 
       height = c(20), width = c(20), dpi = 600, units = "cm")
...
ACE_Zn_origin
ggsave("Papers_R/2024_DeVleeschouwer/ACE_Matching/Output/itrax_Composite/Matching_mean/ACE/cps/origin/Zn_origin_lm_wlm.pdf", 
       height = c(20), width = c(20), dpi = 600, units = "cm")
...
ACE_Rb_origin
ggsave("Papers_R/2024_DeVleeschouwer/ACE_Matching/Output/itrax_Composite/Matching_mean/ACE/cps/origin/Rb_origin_lm_wlm.pdf", 
       height = c(20), width = c(20), dpi = 600, units = "cm")
...
ACE_Sr_origin
ggsave("Papers_R/2024_DeVleeschouwer/ACE_Matching/Output/itrax_Composite/Matching_mean/ACE/cps/origin/Sr_origin_lm_wlm.pdf", 
       height = c(20), width = c(20), dpi = 600, units = "cm")
...
ACE_DM_origin
ggsave("Papers_R/2024_DeVleeschouwer/ACE_Matching/Output/itrax_Composite/Matching_mean/ACE/cps/origin/DM_origin_lm_wlm.pdf", 
       height = c(20), width = c(20), dpi = 600, units = "cm")
...
ggsave("Papers_R/2024_DeVleeschouwer/ACE_Matching/Output/itrax_Composite/Matching_mean/ACE/cps/origin/K_origin_performance_lm.pdf", 
       height = c(30), width = c(30), dpi = 600, units = "cm")
...
ggsave("Papers_R/2024_DeVleeschouwer/ACE_Matching/Output/itrax_Composite/Matching_mean/ACE/cps/origin/K_origin_performance_wlm.pdf", 
       height = c(30), width = c(30), dpi = 600, units = "cm")
...
ggsave("Papers_R/2024_DeVleeschouwer/ACE_Matching/Output/itrax_Composite/Matching_mean/ACE/cps/origin/Mn_origin_performance_lm.pdf", 
       height = c(30), width = c(30), dpi = 600, units = "cm")
...
ggsave("Papers_R/2024_DeVleeschouwer/ACE_Matching/Output/itrax_Composite/Matching_mean/ACE/cps/origin/Mn_origin_performance_wlm.pdf", 
       height = c(30), width = c(30), dpi = 600, units = "cm")
...
ggsave("Papers_R/2024_DeVleeschouwer/ACE_Matching/Output/itrax_Composite/Matching_mean/ACE/cps/origin/Ti_origin_performance_lm.pdf", 
       height = c(30), width = c(30), dpi = 600, units = "cm")
...
ggsave("Papers_R/2024_DeVleeschouwer/ACE_Matching/Output/itrax_Composite/Matching_mean/ACE/cps/origin/Ti_origin_performance_wlm.pdf", 
       height = c(30), width = c(30), dpi = 600, units = "cm")
...
ggsave("Papers_R/2024_DeVleeschouwer/ACE_Matching/Output/itrax_Composite/Matching_mean/ACE/cps/origin/Fe_origin_performance_lm.pdf", 
       height = c(30), width = c(30), dpi = 600, units = "cm")
...
ggsave("Papers_R/2024_DeVleeschouwer/ACE_Matching/Output/itrax_Composite/Matching_mean/ACE/cps/origin/Fe_origin_performance_wlm.pdf", 
       height = c(30), width = c(30), dpi = 600, units = "cm")
...
ggsave("Papers_R/2024_DeVleeschouwer/ACE_Matching/Output/itrax_Composite/Matching_mean/ACE/cps/origin/Co_origin_performance_lm.pdf", 
       height = c(30), width = c(30), dpi = 600, units = "cm")
...
ggsave("Papers_R/2024_DeVleeschouwer/ACE_Matching/Output/itrax_Composite/Matching_mean/ACE/cps/origin/Co_origin_performance_wlm.pdf", 
       height = c(30), width = c(30), dpi = 600, units = "cm")
...
ggsave("Papers_R/2024_DeVleeschouwer/ACE_Matching/Output/itrax_Composite/Matching_mean/ACE/cps/origin/Ni_origin_performance_lm.pdf", 
       height = c(30), width = c(30), dpi = 600, units = "cm")
...
ggsave("Papers_R/2024_DeVleeschouwer/ACE_Matching/Output/itrax_Composite/Matching_mean/ACE/cps/origin/Ni_origin_performance_wlm.pdf", 
       height = c(30), width = c(30), dpi = 600, units = "cm")
...
ggsave("Papers_R/2024_DeVleeschouwer/ACE_Matching/Output/itrax_Composite/Matching_mean/ACE/cps/origin/Cu_origin_performance_lm.pdf", 
       height = c(30), width = c(30), dpi = 600, units = "cm")
...
ggsave("Papers_R/2024_DeVleeschouwer/ACE_Matching/Output/itrax_Composite/Matching_mean/ACE/cps/origin/Cu_origin_performance_wlm.pdf", 
       height = c(30), width = c(30), dpi = 600, units = "cm")
...
ggsave("Papers_R/2024_DeVleeschouwer/ACE_Matching/Output/itrax_Composite/Matching_mean/ACE/cps/origin/Zn_origin_performance_lm.pdf", 
       height = c(30), width = c(30), dpi = 600, units = "cm")
...
ggsave("Papers_R/2024_DeVleeschouwer/ACE_Matching/Output/itrax_Composite/Matching_mean/ACE/cps/origin/Zn_origin_performance_wlm.pdf", 
       height = c(30), width = c(30), dpi = 600, units = "cm")
...
ggsave("Papers_R/2024_DeVleeschouwer/ACE_Matching/Output/itrax_Composite/Matching_mean/ACE/cps/origin/Rb_origin_performance_lm.pdf", 
       height = c(30), width = c(30), dpi = 600, units = "cm")
...
ggsave("Papers_R/2024_DeVleeschouwer/ACE_Matching/Output/itrax_Composite/Matching_mean/ACE/cps/origin/Rb_origin_performance_wlm.pdf", 
       height = c(30), width = c(30), dpi = 600, units = "cm")
...
ggsave("Papers_R/2024_DeVleeschouwer/ACE_Matching/Output/itrax_Composite/Matching_mean/ACE/cps/origin/Sr_origin_performance_lm.pdf", 
       height = c(30), width = c(30), dpi = 600, units = "cm")
...
ggsave("Papers_R/2024_DeVleeschouwer/ACE_Matching/Output/itrax_Composite/Matching_mean/ACE/cps/origin/Sr_origin_performance_wlm.pdf", 
       height = c(30), width = c(30), dpi = 600, units = "cm")
...
ggsave("Papers_R/2024_DeVleeschouwer/ACE_Matching/Output/itrax_Composite/Matching_mean/ACE/cps/origin/DM_origin_performance_lm.pdf", 
       height = c(30), width = c(30), dpi = 600, units = "cm")
...
ggsave("Papers_R/2024_DeVleeschouwer/ACE_Matching/Output/itrax_Composite/Matching_mean/ACE/cps/origin/DM_origin_performance_wlm.pdf", 
       height = c(30), width = c(30), dpi = 600, units = "cm")
...
ggarrange(ACE_K_origin, ACE_Mn_origin, ACE_Ti_origin, 
          ...
          ncol = 3, nrow = 4, common.legend = TRUE)
ggsave("Papers_R/2024_DeVleeschouwer/ACE_Matching/Output/itrax_Composite/Matching_mean/ACE/cps/ACE_OLS_Summary_origin_lm_wlm.pdf", 
       height = c(50), width = c(50), dpi = 600, units = "cm")
