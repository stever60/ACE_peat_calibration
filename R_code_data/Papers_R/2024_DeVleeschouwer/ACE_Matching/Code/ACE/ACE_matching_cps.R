...
ACE_Zr_wlm_origin <- lm(Zr_ICP ~ Zr-1, weight = 1/Zr_ICP_sd, data = ACE_all)
summary(ACE_Zr_wlm_origin) # summary stats
check_model(ACE_Zr_wlm_origin) # summary check plots
ggsave("Papers_R/2024_DeVleeschouwer/ACE_Matching/Output/itrax_Composite/Matching_mean/ACE/cps/origin/Zr_origin_performance_wlm.pdf", 
       height = c(30), width = c(30), dpi = 600, units = "cm")
