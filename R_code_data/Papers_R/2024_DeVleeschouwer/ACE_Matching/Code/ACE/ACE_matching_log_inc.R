...
# Zr unweighted ---------------------------
ACE_Zr_origin <- ggplot(ACE_all, aes(x = coh_inc, y = dry_mass_pc)) +
  ...
  theme(legend.title = element_blank(),legend.text = element_text(size = 8), 
        ...
        axis.title=element_text(size=10, colour = "black"),
        title = element_text(size=10, colour = "black")) +
  labs(x = "coh/inc (XRF-CS) / cps", y = "Zr (ICPMS) / ppm" ) +
  ggtitle("ACE: Zr (ICP SD weighted = blue; unweighted = black)")
ACE_Zr_origin
ggsave("Papers_R/2024_DeVleeschouwer/ACE_Matching/Output/itrax_Composite/Matching_mean/ACE/log_inc/origin/Zr_origin_lm_wlm.pdf", 
       height = c(20), width = c(20), dpi = 600, units = "cm")
...
#Performance: Zr unweighted lm stats forced through origin
ACE_Zr_lm_origin <- lm(dry_mass_pc ~ coh_inc-1, data = ACE_all)
summary(ACE_Zr_lm_origin) # summary stats
check_model(ACE_Zr_lm_origin) # summary check plots
ggsave("Papers_R/2024_DeVleeschouwer/ACE_Matching/Output/itrax_Composite/Matching_mean/ACE/log_inc/origin/Zr_origin_performance_lm.pdf", 
       height = c(30), width = c(30), dpi = 600, units = "cm")
ACE_Zr_lm_origin_mp <- model_performance(ACE_Zr_lm_origin) # AIC - Akaike information criterion; BIC Bayesian IC: lower = better fit for both
display(ACE_Zr_lm_origin_mp)
bptest(ACE_Zr_lm_origin) # lmtest package check for heteroscedasticity - p <0.05 = reject null hypothesis - heteroscedasticity present
check_heteroscedasticity(ACE_Zr_lm_origin) # Performance package summary check for heteroscedasticity
icc(ACE_Zr_lm)

#Performance: Zr weighted lm forced through origin
ACE_Zr_wlm_origin <- lm(dry_mass_pc ~ coh_inc-1, weight = 1/dry_mass_err, data = ACE_all)
summary(ACE_Zr_wlm_origin) # summary stats
check_model(ACE_Zr_wlm_origin) # summary check plots
ggsave("Papers_R/2024_DeVleeschouwer/ACE_Matching/Output/itrax_Composite/Matching_mean/ACE/log_inc/origin/Zr_origin_performance_wlm.pdf", 
       height = c(30), width = c(30), dpi = 600, units = "cm")
ACE_Zr_wlm_origin_mp <- model_performance(ACE_Zr_wlm_origin) # AIC - Akaike information criterion; BIC Bayesian IC: lower = better fit for both
display(ACE_Zr_wlm_origin_mp)
bptest(ACE_Zr_wlm_origin) # lmtest package check for heteroscedasticity - p <0.05 = reject null hypothesis - heteroscedasticity present
check_heteroscedasticity(ACE_Zr_wlm_origin) # Performance package summary check for heteroscedasticity
icc(ACE_Zr_wlm)
