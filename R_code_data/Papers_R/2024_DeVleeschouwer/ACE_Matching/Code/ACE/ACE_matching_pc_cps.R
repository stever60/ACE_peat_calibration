...
ACE_Zr_origin
ggsave("Papers_R/2024_DeVleeschouwer/ACE_Matching/Output/itrax_Composite/Matching_mean/ACE/pc_cps/origin/Zr_origin_lm_wlm.pdf", 
       height = c(20), width = c(20), dpi = 600, units = "cm")
...
ggsave("Papers_R/2024_DeVleeschouwer/ACE_Matching/Output/itrax_Composite/Matching_mean/ACE/pc_cps/origin/Zr_origin_performance_lm.pdf", 
       height = c(30), width = c(30), dpi = 600, units = "cm")
...
ggsave("Papers_R/2024_DeVleeschouwer/ACE_Matching/Output/itrax_Composite/Matching_mean/ACE/pc_cps/origin/Zr_origin_performance_wlm.pdf", 
       height = c(30), width = c(30), dpi = 600, units = "cm")
...
ggarrange(ACE_K_origin, ACE_Mn_origin, ACE_Ti_origin, 
          ...
          ACE_Rb_origin, ACE_Sr_origin, ACE_Zr_origin,
          ncol = 3, nrow = 4, common.legend = TRUE)
