# Figure 3 - Linear models, ordinary and weighted least squares regression analysis (OLS, WLS)
...
write.csv(ACE_xrf_icp_matched,"Papers_R/2024_DeVleeschouwer/Figure3/Data/Output/cps/ACE_matched_xrf_icp_cps.csv", row.names = FALSE)
