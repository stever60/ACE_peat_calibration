...
ACE_xrf_cps
write.csv(ACE_xrf_cps,"Papers_R/2024_DeVleeschouwer/Figure4/Data/Output/ACE/ACE_xrf_cps.csv", row.names = FALSE)
...
ACE_xrf_log_inc
write.csv(ACE_xrf_log_inc,"Papers_R/2024_DeVleeschouwer/Figure4/Data/Output/ACE/ACE_xrf_log_inc.csv", row.names = FALSE)
...
ACE_xrf_clr <-read_csv("Papers_R/2024_DeVleeschouwer/Figure4/Data/Input/ACE_ITRAX_qc_acf_clr.csv") %>% 
  select(Location:MSE, all_of(acf_icp_Elements_key), Total_scatter, inc_coh, coh_inc)
ACE_xrf_clr
write.csv(ACE_xrf_cps,"Papers_R/2024_DeVleeschouwer/Figure4/Data/Output/ACE/ACE_xrf_clr.csv", row.names = FALSE)
...
write.csv(ACE_matched_xrf_icp_log_inc,"Papers_R/2024_DeVleeschouwer/Figure4/Data/Output/ACE/ACE_matched_xrf_icp_log_inc.csv", row.names = FALSE)
...
write.csv(ACE_matched_xrf_icp_log_inc_Z,"Papers_R/2024_DeVleeschouwer/Figure4/Data/Output/ACE/ACE_matched_xrf_icp_log_inc_Z.csv", row.names = FALSE)
...
write.csv(ACE_ICP_ppm,"Papers_R/2024_DeVleeschouwer/Figure4/Data/Output/ACE/ACE_matched_xrf_icp_cps.csv", row.names = FALSE)

# Input ICPMS data for comparison / overlay
ACE_ICP_ppm_Ti <-read_csv("Papers_R/2024_DeVleeschouwer/Figure4/Data/Output/ACE/ACE_matched_xrf_icp_cps.csv") %>%
...
ACE_xrf_calib_Ti
write.csv(ACE_xrf_calib_Ti,"Papers_R/2024_DeVleeschouwer/Figure4/Data/Output/HER42PB/HER42PB/ACE_xrf_calib_Ti.csv", row.names = FALSE)


# HER42PB Final Plots - START HERE AFTER ABOVE FILE HAS BEEN CREATED --------------------

# HER42PB - Ti -----------------------------------------------------------

HER42PB_xrf_calib_Ti <- read_csv("Papers_R/2024_DeVleeschouwer/Figure4/Data/Output/HER42PB/HER42PB/ACE_xrf_calib_Ti.csv") %>% 
  filter(Site == "HER42PB")
write.csv(HER42PB_xrf_calib_Ti,"Papers_R/2024_DeVleeschouwer/Figure4/Data/Output/HER42PB/HER42PB_xrf_calib_Ti.csv", row.names = FALSE)
