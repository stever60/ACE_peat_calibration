...
ACE_matched_xrf_icp_log_inc <-read_csv("Papers_R/2024_DeVleeschouwer/Figure3_ACE_PLS/Input/ACE_subsample_xrf_icp_matched_log_inc.csv") 
...
df0 <- ACE_matched_xrf_icp_log_inc %>%
  dplyr::select(Site, depth, SH20_mean_age, SH20_mean_95CI, all_of(xrf_icp_elements1)) %>%
  tidyr::drop_na()
...
capture.output(summary(pls_train_model_LOO), file = "Papers_R/2024_DeVleeschouwer/Figure3_ACE_PLS/Output/PLSR/log_inc/PLS_model_LOO_summary_Ti.txt")
...
pdf("Papers_R/2024_DeVleeschouwer/Figure3_ACE_PLS/Output/PLSR/log_inc/PLS_rmsep_plot_LOO.pdf", width = 4, height = 4)
...
sink("Papers_R/2024_DeVleeschouwer/Figure3_ACE_PLS/Output/PLSR/log_inc/RMSEP_Jackknife_all_LOO.txt")
...
# Save summary output to a text file
capture.output(summary(pls_train_model_CV), file = "Papers_R/2024_DeVleeschouwer/Figure3_ACE_PLS/Output/PLSR/log_inc/PLS_model_CV_summary_Ti.txt")

# Plot RMSEP to screen to choose number of components - where first becomes flat
plot(RMSEP(pls_train_model_CV), legendpos = "topright")

# Open a PDF in device
pdf("Papers_R/2024_DeVleeschouwer/Figure3_ACE_PLS/Output/PLSR/log_inc/PLS_rmsep_plot_CV.pdf", width = 4, height = 4)
...
sink("Papers_R/2024_DeVleeschouwer/Figure3_ACE_PLS/Output/PLSR/log_inc/RMSEP_Jackknife_all_CV.txt")
cat("RMSEP values for ICP elements:\n\n")
cat("Ti_ICP RMSEP:\n")
...
plot(predicted_icp, actual_icp_tbl)
...
# Open a PDF in device
pdf("Papers_R/2024_DeVleeschouwer/Figure3_ACE_PLS/Output/PLSR/log_inc/PLS_BIC_plot.pdf", width = 4, height = 4)
...
df_predicted
write.csv(df_predicted,"Papers_R/2024_DeVleeschouwer/Figure3_ACE_PLS/Output/PLSR/log_inc/Ti_ICP_predicted_log_inc.csv", row.names = FALSE)
...
write_csv(summary_df_log_inc_CI, "Papers_R/2024_DeVleeschouwer/Figure3_ACE_PLS/Output/PLSR/log_inc/Summary_log_inc_R2_RMSE_CI.csv")
...
PLS_final_Ti <- ggplot(df_predicted, aes(x = Ti_ICP, y = Ti_ICP_pred , color = Site)) +
  ...
  labs(
    ...
    x = "Observed ICP-MS [Ln(element)]",
    y = "Predicted [XRF-CS Ln(element/inc)]"
  ) +
  #theme_minimal() +
  coord_equal() +
...
print(PLS_final_Ti)
ggsave("Papers_R/2024_DeVleeschouwer/Figure3_ACE_PLS/Output/PLSR/log_inc/Ti_plsr_log_inc_as_log.pdf", 
...
#   output_path = "Papers_R/2024_DeVleeschouwer/Figure3_ACE_PLS/Output/PLSR/log_inc/Ti_plsr_log_inc_as_log.pdf"
# )
...
theme_set(theme_classic(base_size=12))
palette_set <- "jco" # define cb-friendly palette used in other plots or use "npg", "uchicago"
PLS_final_Ca <- ggplot(df_predicted, aes(y = Ca_ICP_pred, x = Ca_ICP, color = Site)) +
  ggpubr::color_palette(palette_set) +
  geom_point(shape = 16, size = 3, alpha = 0.9) +
  geom_abline(intercept = 0, slope = 1, linetype = "dashed") +
  labs(
...
print(PLS_final_Ca)
ggsave("Papers_R/2024_DeVleeschouwer/Figure3_ACE_PLS/Output/PLSR/log_inc/Ca_plsr_log_inc_as_log.pdf", 
       height = c(20), width = c(20), dpi = 600, units = "cm")
...
PLS_final_Sr <- ggplot(df_predicted, aes(y = Sr_ICP_pred, x = Sr_ICP, color = Site)) +
  ggpubr::color_palette(palette_set) +
  geom_point(shape = 16, size = 3, alpha = 0.9) +
  geom_abline(intercept = 0, slope = 1, linetype = "dashed") +
  labs(
...
print(PLS_final_Sr)
ggsave("Papers_R/2024_DeVleeschouwer/Figure3_ACE_PLS/Output/PLSR/log_inc/Sr_plsr_log_inc_as_log.pdf", 
       height = c(20), width = c(20), dpi = 600, units = "cm")
...
PLS_final_Zr <- ggplot(df_predicted, aes(y = Zr_ICP_pred, x = Zr_ICP, color = Site)) +
  ggpubr::color_palette(palette_set) +
  geom_point(shape = 16, size = 3, alpha = 0.9) +
  geom_abline(intercept = 0, slope = 1, linetype = "dashed") +
  labs(
...
print(PLS_final_Zr)
ggsave("Papers_R/2024_DeVleeschouwer/Figure3_ACE_PLS/Output/PLSR/log_inc/Zr_plsr_log_inc_as_log.pdf", 
       height = c(20), width = c(20), dpi = 600, units = "cm")
...
df_predicted_exp <- df_predicted %>% 
  dplyr::select(Ti_ICP_pred:Zr_ICP_pred) %>% 
  exp() %>% 
  rename_with(~ paste0(., "_ppm"))
df_predicted_exp
write.csv(df_predicted,"Papers_R/2024_DeVleeschouwer/Figure3_ACE_PLS/Output/PLSR/log_inc/Ti_ICP_predicted_ppm.csv", row.names = FALSE)
...
write.csv(df_predicted_ppm,"Papers_R/2024_DeVleeschouwer/Figure3_ACE_PLS/Output/PLSR/log_inc/ACE_ICP_act_pred_ppm.csv", row.names = FALSE)

# RMSE and R² and CI summary table for each element  --------------------

pred_ppm <- df_predicted_ppm %>% 
  dplyr::select(Ti_ICP_pred_ppm, Ca_ICP_pred_ppm, Sr_ICP_pred_ppm, Zr_ICP_pred_ppm)
actual_ppm <- df_predicted_ppm %>% 
  dplyr::select(Ti_ICP, Ca_ICP, Sr_ICP, Zr_ICP)
...
write_csv(summary_df_log_inc_CI_ppm, "Papers_R/2024_DeVleeschouwer/Figure3_ACE_PLS/Output/PLSR/log_inc/Summary_log_inc_R2_RMSE_CI_ppm.csv")
...
theme_set(theme_classic(base_size=12))
palette_set <- "jco" # define cb-friendly palette used in other plots or use "npg", "uchicago"
PLS_final_ppm_Ti <- ggplot(df_predicted_ppm, aes(y = Ti_ICP_pred_ppm, x = Ti_ICP, color = Site)) +
  ggpubr::color_palette(palette_set) +
  geom_point(shape = 16, size = 3, alpha = 0.9) +
  geom_abline(intercept = 0, slope = 1, linetype = "dashed") +
  labs(
    title = expression("PLS Ti log_inc model as"~"mg kg"^{-1}*""),
    x = expression("Observed XRF-CS (mg kg"^{-1}*")"),
...
ggsave("Papers_R/2024_DeVleeschouwer/Figure3_ACE_PLS/Output/PLSR/log_inc/Ti_plsr_log_inc_as_ppm.pdf", 
       height = c(20), width = c(20), dpi = 600, units = "cm")
...
theme_set(theme_classic(base_size=12))
palette_set <- "jco" # define cb-friendly palette used in other plots or use "npg", "uchicago"
PLS_final_ppm_Ca <- ggplot(df_predicted_ppm, aes(y = Ca_ICP_pred_ppm, x = Ca_ICP, color = Site)) +
  ggpubr::color_palette(palette_set) +
  geom_point(shape = 16, size = 3, alpha = 0.9) +
  geom_abline(intercept = 0, slope = 1, linetype = "dashed") +
  labs(
...
ggsave("Papers_R/2024_DeVleeschouwer/Figure3_ACE_PLS/Output/PLSR/log_inc/Ca_plsr_log_inc_as_ppm.pdf", 
       height = c(20), width = c(20), dpi = 600, units = "cm")
...
theme_set(theme_classic(base_size=12))
palette_set <- "jco" # define cb-friendly palette used in other plots or use "npg", "uchiSrgo"
PLS_final_ppm_Sr <- ggplot(df_predicted_ppm, aes(y = Sr_ICP_pred_ppm, x = Sr_ICP, color = Site)) +
  ggpubr::color_palette(palette_set) +
  geom_point(shape = 16, size = 3, alpha = 0.9) +
  geom_abline(intercept = 0, slope = 1, linetype = "dashed") +
  labs(
...
ggsave("Papers_R/2024_DeVleeschouwer/Figure3_ACE_PLS/Output/PLSR/log_inc/Sr_plsr_log_inc_as_ppm.pdf", 
       height = c(20), width = c(20), dpi = 600, units = "cm")
...
theme_set(theme_classic(base_size=12))
palette_set <- "jco" # define cb-friendly palette used in other plots or use "npg", "uchiZrgo"
PLS_final_ppm_Zr <- ggplot(df_predicted_ppm, aes(y = Zr_ICP_pred_ppm, x = Zr_ICP, color = Site)) +
  ggpubr::color_palette(palette_set) +
  geom_point(shape = 16, size = 3, alpha = 0.9) +
  geom_abline(intercept = 0, slope = 1, linetype = "dashed") +
  labs(
...
ggsave("Papers_R/2024_DeVleeschouwer/Figure3_ACE_PLS/Output/PLSR/log_inc/Zr_plsr_log_inc_as_ppm.pdf", 
       height = c(20), width = c(20), dpi = 600, units = "cm")
...
write.csv(ACE_PLS_ppm_pred_log_inc,"Papers_R/2024_DeVleeschouwer/Figure3_ACE_PLS/Output/PLSR/log_inc/ACE_PLS_ppm_pred_log_inc.csv", row.names = FALSE)
# Extract site data -----------------------------------------------------

ACE_PLS_ppm_pred_log_inc <- read_csv("Papers_R/2024_DeVleeschouwer/Figure3_ACE_PLS/Output/PLSR/log_inc/ACE_PLS_ppm_pred_log_inc.csv")
...
write.csv(HER42PB_PLS_ppm_pred_log_inc,"Papers_R/2024_DeVleeschouwer/Figure3_ACE_PLS/Output/PLSR/log_inc/HER42PB/HER42PB_PLS_ppm_pred_log_inc.csv", row.names = FALSE)

# Extract BI10 log_inc predicted ppm data 
BI10_PLS_ppm_pred_log_inc <- ACE_PLS_ppm_pred_log_inc %>% 
  filter(Site == "BI10")
BI10_PLS_ppm_pred_log_inc
write.csv(BI10_PLS_ppm_pred_log_inc,"Papers_R/2024_DeVleeschouwer/Figure3_ACE_PLS/Output/PLSR/log_inc//BI10/BI10_PLS_ppm_pred_log_inc.csv", row.names = FALSE)
...
write.csv(KER1_PLS_ppm_pred_log_inc,"Papers_R/2024_DeVleeschouwer/Figure3_ACE_PLS/Output/PLSR/log_inc/KER1/KER1_PLS_ppm_pred_log_inc.csv", row.names = FALSE)
...
write.csv(KER3_PLS_ppm_pred_log_inc,"Papers_R/2024_DeVleeschouwer/Figure3_ACE_PLS/Output/PLSR/log_inc/KER3/KER3_PLS_ppm_pred_log_inc.csv", row.names = FALSE)
...
write.csv(PB1_PLS_ppm_pred_log_inc,"Papers_R/2024_DeVleeschouwer/Figure3_ACE_PLS/Output/PLSR/log_inc/PB1/PB1_PLS_ppm_pred_log_inc.csv", row.names = FALSE)
...
HER42PB_PLS_ppm_pred_log_inc <-read_csv("Papers_R/2024_DeVleeschouwer/Figure3_ACE_PLS/Output/PLSR/log_inc/HER42PB/HER42PB_PLS_ppm_pred_log_inc.csv") %>% 
  filter(Site == "HER42PB")
HER42PB_PLS_ppm_pred_log_inc
...
HER42PB_PLS_ppm_pred_clr <-read_csv("Papers_R/2024_DeVleeschouwer/Figure3_ACE_PLS/Output/PLSR/clr/HER42PB/HER42PB_PLS_ppm_pred_clr.csv")
...
# Save the output
ggsave("Papers_R/2024_DeVleeschouwer/Figure3_ACE_PLS/Output/PLSR/log_inc/HER42PB/HER42PB_Ti_log_inc_PLS_depth.pdf",
...
# Save the output
ggsave("Papers_R/2024_DeVleeschouwer/Figure3_ACE_PLS/Output/PLSR/log_inc/HER42PB/HER42PB_Ti_log_inc_PLS_age.pdf",
...
plot_element_depth_log_inc_with_ICP(
  ...
  output_dir = "Papers_R/2024_DeVleeschouwer/Figure3_ACE_PLS/Output/PLSR/log_inc/HER42PB", 
...
plot_log_inc_pls_wls_vs_depth(
  ...
  df_icp = HER42PB_ICP,
  save_path = "Papers_R/2024_DeVleeschouwer/Figure3_ACE_PLS/Output/PLSR/log_inc/HER42PB/P1_HER42PB_Ti_log_inc_PLS_WLS_depth.pdf"
)
...
plot_log_inc_clr_vs_depth(
  ...
  df_icp = HER42PB_ICP,
  save_path = "Papers_R/2024_DeVleeschouwer/Figure3_ACE_PLS/Output/PLSR/log_inc/HER42PB/P2_HER42PB_Ti_PLS_log_inc_clr_depth.pdf"
)
...
plot_log_inc_wls_vs_age(
  ...
  df_wls = HER42PB_WLS_ppm_pred_log_inc,
  df_icp = HER42PB_ICP,
  save_path = "Papers_R/2024_DeVleeschouwer/Figure3_ACE_PLS/Output/PLSR/log_inc/HER42PB/P3_HER42PB_Ti_log_inc_PLS_WLS_age.pdf"
)
...
plot_log_inc_clr_vs_age(
  ...
  df_clr = HER42PB_PLS_ppm_pred_clr,
  df_icp = HER42PB_ICP,
  save_path = "Papers_R/2024_DeVleeschouwer/Figure3_ACE_PLS/Output/PLSR/log_inc/HER42PB/P4_HER42PB_Ti_PLS_log_inc_clr_age.pdf"
)
...
BI10_PLS_ppm_pred_log_inc <-read_csv("Papers_R/2024_DeVleeschouwer/Figure3_ACE_PLS/Output/PLSR/log_inc/BI10/BI10_PLS_ppm_pred_log_inc.csv") %>% 
  filter(Site == "BI10")
BI10_PLS_ppm_pred_log_inc
...
BI10_PLS_ppm_pred_clr <-read_csv("Papers_R/2024_DeVleeschouwer/Figure3_ACE_PLS/Output/PLSR/clr/BI10/BI10_PLS_ppm_pred_clr.csv")
...
ggplot(BI10_PLS_ppm_pred_log_inc, aes(y = depth)) +
  ...
  theme(plot.title = element_text(color = "black", size = 12, face = "bold"),
        ...
        axis.line = element_line(size = 0.75),
        axis.ticks = element_line(size = 0.75))
ggsave("Papers_R/2024_DeVleeschouwer/Figure3_ACE_PLS/Output/PLSR/log_inc/BI10/BI10_Ti_log_inc_PLS_depth.pdf",
...
ggplot(BI10_PLS_ppm_pred_log_inc, aes(x = SH20_age)) +
  ...
  theme(plot.title = element_text(color = "black", size = 12, face = "bold"),
        ...
        axis.line = element_line(size = 0.75),
        axis.ticks = element_line(size = 0.75))
ggsave("Papers_R/2024_DeVleeschouwer/Figure3_ACE_PLS/Output/PLSR/log_inc/BI10/BI10_Ti_log_inc_PLS_age.pdf",
...
plot_element_depth_log_inc_with_ICP(
  ...
  icp_data = BI10_ICP,
  output_dir = "Papers_R/2024_DeVleeschouwer/Figure3_ACE_PLS/Output/PLSR/log_inc/BI10", 
  age_model = BI10_adm,
  age_breaks = seq(0, 12000, by = 500)
)
# Create site_depth for plot matrix
...
plot_log_inc_pls_wls_vs_depth(
  ...
  df_icp = BI10_ICP,
  save_path = "Papers_R/2024_DeVleeschouwer/Figure3_ACE_PLS/Output/PLSR/log_inc/BI10/P1_BI10_Ti_log_inc_PLS_WLS_depth.pdf"
)
...
plot_log_inc_clr_vs_depth(
  ...
  df_icp = BI10_ICP,
  save_path = "Papers_R/2024_DeVleeschouwer/Figure3_ACE_PLS/Output/PLSR/log_inc/BI10/P2_BI10_Ti_PLS_log_inc_clr_depth.pdf"
)
...
plot_log_inc_wls_vs_age(
  ...
  df_wls = BI10_WLS_ppm_pred_log_inc,
  df_icp = BI10_ICP,
  save_path = "Papers_R/2024_DeVleeschouwer/Figure3_ACE_PLS/Output/PLSR/log_inc/BI10/P3_BI10_Ti_log_inc_PLS_WLS_age.pdf"
)
...
plot_log_inc_clr_vs_age(
  ...
  df_clr = BI10_PLS_ppm_pred_clr,
  df_icp = BI10_ICP,
  save_path = "Papers_R/2024_DeVleeschouwer/Figure3_ACE_PLS/Output/PLSR/log_inc/BI10/P4_BI10_Ti_PLS_log_inc_clr_age.pdf"
)
...
KER1_PLS_ppm_pred_clr <-read_csv("Papers_R/2024_DeVleeschouwer/Figure3_ACE_PLS/Output/PLSR/clr/KER1/KER1_PLS_ppm_pred_clr.csv")
...
ggplot(KER1_PLS_ppm_pred_log_inc, aes(y = depth)) +
  ...
  theme(plot.title = element_text(color = "black", size = 12, face = "bold"),
        ...
        axis.line = element_line(size = 0.75),
        axis.ticks = element_line(size = 0.75))
ggsave("Papers_R/2024_DeVleeschouwer/Figure3_ACE_PLS/Output/PLSR/log_inc/KER1/KER1_Ti_log_inc_PLS_depth.pdf",
       height = c(24), width = c(12), dpi = 600, units = "cm")
...
ggplot(KER1_PLS_ppm_pred_log_inc, aes(x = SH20_age)) +
  ...
  theme(plot.title = element_text(color = "black", size = 12, face = "bold"),
        ...
        axis.line = element_line(size = 0.75),
        axis.ticks = element_line(size = 0.75))
ggsave("Papers_R/2024_DeVleeschouwer/Figure3_ACE_PLS/Output/PLSR/log_inc/KER1/KER1_Ti_log_inc_PLS_age.pdf",
       height = c(12), width = c(24), dpi = 600, units = "cm")
...
plot_element_depth_log_inc_with_ICP(
  ...
  icp_data = KER1_ICP,
  output_dir = "Papers_R/2024_DeVleeschouwer/Figure3_ACE_PLS/Output/PLSR/log_inc/KER1", 
  age_model = KER1_adm,
  age_breaks = seq(0, 12000, by = 500)
)
# Create site_depth for plot matrix
...
plot_log_inc_pls_wls_vs_depth(
  ...
  df_icp = KER1_ICP,
  save_path = "Papers_R/2024_DeVleeschouwer/Figure3_ACE_PLS/Output/PLSR/log_inc/KER1/P1_KER1_Ti_log_inc_PLS_WLS_depth.pdf"
)
...
plot_log_inc_clr_vs_depth(
  ...
  df_icp = KER1_ICP,
  save_path = "Papers_R/2024_DeVleeschouwer/Figure3_ACE_PLS/Output/PLSR/log_inc/KER1/P2_KER1_Ti_PLS_log_inc_clr_depth.pdf"
)
...
plot_log_inc_wls_vs_age(
  ...
  df_wls = KER1_WLS_ppm_pred_log_inc,
  df_icp = KER1_ICP,
  save_path = "Papers_R/2024_DeVleeschouwer/Figure3_ACE_PLS/Output/PLSR/log_inc/KER1/P3_KER1_Ti_log_inc_PLS_WLS_age.pdf"
)
...
plot_log_inc_clr_vs_age(
  ...
  df_clr = KER1_PLS_ppm_pred_clr,
  df_icp = KER1_ICP,
  save_path = "Papers_R/2024_DeVleeschouwer/Figure3_ACE_PLS/Output/PLSR/log_inc/KER1/P4_KER1_Ti_PLS_log_inc_clr_age.pdf"
)
...
KER3_PLS_ppm_pred_log_inc <-read_csv("Papers_R/2024_DeVleeschouwer/Figure3_ACE_PLS/Output/PLSR/log_inc/KER3/KER3_PLS_ppm_pred_log_inc.csv") %>% 
  filter(Site == "KER3")
KER3_PLS_ppm_pred_log_inc
...
KER3_PLS_ppm_pred_clr <-read_csv("Papers_R/2024_DeVleeschouwer/Figure3_ACE_PLS/Output/PLSR/clr/KER3/KER3_PLS_ppm_pred_clr.csv")
...
ggplot(KER3_PLS_ppm_pred_log_inc, aes(y = depth)) +
  ...
  theme(plot.title = element_text(color = "black", size = 12, face = "bold"),
        ...
        axis.line = element_line(size = 0.75),
        axis.ticks = element_line(size = 0.75))
ggsave("Papers_R/2024_DeVleeschouwer/Figure3_ACE_PLS/Output/PLSR/log_inc/KER3/KER3_Ti_log_inc_PLS_depth.pdf",
       height = c(24), width = c(12), dpi = 600, units = "cm")
...
ggplot(KER3_PLS_ppm_pred_log_inc, aes(x = SH20_age)) +
  ...
  theme(plot.title = element_text(color = "black", size = 12, face = "bold"),
        ...
        axis.line = element_line(size = 0.75),
        axis.ticks = element_line(size = 0.75))
ggsave("Papers_R/2024_DeVleeschouwer/Figure3_ACE_PLS/Output/PLSR/log_inc/KER3/KER3_Ti_log_inc_PLS_age.pdf",
       height = c(12), width = c(24), dpi = 600, units = "cm")
...
plot_element_depth_log_inc_with_ICP(
  ...
  icp_data = KER3_ICP,
  output_dir = "Papers_R/2024_DeVleeschouwer/Figure3_ACE_PLS/Output/PLSR/log_inc/KER3", 
  age_model = KER3_adm,
  age_breaks = seq(0, 12000, by = 500)
)
# Create site_depth for plot matrix
...
plot_log_inc_pls_wls_vs_depth(
  ...
  df_icp = KER3_ICP,
  save_path = "Papers_R/2024_DeVleeschouwer/Figure3_ACE_PLS/Output/PLSR/log_inc/KER3/P1_KER3_Ti_log_inc_PLS_WLS_depth.pdf"
)
...
plot_log_inc_clr_vs_depth(
  ...
  df_icp = KER3_ICP,
  save_path = "Papers_R/2024_DeVleeschouwer/Figure3_ACE_PLS/Output/PLSR/log_inc/KER3/P2_KER3_Ti_PLS_log_inc_clr_depth.pdf"
)
...
plot_log_inc_wls_vs_age(
  ...
  df_wls = KER3_WLS_ppm_pred_log_inc,
  df_icp = KER3_ICP,
  save_path = "Papers_R/2024_DeVleeschouwer/Figure3_ACE_PLS/Output/PLSR/log_inc/KER3/P3_KER3_Ti_log_inc_PLS_WLS_age.pdf"
)
...
plot_log_inc_clr_vs_age(
  ...
  df_clr = KER3_PLS_ppm_pred_clr,
  df_icp = KER3_ICP,
  save_path = "Papers_R/2024_DeVleeschouwer/Figure3_ACE_PLS/Output/PLSR/log_inc/KER3/P4_KER3_Ti_PLS_log_inc_clr_age.pdf"
)
...
PB1_PLS_ppm_pred_log_inc <-read_csv("Papers_R/2024_DeVleeschouwer/Figure3_ACE_PLS/Output/PLSR/log_inc/PB1/PB1_PLS_ppm_pred_log_inc.csv") %>% 
  filter(Site == "PB1")
PB1_PLS_ppm_pred_log_inc
...
PB1_PLS_ppm_pred_clr <-read_csv("Papers_R/2024_DeVleeschouwer/Figure3_ACE_PLS/Output/PLSR/clr/PB1/PB1_PLS_ppm_pred_clr.csv")
...
ggplot(PB1_PLS_ppm_pred_log_inc, aes(y = depth)) +
  ...
  theme(plot.title = element_text(color = "black", size = 12, face = "bold"),
        ...
        axis.line = element_line(size = 0.75),
        axis.ticks = element_line(size = 0.75))
ggsave("Papers_R/2024_DeVleeschouwer/Figure3_ACE_PLS/Output/PLSR/log_inc/PB1/PB1_Ti_log_inc_PLS_depth.pdf",
       height = c(24), width = c(12), dpi = 600, units = "cm")
...
ggplot(PB1_PLS_ppm_pred_log_inc, aes(x = SH20_age)) +
  ...
  theme(plot.title = element_text(color = "black", size = 12, face = "bold"),
        ...
        axis.line = element_line(size = 0.75),
        axis.ticks = element_line(size = 0.75))
ggsave("Papers_R/2024_DeVleeschouwer/Figure3_ACE_PLS/Output/PLSR/log_inc/PB1/PB1_Ti_log_inc_PLS_age.pdf",
       height = c(12), width = c(24), dpi = 600, units = "cm")
...
plot_element_depth_log_inc_with_ICP(
  ...
  icp_data = PB1_ICP,
  output_dir = "Papers_R/2024_DeVleeschouwer/Figure3_ACE_PLS/Output/PLSR/log_inc/PB1", 
  age_model = PB1_adm,
  age_breaks = seq(0, 12000, by = 500)
)
# Create site_depth for plot matrix
...
plot_log_inc_pls_wls_vs_depth(
  ...
  df_icp = PB1_ICP,
  save_path = "Papers_R/2024_DeVleeschouwer/Figure3_ACE_PLS/Output/PLSR/log_inc/PB1/P1_PB1_Ti_log_inc_PLS_WLS_depth.pdf"
)
...
plot_log_inc_clr_vs_depth(
  ...
  df_icp = PB1_ICP,
  save_path = "Papers_R/2024_DeVleeschouwer/Figure3_ACE_PLS/Output/PLSR/log_inc/PB1/P2_PB1_Ti_PLS_log_inc_clr_depth.pdf"
)
...
plot_log_inc_wls_vs_age(
  ...
  df_wls = PB1_WLS_ppm_pred_log_inc,
  df_icp = PB1_ICP,
  save_path = "Papers_R/2024_DeVleeschouwer/Figure3_ACE_PLS/Output/PLSR/log_inc/PB1/P3_PB1_Ti_log_inc_PLS_WLS_age.pdf"
)
...
plot_log_inc_clr_vs_age(
  ...
  df_clr = PB1_PLS_ppm_pred_clr,
  df_icp = PB1_ICP,
  save_path = "Papers_R/2024_DeVleeschouwer/Figure3_ACE_PLS/Output/PLSR/log_inc/PB1/P4_PB1_Ti_PLS_log_inc_clr_age.pdf"
)
...
ggsave("Papers_R/2024_DeVleeschouwer/Figure3_ACE_PLS/Output/PLSR/log_inc/Fig4_ACE_PLS_Ti4.pdf",
...
ggsave("Papers_R/2024_DeVleeschouwer/Figure3_ACE_PLS/Output/PLSR/log_inc/Fig4_ACE_PLS_Ti5.pdf",
...
#   df_wls = HER42PB_WLS_ppm_pred_log_inc,
#   df_icp = HER42PB_ICP,
#   save_path = "Papers_R/2024_DeVleeschouwer/Figure3_ACE_PLS/Output/PLSR/log_inc/HER42PB/P1_HER42PB_Ca_log_inc_PLS_WLS_depth.pdf"
# )
# 
# P2 Define inputs & save
plot_log_inc_clr_vs_depth(
  ...
  df_clr = HER42PB_PLS_ppm_pred_clr,
  df_icp = HER42PB_ICP,
  save_path = "Papers_R/2024_DeVleeschouwer/Figure3_ACE_PLS/Output/PLSR/log_inc/HER42PB/P2_HER42PB_Ca_PLS_log_inc_clr_depth.pdf"
)
...
#   df_wls = HER42PB_WLS_ppm_pred_log_inc,
#   df_icp = HER42PB_ICP,
#   save_path = "Papers_R/2024_DeVleeschouwer/Figure3_ACE_PLS/Output/PLSR/log_inc/HER42PB/P3_HER42PB_Ca_log_inc_PLS_WLS_age.pdf"
# )
# 
# P4 Define inputs & save
plot_log_inc_clr_vs_age(
  ...
  df_clr = HER42PB_PLS_ppm_pred_clr,
  df_icp = HER42PB_ICP,
  save_path = "Papers_R/2024_DeVleeschouwer/Figure3_ACE_PLS/Output/PLSR/log_inc/HER42PB/P4_HER42PB_Ca_PLS_log_inc_clr_age.pdf"
)
...
#   df_wls = BI10_WLS_ppm_pred_log_inc,
#   df_icp = BI10_ICP,
#   save_path = "Papers_R/2024_DeVleeschouwer/Figure3_ACE_PLS/Output/PLSR/log_inc/BI10/P1_BI10_Ca_log_inc_PLS_WLS_depth.pdf"
# )
# 
# P2 Define inputs & save
plot_log_inc_clr_vs_depth(
  ...
  df_clr = BI10_PLS_ppm_pred_clr,
  df_icp = BI10_ICP,
  save_path = "Papers_R/2024_DeVleeschouwer/Figure3_ACE_PLS/Output/PLSR/log_inc/BI10/P2_BI10_Ca_PLS_log_inc_clr_depth.pdf"
)
...
#   df_wls = BI10_WLS_ppm_pred_log_inc,
#   df_icp = BI10_ICP,
#   save_path = "Papers_R/2024_DeVleeschouwer/Figure3_ACE_PLS/Output/PLSR/log_inc/BI10/P3_BI10_Ca_log_inc_PLS_WLS_age.pdf"
# )
# 
# P4 Define inputs & save
plot_log_inc_clr_vs_age(
  ...
  df_clr = BI10_PLS_ppm_pred_clr,
  df_icp = BI10_ICP,
  save_path = "Papers_R/2024_DeVleeschouwer/Figure3_ACE_PLS/Output/PLSR/log_inc/BI10/P4_BI10_Ca_PLS_log_inc_clr_age.pdf"
)
...
#   df_wls = KER1_WLS_ppm_pred_log_inc,
#   df_icp = KER1_ICP,
#   save_path = "Papers_R/2024_DeVleeschouwer/Figure3_ACE_PLS/Output/PLSR/log_inc/KER1/P1_KER1_Ca_log_inc_PLS_WLS_depth.pdf"
# )
# 
# P2 Define inputs & save
plot_log_inc_clr_vs_depth(
  ...
  df_clr = KER1_PLS_ppm_pred_clr,
  df_icp = KER1_ICP,
  save_path = "Papers_R/2024_DeVleeschouwer/Figure3_ACE_PLS/Output/PLSR/log_inc/KER1/P2_KER1_Ca_PLS_log_inc_clr_depth.pdf"
)
# 
# KER1 Age - multiple plots & overlays --------------------------------------
# 
...
#   df_wls = KER1_WLS_ppm_pred_log_inc,
#   df_icp = KER1_ICP,
#   save_path = "Papers_R/2024_DeVleeschouwer/Figure3_ACE_PLS/Output/PLSR/log_inc/KER1/P3_KER1_Ca_log_inc_PLS_WLS_age.pdf"
# )
# 
# P4 Define inputs & save
plot_log_inc_clr_vs_age(
  ...
  df_clr = KER1_PLS_ppm_pred_clr,
  df_icp = KER1_ICP,
  save_path = "Papers_R/2024_DeVleeschouwer/Figure3_ACE_PLS/Output/PLSR/log_inc/KER1/P4_KER1_Ca_PLS_log_inc_clr_age.pdf"
)
# 
# -------------------------------------------------------------------------
# KER3 Depth - ICPMS overlay ------------------------------------------------
...
#   df_wls = KER3_WLS_ppm_pred_log_inc,
#   df_icp = KER3_ICP,
#   save_path = "Papers_R/2024_DeVleeschouwer/Figure3_ACE_PLS/Output/PLSR/log_inc/KER3/P1_KER3_Ca_log_inc_PLS_WLS_depth.pdf"
# )
# 
# P2 Define inputs & save
plot_log_inc_clr_vs_depth(
  ...
  df_clr = KER3_PLS_ppm_pred_clr,
  df_icp = KER3_ICP,
  save_path = "Papers_R/2024_DeVleeschouwer/Figure3_ACE_PLS/Output/PLSR/log_inc/KER3/P2_KER3_Ca_PLS_log_inc_clr_depth.pdf"
)
...
#   df_wls = KER3_WLS_ppm_pred_log_inc,
#   df_icp = KER3_ICP,
#   save_path = "Papers_R/2024_DeVleeschouwer/Figure3_ACE_PLS/Output/PLSR/log_inc/KER3/P3_KER3_Ca_log_inc_PLS_WLS_age.pdf"
# )
# 
# P4 Define inputs & save
plot_log_inc_clr_vs_age(
  ...
  df_clr = KER3_PLS_ppm_pred_clr,
  df_icp = KER3_ICP,
  save_path = "Papers_R/2024_DeVleeschouwer/Figure3_ACE_PLS/Output/PLSR/log_inc/KER3/P4_KER3_Ca_PLS_log_inc_clr_age.pdf"
)
...
#   df_wls = PB1_WLS_ppm_pred_log_inc,
#   df_icp = PB1_ICP,
#   save_path = "Papers_R/2024_DeVleeschouwer/Figure3_ACE_PLS/Output/PLSR/log_inc/PB1/P1_PB1_Ca_log_inc_PLS_WLS_depth.pdf"
# )
# 
# # P2 Define inputs & save
# plot_log_inc_clr_vs_depth(
...
#   df_clr = PB1_PLS_ppm_pred_clr,
#   df_icp = PB1_ICP,
#   save_path = "Papers_R/2024_DeVleeschouwer/Figure3_ACE_PLS/Output/PLSR/log_inc/PB1/P2_PB1_Ca_PLS_log_inc_clr_depth.pdf"
# )
...
#   df_wls = PB1_WLS_ppm_pred_log_inc,
#   df_icp = PB1_ICP,
#   save_path = "Papers_R/2024_DeVleeschouwer/Figure3_ACE_PLS/Output/PLSR/log_inc/PB1/P3_PB1_Ca_log_inc_PLS_WLS_age.pdf"
# )
# 
# # P4 Define inputs & save
# plot_log_inc_clr_vs_age(
...
#   df_clr = PB1_PLS_ppm_pred_clr,
#   df_icp = PB1_ICP,
#   save_path = "Papers_R/2024_DeVleeschouwer/Figure3_ACE_PLS/Output/PLSR/log_inc/PB1/P4_PB1_Ca_PLS_log_inc_clr_age.pdf"
# )
# 
# this doesn't work for Ca
# Matrix plots -----------------------------------------------------------------
...
ggarrange(BI10_depth_Ca, HER42PB_depth_Ca, KER1_depth_Ca, KER3_depth_Ca, PB1_depth_Ca,
          ncol = 5, nrow = 1, common.legend = TRUE)
ggsave("Papers_R/2024_DeVleeschouwer/Figure3_ACE_PLS/Output/PLSR/log_inc/Fig4_ACE_PLS_Ca.pdf",
       height = c(15), width = c(40), dpi = 600, units = "cm")
...
#   df_wls = HER42PB_WLS_ppm_pred_log_inc,
#   df_icp = HER42PB_ICP,
#   save_path = "Papers_R/2024_DeVleeschouwer/Figure3_ACE_PLS/Output/PLSR/log_inc/HER42PB/P1_HER42PB_Sr_log_inc_PLS_WLS_depth.pdf"
# )
# 
# P2 Define inputs & save
plot_log_inc_clr_vs_depth(
  ...
  df_clr = HER42PB_PLS_ppm_pred_clr,
  df_icp = HER42PB_ICP,
  save_path = "Papers_R/2024_DeVleeschouwer/Figure3_ACE_PLS/Output/PLSR/log_inc/HER42PB/P2_HER42PB_Sr_PLS_log_inc_clr_depth.pdf"
)
...
#   df_wls = HER42PB_WLS_ppm_pred_log_inc,
#   df_icp = HER42PB_ICP,
#   save_path = "Papers_R/2024_DeVleeschouwer/Figure3_ACE_PLS/Output/PLSR/log_inc/HER42PB/P3_HER42PB_Sr_log_inc_PLS_WLS_age.pdf"
# )
# 
# P4 Define inputs & save
plot_log_inc_clr_vs_age(
  ...
  df_clr = HER42PB_PLS_ppm_pred_clr,
  df_icp = HER42PB_ICP,
  save_path = "Papers_R/2024_DeVleeschouwer/Figure3_ACE_PLS/Output/PLSR/log_inc/HER42PB/P4_HER42PB_Sr_PLS_log_inc_clr_age.pdf"
)
...
#   df_wls = BI10_WLS_ppm_pred_log_inc,
#   df_icp = BI10_ICP,
#   save_path = "Papers_R/2024_DeVleeschouwer/Figure3_ACE_PLS/Output/PLSR/log_inc/BI10/P1_BI10_Sr_log_inc_PLS_WLS_depth.pdf"
# )
# 
# P2 Define inputs & save
plot_log_inc_clr_vs_depth(
  ...
  df_clr = BI10_PLS_ppm_pred_clr,
  df_icp = BI10_ICP,
  save_path = "Papers_R/2024_DeVleeschouwer/Figure3_ACE_PLS/Output/PLSR/log_inc/BI10/P2_BI10_Sr_PLS_log_inc_clr_depth.pdf"
)
# 
# BI10 Age - multiple plots & overlays --------------------------------------
# 
...
#   df_wls = BI10_WLS_ppm_pred_log_inc,
#   df_icp = BI10_ICP,
#   save_path = "Papers_R/2024_DeVleeschouwer/Figure3_ACE_PLS/Output/PLSR/log_inc/BI10/P3_BI10_Sr_log_inc_PLS_WLS_age.pdf"
# )
# 
# P4 Define inputs & save
plot_log_inc_clr_vs_age(
  ...
  df_clr = BI10_PLS_ppm_pred_clr,
  df_icp = BI10_ICP,
  save_path = "Papers_R/2024_DeVleeschouwer/Figure3_ACE_PLS/Output/PLSR/log_inc/BI10/P4_BI10_Sr_PLS_log_inc_clr_age.pdf"
)
...
#   df_wls = KER1_WLS_ppm_pred_log_inc,
#   df_icp = KER1_ICP,
#   save_path = "Papers_R/2024_DeVleeschouwer/Figure3_ACE_PLS/Output/PLSR/log_inc/KER1/P1_KER1_Sr_log_inc_PLS_WLS_depth.pdf"
# )
# 
# P2 Define inputs & save
plot_log_inc_clr_vs_depth(
  ...
  df_clr = KER1_PLS_ppm_pred_clr,
  df_icp = KER1_ICP,
  save_path = "Papers_R/2024_DeVleeschouwer/Figure3_ACE_PLS/Output/PLSR/log_inc/KER1/P2_KER1_Sr_PLS_log_inc_clr_depth.pdf"
)
...
#   df_wls = KER1_WLS_ppm_pred_log_inc,
#   df_icp = KER1_ICP,
#   save_path = "Papers_R/2024_DeVleeschouwer/Figure3_ACE_PLS/Output/PLSR/log_inc/KER1/P3_KER1_Sr_log_inc_PLS_WLS_age.pdf"
# )
# 
# P4 Define inputs & save
plot_log_inc_clr_vs_age(
  ...
  df_clr = KER1_PLS_ppm_pred_clr,
  df_icp = KER1_ICP,
  save_path = "Papers_R/2024_DeVleeschouwer/Figure3_ACE_PLS/Output/PLSR/log_inc/KER1/P4_KER1_Sr_PLS_log_inc_clr_age.pdf"
)
...
#   df_wls = KER3_WLS_ppm_pred_log_inc,
#   df_icp = KER3_ICP,
#   save_path = "Papers_R/2024_DeVleeschouwer/Figure3_ACE_PLS/Output/PLSR/log_inc/KER3/P1_KER3_Sr_log_inc_PLS_WLS_depth.pdf"
# )
# 
# P2 Define inputs & save
plot_log_inc_clr_vs_depth(
  ...
  df_clr = KER3_PLS_ppm_pred_clr,
  df_icp = KER3_ICP,
  save_path = "Papers_R/2024_DeVleeschouwer/Figure3_ACE_PLS/Output/PLSR/log_inc/KER3/P2_KER3_Sr_PLS_log_inc_clr_depth.pdf"
)
...
#   df_wls = KER3_WLS_ppm_pred_log_inc,
#   df_icp = KER3_ICP,
#   save_path = "Papers_R/2024_DeVleeschouwer/Figure3_ACE_PLS/Output/PLSR/log_inc/KER3/P3_KER3_Sr_log_inc_PLS_WLS_age.pdf"
# )
...
plot_log_inc_clr_vs_age(
  ...
  df_clr = KER3_PLS_ppm_pred_clr,
  df_icp = KER3_ICP,
  save_path = "Papers_R/2024_DeVleeschouwer/Figure3_ACE_PLS/Output/PLSR/log_inc/KER3/P4_KER3_Sr_PLS_log_inc_clr_age.pdf"
)
...
#   df_wls = PB1_WLS_ppm_pred_log_inc,
#   df_icp = PB1_ICP,
#   save_path = "Papers_R/2024_DeVleeschouwer/Figure3_ACE_PLS/Output/PLSR/log_inc/PB1/P1_PB1_Sr_log_inc_PLS_WLS_depth.pdf"
# )
# 
# P2 Define inputs & save
plot_log_inc_clr_vs_depth(
  ...
  df_clr = PB1_PLS_ppm_pred_clr,
  df_icp = PB1_ICP,
  save_path = "Papers_R/2024_DeVleeschouwer/Figure3_ACE_PLS/Output/PLSR/log_inc/PB1/P2_PB1_Sr_PLS_log_inc_clr_depth.pdf"
)
...
#   df_wls = PB1_WLS_ppm_pred_log_inc,
#   df_icp = PB1_ICP,
#   save_path = "Papers_R/2024_DeVleeschouwer/Figure3_ACE_PLS/Output/PLSR/log_inc/PB1/P3_PB1_Sr_log_inc_PLS_WLS_age.pdf"
# )
# 
# P4 Define inputs & save
plot_log_inc_clr_vs_age(
  ...
  df_clr = PB1_PLS_ppm_pred_clr,
  df_icp = PB1_ICP,
  save_path = "Papers_R/2024_DeVleeschouwer/Figure3_ACE_PLS/Output/PLSR/log_inc/PB1/P4_PB1_Sr_PLS_log_inc_clr_age.pdf"
)
...
ggarrange(BI10_depth_Sr, HER42PB_depth_Sr, KER1_depth_Sr, KER3_depth_Sr, PB1_depth_Sr,
          ncol = 5, nrow = 1, common.legend = TRUE)
ggsave("Papers_R/2024_DeVleeschouwer/Figure3_ACE_PLS/Output/PLSR/log_inc/Fig4_ACE_PLS_Sr.pdf",
       height = c(15), width = c(40), dpi = 600, units = "cm")
...
#   df_wls = HER42PB_WLS_ppm_pred_log_inc,
#   df_icp = HER42PB_ICP,
#   save_path = "Papers_R/2024_DeVleeschouwer/Figure3_ACE_PLS/Output/PLSR/log_inc/HER42PB/P1_HER42PB_Zr_log_inc_PLS_WLS_depth.pdf"
# )
...
plot_log_inc_clr_vs_depth(
  ...
  df_clr = HER42PB_PLS_ppm_pred_clr,
  df_icp = HER42PB_ICP,
  save_path = "Papers_R/2024_DeVleeschouwer/Figure3_ACE_PLS/Output/PLSR/log_inc/HER42PB/P2_HER42PB_Zr_PLS_log_inc_clr_depth.pdf"
)
...
#   df_wls = HER42PB_WLS_ppm_pred_log_inc,
#   df_icp = HER42PB_ICP,
#   save_path = "Papers_R/2024_DeVleeschouwer/Figure3_ACE_PLS/Output/PLSR/log_inc/HER42PB/P3_HER42PB_Zr_log_inc_PLS_WLS_age.pdf"
# )
...
plot_log_inc_clr_vs_age(
  ...
  df_clr = HER42PB_PLS_ppm_pred_clr,
  df_icp = HER42PB_ICP,
  save_path = "Papers_R/2024_DeVleeschouwer/Figure3_ACE_PLS/Output/PLSR/log_inc/HER42PB/P4_HER42PB_Zr_PLS_log_inc_clr_age.pdf"
)
...
#   df_wls = BI10_WLS_ppm_pred_log_inc,
#   df_icp = BI10_ICP,
#   save_path = "Papers_R/2024_DeVleeschouwer/Figure3_ACE_PLS/Output/PLSR/log_inc/BI10/P1_BI10_Zr_log_inc_PLS_WLS_depth.pdf"
# )
...
plot_log_inc_clr_vs_depth(
  ...
  df_clr = BI10_PLS_ppm_pred_clr,
  df_icp = BI10_ICP,
  save_path = "Papers_R/2024_DeVleeschouwer/Figure3_ACE_PLS/Output/PLSR/log_inc/BI10/P2_BI10_Zr_PLS_log_inc_clr_depth.pdf"
)
...
#   df_wls = BI10_WLS_ppm_pred_log_inc,
#   df_icp = BI10_ICP,
#   save_path = "Papers_R/2024_DeVleeschouwer/Figure3_ACE_PLS/Output/PLSR/log_inc/BI10/P3_BI10_Zr_log_inc_PLS_WLS_age.pdf"
# )
...
plot_log_inc_clr_vs_age(
  ...
  df_clr = BI10_PLS_ppm_pred_clr,
  df_icp = BI10_ICP,
  save_path = "Papers_R/2024_DeVleeschouwer/Figure3_ACE_PLS/Output/PLSR/log_inc/BI10/P4_BI10_Zr_PLS_log_inc_clr_age.pdf"
)
...
#   df_wls = KER1_WLS_ppm_pred_log_inc,
#   df_icp = KER1_ICP,
#   save_path = "Papers_R/2024_DeVleeschouwer/Figure3_ACE_PLS/Output/PLSR/log_inc/KER1/P1_KER1_Zr_log_inc_PLS_WLS_depth.pdf"
# )
...
plot_log_inc_clr_vs_depth(
  ...
  df_clr = KER1_PLS_ppm_pred_clr,
  df_icp = KER1_ICP,
  save_path = "Papers_R/2024_DeVleeschouwer/Figure3_ACE_PLS/Output/PLSR/log_inc/KER1/P2_KER1_Zr_PLS_log_inc_clr_depth.pdf"
)
...
#   df_wls = KER1_WLS_ppm_pred_log_inc,
#   df_icp = KER1_ICP,
#   save_path = "Papers_R/2024_DeVleeschouwer/Figure3_ACE_PLS/Output/PLSR/log_inc/KER1/P3_KER1_Zr_log_inc_PLS_WLS_age.pdf"
# )
...
plot_log_inc_clr_vs_age(
  ...
  df_clr = KER1_PLS_ppm_pred_clr,
  df_icp = KER1_ICP,
  save_path = "Papers_R/2024_DeVleeschouwer/Figure3_ACE_PLS/Output/PLSR/log_inc/KER1/P4_KER1_Zr_PLS_log_inc_clr_age.pdf"
)
...
#   df_wls = KER3_WLS_ppm_pred_log_inc,
#   df_icp = KER3_ICP,
#   save_path = "Papers_R/2024_DeVleeschouwer/Figure3_ACE_PLS/Output/PLSR/log_inc/KER3/P1_KER3_Zr_log_inc_PLS_WLS_depth.pdf"
# )
...
plot_log_inc_clr_vs_depth(
  ...
  df_clr = KER3_PLS_ppm_pred_clr,
  df_icp = KER3_ICP,
  save_path = "Papers_R/2024_DeVleeschouwer/Figure3_ACE_PLS/Output/PLSR/log_inc/KER3/P2_KER3_Zr_PLS_log_inc_clr_depth.pdf"
)
...
#   df_wls = KER3_WLS_ppm_pred_log_inc,
#   df_icp = KER3_ICP,
#   save_path = "Papers_R/2024_DeVleeschouwer/Figure3_ACE_PLS/Output/PLSR/log_inc/KER3/P3_KER3_Zr_log_inc_PLS_WLS_age.pdf"
# )
...
plot_log_inc_clr_vs_age(
  ...
  df_clr = KER3_PLS_ppm_pred_clr,
  df_icp = KER3_ICP,
  save_path = "Papers_R/2024_DeVleeschouwer/Figure3_ACE_PLS/Output/PLSR/log_inc/KER3/P4_KER3_Zr_PLS_log_inc_clr_age.pdf"
)
...
#   df_wls = PB1_WLS_ppm_pred_log_inc,
#   df_icp = PB1_ICP,
#   save_path = "Papers_R/2024_DeVleeschouwer/Figure3_ACE_PLS/Output/PLSR/log_inc/PB1/P1_PB1_Zr_log_inc_PLS_WLS_depth.pdf"
# )
...
plot_log_inc_clr_vs_depth(
  ...
  df_clr = PB1_PLS_ppm_pred_clr,
  df_icp = PB1_ICP,
  save_path = "Papers_R/2024_DeVleeschouwer/Figure3_ACE_PLS/Output/PLSR/log_inc/PB1/P2_PB1_Zr_PLS_log_inc_clr_depth.pdf"
)
...
#   df_wls = PB1_WLS_ppm_pred_log_inc,
#   df_icp = PB1_ICP,
#   save_path = "Papers_R/2024_DeVleeschouwer/Figure3_ACE_PLS/Output/PLSR/log_inc/PB1/P3_PB1_Zr_log_inc_PLS_WLS_age.pdf"
# )
...
plot_log_inc_clr_vs_age(
  ...
  df_clr = PB1_PLS_ppm_pred_clr,
  df_icp = PB1_ICP,
  save_path = "Papers_R/2024_DeVleeschouwer/Figure3_ACE_PLS/Output/PLSR/log_inc/PB1/P4_PB1_Zr_PLS_log_inc_clr_age.pdf"
)
...
ggarrange(BI10_depth_Zr, KER1_depth_Zr, KER3_depth_Zr, PB1_depth_Zr,
          ncol = 4, nrow = 1, common.legend = TRUE)
ggsave("Papers_R/2024_DeVleeschouwer/Figure3_ACE_PLS/Output/PLSR/log_inc/Fig4_ACE_PLS_Zr4.pdf",
       height = c(15), width = c(30), dpi = 600, units = "cm")

# Summary 5x1 matrix ACE PLS Zr & Supp info
ggarrange(BI10_depth_Zr, HER42PB_depth_Zr, KER1_depth_Zr, KER3_depth_Zr, PB1_depth_Zr,
          ncol = 5, nrow = 1, common.legend = TRUE)
ggsave("Papers_R/2024_DeVleeschouwer/Figure3_ACE_PLS/Output/PLSR/log_inc/Fig4_ACE_PLS_Zr5.pdf",
...
summary(pls_model)
# Save summary output to a text file
capture.output(summary(pls_model), file = "Papers_R/2024_DeVleeschouwer/Figure3_ACE_PLS/Output/PLSR/log_inc/Bootstrap_pls_model_summary.txt")
...
Ti_ICP_test_df
write.csv(Ti_ICP_test_df,"Papers_R/2024_DeVleeschouwer/Figure3_ACE_PLS/Output/PLSR_train_test/Ti/Ti_ICP_predicted.csv", row.names = FALSE)
...
ggplot(train_plot_df, aes(x = Comp1, y = Comp2, color = Site)) +
  ...
  theme(plot.title = element_text(color="black", size=12, face="bold"),
        ...
        axis.text.y = element_text(size=12))
  #coord_equal()
ggsave("Papers_R/2024_DeVleeschouwer/Figure3_ACE_PLS/Output/PLSR_train_test/Ti/Ti_training_comp1vs2.pdf", 
       height = c(20), width = c(20), dpi = 600, units = "cm")
  #theme_minimal()
...
ggplot(Ti_ICP_test_df, aes(x = Ti_ICP, y = Ti_ICP_pred, color = Site)) +
  ...
  theme(plot.title = element_text(color="black", size=12, face="bold"),
        ...
        axis.text.y = element_text(size=12))
#coord_equal()
ggsave("Papers_R/2024_DeVleeschouwer/Figure3_ACE_PLS/Output/PLSR_train_test/Ti/Ti_pred_meas.pdf", 
       height = c(20), width = c(20), dpi = 600, units = "cm")
#theme_minimal()
# Regression Equation
...
ggplot(rmse_df, aes(x = RMSE)) +
  ...
  labs(title = "Histogram of Bootstrapped RMSE Values for Ti 0.6 train:test",
       ...
       y = "Frequency") +
  theme_minimal()
ggsave("Papers_R/2024_DeVleeschouwer/Figure3_ACE_PLS/Output/PLSR_train_test/Ti/Ti_RMSE_hist_bootstrapping.pdf", 
       height = c(20), width = c(20), dpi = 600, units = "cm")
...
write.csv(Ti_ppm_PLS_predicted_bs,"Papers_R/2024_DeVleeschouwer/Figure3_ACE_PLS/Output/PLSR_train_test/Ti/ACE_Ti_ppm_PLS_predicted_bstrap.csv", row.names = FALSE)

# Extract HER42PB data for Figure 4
HER42PB_Ti_ppm_PLS_predicted_bs <- Ti_ppm_PLS_predicted_bs %>% 
  filter(Site == "HER42PB")
HER42PB_Ti_ppm_PLS_predicted_bs
write.csv(HER42PB_Ti_ppm_PLS_predicted_bs,"Papers_R/2024_DeVleeschouwer/Figure3_ACE_PLS/Output/PLSR_train_test/Ti/HER42PB_Ti_ppm_PLS_predicted_bstrap.csv", row.names = FALSE)
...
# sink(file = "Papers_R/2024_DeVleeschouwer/Figure3_ACE_PLS/Output/PLSR_train_test/Ti/Summary_stats.txt")
...
write.csv(df_test_joined,"Papers_R/2024_DeVleeschouwer/Figure3_ACE_PLS/Output/PLSR_train_test/Ti/Ti_ICP_predicted_baseR.csv", row.names = FALSE)
