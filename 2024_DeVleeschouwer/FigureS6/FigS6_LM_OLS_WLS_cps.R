# Figure S6 - Linear models, ordinary and weighted least squares regression analysis (OLS, WLS)
...
# Import ACE Subample-ICPMS_XRF-cps matched file ----------------------------------------------
...
# Set up Linear modelling - OLS regression tests ----------------------------------------------- 
...
ggsave("Papers_R/2024_DeVleeschouwer/FigureS6/Plots/FigS6c_OLS_WLS_cps/Ca/Ca_OLS_performance.pdf", 
...
ggsave("Papers_R/2024_DeVleeschouwer/FigureS6/Plots/FigS6c_OLS_WLS_cps/Ca/Ca_OLS_wt_performance.pdf", 
       height = c(30), width = c(30), dpi = 600, units = "cm")
...
ggsave("Papers_R/2024_DeVleeschouwer/FigureS6/Plots/FigS6c_OLS_WLS_cps/Ca/Ca_WLS_performance.pdf", 
       height = c(30), width = c(30), dpi = 600, units = "cm")
...
ggsave("Papers_R/2024_DeVleeschouwer/FigureS6/Plots/FigS6c_OLS_WLS_cps/Ca/Ca_WLS_wt_performance.pdf", 
       height = c(30), width = c(30), dpi = 600, units = "cm")
...
write.csv(ACE_Ca_lm_no_outliers,"Papers_R/2024_DeVleeschouwer/FigureS6/Plots/FigS6c_OLS_WLS_cps/Ca/ACE_Ca_OLS_no_outliers.csv", row.names = FALSE)
...
write.csv(ACE_Ca_wlm_no_outliers,"Papers_R/2024_DeVleeschouwer/FigureS6/Plots/FigS6c_OLS_WLS_cps/Ca/ACE_Ca_OLS_wt_no_outliers.csv", row.names = FALSE)
...
write.csv(ACE_Ca_wls_no_outliers,"Papers_R/2024_DeVleeschouwer/FigureS6/Plots/FigS6c_OLS_WLS_cps/Ca/ACE_Ca_WLS_no_outliers.csv", row.names = FALSE)
...
write.csv(ACE_Ca_wls_wt_no_outliers,"Papers_R/2024_DeVleeschouwer/FigureS6/Plots/FigS6c_OLS_WLS_cps/Ca/ACE_Ca_WLS_wt_no_outliers.csv", row.names = FALSE)

# Write stats to file
# 1) OLS - write to file
sink(file = "Papers_R/2024_DeVleeschouwer/FigureS6/Plots/FigS6c_OLS_WLS_cps/Ca/Ca_OLS_summary.txt")
summary(ACE_Ca_lm)
glance(ACE_Ca_lm)
model_performance(ACE_Ca_lm) # AIC - Akaike information criterion; BIC Bayesian IC: lower = better fit for both
...
pdf(file = "Papers_R/2024_DeVleeschouwer/FigureS6/Plots/FigS6c_OLS_WLS_cps/Ca/ACE_Ca_lm_lev_bar.pdf")
barplot(hatvalues(ACE_Ca_lm), 
        col = "aquamarine3")
dev.off()
pdf(file = "Papers_R/2024_DeVleeschouwer/FigureS6/Plots/FigS6c_OLS_WLS_cps/Ca/ACE_Ca_lm_lev.pdf")
leveragePlots(ACE_Ca_lm,layout=c(2,2)) 
dev.off()
pdf(file = "Papers_R/2024_DeVleeschouwer/FigureS6/Plots/FigS6c_OLS_WLS_cps/Ca/ACE_Ca_lm_lev_cooks.pdf")
par(mfrow = c(2, 2))
plot(ACE_Ca_lm)
dev.off()
# 2) OLS weighted - write to file
sink(file = "Papers_R/2024_DeVleeschouwer/FigureS6/Plots/FigS6c_OLS_WLS_cps/Ca/Ca_OLS_wt_summary.txt")
summary(ACE_Ca_wlm)
glance(ACE_Ca_wlm)
model_performance(ACE_Ca_wlm) # AIC - Akaike information criterion; BIC Bayesian IC: lower = better fit for both
...
sink(file = NULL)
#Summary Leverage & Cooks distnce plots - write to file 
pdf(file = "Papers_R/2024_DeVleeschouwer/FigureS6/Plots/FigS6c_OLS_WLS_cps/Ca/ACE_Ca_wlm_lev_bar.pdf")
barplot(hatvalues(ACE_Ca_wlm), 
        col = "red")
dev.off()
pdf(file = "Papers_R/2024_DeVleeschouwer/FigureS6/Plots/FigS6c_OLS_WLS_cps/Ca/ACE_Ca_wlm_lev.pdf")
leveragePlots(ACE_Ca_wlm,layout=c(2,2)) 
dev.off()
pdf(file = "Papers_R/2024_DeVleeschouwer/FigureS6/Plots/FigS6c_OLS_WLS_cps/Ca/ACE_Ca_wlm_lev_cooks.pdf")
par(mfrow = c(2, 2))
plot(ACE_Ca_wlm)
dev.off()
# 3) WLS - write to file
sink(file = "Papers_R/2024_DeVleeschouwer/FigureS6/Plots/FigS6c_OLS_WLS_cps/Ca/Ca_WLS_summary.txt")
summary(ACE_Ca_wls)
glance(ACE_Ca_wls)
model_performance(ACE_Ca_wls) # AIC - Akaike information criterion; BIC Bayesian IC: lower = better fit for both
...
sink(file = NULL)
#Summary Leverage & Cooks distnce plots - write to file 
pdf(file = "Papers_R/2024_DeVleeschouwer/FigureS6/Plots/FigS6c_OLS_WLS_cps/Ca/ACE_Ca_wls_lev_bar.pdf")
barplot(hatvalues(ACE_Ca_wls), 
        col = "blue")
dev.off()
pdf(file = "Papers_R/2024_DeVleeschouwer/FigureS6/Plots/FigS6c_OLS_WLS_cps/Ca/ACE_Ca_wls_lev.pdf")
leveragePlots(ACE_Ca_wls,layout=c(2,2)) 
dev.off()
pdf(file = "Papers_R/2024_DeVleeschouwer/FigureS6/Plots/FigS6c_OLS_WLS_cps/Ca/ACE_Ca_wls_lev_cooks.pdf")
par(mfrow = c(2, 2))
plot(ACE_Ca_wls)
dev.off()
# 4) WLS weighted - write to file
sink(file = "Papers_R/2024_DeVleeschouwer/FigureS6/Plots/FigS6c_OLS_WLS_cps/Ca/Ca_WLS_wt_summary.txt")
...
sink(file = NULL)
#Summary Leverage & Cooks distnce plots - write to file 
pdf(file = "Papers_R/2024_DeVleeschouwer/FigureS6/Plots/FigS6c_OLS_WLS_cps/Ca/ACE_Ca_wls_wt_lev_bar.pdf")
barplot(hatvalues(ACE_Ca_wls_wt), 
        col = "green")
dev.off()
pdf(file = "Papers_R/2024_DeVleeschouwer/FigureS6/Plots/FigS6c_OLS_WLS_cps/Ca/ACE_Ca_wls_wt_lev.pdf")
leveragePlots(ACE_Ca_wls_wt,layout=c(2,2)) 
dev.off()
pdf(file = "Papers_R/2024_DeVleeschouwer/FigureS6/Plots/FigS6c_OLS_WLS_cps/Ca/ACE_Ca_wls_wt_lev_cooks.pdf")
par(mfrow = c(2, 2))
plot(ACE_Ca_wls_wt)
dev.off()
...
ACE_Ca <- ggplot(ACE_dataset, aes(x = Ca, y = Ca_ICP)) + #ACE_dataset
  ...
  labs(x = paste(element_title,  itrax_dataset, "[XRF-CS]") , y = paste0(element_title, " mg kg-1 [ICPMS]")) +
  scale_y_continuous(labels = scales::comma) +
  ggtitle(paste("Site: ", site_title, "; ", element_title, " cps"))
ACE_Ca
...
ACE_Ca_final
ggsave("Papers_R/2024_DeVleeschouwer/FigureS6/Plots/FigS6c_OLS_WLS_cps/Ca/Ca_OLS_WLS_summary.pdf", 
...
Ca_data_2_out <- bind_cols(Ca_data_1_out, Ca_pred.int2) %>%
  ...
  print()
write.csv(Ca_data_2_out,"Papers_R/2024_DeVleeschouwer/FigureS6/Plots/FigS6c_OLS_WLS_cps/Ca/Ca_OLS_WLS_predict.csv", row.names = FALSE)
...
ACE_Ca_predict <- ACE_Ca_final + 
  ...
  ggtitle(paste("Site: ", site_title, "; ", "Element: " , element_title, " cps [95% CI & PI]"))
ACE_Ca_predict
ggsave("Papers_R/2024_DeVleeschouwer/FigureS6/Plots/FigS6c_OLS_WLS_cps/Ca/Ca_OLS_WLS_predict.pdf", 
...
ggsave("Papers_R/2024_DeVleeschouwer/FigureS6/Plots/FigS6c_OLS_WLS_cps/Ti/Ti_OLS_performance.pdf", 
       height = c(30), width = c(30), dpi = 600, units = "cm")
...
ggsave("Papers_R/2024_DeVleeschouwer/FigureS6/Plots/FigS6c_OLS_WLS_cps/Ti/Ti_OLS_wt_performance.pdf", 
       height = c(30), width = c(30), dpi = 600, units = "cm")
...
ggsave("Papers_R/2024_DeVleeschouwer/FigureS6/Plots/FigS6c_OLS_WLS_cps/Ti/Ti_WLS_performance.pdf", 
       height = c(30), width = c(30), dpi = 600, units = "cm")
...
ggsave("Papers_R/2024_DeVleeschouwer/FigureS6/Plots/FigS6c_OLS_WLS_cps/Ti/Ti_WLS_wt_performance.pdf", 
       height = c(30), width = c(30), dpi = 600, units = "cm")
...
write.csv(ACE_Ti_lm_no_outliers,"Papers_R/2024_DeVleeschouwer/FigureS6/Plots/FigS6c_OLS_WLS_cps/Ti/ACE_Ti_OLS_no_outliers.csv", row.names = FALSE)
...
write.csv(ACE_Ti_wlm_no_outliers,"Papers_R/2024_DeVleeschouwer/FigureS6/Plots/FigS6c_OLS_WLS_cps/Ti/ACE_Ti_OLS_wt_no_outliers.csv", row.names = FALSE)
...
write.csv(ACE_Ti_wls_no_outliers,"Papers_R/2024_DeVleeschouwer/FigureS6/Plots/FigS6c_OLS_WLS_cps/Ti/ACE_Ti_WLS_no_outliers.csv", row.names = FALSE)
...
write.csv(ACE_Ti_wls_wt_no_outliers,"Papers_R/2024_DeVleeschouwer/FigureS6/Plots/FigS6c_OLS_WLS_cps/Ti/ACE_Ti_WLS_wt_no_outliers.csv", row.names = FALSE)

# Write stats to file
# 1) OLS - write to file
sink(file = "Papers_R/2024_DeVleeschouwer/FigureS6/Plots/FigS6c_OLS_WLS_cps/Ti/Ti_OLS_summary.txt")
summary(ACE_Ti_lm)
glance(ACE_Ti_lm)
model_performance(ACE_Ti_lm) # AIC - Akaike information criterion; BIC Bayesian IC: lower = better fit for both
...
sink(file = NULL)
#Summary Leverage & Cooks distnce plots - write to file 
pdf(file = "Papers_R/2024_DeVleeschouwer/FigureS6/Plots/FigS6c_OLS_WLS_cps/Ti/ACE_Ti_lm_lev_bar.pdf")
barplot(hatvalues(ACE_Ti_lm), 
        col = "aquamarine3")
dev.off()
pdf(file = "Papers_R/2024_DeVleeschouwer/FigureS6/Plots/FigS6c_OLS_WLS_cps/Ti/ACE_Ti_lm_lev.pdf")
leveragePlots(ACE_Ti_lm,layout=c(2,2)) 
dev.off()
pdf(file = "Papers_R/2024_DeVleeschouwer/FigureS6/Plots/FigS6c_OLS_WLS_cps/Ti/ACE_Ti_lm_lev_cooks.pdf")
par(mfrow = c(2, 2))
plot(ACE_Ti_lm)
dev.off()
# 2) OLS weighted - write to file
sink(file = "Papers_R/2024_DeVleeschouwer/FigureS6/Plots/FigS6c_OLS_WLS_cps/Ti/Ti_OLS_wt_summary.txt")
summary(ACE_Ti_wlm)
glance(ACE_Ti_wlm)
model_performance(ACE_Ti_wlm) # AIC - Akaike information criterion; BIC Bayesian IC: lower = better fit for both
...
sink(file = NULL)
#Summary Leverage & Cooks distnce plots - write to file 
pdf(file = "Papers_R/2024_DeVleeschouwer/FigureS6/Plots/FigS6c_OLS_WLS_cps/Ti/ACE_Ti_wlm_lev_bar.pdf")
barplot(hatvalues(ACE_Ti_wlm), 
        col = "red")
dev.off()
pdf(file = "Papers_R/2024_DeVleeschouwer/FigureS6/Plots/FigS6c_OLS_WLS_cps/Ti/ACE_Ti_wlm_lev.pdf")
leveragePlots(ACE_Ti_wlm,layout=c(2,2)) 
dev.off()
pdf(file = "Papers_R/2024_DeVleeschouwer/FigureS6/Plots/FigS6c_OLS_WLS_cps/Ti/ACE_Ti_wlm_lev_cooks.pdf")
par(mfrow = c(2, 2))
plot(ACE_Ti_wlm)
dev.off()
# 3) WLS - write to file
sink(file = "Papers_R/2024_DeVleeschouwer/FigureS6/Plots/FigS6c_OLS_WLS_cps/Ti/Ti_WLS_summary.txt")
summary(ACE_Ti_wls)
glance(ACE_Ti_wls)
model_performance(ACE_Ti_wls) # AIC - Akaike information criterion; BIC Bayesian IC: lower = better fit for both
...
sink(file = NULL)
#Summary Leverage & Cooks distnce plots - write to file 
pdf(file = "Papers_R/2024_DeVleeschouwer/FigureS6/Plots/FigS6c_OLS_WLS_cps/Ti/ACE_Ti_wls_lev_bar.pdf")
barplot(hatvalues(ACE_Ti_wls), 
        col = "blue")
dev.off()
pdf(file = "Papers_R/2024_DeVleeschouwer/FigureS6/Plots/FigS6c_OLS_WLS_cps/Ti/ACE_Ti_wls_lev.pdf")
leveragePlots(ACE_Ti_wls,layout=c(2,2)) 
dev.off()
pdf(file = "Papers_R/2024_DeVleeschouwer/FigureS6/Plots/FigS6c_OLS_WLS_cps/Ti/ACE_Ti_wls_lev_cooks.pdf")
par(mfrow = c(2, 2))
plot(ACE_Ti_wls)
dev.off()
# 4) WLS weighted - write to file
sink(file = "Papers_R/2024_DeVleeschouwer/FigureS6/Plots/FigS6c_OLS_WLS_cps/Ti/Ti_WLS_wt_summary.txt")
...
sink(file = NULL)
#Summary Leverage & Cooks distnce plots - write to file 
pdf(file = "Papers_R/2024_DeVleeschouwer/FigureS6/Plots/FigS6c_OLS_WLS_cps/Ti/ACE_Ti_wls_wt_lev_bar.pdf")
barplot(hatvalues(ACE_Ti_wls_wt), 
        col = "green")
dev.off()
pdf(file = "Papers_R/2024_DeVleeschouwer/FigureS6/Plots/FigS6c_OLS_WLS_cps/Ti/ACE_Ti_wls_wt_lev.pdf")
leveragePlots(ACE_Ti_wls_wt,layout=c(2,2)) 
dev.off()
pdf(file = "Papers_R/2024_DeVleeschouwer/FigureS6/Plots/FigS6c_OLS_WLS_cps/Ti/ACE_Ti_wls_wt_lev_cooks.pdf")
par(mfrow = c(2, 2))
plot(ACE_Ti_wls_wt)
dev.off()
...
ACE_Ti_final <- ACE_Ti + 
  ...
  geom_text(data=data.frame(), aes(label=paste("OLS: ", ACE_Ti_lm_eqn(df)), x = -Inf, y = Inf),
            parse = TRUE, colour = "blue", hjust = -0.15, vjust = 5, size = 3)
ACE_Ti_final
ggsave("Papers_R/2024_DeVleeschouwer/FigureS6/Plots/FigS6c_OLS_WLS_cps/Ti/Ti_OLS_WLS_summary.pdf", 
       height = c(20), width = c(20), dpi = 600, units = "cm")
...
Ti_data_2_out <- bind_cols(Ti_data_1_out, Ti_pred.int2) %>%
  ...
  print()
write.csv(Ti_data_2_out,"Papers_R/2024_DeVleeschouwer/FigureS6/Plots/FigS6c_OLS_WLS_cps/Ti/Ti_OLS_WLS_predict.csv", row.names = FALSE)
...
ACE_Ti_predict <- ACE_Ti_final + 
  ...
  ggtitle(paste("Site: ", site_title, "; ", "Element: " , element_title, " cps [95% CI & PI]"))
ACE_Ti_predict
ggsave("Papers_R/2024_DeVleeschouwer/FigureS6/Plots/FigS6c_OLS_WLS_cps/Ti/Ti_OLS_WLS_predict.pdf", 
       height = c(16), width = c(16), dpi = 600, units = "cm")
...
ggsave("Papers_R/2024_DeVleeschouwer/FigureS6/Plots/FigS6c_OLS_WLS_cps/Mn/Mn_OLS_performance.pdf", 
       height = c(30), width = c(30), dpi = 600, units = "cm")
...
ggsave("Papers_R/2024_DeVleeschouwer/FigureS6/Plots/FigS6c_OLS_WLS_cps/Mn/Mn_OLS_wt_performance.pdf", 
       height = c(30), width = c(30), dpi = 600, units = "cm")
...
ggsave("Papers_R/2024_DeVleeschouwer/FigureS6/Plots/FigS6c_OLS_WLS_cps/Mn/Mn_WLS_performance.pdf", 
       height = c(30), width = c(30), dpi = 600, units = "cm")
...
ggsave("Papers_R/2024_DeVleeschouwer/FigureS6/Plots/FigS6c_OLS_WLS_cps/Mn/Mn_WLS_wt_performance.pdf", 
       height = c(30), width = c(30), dpi = 600, units = "cm")
...
write.csv(ACE_Mn_lm_no_outliers,"Papers_R/2024_DeVleeschouwer/FigureS6/Plots/FigS6c_OLS_WLS_cps/Mn/ACE_Mn_OLS_no_outliers.csv", row.names = FALSE)
...
write.csv(ACE_Mn_wlm_no_outliers,"Papers_R/2024_DeVleeschouwer/FigureS6/Plots/FigS6c_OLS_WLS_cps/Mn/ACE_Mn_OLS_wt_no_outliers.csv", row.names = FALSE)
...
write.csv(ACE_Mn_wls_no_outliers,"Papers_R/2024_DeVleeschouwer/FigureS6/Plots/FigS6c_OLS_WLS_cps/Mn/ACE_Mn_WLS_no_outliers.csv", row.names = FALSE)
...
write.csv(ACE_Mn_wls_wt_no_outliers,"Papers_R/2024_DeVleeschouwer/FigureS6/Plots/FigS6c_OLS_WLS_cps/Mn/ACE_Mn_WLS_wt_no_outliers.csv", row.names = FALSE)

# Write stats to file
# 1) OLS - write to file
sink(file = "Papers_R/2024_DeVleeschouwer/FigureS6/Plots/FigS6c_OLS_WLS_cps/Mn/Mn_OLS_summary.txt")
summary(ACE_Mn_lm)
glance(ACE_Mn_lm)
model_performance(ACE_Mn_lm) # AIC - Akaike information criterion; BIC Bayesian IC: lower = better fit for both
...
sink(file = NULL)
#Summary Leverage & Cooks distnce plots - write to file 
pdf(file = "Papers_R/2024_DeVleeschouwer/FigureS6/Plots/FigS6c_OLS_WLS_cps/Mn/ACE_Mn_lm_lev_bar.pdf")
barplot(hatvalues(ACE_Mn_lm), 
        col = "aquamarine3")
dev.off()
pdf(file = "Papers_R/2024_DeVleeschouwer/FigureS6/Plots/FigS6c_OLS_WLS_cps/Mn/ACE_Mn_lm_lev.pdf")
leveragePlots(ACE_Mn_lm,layout=c(2,2)) 
dev.off()
pdf(file = "Papers_R/2024_DeVleeschouwer/FigureS6/Plots/FigS6c_OLS_WLS_cps/Mn/ACE_Mn_lm_lev_cooks.pdf")
par(mfrow = c(2, 2))
plot(ACE_Mn_lm)
dev.off()
# 2) OLS weighted - write to file
sink(file = "Papers_R/2024_DeVleeschouwer/FigureS6/Plots/FigS6c_OLS_WLS_cps/Mn/Mn_OLS_wt_summary.txt")
summary(ACE_Mn_wlm)
glance(ACE_Mn_wlm)
model_performance(ACE_Mn_wlm) # AIC - Akaike information criterion; BIC Bayesian IC: lower = better fit for both
...
sink(file = NULL)
#Summary Leverage & Cooks distnce plots - write to file 
pdf(file = "Papers_R/2024_DeVleeschouwer/FigureS6/Plots/FigS6c_OLS_WLS_cps/Mn/ACE_Mn_wlm_lev_bar.pdf")
barplot(hatvalues(ACE_Mn_wlm), 
        col = "red")
dev.off()
pdf(file = "Papers_R/2024_DeVleeschouwer/FigureS6/Plots/FigS6c_OLS_WLS_cps/Mn/ACE_Mn_wlm_lev.pdf")
leveragePlots(ACE_Mn_wlm,layout=c(2,2)) 
dev.off()
pdf(file = "Papers_R/2024_DeVleeschouwer/FigureS6/Plots/FigS6c_OLS_WLS_cps/Mn/ACE_Mn_wlm_lev_cooks.pdf")
par(mfrow = c(2, 2))
plot(ACE_Mn_wlm)
dev.off()
# 3) WLS - write to file
sink(file = "Papers_R/2024_DeVleeschouwer/FigureS6/Plots/FigS6c_OLS_WLS_cps/Mn/Mn_WLS_summary.txt")
summary(ACE_Mn_wls)
glance(ACE_Mn_wls)
model_performance(ACE_Mn_wls) # AIC - Akaike information criterion; BIC Bayesian IC: lower = better fit for both
...
sink(file = NULL)
#Summary Leverage & Cooks distnce plots - write to file 
pdf(file = "Papers_R/2024_DeVleeschouwer/FigureS6/Plots/FigS6c_OLS_WLS_cps/Mn/ACE_Mn_wls_lev_bar.pdf")
barplot(hatvalues(ACE_Mn_wls), 
        col = "blue")
dev.off()
pdf(file = "Papers_R/2024_DeVleeschouwer/FigureS6/Plots/FigS6c_OLS_WLS_cps/Mn/ACE_Mn_wls_lev.pdf")
leveragePlots(ACE_Mn_wls,layout=c(2,2)) 
dev.off()
pdf(file = "Papers_R/2024_DeVleeschouwer/FigureS6/Plots/FigS6c_OLS_WLS_cps/Mn/ACE_Mn_wls_lev_cooks.pdf")
par(mfrow = c(2, 2))
plot(ACE_Mn_wls)
dev.off()
# 4) WLS weighted - write to file
sink(file = "Papers_R/2024_DeVleeschouwer/FigureS6/Plots/FigS6c_OLS_WLS_cps/Mn/Mn_WLS_wt_summary.txt")
...
sink(file = NULL)
#Summary Leverage & Cooks distnce plots - write to file 
pdf(file = "Papers_R/2024_DeVleeschouwer/FigureS6/Plots/FigS6c_OLS_WLS_cps/Mn/ACE_Mn_wls_wt_lev_bar.pdf")
barplot(hatvalues(ACE_Mn_wls_wt), 
        col = "green")
dev.off()
pdf(file = "Papers_R/2024_DeVleeschouwer/FigureS6/Plots/FigS6c_OLS_WLS_cps/Mn/ACE_Mn_wls_wt_lev.pdf")
leveragePlots(ACE_Mn_wls_wt,layout=c(2,2)) 
dev.off()
pdf(file = "Papers_R/2024_DeVleeschouwer/FigureS6/Plots/FigS6c_OLS_WLS_cps/Mn/ACE_Mn_wls_wt_lev_cooks.pdf")
par(mfrow = c(2, 2))
plot(ACE_Mn_wls_wt)
dev.off()
...
ACE_Mn_final <- ACE_Mn + 
  ...
  geom_text(data=data.frame(), aes(label=paste("OLS: ", ACE_Mn_lm_eqn(df)), x = -Inf, y = Inf),
            parse = TRUE, colour = "blue", hjust = -0.15, vjust = 5, size = 3)
ACE_Mn_final
ggsave("Papers_R/2024_DeVleeschouwer/FigureS6/Plots/FigS6c_OLS_WLS_cps/Mn/Mn_OLS_WLS_summary.pdf", 
       height = c(20), width = c(20), dpi = 600, units = "cm")
...
Mn_data_2_out <- bind_cols(Mn_data_1_out, Mn_pred.int2) %>%
  ...
  print()
write.csv(Mn_data_2_out,"Papers_R/2024_DeVleeschouwer/FigureS6/Plots/FigS6c_OLS_WLS_cps/Mn/Mn_OLS_WLS_predict.csv", row.names = FALSE)
...
ACE_Mn_predict <- ACE_Mn_final + 
  ...
  ggtitle(paste("Site: ", site_title, "; ", "Element: " , element_title, " cps [95% CI & PI]"))
ACE_Mn_predict
ggsave("Papers_R/2024_DeVleeschouwer/FigureS6/Plots/FigS6c_OLS_WLS_cps/Mn/Mn_OLS_WLS_predict.pdf", 
       height = c(16), width = c(16), dpi = 600, units = "cm")
...
ggsave("Papers_R/2024_DeVleeschouwer/FigureS6/Plots/FigS6c_OLS_WLS_cps/Fe/Fe_OLS_performance.pdf", 
       height = c(30), width = c(30), dpi = 600, units = "cm")
...
ggsave("Papers_R/2024_DeVleeschouwer/FigureS6/Plots/FigS6c_OLS_WLS_cps/Fe/Fe_OLS_wt_performance.pdf", 
       height = c(30), width = c(30), dpi = 600, units = "cm")
...
ggsave("Papers_R/2024_DeVleeschouwer/FigureS6/Plots/FigS6c_OLS_WLS_cps/Fe/Fe_WLS_performance.pdf", 
       height = c(30), width = c(30), dpi = 600, units = "cm")
...
ggsave("Papers_R/2024_DeVleeschouwer/FigureS6/Plots/FigS6c_OLS_WLS_cps/Fe/Fe_WLS_wt_performance.pdf", 
       height = c(30), width = c(30), dpi = 600, units = "cm")
...
write.csv(ACE_Fe_lm_no_outliers,"Papers_R/2024_DeVleeschouwer/FigureS6/Plots/FigS6c_OLS_WLS_cps/Fe/ACE_Fe_OLS_no_outliers.csv", row.names = FALSE)
...
write.csv(ACE_Fe_wlm_no_outliers,"Papers_R/2024_DeVleeschouwer/FigureS6/Plots/FigS6c_OLS_WLS_cps/Fe/ACE_Fe_OLS_wt_no_outliers.csv", row.names = FALSE)
...
write.csv(ACE_Fe_wls_no_outliers,"Papers_R/2024_DeVleeschouwer/FigureS6/Plots/FigS6c_OLS_WLS_cps/Fe/ACE_Fe_WLS_no_outliers.csv", row.names = FALSE)
...
write.csv(ACE_Fe_wls_wt_no_outliers,"Papers_R/2024_DeVleeschouwer/FigureS6/Plots/FigS6c_OLS_WLS_cps/Fe/ACE_Fe_WLS_wt_no_outliers.csv", row.names = FALSE)

# Write stats to file
# 1) OLS - write to file
sink(file = "Papers_R/2024_DeVleeschouwer/FigureS6/Plots/FigS6c_OLS_WLS_cps/Fe/Fe_OLS_summary.txt")
summary(ACE_Fe_lm)
glance(ACE_Fe_lm)
model_performance(ACE_Fe_lm) # AIC - Akaike information criterion; BIC Bayesian IC: lower = better fit for both
...
sink(file = NULL)
#Summary Leverage & Cooks distnce plots - write to file 
pdf(file = "Papers_R/2024_DeVleeschouwer/FigureS6/Plots/FigS6c_OLS_WLS_cps/Fe/ACE_Fe_lm_lev_bar.pdf")
barplot(hatvalues(ACE_Fe_lm), 
        col = "aquamarine3")
dev.off()
pdf(file = "Papers_R/2024_DeVleeschouwer/FigureS6/Plots/FigS6c_OLS_WLS_cps/Fe/ACE_Fe_lm_lev.pdf")
leveragePlots(ACE_Fe_lm,layout=c(2,2)) 
dev.off()
pdf(file = "Papers_R/2024_DeVleeschouwer/FigureS6/Plots/FigS6c_OLS_WLS_cps/Fe/ACE_Fe_lm_lev_cooks.pdf")
par(mfrow = c(2, 2))
plot(ACE_Fe_lm)
dev.off()
# 2) OLS weighted - write to file
sink(file = "Papers_R/2024_DeVleeschouwer/FigureS6/Plots/FigS6c_OLS_WLS_cps/Fe/Fe_OLS_wt_summary.txt")
summary(ACE_Fe_wlm)
glance(ACE_Fe_wlm)
model_performance(ACE_Fe_wlm) # AIC - Akaike information criterion; BIC Bayesian IC: lower = better fit for both
...
sink(file = NULL)
#Summary Leverage & Cooks distnce plots - write to file 
pdf(file = "Papers_R/2024_DeVleeschouwer/FigureS6/Plots/FigS6c_OLS_WLS_cps/Fe/ACE_Fe_wlm_lev_bar.pdf")
barplot(hatvalues(ACE_Fe_wlm), 
        col = "red")
dev.off()
pdf(file = "Papers_R/2024_DeVleeschouwer/FigureS6/Plots/FigS6c_OLS_WLS_cps/Fe/ACE_Fe_wlm_lev.pdf")
leveragePlots(ACE_Fe_wlm,layout=c(2,2)) 
dev.off()
pdf(file = "Papers_R/2024_DeVleeschouwer/FigureS6/Plots/FigS6c_OLS_WLS_cps/Fe/ACE_Fe_wlm_lev_cooks.pdf")
par(mfrow = c(2, 2))
plot(ACE_Fe_wlm)
dev.off()
# 3) WLS - write to file
sink(file = "Papers_R/2024_DeVleeschouwer/FigureS6/Plots/FigS6c_OLS_WLS_cps/Fe/Fe_WLS_summary.txt")
summary(ACE_Fe_wls)
glance(ACE_Fe_wls)
model_performance(ACE_Fe_wls) # AIC - Akaike information criterion; BIC Bayesian IC: lower = better fit for both
...
sink(file = NULL)
#Summary Leverage & Cooks distnce plots - write to file 
pdf(file = "Papers_R/2024_DeVleeschouwer/FigureS6/Plots/FigS6c_OLS_WLS_cps/Fe/ACE_Fe_wls_lev_bar.pdf")
barplot(hatvalues(ACE_Fe_wls), 
        col = "blue")
dev.off()
pdf(file = "Papers_R/2024_DeVleeschouwer/FigureS6/Plots/FigS6c_OLS_WLS_cps/Fe/ACE_Fe_wls_lev.pdf")
leveragePlots(ACE_Fe_wls,layout=c(2,2)) 
dev.off()
pdf(file = "Papers_R/2024_DeVleeschouwer/FigureS6/Plots/FigS6c_OLS_WLS_cps/Fe/ACE_Fe_wls_lev_cooks.pdf")
par(mfrow = c(2, 2))
plot(ACE_Fe_wls)
dev.off()
# 4) WLS weighted - write to file
sink(file = "Papers_R/2024_DeVleeschouwer/FigureS6/Plots/FigS6c_OLS_WLS_cps/Fe/Fe_WLS_wt_summary.txt")
...
sink(file = NULL)
#Summary Leverage & Cooks distnce plots - write to file 
pdf(file = "Papers_R/2024_DeVleeschouwer/FigureS6/Plots/FigS6c_OLS_WLS_cps/Fe/ACE_Fe_wls_wt_lev_bar.pdf")
barplot(hatvalues(ACE_Fe_wls_wt), 
        col = "green")
dev.off()
pdf(file = "Papers_R/2024_DeVleeschouwer/FigureS6/Plots/FigS6c_OLS_WLS_cps/Fe/ACE_Fe_wls_wt_lev.pdf")
leveragePlots(ACE_Fe_wls_wt,layout=c(2,2)) 
dev.off()
pdf(file = "Papers_R/2024_DeVleeschouwer/FigureS6/Plots/FigS6c_OLS_WLS_cps/Fe/ACE_Fe_wls_wt_lev_cooks.pdf")
par(mfrow = c(2, 2))
plot(ACE_Fe_wls_wt)
dev.off()
...
ACE_Fe_final <- ACE_Fe + 
  ...
  geom_text(data=data.frame(), aes(label=paste("OLS: ", ACE_Fe_lm_eqn(df)), x = -Inf, y = Inf),
            parse = TRUE, colour = "blue", hjust = -0.15, vjust = 5, size = 3)
ACE_Fe_final
ggsave("Papers_R/2024_DeVleeschouwer/FigureS6/Plots/FigS6c_OLS_WLS_cps/Fe/Fe_OLS_WLS_summary.pdf", 
       height = c(20), width = c(20), dpi = 600, units = "cm")
...
Fe_data_2_out <- bind_cols(Fe_data_1_out, Fe_pred.int2) %>%
  ...
  print()
write.csv(Fe_data_2_out,"Papers_R/2024_DeVleeschouwer/FigureS6/Plots/FigS6c_OLS_WLS_cps/Fe/Fe_OLS_WLS_predict.csv", row.names = FALSE)
...
ACE_Fe_predict <- ACE_Fe_final + 
  ...
  ggtitle(paste("Site: ", site_title, "; ", "Element: " , element_title, " cps [95% CI & PI]"))
ACE_Fe_predict
ggsave("Papers_R/2024_DeVleeschouwer/FigureS6/Plots/FigS6c_OLS_WLS_cps/Fe/Fe_OLS_WLS_predict.pdf", 
       height = c(16), width = c(16), dpi = 600, units = "cm")
# ACE_Sr LM -----------------------------------------------------------------------
...
ggsave("Papers_R/2024_DeVleeschouwer/FigureS6/Plots/FigS6c_OLS_WLS_cps/Sr/Sr_OLS_performance.pdf", 
       height = c(30), width = c(30), dpi = 600, units = "cm")
...
ggsave("Papers_R/2024_DeVleeschouwer/FigureS6/Plots/FigS6c_OLS_WLS_cps/Sr/Sr_OLS_wt_performance.pdf", 
       height = c(30), width = c(30), dpi = 600, units = "cm")
...
ggsave("Papers_R/2024_DeVleeschouwer/FigureS6/Plots/FigS6c_OLS_WLS_cps/Sr/Sr_WLS_performance.pdf", 
       height = c(30), width = c(30), dpi = 600, units = "cm")
...
ggsave("Papers_R/2024_DeVleeschouwer/FigureS6/Plots/FigS6c_OLS_WLS_cps/Sr/Sr_WLS_wt_performance.pdf", 
       height = c(30), width = c(30), dpi = 600, units = "cm")
...
write.csv(ACE_Sr_lm_no_outliers,"Papers_R/2024_DeVleeschouwer/FigureS6/Plots/FigS6c_OLS_WLS_cps/Sr/ACE_Sr_OLS_no_outliers.csv", row.names = FALSE)
...
write.csv(ACE_Sr_wlm_no_outliers,"Papers_R/2024_DeVleeschouwer/FigureS6/Plots/FigS6c_OLS_WLS_cps/Sr/ACE_Sr_OLS_wt_no_outliers.csv", row.names = FALSE)
...
write.csv(ACE_Sr_wls_no_outliers,"Papers_R/2024_DeVleeschouwer/FigureS6/Plots/FigS6c_OLS_WLS_cps/Sr/ACE_Sr_WLS_no_outliers.csv", row.names = FALSE)
...
write.csv(ACE_Sr_wls_wt_no_outliers,"Papers_R/2024_DeVleeschouwer/FigureS6/Plots/FigS6c_OLS_WLS_cps/Sr/ACE_Sr_WLS_wt_no_outliers.csv", row.names = FALSE)

# Write stats to file
# 1) OLS - write to file
sink(file = "Papers_R/2024_DeVleeschouwer/FigureS6/Plots/FigS6c_OLS_WLS_cps/Sr/Sr_OLS_summary.txt")
summary(ACE_Sr_lm)
glance(ACE_Sr_lm)
model_performance(ACE_Sr_lm) # AIC - Akaike information criterion; BIC Bayesian IC: lower = better fit for both
...
sink(file = NULL)
#Summary Leverage & Cooks distnce plots - write to file 
pdf(file = "Papers_R/2024_DeVleeschouwer/FigureS6/Plots/FigS6c_OLS_WLS_cps/Sr/ACE_Sr_lm_lev_bar.pdf")
barplot(hatvalues(ACE_Sr_lm), 
        col = "aquamarine3")
dev.off()
pdf(file = "Papers_R/2024_DeVleeschouwer/FigureS6/Plots/FigS6c_OLS_WLS_cps/Sr/ACE_Sr_lm_lev.pdf")
leveragePlots(ACE_Sr_lm,layout=c(2,2)) 
dev.off()
pdf(file = "Papers_R/2024_DeVleeschouwer/FigureS6/Plots/FigS6c_OLS_WLS_cps/Sr/ACE_Sr_lm_lev_cooks.pdf")
par(mfrow = c(2, 2))
plot(ACE_Sr_lm)
dev.off()
# 2) OLS weighted - write to file
sink(file = "Papers_R/2024_DeVleeschouwer/FigureS6/Plots/FigS6c_OLS_WLS_cps/Sr/Sr_OLS_wt_summary.txt")
summary(ACE_Sr_wlm)
glance(ACE_Sr_wlm)
model_performance(ACE_Sr_wlm) # AIC - Akaike information criterion; BIC Bayesian IC: lower = better fit for both
...
sink(file = NULL)
#Summary Leverage & Cooks distnce plots - write to file 
pdf(file = "Papers_R/2024_DeVleeschouwer/FigureS6/Plots/FigS6c_OLS_WLS_cps/Sr/ACE_Sr_wlm_lev_bar.pdf")
barplot(hatvalues(ACE_Sr_wlm), 
        col = "red")
dev.off()
pdf(file = "Papers_R/2024_DeVleeschouwer/FigureS6/Plots/FigS6c_OLS_WLS_cps/Sr/ACE_Sr_wlm_lev.pdf")
leveragePlots(ACE_Sr_wlm,layout=c(2,2)) 
dev.off()
pdf(file = "Papers_R/2024_DeVleeschouwer/FigureS6/Plots/FigS6c_OLS_WLS_cps/Sr/ACE_Sr_wlm_lev_cooks.pdf")
par(mfrow = c(2, 2))
plot(ACE_Sr_wlm)
dev.off()
# 3) WLS - write to file
sink(file = "Papers_R/2024_DeVleeschouwer/FigureS6/Plots/FigS6c_OLS_WLS_cps/Sr/Sr_WLS_summary.txt")
summary(ACE_Sr_wls)
glance(ACE_Sr_wls)
model_performance(ACE_Sr_wls) # AIC - Akaike information criterion; BIC Bayesian IC: lower = better fit for both
...
sink(file = NULL)
#Summary Leverage & Cooks distnce plots - write to file 
pdf(file = "Papers_R/2024_DeVleeschouwer/FigureS6/Plots/FigS6c_OLS_WLS_cps/Sr/ACE_Sr_wls_lev_bar.pdf")
barplot(hatvalues(ACE_Sr_wls), 
        col = "blue")
dev.off()
pdf(file = "Papers_R/2024_DeVleeschouwer/FigureS6/Plots/FigS6c_OLS_WLS_cps/Sr/ACE_Sr_wls_lev.pdf")
leveragePlots(ACE_Sr_wls,layout=c(2,2)) 
dev.off()
pdf(file = "Papers_R/2024_DeVleeschouwer/FigureS6/Plots/FigS6c_OLS_WLS_cps/Sr/ACE_Sr_wls_lev_cooks.pdf")
par(mfrow = c(2, 2))
plot(ACE_Sr_wls)
dev.off()
# 4) WLS weighted - write to file
sink(file = "Papers_R/2024_DeVleeschouwer/FigureS6/Plots/FigS6c_OLS_WLS_cps/Sr/Sr_WLS_wt_summary.txt")
...
sink(file = NULL)
#Summary Leverage & Cooks distnce plots - write to file 
pdf(file = "Papers_R/2024_DeVleeschouwer/FigureS6/Plots/FigS6c_OLS_WLS_cps/Sr/ACE_Sr_wls_wt_lev_bar.pdf")
barplot(hatvalues(ACE_Sr_wls_wt), 
        col = "green")
dev.off()
pdf(file = "Papers_R/2024_DeVleeschouwer/FigureS6/Plots/FigS6c_OLS_WLS_cps/Sr/ACE_Sr_wls_wt_lev.pdf")
leveragePlots(ACE_Sr_wls_wt,layout=c(2,2)) 
dev.off()
pdf(file = "Papers_R/2024_DeVleeschouwer/FigureS6/Plots/FigS6c_OLS_WLS_cps/Sr/ACE_Sr_wls_wt_lev_cooks.pdf")
par(mfrow = c(2, 2))
plot(ACE_Sr_wls_wt)
dev.off()
...
ACE_Sr_final <- ACE_Sr + 
  ...
  geom_text(data=data.frame(), aes(label=paste("OLS: ", ACE_Sr_lm_eqn(df)), x = -Inf, y = Inf),
            parse = TRUE, colour = "blue", hjust = -0.15, vjust = 5, size = 3)
ACE_Sr_final
ggsave("Papers_R/2024_DeVleeschouwer/FigureS6/Plots/FigS6c_OLS_WLS_cps/Sr/Sr_OLS_WLS_summary.pdf", 
       height = c(20), width = c(20), dpi = 600, units = "cm")
...
Sr_data_2_out <- bind_cols(Sr_data_1_out, Sr_pred.int2) %>%
  ...
  print()
write.csv(Sr_data_2_out,"Papers_R/2024_DeVleeschouwer/FigureS6/Plots/FigS6c_OLS_WLS_cps/Sr/Sr_OLS_WLS_predict.csv", row.names = FALSE)
...
ACE_Sr_predict <- ACE_Sr_final + 
  ...
  ggtitle(paste("Site: ", site_title, "; ", "Element: " , element_title, " cps [95% CI & PI]"))
ACE_Sr_predict
ggsave("Papers_R/2024_DeVleeschouwer/FigureS6/Plots/FigS6c_OLS_WLS_cps/Sr/Sr_OLS_WLS_predict.pdf", 
       height = c(16), width = c(16), dpi = 600, units = "cm")
...
ggsave("Papers_R/2024_DeVleeschouwer/FigureS6/Plots/FigS6c_OLS_WLS_cps/Zr/Zr_OLS_performance.pdf", 
       height = c(30), width = c(30), dpi = 600, units = "cm")
...
ggsave("Papers_R/2024_DeVleeschouwer/FigureS6/Plots/FigS6c_OLS_WLS_cps/Zr/Zr_OLS_wt_performance.pdf", 
       height = c(30), width = c(30), dpi = 600, units = "cm")
...
ggsave("Papers_R/2024_DeVleeschouwer/FigureS6/Plots/FigS6c_OLS_WLS_cps/Zr/Zr_WLS_performance.pdf", 
       height = c(30), width = c(30), dpi = 600, units = "cm")
...
ggsave("Papers_R/2024_DeVleeschouwer/FigureS6/Plots/FigS6c_OLS_WLS_cps/Zr/Zr_WLS_wt_performance.pdf", 
       height = c(30), width = c(30), dpi = 600, units = "cm")
...
write.csv(ACE_Zr_lm_no_outliers,"Papers_R/2024_DeVleeschouwer/FigureS6/Plots/FigS6c_OLS_WLS_cps/Zr/ACE_Zr_OLS_no_outliers.csv", row.names = FALSE)
...
write.csv(ACE_Zr_wlm_no_outliers,"Papers_R/2024_DeVleeschouwer/FigureS6/Plots/FigS6c_OLS_WLS_cps/Zr/ACE_Zr_OLS_wt_no_outliers.csv", row.names = FALSE)
...
write.csv(ACE_Zr_wls_no_outliers,"Papers_R/2024_DeVleeschouwer/FigureS6/Plots/FigS6c_OLS_WLS_cps/Zr/ACE_Zr_WLS_no_outliers.csv", row.names = FALSE)
...
write.csv(ACE_Zr_wls_wt_no_outliers,"Papers_R/2024_DeVleeschouwer/FigureS6/Plots/FigS6c_OLS_WLS_cps/Zr/ACE_Zr_WLS_wt_no_outliers.csv", row.names = FALSE)

# Write stats to file
# 1) OLS - write to file
sink(file = "Papers_R/2024_DeVleeschouwer/FigureS6/Plots/FigS6c_OLS_WLS_cps/Zr/Zr_OLS_summary.txt")
summary(ACE_Zr_lm)
glance(ACE_Zr_lm)
model_performance(ACE_Zr_lm) # AIC - Akaike information criterion; BIC Bayesian IC: lower = better fit for both
...
sink(file = NULL)
#Summary Leverage & Cooks distnce plots - write to file 
pdf(file = "Papers_R/2024_DeVleeschouwer/FigureS6/Plots/FigS6c_OLS_WLS_cps/Zr/ACE_Zr_lm_lev_bar.pdf")
barplot(hatvalues(ACE_Zr_lm), 
        col = "aquamarine3")
dev.off()
pdf(file = "Papers_R/2024_DeVleeschouwer/FigureS6/Plots/FigS6c_OLS_WLS_cps/Zr/ACE_Zr_lm_lev.pdf")
leveragePlots(ACE_Zr_lm,layout=c(2,2)) 
dev.off()
pdf(file = "Papers_R/2024_DeVleeschouwer/FigureS6/Plots/FigS6c_OLS_WLS_cps/Zr/ACE_Zr_lm_lev_cooks.pdf")
par(mfrow = c(2, 2))
plot(ACE_Zr_lm)
dev.off()
# 2) OLS weighted - write to file
sink(file = "Papers_R/2024_DeVleeschouwer/FigureS6/Plots/FigS6c_OLS_WLS_cps/Zr/Zr_OLS_wt_summary.txt")
summary(ACE_Zr_wlm)
glance(ACE_Zr_wlm)
model_performance(ACE_Zr_wlm) # AIC - Akaike information criterion; BIC Bayesian IC: lower = better fit for both
...
sink(file = NULL)
#Summary Leverage & Cooks distnce plots - write to file 
pdf(file = "Papers_R/2024_DeVleeschouwer/FigureS6/Plots/FigS6c_OLS_WLS_cps/Zr/ACE_Zr_wlm_lev_bar.pdf")
barplot(hatvalues(ACE_Zr_wlm), 
        col = "red")
dev.off()
pdf(file = "Papers_R/2024_DeVleeschouwer/FigureS6/Plots/FigS6c_OLS_WLS_cps/Zr/ACE_Zr_wlm_lev.pdf")
leveragePlots(ACE_Zr_wlm,layout=c(2,2)) 
dev.off()
pdf(file = "Papers_R/2024_DeVleeschouwer/FigureS6/Plots/FigS6c_OLS_WLS_cps/Zr/ACE_Zr_wlm_lev_cooks.pdf")
par(mfrow = c(2, 2))
plot(ACE_Zr_wlm)
dev.off()
# 3) WLS - write to file
sink(file = "Papers_R/2024_DeVleeschouwer/FigureS6/Plots/FigS6c_OLS_WLS_cps/Zr/Zr_WLS_summary.txt")
summary(ACE_Zr_wls)
glance(ACE_Zr_wls)
model_performance(ACE_Zr_wls) # AIC - Akaike information criterion; BIC Bayesian IC: lower = better fit for both
...
sink(file = NULL)
#Summary Leverage & Cooks distnce plots - write to file 
pdf(file = "Papers_R/2024_DeVleeschouwer/FigureS6/Plots/FigS6c_OLS_WLS_cps/Zr/ACE_Zr_wls_lev_bar.pdf")
barplot(hatvalues(ACE_Zr_wls), 
        col = "blue")
dev.off()
pdf(file = "Papers_R/2024_DeVleeschouwer/FigureS6/Plots/FigS6c_OLS_WLS_cps/Zr/ACE_Zr_wls_lev.pdf")
leveragePlots(ACE_Zr_wls,layout=c(2,2)) 
dev.off()
pdf(file = "Papers_R/2024_DeVleeschouwer/FigureS6/Plots/FigS6c_OLS_WLS_cps/Zr/ACE_Zr_wls_lev_cooks.pdf")
par(mfrow = c(2, 2))
plot(ACE_Zr_wls)
dev.off()
# 4) WLS weighted - write to file
sink(file = "Papers_R/2024_DeVleeschouwer/FigureS6/Plots/FigS6c_OLS_WLS_cps/Zr/Zr_WLS_wt_summary.txt")
...
sink(file = NULL)
#Summary Leverage & Cooks distnce plots - write to file 
pdf(file = "Papers_R/2024_DeVleeschouwer/FigureS6/Plots/FigS6c_OLS_WLS_cps/Zr/ACE_Zr_wls_wt_lev_bar.pdf")
barplot(hatvalues(ACE_Zr_wls_wt), 
        col = "green")
dev.off()
pdf(file = "Papers_R/2024_DeVleeschouwer/FigureS6/Plots/FigS6c_OLS_WLS_cps/Zr/ACE_Zr_wls_wt_lev.pdf")
leveragePlots(ACE_Zr_wls_wt,layout=c(2,2)) 
dev.off()
pdf(file = "Papers_R/2024_DeVleeschouwer/FigureS6/Plots/FigS6c_OLS_WLS_cps/Zr/ACE_Zr_wls_wt_lev_cooks.pdf")
par(mfrow = c(2, 2))
plot(ACE_Zr_wls_wt)
dev.off()
...
ACE_Zr_final <- ACE_Zr + 
  ...
  geom_text(data=data.frame(), aes(label=paste("OLS: ", ACE_Zr_lm_eqn(df)), x = -Inf, y = Inf),
            parse = TRUE, colour = "blue", hjust = -0.15, vjust = 5, size = 3)
ACE_Zr_final
ggsave("Papers_R/2024_DeVleeschouwer/FigureS6/Plots/FigS6c_OLS_WLS_cps/Zr/Zr_OLS_WLS_summary.pdf", 
       height = c(20), width = c(20), dpi = 600, units = "cm")
...
Zr_data_2_out <- bind_cols(Zr_data_1_out, Zr_pred.int2) %>%
  ...
  print()
write.csv(Zr_data_2_out,"Papers_R/2024_DeVleeschouwer/FigureS6/Plots/FigS6c_OLS_WLS_cps/Zr/Zr_OLS_WLS_predict.csv", row.names = FALSE)
...
ACE_Zr_predict <- ACE_Zr_final + 
  ...
  ggtitle(paste("Site: ", site_title, "; ", "Element: " , element_title, " cps [95% CI & PI]"))
ACE_Zr_predict
ggsave("Papers_R/2024_DeVleeschouwer/FigureS6/Plots/FigS6c_OLS_WLS_cps/Zr/Zr_OLS_WLS_predict.pdf", 
       height = c(16), width = c(16), dpi = 600, units = "cm")
# Figure 3c - Primary matched elements -------------------------------------------------------------------------
...
ggsave("Papers_R/2024_DeVleeschouwer/FigureS6/Plots/FigS6c_OLS_WLS_cps/ACE_FigS6c_OLS_WLS_cps_key_predict.pdf",
...
ggsave("Papers_R/2024_DeVleeschouwer/FigureS6/Plots/FigS6c_OLS_WLS_cps/K/K_OLS_performance.pdf", 
       height = c(30), width = c(30), dpi = 600, units = "cm")
...
write.csv(ACE_K_lm_no_outliers,"Papers_R/2024_DeVleeschouwer/FigureS6/Plots/FigS6c_OLS_WLS_cps/K/ACE_K_OLS_no_outliers.csv", row.names = FALSE)
...
ggsave("Papers_R/2024_DeVleeschouwer/FigureS6/Plots/FigS6c_OLS_WLS_cps/K/K_OLS_wt_performance.pdf", 
       height = c(30), width = c(30), dpi = 600, units = "cm")
# Leverage - 2x difference from mean consider removal due to high leverage
...
write.csv(ACE_K_wlm_no_outliers,"Papers_R/2024_DeVleeschouwer/FigureS6/Plots/FigS6c_OLS_WLS_cps/K/ACE_K_OLS_wt_no_outliers.csv", row.names = FALSE)
...
ggsave("Papers_R/2024_DeVleeschouwer/FigureS6/Plots/FigS6c_OLS_WLS_cps/K/K_WLS_performance.pdf", 
       height = c(30), width = c(30), dpi = 600, units = "cm")
# Leverage - 2x difference from mean consider removal due to high leverage
...
write.csv(ACE_K_wls_no_outliers,"Papers_R/2024_DeVleeschouwer/FigureS6/Plots/FigS6c_OLS_WLS_cps/K/ACE_K_WLS_no_outliers.csv", row.names = FALSE)
...
ggsave("Papers_R/2024_DeVleeschouwer/FigureS6/Plots/FigS6c_OLS_WLS_cps/K/K_WLS_wt_performance.pdf", 
       height = c(30), width = c(30), dpi = 600, units = "cm")
# Leverage - 2x difference from mean consider removal due to high leverage
...
write.csv(ACE_K_wls_wt_no_outliers,"Papers_R/2024_DeVleeschouwer/FigureS6/Plots/FigS6c_OLS_WLS_cps/K/ACE_K_WLS_wt_no_outliers.csv", row.names = FALSE)

# Save stats & stats tests plots to file

# 1) OLS
# Performance indicators
sink(file = "Papers_R/2024_DeVleeschouwer/FigureS6/Plots/FigS6c_OLS_WLS_cps/K/K_OLS_wt_summary.txt")
summary(ACE_K_wlm)
glance(ACE_K_wlm)
model_performance(ACE_K_wlm) # AIC - Akaike information criterion; BIC Bayesian IC: lower = better fit for both
...
pdf(file = "Papers_R/2024_DeVleeschouwer/FigureS6/Plots/FigS6c_OLS_WLS_cps/K/ACE_K_lm_lev_bar.pdf")
barplot(hatvalues(ACE_K_wlm), col = "aquamarine3")
dev.off()
pdf(file = "Papers_R/2024_DeVleeschouwer/FigureS6/Plots/FigS6c_OLS_WLS_cps/K/ACE_K_lm_lev.pdf")
leveragePlots(ACE_K_wlm,layout=c(2,2)) 
dev.off()
pdf(file = "Papers_R/2024_DeVleeschouwer/FigureS6/Plots/FigS6c_OLS_WLS_cps/K/ACE_K_lm_lev_cooks.pdf")
par(mfrow = c(2, 2))
plot(ACE_K_wlm)
dev.off()
...
# 2) OLS weighted
# Performance indicators
sink(file = "Papers_R/2024_DeVleeschouwer/FigureS6/Plots/FigS6c_OLS_WLS_cps/K/K_OLS_summary.txt")
summary(ACE_K_wlm)
glance(ACE_K_wlm)
model_performance(ACE_K_wlm) # AIC - Akaike information criterion; BIC Bayesian IC: lower = better fit for both
bptest(ACE_K_wlm) # lmtest package check for heteroscedasticity - p <0.05 = reject null hypothesis - heteroscedasticity present
...
sink(file = NULL)
# Leverage & Cooks distance - influence tests
pdf(file = "Papers_R/2024_DeVleeschouwer/FigureS6/Plots/FigS6c_OLS_WLS_cps/K/ACE_K_wlm_lev_bar.pdf")
barplot(hatvalues(ACE_K_wlm), col = "red")
dev.off()
pdf(file = "Papers_R/2024_DeVleeschouwer/FigureS6/Plots/FigS6c_OLS_WLS_cps/K/ACE_K_wlm_lev.pdf")
leveragePlots(ACE_K_wlm,layout=c(2,2)) 
dev.off()
pdf(file = "Papers_R/2024_DeVleeschouwer/FigureS6/Plots/FigS6c_OLS_WLS_cps/K/ACE_K_wlm_lev_cooks.pdf")
par(mfrow = c(2, 2))
plot(ACE_K_wlm)
dev.off()
...
# 3) WLS
# Performance indicators
sink(file = "Papers_R/2024_DeVleeschouwer/FigureS6/Plots/FigS6c_OLS_WLS_cps/K/K_WLS_summary.txt")
summary(ACE_K_wls)
glance(ACE_K_wls)
model_performance(ACE_K_wls) # AIC - Akaike information criterion; BIC Bayesian IC: lower = better fit for both
...
sink(file = NULL)
# Leverage & Cooks distance - influence tests
pdf(file = "Papers_R/2024_DeVleeschouwer/FigureS6/Plots/FigS6c_OLS_WLS_cps/K/ACE_K_wls_lev_bar.pdf")
barplot(hatvalues(ACE_K_wls), col = "blue")
dev.off()
pdf(file = "Papers_R/2024_DeVleeschouwer/FigureS6/Plots/FigS6c_OLS_WLS_cps/K/ACE_K_wls_lev.pdf")
leveragePlots(ACE_K_wls,layout=c(2,2)) 
dev.off()
pdf(file = "Papers_R/2024_DeVleeschouwer/FigureS6/Plots/FigS6c_OLS_WLS_cps/K/ACE_K_wls_lev_cooks.pdf")
par(mfrow = c(2, 2))
plot(ACE_K_wls)
dev.off()
...
# 4) WLS weighted
# Performance indicators
sink(file = "Papers_R/2024_DeVleeschouwer/FigureS6/Plots/FigS6c_OLS_WLS_cps/K/K_WLS_wt_summary.txt")
...
sink(file = NULL)
# Leverage & Cooks distance - influence tests
pdf(file = "Papers_R/2024_DeVleeschouwer/FigureS6/Plots/FigS6c_OLS_WLS_cps/K/ACE_K_wls_wt_lev_bar.pdf")
barplot(hatvalues(ACE_K_wls_wt), col = "green")
dev.off()
pdf(file = "Papers_R/2024_DeVleeschouwer/FigureS6/Plots/FigS6c_OLS_WLS_cps/K/ACE_K_wls_wt_lev.pdf")
leveragePlots(ACE_K_wls_wt,layout=c(2,2)) 
dev.off()
pdf(file = "Papers_R/2024_DeVleeschouwer/FigureS6/Plots/FigS6c_OLS_WLS_cps/K/ACE_K_wls_wt_lev_cooks.pdf")
par(mfrow = c(2, 2))
plot(ACE_K_wls_wt)
dev.off()
...
ACE_K_final <- ACE_K + 
  ...
  geom_text(data=data.frame(), aes(label=paste("OLS: ", ACE_K_lm_eqn(df)), x = -Inf, y = Inf),
            parse = TRUE, colour = "blue", hjust = -0.15, vjust = 5, size = 3)
ACE_K_final
ggsave("Papers_R/2024_DeVleeschouwer/FigureS6/Plots/FigS6c_OLS_WLS_cps/K/K_OLS_WLS_summary.pdf", 
       height = c(20), width = c(20), dpi = 600, units = "cm")
...
K_data_2_out <- bind_cols(K_data_1_out, K_pred.int2) %>%
  ...
  print()
write.csv(K_data_2_out,"Papers_R/2024_DeVleeschouwer/FigureS6/Plots/FigS6c_OLS_WLS_cps/K/K_OLS_WLS_predict.csv", row.names = FALSE)
...
ACE_K_predict <- ACE_K_final + 
  ...
  ggtitle(paste("Site: ", site_title, "; ", "Element: " , element_title, " cps [95% CI & PI]"))
ACE_K_predict
ggsave("Papers_R/2024_DeVleeschouwer/FigureS6/Plots/FigS6c_OLS_WLS_cps/K/K_OLS_WLS_predict.pdf", 
       height = c(16), width = c(16), dpi = 600, units = "cm")
...
ggsave("Papers_R/2024_DeVleeschouwer/FigureS6/Plots/FigS6c_OLS_WLS_cps/Co/Co_OLS_performance.pdf", 
       height = c(30), width = c(30), dpi = 600, units = "cm")
...
ggsave("Papers_R/2024_DeVleeschouwer/FigureS6/Plots/FigS6c_OLS_WLS_cps/Co/Co_OLS_wt_performance.pdf", 
       height = c(30), width = c(30), dpi = 600, units = "cm")
...
ggsave("Papers_R/2024_DeVleeschouwer/FigureS6/Plots/FigS6c_OLS_WLS_cps/Co/Co_WLS_performance.pdf", 
       height = c(30), width = c(30), dpi = 600, units = "cm")
...
ggsave("Papers_R/2024_DeVleeschouwer/FigureS6/Plots/FigS6c_OLS_WLS_cps/Co/Co_WLS_wt_performance.pdf", 
       height = c(30), width = c(30), dpi = 600, units = "cm")
...
write.csv(ACE_Co_lm_no_outliers,"Papers_R/2024_DeVleeschouwer/FigureS6/Plots/FigS6c_OLS_WLS_cps/Co/ACE_Co_OLS_no_outliers.csv", row.names = FALSE)
...
write.csv(ACE_Co_wlm_no_outliers,"Papers_R/2024_DeVleeschouwer/FigureS6/Plots/FigS6c_OLS_WLS_cps/Co/ACE_Co_OLS_wt_no_outliers.csv", row.names = FALSE)
...
write.csv(ACE_Co_wls_no_outliers,"Papers_R/2024_DeVleeschouwer/FigureS6/Plots/FigS6c_OLS_WLS_cps/Co/ACE_Co_WLS_no_outliers.csv", row.names = FALSE)
...
write.csv(ACE_Co_wls_wt_no_outliers,"Papers_R/2024_DeVleeschouwer/FigureS6/Plots/FigS6c_OLS_WLS_cps/Co/ACE_Co_WLS_wt_no_outliers.csv", row.names = FALSE)

# Write stats to file
# 1) OLS - write to file
sink(file = "Papers_R/2024_DeVleeschouwer/FigureS6/Plots/FigS6c_OLS_WLS_cps/Co/Co_OLS_summary.txt")
summary(ACE_Co_lm)
glance(ACE_Co_lm)
model_performance(ACE_Co_lm) # AIC - Akaike information criterion; BIC Bayesian IC: lower = better fit for both
...
sink(file = NULL)
#Summary Leverage & Cooks distnce plots - write to file 
pdf(file = "Papers_R/2024_DeVleeschouwer/FigureS6/Plots/FigS6c_OLS_WLS_cps/Co/ACE_Co_lm_lev_bar.pdf")
barplot(hatvalues(ACE_Co_lm), 
        col = "aquamarine3")
dev.off()
pdf(file = "Papers_R/2024_DeVleeschouwer/FigureS6/Plots/FigS6c_OLS_WLS_cps/Co/ACE_Co_lm_lev.pdf")
leveragePlots(ACE_Co_lm,layout=c(2,2)) 
dev.off()
pdf(file = "Papers_R/2024_DeVleeschouwer/FigureS6/Plots/FigS6c_OLS_WLS_cps/Co/ACE_Co_lm_lev_cooks.pdf")
par(mfrow = c(2, 2))
plot(ACE_Co_lm)
dev.off()
# 2) OLS weighted - write to file
sink(file = "Papers_R/2024_DeVleeschouwer/FigureS6/Plots/FigS6c_OLS_WLS_cps/Co/Co_OLS_wt_summary.txt")
summary(ACE_Co_wlm)
glance(ACE_Co_wlm)
model_performance(ACE_Co_wlm) # AIC - Akaike information criterion; BIC Bayesian IC: lower = better fit for both
...
sink(file = NULL)
#Summary Leverage & Cooks distnce plots - write to file 
pdf(file = "Papers_R/2024_DeVleeschouwer/FigureS6/Plots/FigS6c_OLS_WLS_cps/Co/ACE_Co_wlm_lev_bar.pdf")
barplot(hatvalues(ACE_Co_wlm), 
        col = "red")
dev.off()
pdf(file = "Papers_R/2024_DeVleeschouwer/FigureS6/Plots/FigS6c_OLS_WLS_cps/Co/ACE_Co_wlm_lev.pdf")
leveragePlots(ACE_Co_wlm,layout=c(2,2)) 
dev.off()
pdf(file = "Papers_R/2024_DeVleeschouwer/FigureS6/Plots/FigS6c_OLS_WLS_cps/Co/ACE_Co_wlm_lev_cooks.pdf")
par(mfrow = c(2, 2))
plot(ACE_Co_wlm)
dev.off()
# 3) WLS - write to file
sink(file = "Papers_R/2024_DeVleeschouwer/FigureS6/Plots/FigS6c_OLS_WLS_cps/Co/Co_WLS_summary.txt")
summary(ACE_Co_wls)
glance(ACE_Co_wls)
model_performance(ACE_Co_wls) # AIC - Akaike information criterion; BIC Bayesian IC: lower = better fit for both
...
sink(file = NULL)
#Summary Leverage & Cooks distnce plots - write to file 
pdf(file = "Papers_R/2024_DeVleeschouwer/FigureS6/Plots/FigS6c_OLS_WLS_cps/Co/ACE_Co_wls_lev_bar.pdf")
barplot(hatvalues(ACE_Co_wls), 
        col = "blue")
dev.off()
pdf(file = "Papers_R/2024_DeVleeschouwer/FigureS6/Plots/FigS6c_OLS_WLS_cps/Co/ACE_Co_wls_lev.pdf")
leveragePlots(ACE_Co_wls,layout=c(2,2)) 
dev.off()
pdf(file = "Papers_R/2024_DeVleeschouwer/FigureS6/Plots/FigS6c_OLS_WLS_cps/Co/ACE_Co_wls_lev_cooks.pdf")
par(mfrow = c(2, 2))
plot(ACE_Co_wls)
dev.off()
# 4) WLS weighted - write to file
sink(file = "Papers_R/2024_DeVleeschouwer/FigureS6/Plots/FigS6c_OLS_WLS_cps/Co/Co_WLS_wt_summary.txt")
...
sink(file = NULL)
#Summary Leverage & Cooks distnce plots - write to file 
pdf(file = "Papers_R/2024_DeVleeschouwer/FigureS6/Plots/FigS6c_OLS_WLS_cps/Co/ACE_Co_wls_wt_lev_bar.pdf")
barplot(hatvalues(ACE_Co_wls_wt), 
        col = "green")
dev.off()
pdf(file = "Papers_R/2024_DeVleeschouwer/FigureS6/Plots/FigS6c_OLS_WLS_cps/Co/ACE_Co_wls_wt_lev.pdf")
leveragePlots(ACE_Co_wls_wt,layout=c(2,2)) 
dev.off()
pdf(file = "Papers_R/2024_DeVleeschouwer/FigureS6/Plots/FigS6c_OLS_WLS_cps/Co/ACE_Co_wls_wt_lev_cooks.pdf")
par(mfrow = c(2, 2))
plot(ACE_Co_wls_wt)
dev.off()
...
ACE_Co_final <- ACE_Co + 
  ...
  geom_text(data=data.frame(), aes(label=paste("OLS: ", ACE_Co_lm_eqn(df)), x = -Inf, y = Inf),
            parse = TRUE, colour = "blue", hjust = -0.15, vjust = 5, size = 3)
ACE_Co_final
ggsave("Papers_R/2024_DeVleeschouwer/FigureS6/Plots/FigS6c_OLS_WLS_cps/Co/Co_OLS_WLS_summary.pdf", 
       height = c(20), width = c(20), dpi = 600, units = "cm")
...
Co_data_2_out <- bind_cols(Co_data_1_out, Co_pred.int2) %>%
  ...
  print()
write.csv(Co_data_2_out,"Papers_R/2024_DeVleeschouwer/FigureS6/Plots/FigS6c_OLS_WLS_cps/Co/Co_OLS_WLS_predict.csv", row.names = FALSE)
...
ACE_Co_predict <- ACE_Co_final + 
  ...
  ggtitle(paste("Site: ", site_title, "; ", "Element: " , element_title, " cps [95% CI & PI]"))
ACE_Co_predict
ggsave("Papers_R/2024_DeVleeschouwer/FigureS6/Plots/FigS6c_OLS_WLS_cps/Co/Co_OLS_WLS_predict.pdf", 
       height = c(16), width = c(16), dpi = 600, units = "cm")
# ACE_Ni LM  -----------------------------------------------------------------------
...
ggsave("Papers_R/2024_DeVleeschouwer/FigureS6/Plots/FigS6c_OLS_WLS_cps/Ni/Ni_OLS_performance.pdf", 
       height = c(30), width = c(30), dpi = 600, units = "cm")
...
ggsave("Papers_R/2024_DeVleeschouwer/FigureS6/Plots/FigS6c_OLS_WLS_cps/Ni/Ni_OLS_wt_performance.pdf", 
       height = c(30), width = c(30), dpi = 600, units = "cm")
...
ggsave("Papers_R/2024_DeVleeschouwer/FigureS6/Plots/FigS6c_OLS_WLS_cps/Ni/Ni_WLS_performance.pdf", 
       height = c(30), width = c(30), dpi = 600, units = "cm")
...
ggsave("Papers_R/2024_DeVleeschouwer/FigureS6/Plots/FigS6c_OLS_WLS_cps/Ni/Ni_WLS_wt_performance.pdf", 
       height = c(30), width = c(30), dpi = 600, units = "cm")
...
write.csv(ACE_Ni_lm_no_outliers,"Papers_R/2024_DeVleeschouwer/FigureS6/Plots/FigS6c_OLS_WLS_cps/Ni/ACE_Ni_OLS_no_outliers.csv", row.names = FALSE)
...
write.csv(ACE_Ni_wlm_no_outliers,"Papers_R/2024_DeVleeschouwer/FigureS6/Plots/FigS6c_OLS_WLS_cps/Ni/ACE_Ni_OLS_wt_no_outliers.csv", row.names = FALSE)
...
write.csv(ACE_Ni_wls_no_outliers,"Papers_R/2024_DeVleeschouwer/FigureS6/Plots/FigS6c_OLS_WLS_cps/Ni/ACE_Ni_WLS_no_outliers.csv", row.names = FALSE)
...
write.csv(ACE_Ni_wls_wt_no_outliers,"Papers_R/2024_DeVleeschouwer/FigureS6/Plots/FigS6c_OLS_WLS_cps/Ni/ACE_Ni_WLS_wt_no_outliers.csv", row.names = FALSE)

# Write stats to file
# 1) OLS - write to file
sink(file = "Papers_R/2024_DeVleeschouwer/FigureS6/Plots/FigS6c_OLS_WLS_cps/Ni/Ni_OLS_summary.txt")
summary(ACE_Ni_lm)
glance(ACE_Ni_lm)
model_performance(ACE_Ni_lm) # AIC - Akaike information criterion; BIC Bayesian IC: lower = better fit for both
...
sink(file = NULL)
#Summary Leverage & Cooks distnce plots - write to file 
pdf(file = "Papers_R/2024_DeVleeschouwer/FigureS6/Plots/FigS6c_OLS_WLS_cps/Ni/ACE_Ni_lm_lev_bar.pdf")
barplot(hatvalues(ACE_Ni_lm), 
        col = "aquamarine3")
dev.off()
pdf(file = "Papers_R/2024_DeVleeschouwer/FigureS6/Plots/FigS6c_OLS_WLS_cps/Ni/ACE_Ni_lm_lev.pdf")
leveragePlots(ACE_Ni_lm,layout=c(2,2)) 
dev.off()
pdf(file = "Papers_R/2024_DeVleeschouwer/FigureS6/Plots/FigS6c_OLS_WLS_cps/Ni/ACE_Ni_lm_lev_cooks.pdf")
par(mfrow = c(2, 2))
plot(ACE_Ni_lm)
dev.off()
# 2) OLS weighted - write to file
sink(file = "Papers_R/2024_DeVleeschouwer/FigureS6/Plots/FigS6c_OLS_WLS_cps/Ni/Ni_OLS_wt_summary.txt")
summary(ACE_Ni_wlm)
glance(ACE_Ni_wlm)
model_performance(ACE_Ni_wlm) # AIC - Akaike information criterion; BIC Bayesian IC: lower = better fit for both
...
sink(file = NULL)
#Summary Leverage & Cooks distnce plots - write to file 
pdf(file = "Papers_R/2024_DeVleeschouwer/FigureS6/Plots/FigS6c_OLS_WLS_cps/Ni/ACE_Ni_wlm_lev_bar.pdf")
barplot(hatvalues(ACE_Ni_wlm), 
        col = "red")
dev.off()
pdf(file = "Papers_R/2024_DeVleeschouwer/FigureS6/Plots/FigS6c_OLS_WLS_cps/Ni/ACE_Ni_wlm_lev.pdf")
leveragePlots(ACE_Ni_wlm,layout=c(2,2)) 
dev.off()
pdf(file = "Papers_R/2024_DeVleeschouwer/FigureS6/Plots/FigS6c_OLS_WLS_cps/Ni/ACE_Ni_wlm_lev_cooks.pdf")
par(mfrow = c(2, 2))
plot(ACE_Ni_wlm)
dev.off()
# 3) WLS - write to file
sink(file = "Papers_R/2024_DeVleeschouwer/FigureS6/Plots/FigS6c_OLS_WLS_cps/Ni/Ni_WLS_summary.txt")
summary(ACE_Ni_wls)
glance(ACE_Ni_wls)
model_performance(ACE_Ni_wls) # AIC - Akaike information criterion; BIC Bayesian IC: lower = better fit for both
...
sink(file = NULL)
#Summary Leverage & Cooks distnce plots - write to file 
pdf(file = "Papers_R/2024_DeVleeschouwer/FigureS6/Plots/FigS6c_OLS_WLS_cps/Ni/ACE_Ni_wls_lev_bar.pdf")
barplot(hatvalues(ACE_Ni_wls), 
        col = "blue")
dev.off()
pdf(file = "Papers_R/2024_DeVleeschouwer/FigureS6/Plots/FigS6c_OLS_WLS_cps/Ni/ACE_Ni_wls_lev.pdf")
leveragePlots(ACE_Ni_wls,layout=c(2,2)) 
dev.off()
pdf(file = "Papers_R/2024_DeVleeschouwer/FigureS6/Plots/FigS6c_OLS_WLS_cps/Ni/ACE_Ni_wls_lev_cooks.pdf")
par(mfrow = c(2, 2))
plot(ACE_Ni_wls)
dev.off()
# 4) WLS weighted - write to file
sink(file = "Papers_R/2024_DeVleeschouwer/FigureS6/Plots/FigS6c_OLS_WLS_cps/Ni/Ni_WLS_wt_summary.txt")
...
sink(file = NULL)
#Summary Leverage & Cooks distnce plots - write to file 
pdf(file = "Papers_R/2024_DeVleeschouwer/FigureS6/Plots/FigS6c_OLS_WLS_cps/Ni/ACE_Ni_wls_wt_lev_bar.pdf")
barplot(hatvalues(ACE_Ni_wls_wt), 
        col = "green")
dev.off()
pdf(file = "Papers_R/2024_DeVleeschouwer/FigureS6/Plots/FigS6c_OLS_WLS_cps/Ni/ACE_Ni_wls_wt_lev.pdf")
leveragePlots(ACE_Ni_wls_wt,layout=c(2,2)) 
dev.off()
pdf(file = "Papers_R/2024_DeVleeschouwer/FigureS6/Plots/FigS6c_OLS_WLS_cps/Ni/ACE_Ni_wls_wt_lev_cooks.pdf")
par(mfrow = c(2, 2))
plot(ACE_Ni_wls_wt)
dev.off()
...
ACE_Ni_final <- ACE_Ni + 
  ...
  geom_text(data=data.frame(), aes(label=paste("OLS: ", ACE_Ni_lm_eqn(df)), x = -Inf, y = Inf),
            parse = TRUE, colour = "blue", hjust = -0.15, vjust = 5, size = 3)
ACE_Ni_final
ggsave("Papers_R/2024_DeVleeschouwer/FigureS6/Plots/FigS6c_OLS_WLS_cps/Ni/Ni_OLS_WLS_summary.pdf", 
       height = c(20), width = c(20), dpi = 600, units = "cm")
...
Ni_data_2_out <- bind_cols(Ni_data_1_out, Ni_pred.int2) %>%
  ...
  print()
write.csv(Ni_data_2_out,"Papers_R/2024_DeVleeschouwer/FigureS6/Plots/FigS6c_OLS_WLS_cps/Ni/Ni_OLS_WLS_predict.csv", row.names = FALSE)
...
ACE_Ni_predict <- ACE_Ni_final + 
  ...
  ggtitle(paste("Site: ", site_title, "; ", "Element: " , element_title, " cps [95% CI & PI]"))
ACE_Ni_predict
ggsave("Papers_R/2024_DeVleeschouwer/FigureS6/Plots/FigS6c_OLS_WLS_cps/Ni/Ni_OLS_WLS_predict.pdf", 
       height = c(16), width = c(16), dpi = 600, units = "cm")
# ACE_Cu LM  -----------------------------------------------------------------------
...
ggsave("Papers_R/2024_DeVleeschouwer/FigureS6/Plots/FigS6c_OLS_WLS_cps/Cu/Cu_OLS_performance.pdf", 
       height = c(30), width = c(30), dpi = 600, units = "cm")
...
ggsave("Papers_R/2024_DeVleeschouwer/FigureS6/Plots/FigS6c_OLS_WLS_cps/Cu/Cu_OLS_wt_performance.pdf", 
       height = c(30), width = c(30), dpi = 600, units = "cm")
...
ggsave("Papers_R/2024_DeVleeschouwer/FigureS6/Plots/FigS6c_OLS_WLS_cps/Cu/Cu_WLS_performance.pdf", 
       height = c(30), width = c(30), dpi = 600, units = "cm")
...
ggsave("Papers_R/2024_DeVleeschouwer/FigureS6/Plots/FigS6c_OLS_WLS_cps/Cu/Cu_WLS_wt_performance.pdf", 
       height = c(30), width = c(30), dpi = 600, units = "cm")
...
write.csv(ACE_Cu_lm_no_outliers,"Papers_R/2024_DeVleeschouwer/FigureS6/Plots/FigS6c_OLS_WLS_cps/Cu/ACE_Cu_OLS_no_outliers.csv", row.names = FALSE)
...
write.csv(ACE_Cu_wlm_no_outliers,"Papers_R/2024_DeVleeschouwer/FigureS6/Plots/FigS6c_OLS_WLS_cps/Cu/ACE_Cu_OLS_wt_no_outliers.csv", row.names = FALSE)
...
write.csv(ACE_Cu_wls_no_outliers,"Papers_R/2024_DeVleeschouwer/FigureS6/Plots/FigS6c_OLS_WLS_cps/Cu/ACE_Cu_WLS_no_outliers.csv", row.names = FALSE)
...
write.csv(ACE_Cu_wls_wt_no_outliers,"Papers_R/2024_DeVleeschouwer/FigureS6/Plots/FigS6c_OLS_WLS_cps/Cu/ACE_Cu_WLS_wt_no_outliers.csv", row.names = FALSE)

# Write stats to file
# 1) OLS - write to file
sink(file = "Papers_R/2024_DeVleeschouwer/FigureS6/Plots/FigS6c_OLS_WLS_cps/Cu/Cu_OLS_summary.txt")
summary(ACE_Cu_lm)
glance(ACE_Cu_lm)
model_performance(ACE_Cu_lm) # AIC - Akaike information criterion; BIC Bayesian IC: lower = better fit for both
...
sink(file = NULL)
#Summary Leverage & Cooks distnce plots - write to file 
pdf(file = "Papers_R/2024_DeVleeschouwer/FigureS6/Plots/FigS6c_OLS_WLS_cps/Cu/ACE_Cu_lm_lev_bar.pdf")
barplot(hatvalues(ACE_Cu_lm), 
        col = "aquamarine3")
dev.off()
pdf(file = "Papers_R/2024_DeVleeschouwer/FigureS6/Plots/FigS6c_OLS_WLS_cps/Cu/ACE_Cu_lm_lev.pdf")
leveragePlots(ACE_Cu_lm,layout=c(2,2)) 
dev.off()
pdf(file = "Papers_R/2024_DeVleeschouwer/FigureS6/Plots/FigS6c_OLS_WLS_cps/Cu/ACE_Cu_lm_lev_cooks.pdf")
par(mfrow = c(2, 2))
plot(ACE_Cu_lm)
dev.off()
# 2) OLS weighted - write to file
sink(file = "Papers_R/2024_DeVleeschouwer/FigureS6/Plots/FigS6c_OLS_WLS_cps/Cu/Cu_OLS_wt_summary.txt")
summary(ACE_Cu_wlm)
glance(ACE_Cu_wlm)
model_performance(ACE_Cu_wlm) # AIC - Akaike information criterion; BIC Bayesian IC: lower = better fit for both
...
sink(file = NULL)
#Summary Leverage & Cooks distnce plots - write to file 
pdf(file = "Papers_R/2024_DeVleeschouwer/FigureS6/Plots/FigS6c_OLS_WLS_cps/Cu/ACE_Cu_wlm_lev_bar.pdf")
barplot(hatvalues(ACE_Cu_wlm), 
        col = "red")
dev.off()
pdf(file = "Papers_R/2024_DeVleeschouwer/FigureS6/Plots/FigS6c_OLS_WLS_cps/Cu/ACE_Cu_wlm_lev.pdf")
leveragePlots(ACE_Cu_wlm,layout=c(2,2)) 
dev.off()
pdf(file = "Papers_R/2024_DeVleeschouwer/FigureS6/Plots/FigS6c_OLS_WLS_cps/Cu/ACE_Cu_wlm_lev_cooks.pdf")
par(mfrow = c(2, 2))
plot(ACE_Cu_wlm)
dev.off()
# 3) WLS - write to file
sink(file = "Papers_R/2024_DeVleeschouwer/FigureS6/Plots/FigS6c_OLS_WLS_cps/Cu/Cu_WLS_summary.txt")
summary(ACE_Cu_wls)
glance(ACE_Cu_wls)
model_performance(ACE_Cu_wls) # AIC - Akaike information criterion; BIC Bayesian IC: lower = better fit for both
...
sink(file = NULL)
#Summary Leverage & Cooks distnce plots - write to file 
pdf(file = "Papers_R/2024_DeVleeschouwer/FigureS6/Plots/FigS6c_OLS_WLS_cps/Cu/ACE_Cu_wls_lev_bar.pdf")
barplot(hatvalues(ACE_Cu_wls), 
        col = "blue")
dev.off()
pdf(file = "Papers_R/2024_DeVleeschouwer/FigureS6/Plots/FigS6c_OLS_WLS_cps/Cu/ACE_Cu_wls_lev.pdf")
leveragePlots(ACE_Cu_wls,layout=c(2,2)) 
dev.off()
pdf(file = "Papers_R/2024_DeVleeschouwer/FigureS6/Plots/FigS6c_OLS_WLS_cps/Cu/ACE_Cu_wls_lev_cooks.pdf")
par(mfrow = c(2, 2))
plot(ACE_Cu_wls)
dev.off()
# 4) WLS weighted - write to file
sink(file = "Papers_R/2024_DeVleeschouwer/FigureS6/Plots/FigS6c_OLS_WLS_cps/Cu/Cu_WLS_wt_summary.txt")
...
sink(file = NULL)
#Summary Leverage & Cooks distnce plots - write to file 
pdf(file = "Papers_R/2024_DeVleeschouwer/FigureS6/Plots/FigS6c_OLS_WLS_cps/Cu/ACE_Cu_wls_wt_lev_bar.pdf")
barplot(hatvalues(ACE_Cu_wls_wt), 
        col = "green")
dev.off()
pdf(file = "Papers_R/2024_DeVleeschouwer/FigureS6/Plots/FigS6c_OLS_WLS_cps/Cu/ACE_Cu_wls_wt_lev.pdf")
leveragePlots(ACE_Cu_wls_wt,layout=c(2,2)) 
dev.off()
pdf(file = "Papers_R/2024_DeVleeschouwer/FigureS6/Plots/FigS6c_OLS_WLS_cps/Cu/ACE_Cu_wls_wt_lev_cooks.pdf")
par(mfrow = c(2, 2))
plot(ACE_Cu_wls_wt)
dev.off()
...
ACE_Cu_final <- ACE_Cu + 
  ...
  geom_text(data=data.frame(), aes(label=paste("OLS: ", ACE_Cu_lm_eqn(df)), x = -Inf, y = Inf),
            parse = TRUE, colour = "blue", hjust = -0.15, vjust = 5, size = 3)
ACE_Cu_final
ggsave("Papers_R/2024_DeVleeschouwer/FigureS6/Plots/FigS6c_OLS_WLS_cps/Cu/Cu_OLS_WLS_summary.pdf", 
       height = c(20), width = c(20), dpi = 600, units = "cm")
...
Cu_data_2_out <- bind_cols(Cu_data_1_out, Cu_pred.int2) %>%
  ...
  print()
write.csv(Cu_data_2_out,"Papers_R/2024_DeVleeschouwer/FigureS6/Plots/FigS6c_OLS_WLS_cps/Cu/Cu_OLS_WLS_predict.csv", row.names = FALSE)
...
ACE_Cu_predict <- ACE_Cu_final + 
  ...
  ggtitle(paste("Site: ", site_title, "; ", "Element: " , element_title, " cps [95% CI & PI]"))
ACE_Cu_predict
ggsave("Papers_R/2024_DeVleeschouwer/FigureS6/Plots/FigS6c_OLS_WLS_cps/Cu/Cu_OLS_WLS_predict.pdf", 
       height = c(16), width = c(16), dpi = 600, units = "cm")
# ACE_Zn LM  -----------------------------------------------------------------------
...
ggsave("Papers_R/2024_DeVleeschouwer/FigureS6/Plots/FigS6c_OLS_WLS_cps/Zn/Zn_OLS_performance.pdf", 
       height = c(30), width = c(30), dpi = 600, units = "cm")
...
ggsave("Papers_R/2024_DeVleeschouwer/FigureS6/Plots/FigS6c_OLS_WLS_cps/Zn/Zn_OLS_wt_performance.pdf", 
       height = c(30), width = c(30), dpi = 600, units = "cm")
...
ggsave("Papers_R/2024_DeVleeschouwer/FigureS6/Plots/FigS6c_OLS_WLS_cps/Zn/Zn_WLS_performance.pdf", 
       height = c(30), width = c(30), dpi = 600, units = "cm")
...
ggsave("Papers_R/2024_DeVleeschouwer/FigureS6/Plots/FigS6c_OLS_WLS_cps/Zn/Zn_WLS_wt_performance.pdf", 
       height = c(30), width = c(30), dpi = 600, units = "cm")
...
write.csv(ACE_Zn_lm_no_outliers,"Papers_R/2024_DeVleeschouwer/FigureS6/Plots/FigS6c_OLS_WLS_cps/Zn/ACE_Zn_OLS_no_outliers.csv", row.names = FALSE)
...
write.csv(ACE_Zn_wlm_no_outliers,"Papers_R/2024_DeVleeschouwer/FigureS6/Plots/FigS6c_OLS_WLS_cps/Zn/ACE_Zn_OLS_wt_no_outliers.csv", row.names = FALSE)
...
write.csv(ACE_Zn_wls_no_outliers,"Papers_R/2024_DeVleeschouwer/FigureS6/Plots/FigS6c_OLS_WLS_cps/Zn/ACE_Zn_WLS_no_outliers.csv", row.names = FALSE)
...
write.csv(ACE_Zn_wls_wt_no_outliers,"Papers_R/2024_DeVleeschouwer/FigureS6/Plots/FigS6c_OLS_WLS_cps/Zn/ACE_Zn_WLS_wt_no_outliers.csv", row.names = FALSE)

# Write stats to file
# 1) OLS - write to file
sink(file = "Papers_R/2024_DeVleeschouwer/FigureS6/Plots/FigS6c_OLS_WLS_cps/Zn/Zn_OLS_summary.txt")
summary(ACE_Zn_lm)
glance(ACE_Zn_lm)
model_performance(ACE_Zn_lm) # AIC - Akaike information criterion; BIC Bayesian IC: lower = better fit for both
...
sink(file = NULL)
#Summary Leverage & Cooks distnce plots - write to file 
pdf(file = "Papers_R/2024_DeVleeschouwer/FigureS6/Plots/FigS6c_OLS_WLS_cps/Zn/ACE_Zn_lm_lev_bar.pdf")
barplot(hatvalues(ACE_Zn_lm), 
        col = "aquamarine3")
dev.off()
pdf(file = "Papers_R/2024_DeVleeschouwer/FigureS6/Plots/FigS6c_OLS_WLS_cps/Zn/ACE_Zn_lm_lev.pdf")
leveragePlots(ACE_Zn_lm,layout=c(2,2)) 
dev.off()
pdf(file = "Papers_R/2024_DeVleeschouwer/FigureS6/Plots/FigS6c_OLS_WLS_cps/Zn/ACE_Zn_lm_lev_cooks.pdf")
par(mfrow = c(2, 2))
plot(ACE_Zn_lm)
dev.off()
# 2) OLS weighted - write to file
sink(file = "Papers_R/2024_DeVleeschouwer/FigureS6/Plots/FigS6c_OLS_WLS_cps/Zn/Zn_OLS_wt_summary.txt")
summary(ACE_Zn_wlm)
glance(ACE_Zn_wlm)
model_performance(ACE_Zn_wlm) # AIC - Akaike information criterion; BIC Bayesian IC: lower = better fit for both
...
sink(file = NULL)
#Summary Leverage & Cooks distnce plots - write to file 
pdf(file = "Papers_R/2024_DeVleeschouwer/FigureS6/Plots/FigS6c_OLS_WLS_cps/Zn/ACE_Zn_wlm_lev_bar.pdf")
barplot(hatvalues(ACE_Zn_wlm), 
        col = "red")
dev.off()
pdf(file = "Papers_R/2024_DeVleeschouwer/FigureS6/Plots/FigS6c_OLS_WLS_cps/Zn/ACE_Zn_wlm_lev.pdf")
leveragePlots(ACE_Zn_wlm,layout=c(2,2)) 
dev.off()
pdf(file = "Papers_R/2024_DeVleeschouwer/FigureS6/Plots/FigS6c_OLS_WLS_cps/Zn/ACE_Zn_wlm_lev_cooks.pdf")
par(mfrow = c(2, 2))
plot(ACE_Zn_wlm)
dev.off()
# 3) WLS - write to file
sink(file = "Papers_R/2024_DeVleeschouwer/FigureS6/Plots/FigS6c_OLS_WLS_cps/Zn/Zn_WLS_summary.txt")
summary(ACE_Zn_wls)
glance(ACE_Zn_wls)
model_performance(ACE_Zn_wls) # AIC - Akaike information criterion; BIC Bayesian IC: lower = better fit for both
...
sink(file = NULL)
#Summary Leverage & Cooks distnce plots - write to file 
pdf(file = "Papers_R/2024_DeVleeschouwer/FigureS6/Plots/FigS6c_OLS_WLS_cps/Zn/ACE_Zn_wls_lev_bar.pdf")
barplot(hatvalues(ACE_Zn_wls), 
        col = "blue")
dev.off()
pdf(file = "Papers_R/2024_DeVleeschouwer/FigureS6/Plots/FigS6c_OLS_WLS_cps/Zn/ACE_Zn_wls_lev.pdf")
leveragePlots(ACE_Zn_wls,layout=c(2,2)) 
dev.off()
pdf(file = "Papers_R/2024_DeVleeschouwer/FigureS6/Plots/FigS6c_OLS_WLS_cps/Zn/ACE_Zn_wls_lev_cooks.pdf")
par(mfrow = c(2, 2))
plot(ACE_Zn_wls)
dev.off()
# 4) WLS weighted - write to file
sink(file = "Papers_R/2024_DeVleeschouwer/FigureS6/Plots/FigS6c_OLS_WLS_cps/Zn/Zn_WLS_wt_summary.txt")
...
sink(file = NULL)
#Summary Leverage & Cooks distnce plots - write to file 
pdf(file = "Papers_R/2024_DeVleeschouwer/FigureS6/Plots/FigS6c_OLS_WLS_cps/Zn/ACE_Zn_wls_wt_lev_bar.pdf")
barplot(hatvalues(ACE_Zn_wls_wt), 
        col = "green")
dev.off()
pdf(file = "Papers_R/2024_DeVleeschouwer/FigureS6/Plots/FigS6c_OLS_WLS_cps/Zn/ACE_Zn_wls_wt_lev.pdf")
leveragePlots(ACE_Zn_wls_wt,layout=c(2,2)) 
dev.off()
pdf(file = "Papers_R/2024_DeVleeschouwer/FigureS6/Plots/FigS6c_OLS_WLS_cps/Zn/ACE_Zn_wls_wt_lev_cooks.pdf")
par(mfrow = c(2, 2))
plot(ACE_Zn_wls_wt)
dev.off()
...
ACE_Zn_final <- ACE_Zn + 
  ...
  geom_text(data=data.frame(), aes(label=paste("OLS: ", ACE_Zn_lm_eqn(df)), x = -Inf, y = Inf),
            parse = TRUE, colour = "blue", hjust = -0.15, vjust = 5, size = 3)
ACE_Zn_final
ggsave("Papers_R/2024_DeVleeschouwer/FigureS6/Plots/FigS6c_OLS_WLS_cps/Zn/Zn_OLS_WLS_summary.pdf", 
       height = c(20), width = c(20), dpi = 600, units = "cm")
...
Zn_data_2_out <- bind_cols(Zn_data_1_out, Zn_pred.int2) %>%
  ...
  print()
write.csv(Zn_data_2_out,"Papers_R/2024_DeVleeschouwer/FigureS6/Plots/FigS6c_OLS_WLS_cps/Zn/Zn_OLS_WLS_predict.csv", row.names = FALSE)
...
ACE_Zn_predict <- ACE_Zn_final + 
  ...
  ggtitle(paste("Site: ", site_title, "; ", "Element: " , element_title, " cps [95% CI & PI]"))
ACE_Zn_predict
ggsave("Papers_R/2024_DeVleeschouwer/FigureS6/Plots/FigS6c_OLS_WLS_cps/Zn/Zn_OLS_WLS_predict.pdf", 
       height = c(16), width = c(16), dpi = 600, units = "cm")
# ACE_Rb LM  -----------------------------------------------------------------------
...
ggsave("Papers_R/2024_DeVleeschouwer/FigureS6/Plots/FigS6c_OLS_WLS_cps/Rb/Rb_OLS_performance.pdf", 
       height = c(30), width = c(30), dpi = 600, units = "cm")
...
ggsave("Papers_R/2024_DeVleeschouwer/FigureS6/Plots/FigS6c_OLS_WLS_cps/Rb/Rb_OLS_wt_performance.pdf", 
       height = c(30), width = c(30), dpi = 600, units = "cm")
...
ggsave("Papers_R/2024_DeVleeschouwer/FigureS6/Plots/FigS6c_OLS_WLS_cps/Rb/Rb_WLS_performance.pdf", 
       height = c(30), width = c(30), dpi = 600, units = "cm")
...
ggsave("Papers_R/2024_DeVleeschouwer/FigureS6/Plots/FigS6c_OLS_WLS_cps/Rb/Rb_WLS_wt_performance.pdf", 
       height = c(30), width = c(30), dpi = 600, units = "cm")
...
write.csv(ACE_Rb_lm_no_outliers,"Papers_R/2024_DeVleeschouwer/FigureS6/Plots/FigS6c_OLS_WLS_cps/Rb/ACE_Rb_OLS_no_outliers.csv", row.names = FALSE)
...
write.csv(ACE_Rb_wlm_no_outliers,"Papers_R/2024_DeVleeschouwer/FigureS6/Plots/FigS6c_OLS_WLS_cps/Rb/ACE_Rb_OLS_wt_no_outliers.csv", row.names = FALSE)
...
write.csv(ACE_Rb_wls_no_outliers,"Papers_R/2024_DeVleeschouwer/FigureS6/Plots/FigS6c_OLS_WLS_cps/Rb/ACE_Rb_WLS_no_outliers.csv", row.names = FALSE)
...
write.csv(ACE_Rb_wls_wt_no_outliers,"Papers_R/2024_DeVleeschouwer/FigureS6/Plots/FigS6c_OLS_WLS_cps/Rb/ACE_Rb_WLS_wt_no_outliers.csv", row.names = FALSE)

# Write stats to file
# 1) OLS - write to file
sink(file = "Papers_R/2024_DeVleeschouwer/FigureS6/Plots/FigS6c_OLS_WLS_cps/Rb/Rb_OLS_summary.txt")
summary(ACE_Rb_lm)
glance(ACE_Rb_lm)
model_performance(ACE_Rb_lm) # AIC - Akaike information criterion; BIC Bayesian IC: lower = better fit for both
...
sink(file = NULL)
#Summary Leverage & Cooks distnce plots - write to file 
pdf(file = "Papers_R/2024_DeVleeschouwer/FigureS6/Plots/FigS6c_OLS_WLS_cps/Rb/ACE_Rb_lm_lev_bar.pdf")
barplot(hatvalues(ACE_Rb_lm), 
        col = "aquamarine3")
dev.off()
pdf(file = "Papers_R/2024_DeVleeschouwer/FigureS6/Plots/FigS6c_OLS_WLS_cps/Rb/ACE_Rb_lm_lev.pdf")
leveragePlots(ACE_Rb_lm,layout=c(2,2)) 
dev.off()
pdf(file = "Papers_R/2024_DeVleeschouwer/FigureS6/Plots/FigS6c_OLS_WLS_cps/Rb/ACE_Rb_lm_lev_cooks.pdf")
par(mfrow = c(2, 2))
plot(ACE_Rb_lm)
dev.off()
# 2) OLS weighted - write to file
sink(file = "Papers_R/2024_DeVleeschouwer/FigureS6/Plots/FigS6c_OLS_WLS_cps/Rb/Rb_OLS_wt_summary.txt")
summary(ACE_Rb_wlm)
glance(ACE_Rb_wlm)
model_performance(ACE_Rb_wlm) # AIC - Akaike information criterion; BIC Bayesian IC: lower = better fit for both
...
sink(file = NULL)
#Summary Leverage & Cooks distnce plots - write to file 
pdf(file = "Papers_R/2024_DeVleeschouwer/FigureS6/Plots/FigS6c_OLS_WLS_cps/Rb/ACE_Rb_wlm_lev_bar.pdf")
barplot(hatvalues(ACE_Rb_wlm), 
        col = "red")
dev.off()
pdf(file = "Papers_R/2024_DeVleeschouwer/FigureS6/Plots/FigS6c_OLS_WLS_cps/Rb/ACE_Rb_wlm_lev.pdf")
leveragePlots(ACE_Rb_wlm,layout=c(2,2)) 
dev.off()
pdf(file = "Papers_R/2024_DeVleeschouwer/FigureS6/Plots/FigS6c_OLS_WLS_cps/Rb/ACE_Rb_wlm_lev_cooks.pdf")
par(mfrow = c(2, 2))
plot(ACE_Rb_wlm)
dev.off()
# 3) WLS - write to file
sink(file = "Papers_R/2024_DeVleeschouwer/FigureS6/Plots/FigS6c_OLS_WLS_cps/Rb/Rb_WLS_summary.txt")
summary(ACE_Rb_wls)
glance(ACE_Rb_wls)
model_performance(ACE_Rb_wls) # AIC - Akaike information criterion; BIC Bayesian IC: lower = better fit for both
...
sink(file = NULL)
#Summary Leverage & Cooks distnce plots - write to file 
pdf(file = "Papers_R/2024_DeVleeschouwer/FigureS6/Plots/FigS6c_OLS_WLS_cps/Rb/ACE_Rb_wls_lev_bar.pdf")
barplot(hatvalues(ACE_Rb_wls), 
        col = "blue")
dev.off()
pdf(file = "Papers_R/2024_DeVleeschouwer/FigureS6/Plots/FigS6c_OLS_WLS_cps/Rb/ACE_Rb_wls_lev.pdf")
leveragePlots(ACE_Rb_wls,layout=c(2,2)) 
dev.off()
pdf(file = "Papers_R/2024_DeVleeschouwer/FigureS6/Plots/FigS6c_OLS_WLS_cps/Rb/ACE_Rb_wls_lev_cooks.pdf")
par(mfrow = c(2, 2))
plot(ACE_Rb_wls)
dev.off()
# 4) WLS weighted - write to file
sink(file = "Papers_R/2024_DeVleeschouwer/FigureS6/Plots/FigS6c_OLS_WLS_cps/Rb/Rb_WLS_wt_summary.txt")
...
sink(file = NULL)
#Summary Leverage & Cooks distnce plots - write to file 
pdf(file = "Papers_R/2024_DeVleeschouwer/FigureS6/Plots/FigS6c_OLS_WLS_cps/Rb/ACE_Rb_wls_wt_lev_bar.pdf")
barplot(hatvalues(ACE_Rb_wls_wt), 
        col = "green")
dev.off()
pdf(file = "Papers_R/2024_DeVleeschouwer/FigureS6/Plots/FigS6c_OLS_WLS_cps/Rb/ACE_Rb_wls_wt_lev.pdf")
leveragePlots(ACE_Rb_wls_wt,layout=c(2,2)) 
dev.off()
pdf(file = "Papers_R/2024_DeVleeschouwer/FigureS6/Plots/FigS6c_OLS_WLS_cps/Rb/ACE_Rb_wls_wt_lev_cooks.pdf")
par(mfrow = c(2, 2))
plot(ACE_Rb_wls_wt)
dev.off()
...
ACE_Rb_final <- ACE_Rb + 
  ...
  geom_text(data=data.frame(), aes(label=paste("OLS: ", ACE_Rb_lm_eqn(df)), x = -Inf, y = Inf),
            parse = TRUE, colour = "blue", hjust = -0.15, vjust = 5, size = 3)
ACE_Rb_final
ggsave("Papers_R/2024_DeVleeschouwer/FigureS6/Plots/FigS6c_OLS_WLS_cps/Rb/Rb_OLS_WLS_summary.pdf", 
       height = c(20), width = c(20), dpi = 600, units = "cm")
...
Rb_data_2_out <- bind_cols(Rb_data_1_out, Rb_pred.int2) %>%
  ...
  print()
write.csv(Rb_data_2_out,"Papers_R/2024_DeVleeschouwer/FigureS6/Plots/FigS6c_OLS_WLS_cps/Rb/Rb_OLS_WLS_predict.csv", row.names = FALSE)
...
ACE_Rb_predict <- ACE_Rb_final + 
  ...
  ggtitle(paste("Site: ", site_title, "; ", "Element: " , element_title, " cps [95% CI & PI]"))
ACE_Rb_predict
ggsave("Papers_R/2024_DeVleeschouwer/FigureS6/Plots/FigS6c_OLS_WLS_cps/Rb/Rb_OLS_WLS_predict.pdf", 
       height = c(16), width = c(16), dpi = 600, units = "cm")
...
ggsave("Papers_R/2024_DeVleeschouwer/FigureS6/Plots/FigS6c_OLS_WLS_cps/DM/DM_OLS_performance.pdf", 
       height = c(30), width = c(30), dpi = 600, units = "cm")
# Write summary stats/checks to txt file
sink(file = "Papers_R/2024_DeVleeschouwer/FigureS6/Plots/FigS6c_OLS_WLS_cps/DM/DM_OLS_summary.txt")
summary(ACE_DM_lm)
glance(ACE_DM_lm)
model_performance(ACE_DM_lm) # AIC - Akaike information criterion; BIC Bayesian IC: lower = better fit for both
...
ggsave("Papers_R/2024_DeVleeschouwer/FigureS6/Plots/FigS6c_OLS_WLS_cps/DM/DM_OLS_wt_performance.pdf", 
       height = c(30), width = c(30), dpi = 600, units = "cm")
# Write summary stats/checks to txt file
sink(file = "Papers_R/2024_DeVleeschouwer/FigureS6/Plots/FigS6c_OLS_WLS_cps/DM/DM_OLS_wt_summary.txt")
summary(ACE_DM_wlm)
glance(ACE_DM_wlm)
model_performance(ACE_DM_wlm) # AIC - Akaike information criterion; BIC Bayesian IC: lower = better fit for both
...
ggsave("Papers_R/2024_DeVleeschouwer/FigureS6/Plots/FigS6c_OLS_WLS_cps/DM/DM_WLS_performance.pdf", 
       height = c(30), width = c(30), dpi = 600, units = "cm")
# Write summary stats/checks to txt file
sink(file = "Papers_R/2024_DeVleeschouwer/FigureS6/Plots/FigS6c_OLS_WLS_cps/DM/DM_WLS_summary.txt")
summary(ACE_DM_wls)
glance(ACE_DM_wls)
model_performance(ACE_DM_wls) # AIC - Akaike information criterion; BIC Bayesian IC: lower = better fit for both
...
ggsave("Papers_R/2024_DeVleeschouwer/FigureS6/Plots/FigS6c_OLS_WLS_cps/DM/DM_WLS_wt_performance.pdf", 
       height = c(30), width = c(30), dpi = 600, units = "cm")
# Write summary stats/checks to txt file
sink(file = "Papers_R/2024_DeVleeschouwer/FigureS6/Plots/FigS6c_OLS_WLS_cps/DM/DM_WLS_wt_summary.txt")
...
write.csv(ACE_DM_lm_no_outliers,"Papers_R/2024_DeVleeschouwer/FigureS6/Plots/FigS6c_OLS_WLS_cps/DM/ACE_DM_OLS_no_outliers.csv", row.names = FALSE)

#Summary Leverage & Cooks distnce plots - write to file 
pdf(file = "Papers_R/2024_DeVleeschouwer/FigureS6/Plots/FigS6c_OLS_WLS_cps/DM/ACE_DM_lm_lev_bar.pdf")
barplot(hatvalues(ACE_DM_lm), 
        col = "aquamarine3")
dev.off()
pdf(file = "Papers_R/2024_DeVleeschouwer/FigureS6/Plots/FigS6c_OLS_WLS_cps/DM/ACE_DM_lm_lev.pdf")
leveragePlots(ACE_DM_lm,layout=c(2,2)) 
dev.off()
pdf(file = "Papers_R/2024_DeVleeschouwer/FigureS6/Plots/FigS6c_OLS_WLS_cps/DM/ACE_DM_lm_lev_cooks.pdf")
par(mfrow = c(2, 2))
plot(ACE_DM_lm)
dev.off()
...
write.csv(ACE_DM_wlm_no_outliers,"Papers_R/2024_DeVleeschouwer/FigureS6/Plots/FigS6c_OLS_WLS_cps/DM/OLS_ACE_DM_OLS_wt_no_outliers.csv", row.names = FALSE)

#Summary Leverage & Cooks distnce plots - write to file 
pdf(file = "Papers_R/2024_DeVleeschouwer/FigureS6/Plots/FigS6c_OLS_WLS_cps/DM/ACE_DM_wlm_lev_bar.pdf")
barplot(hatvalues(ACE_DM_wlm), 
        col = "red")
dev.off()
pdf(file = "Papers_R/2024_DeVleeschouwer/FigureS6/Plots/FigS6c_OLS_WLS_cps/DM/ACE_DM_wlm_lev.pdf")
leveragePlots(ACE_DM_wlm,layout=c(2,2)) 
dev.off()
pdf(file = "Papers_R/2024_DeVleeschouwer/FigureS6/Plots/FigS6c_OLS_WLS_cps/DM/ACE_DM_wlm_lev_cooks.pdf")
par(mfrow = c(2, 2))
plot(ACE_DM_wlm)
dev.off()
...
write.csv(ACE_DM_wls_no_outliers,"Papers_R/2024_DeVleeschouwer/FigureS6/Plots/FigS6c_OLS_WLS_cps/DM/ACE_ACE_DM_WLS_no_outliers.csv", row.names = FALSE)

#Summary Leverage & Cooks distnce plots - write to file 
pdf(file = "Papers_R/2024_DeVleeschouwer/FigureS6/Plots/FigS6c_OLS_WLS_cps/DM/ACE_ACE_DM_wls_lev_bar.pdf")
barplot(hatvalues(ACE_DM_wls), 
        col = "blue")
dev.off()
pdf(file = "Papers_R/2024_DeVleeschouwer/FigureS6/Plots/FigS6c_OLS_WLS_cps/DM/ACE_ACE_DM_wls_lev.pdf")
leveragePlots(ACE_DM_wls,layout=c(2,2)) 
dev.off()
pdf(file = "Papers_R/2024_DeVleeschouwer/FigureS6/Plots/FigS6c_OLS_WLS_cps/DM/ACE_ACE_DM_wls_lev_cooks.pdf")
par(mfrow = c(2, 2))
plot(ACE_DM_wls)
dev.off()
...
write.csv(ACE_DM_wls_wt_no_outliers,"Papers_R/2024_DeVleeschouwer/FigureS6/Plots/FigS6c_OLS_WLS_cps/DM/ACE_ACE_DM_WLS_wt_no_outliers.csv", row.names = FALSE)

#Summary Leverage & Cooks distnce plots - write to file 
pdf(file = "Papers_R/2024_DeVleeschouwer/FigureS6/Plots/FigS6c_OLS_WLS_cps/DM/ACE_ACE_DM_wls_wt_lev_bar.pdf")
barplot(hatvalues(ACE_DM_wls_wt), 
        col = "green")
dev.off()
pdf(file = "Papers_R/2024_DeVleeschouwer/FigureS6/Plots/FigS6c_OLS_WLS_cps/DM/ACE_ACE_DM_wls_wt_lev.pdf")
leveragePlots(ACE_DM_wls_wt,layout=c(2,2)) 
dev.off()
pdf(file = "Papers_R/2024_DeVleeschouwer/FigureS6/Plots/FigS6c_OLS_WLS_cps/DM/ACE_ACE_DM_wls_wt_lev_cooks.pdf")
par(mfrow = c(2, 2))
plot(ACE_DM_wls_wt)
dev.off()
...
ACE_DM_final <- ACE_DM + 
  ...
  geom_text(data=data.frame(), aes(label=paste("OLS: ", ACE_DM_lm_eqn(df)), x = -Inf, y = Inf),
            parse = TRUE, colour = "blue", hjust = -0.15, vjust = 5, size = 3)
ACE_DM_final
ggsave("Papers_R/2024_DeVleeschouwer/FigureS6/Plots/FigS6c_OLS_WLS_cps/DM/DM_OLS_WLS_summary.pdf", 
       height = c(20), width = c(20), dpi = 600, units = "cm")


# Supplementary Figures - Secondary & all Matched Elements -------------------------------------------------------------
...
ggarrange(ACE_K_predict, ACE_Co_predict, ACE_Ni_predict, 
          ...
          ncol = 2, nrow = 3, common.legend = TRUE)
ggsave("Papers_R/2024_DeVleeschouwer/FigureS6/Plots/FigS6c_OLS_WLS_cps/ACE_FigS6c_OLS_WLS_cps_2ndry_predict.pdf",
       height = c(40), width = c(30), dpi = 600, units = "cm")
...
ggsave("Papers_R/2024_DeVleeschouwer/FigureS6/Plots/FigS6c_OLS_WLS_cps/ACE_FigS6c_OLS_WLS_cps_all_predict.pdf",
