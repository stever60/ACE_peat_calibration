# Figure 4c - Linear models, ordinary and weighted least squares regression analysis (OLS, WLS)
# For Log_inc dataset with WSL_wt defined outliers removed r=for each element as generated by Fig4b_OLS_WLS_log_inc. R code 
...
ACE_Ca <-read_csv("Papers_R/2024_DeVleeschouwer/Figure4/Plots/Fig4b_OLS_WLS_clr/Ca/ACE_Ca_OLS_wt_no_outliers.csv")
ACE_LM1 <- ACE_Ca
ACE_LM1
...
ggsave("Papers_R/2024_DeVleeschouwer/Figure4/Plots/Fig4b_OLS_WLS_clr/1_Outliers_removed/Ca_OLS_wt/Ca_OLS_performance.pdf", 
...
ggsave("Papers_R/2024_DeVleeschouwer/Figure4/Plots/Fig4b_OLS_WLS_clr/1_Outliers_removed/Ca_OLS_wt/Ca_OLS_wt_performance.pdf", 
       height = c(30), width = c(30), dpi = 600, units = "cm")
...
ggsave("Papers_R/2024_DeVleeschouwer/Figure4/Plots/Fig4b_OLS_WLS_clr/1_Outliers_removed/Ca_OLS_wt/Ca_WLS_performance.pdf", 
       height = c(30), width = c(30), dpi = 600, units = "cm")
...
ggsave("Papers_R/2024_DeVleeschouwer/Figure4/Plots/Fig4b_OLS_WLS_clr/1_Outliers_removed/Ca_OLS_wt/Ca_WLS_wt_performance.pdf", 
       height = c(30), width = c(30), dpi = 600, units = "cm")

# Write stats to file
# 1) OLS - write to file
sink(file = "Papers_R/2024_DeVleeschouwer/Figure4/Plots/Fig4b_OLS_WLS_clr/1_Outliers_removed/Ca_OLS_wt/Ca_OLS_summary.txt")
summary(ACE_Ca_lm)
glance(ACE_Ca_lm)
model_performance(ACE_Ca_lm) # AIC - Akaike information criterion; BIC Bayesian IC: lower = better fit for both
...
sink(file = "Papers_R/2024_DeVleeschouwer/Figure4/Plots/Fig4b_OLS_WLS_clr/1_Outliers_removed/Ca_OLS_wt/Ca_OLS_wt_summary.txt")
summary(ACE_Ca_wlm)
glance(ACE_Ca_wlm)
model_performance(ACE_Ca_wlm) # AIC - Akaike information criterion; BIC Bayesian IC: lower = better fit for both
...
# 3) WLS - write to file
sink(file = "Papers_R/2024_DeVleeschouwer/Figure4/Plots/Fig4b_OLS_WLS_clr/1_Outliers_removed/Ca_OLS_wt/Ca_WLS_summary.txt")
summary(ACE_Ca_wls)
glance(ACE_Ca_wls)
model_performance(ACE_Ca_wls) # AIC - Akaike information criterion; BIC Bayesian IC: lower = better fit for both
...
sink(file = "Papers_R/2024_DeVleeschouwer/Figure4/Plots/Fig4b_OLS_WLS_clr/1_Outliers_removed/Ca_OLS_wt/Ca_WLS_wt_summary.txt")
...
ACE_Ca_final
ggsave("Papers_R/2024_DeVleeschouwer/Figure4/Plots/Fig4b_OLS_WLS_clr/1_Outliers_removed/Ca_OLS_wt/Ca_OLS_WLS_summary.pdf", 
...
Ca_data_2_out <- bind_cols(Ca_data_1_out, Ca_pred.int2) %>%
  ...
  print()
write.csv(Ca_data_2_out,"Papers_R/2024_DeVleeschouwer/Figure4/Plots/Fig4b_OLS_WLS_clr/1_Outliers_removed/Ca_OLS_wt/Ca_OLS_WLS_predict.csv", row.names = FALSE)
...
ACE_Ca_predict
ggsave("Papers_R/2024_DeVleeschouwer/Figure4/Plots/Fig4b_OLS_WLS_clr/1_Outliers_removed/Ca_OLS_wt/Ca_OLS_WLS_predict.pdf", 
...
# Import ACE log inc normalised matched file with OSL_wt outliers removed for this element generated by Fig4b_OLS_WLS_log_inc. R code 
ACE_Ti <-read_csv("Papers_R/2024_DeVleeschouwer/Figure4/Plots/Fig4b_OLS_WLS_clr/Ti/ACE_Ti_OLS_wt_no_outliers.csv")
ACE_LM1 <- ACE_Ti
ACE_LM1
# Convert Site to use as a grouping variable
ACE_LM1$Site <- as.factor(ACE_LM1$Site)
...
ggsave("Papers_R/2024_DeVleeschouwer/Figure4/Plots/Fig4b_OLS_WLS_clr/1_Outliers_removed/Ti_OLS_wt/Ti_OLS_performance.pdf", 
       height = c(30), width = c(30), dpi = 600, units = "cm")
...
ggsave("Papers_R/2024_DeVleeschouwer/Figure4/Plots/Fig4b_OLS_WLS_clr/1_Outliers_removed/Ti_OLS_wt/Ti_OLS_wt_performance.pdf", 
       height = c(30), width = c(30), dpi = 600, units = "cm")
...
ggsave("Papers_R/2024_DeVleeschouwer/Figure4/Plots/Fig4b_OLS_WLS_clr/1_Outliers_removed/Ti_OLS_wt/Ti_WLS_performance.pdf", 
       height = c(30), width = c(30), dpi = 600, units = "cm")
...
ggsave("Papers_R/2024_DeVleeschouwer/Figure4/Plots/Fig4b_OLS_WLS_clr/1_Outliers_removed/Ti_OLS_wt/Ti_WLS_wt_performance.pdf", 
       height = c(30), width = c(30), dpi = 600, units = "cm")


# Write stats to file
# 1) OLS - write to file
sink(file = "Papers_R/2024_DeVleeschouwer/Figure4/Plots/Fig4b_OLS_WLS_clr/1_Outliers_removed/Ti_OLS_wt/Ti_OLS_summary.txt")
summary(ACE_Ti_lm)
glance(ACE_Ti_lm)
model_performance(ACE_Ti_lm) # AIC - Akaike information criterion; BIC Bayesian IC: lower = better fit for both
...
# 2) OLS weighted - write to file
sink(file = "Papers_R/2024_DeVleeschouwer/Figure4/Plots/Fig4b_OLS_WLS_clr/1_Outliers_removed/Ti_OLS_wt/Ti_OLS_wt_summary.txt")
summary(ACE_Ti_wlm)
glance(ACE_Ti_wlm)
model_performance(ACE_Ti_wlm) # AIC - Akaike information criterion; BIC Bayesian IC: lower = better fit for both
...
# 3) WLS - write to file
sink(file = "Papers_R/2024_DeVleeschouwer/Figure4/Plots/Fig4b_OLS_WLS_clr/1_Outliers_removed/Ti_OLS_wt/Ti_WLS_summary.txt")
summary(ACE_Ti_wls)
glance(ACE_Ti_wls)
model_performance(ACE_Ti_wls) # AIC - Akaike information criterion; BIC Bayesian IC: lower = better fit for both
...
# 4) WLS weighted - write to file
sink(file = "Papers_R/2024_DeVleeschouwer/Figure4/Plots/Fig4b_OLS_WLS_clr/1_Outliers_removed/Ti_OLS_wt/Ti_WLS_wt_summary.txt")
...
ACE_Ti_final <- ACE_Ti + 
  ...
  geom_text(data=data.frame(), aes(label=paste("OLS: ", ACE_Ti_lm_eqn(df)), x = -Inf, y = Inf),
            parse = TRUE, colour = "blue", hjust = -0.15, vjust = 5, size = 3)
ACE_Ti_final
ggsave("Papers_R/2024_DeVleeschouwer/Figure4/Plots/Fig4b_OLS_WLS_clr/1_Outliers_removed/Ti_OLS_wt/Ti_OLS_WLS_summary.pdf", 
       height = c(20), width = c(20), dpi = 600, units = "cm")
...
Ti_data_2_out <- bind_cols(Ti_data_1_out, Ti_pred.int2) %>%
  ...
  print()
write.csv(Ti_data_2_out,"Papers_R/2024_DeVleeschouwer/Figure4/Plots/Fig4b_OLS_WLS_clr/1_Outliers_removed/Ti_OLS_wt/Ti_OLS_WLS_predict.csv", row.names = FALSE)
...
ACE_Ti_predict <- ACE_Ti_final + 
  ...
  ggtitle(paste("Site: ", site_title, "; ", "Element: " , element_title, " clr [95% CI & PI]"))
ACE_Ti_predict
ggsave("Papers_R/2024_DeVleeschouwer/Figure4/Plots/Fig4b_OLS_WLS_clr/1_Outliers_removed/Ti_OLS_wt/Ti_OLS_WLS_predict.pdf", 
       height = c(16), width = c(16), dpi = 600, units = "cm")

# ACE_Mn LM  -----------------------------------------------------------------------

# Import ACE log inc normalised matched file with OSL_wt outliers removed for this element generated by Fig4b_OLS_WLS_log_inc. R code 
ACE_Mn <-read_csv("Papers_R/2024_DeVleeschouwer/Figure4/Plots/Fig4b_OLS_WLS_clr/Mn/ACE_Mn_OLS_wt_no_outliers.csv")
ACE_LM1 <- ACE_Mn
ACE_LM1
# Convert Site to use as a grouping variable
ACE_LM1$Site <- as.factor(ACE_LM1$Site)
...
ggsave("Papers_R/2024_DeVleeschouwer/Figure4/Plots/Fig4b_OLS_WLS_clr/1_Outliers_removed/Mn_OLS_wt/Mn_OLS_performance.pdf", 
       height = c(30), width = c(30), dpi = 600, units = "cm")
...
ggsave("Papers_R/2024_DeVleeschouwer/Figure4/Plots/Fig4b_OLS_WLS_clr/1_Outliers_removed/Mn_OLS_wt/Mn_OLS_wt_performance.pdf", 
       height = c(30), width = c(30), dpi = 600, units = "cm")
...
ggsave("Papers_R/2024_DeVleeschouwer/Figure4/Plots/Fig4b_OLS_WLS_clr/1_Outliers_removed/Mn_OLS_wt/Mn_WLS_performance.pdf", 
       height = c(30), width = c(30), dpi = 600, units = "cm")
...
ggsave("Papers_R/2024_DeVleeschouwer/Figure4/Plots/Fig4b_OLS_WLS_clr/1_Outliers_removed/Mn_OLS_wt/Mn_WLS_wt_performance.pdf", 
       height = c(30), width = c(30), dpi = 600, units = "cm")

# Write stats to file
# 1) OLS - write to file
sink(file = "Papers_R/2024_DeVleeschouwer/Figure4/Plots/Fig4b_OLS_WLS_clr/1_Outliers_removed/Mn_OLS_wt/Mn_OLS_summary.txt")
summary(ACE_Mn_lm)
glance(ACE_Mn_lm)
model_performance(ACE_Mn_lm) # AIC - Akaike information criterion; BIC Bayesian IC: lower = better fit for both
...
# 2) OLS weighted - write to file
sink(file = "Papers_R/2024_DeVleeschouwer/Figure4/Plots/Fig4b_OLS_WLS_clr/1_Outliers_removed/Mn_OLS_wt/Mn_OLS_wt_summary.txt")
summary(ACE_Mn_wlm)
glance(ACE_Mn_wlm)
model_performance(ACE_Mn_wlm) # AIC - Akaike information criterion; BIC Bayesian IC: lower = better fit for both
...
# 3) WLS - write to file
sink(file = "Papers_R/2024_DeVleeschouwer/Figure4/Plots/Fig4b_OLS_WLS_clr/1_Outliers_removed/Mn_OLS_wt/Mn_WLS_summary.txt")
summary(ACE_Mn_wls)
glance(ACE_Mn_wls)
model_performance(ACE_Mn_wls) # AIC - Akaike information criterion; BIC Bayesian IC: lower = better fit for both
...
# 4) WLS weighted - write to file
sink(file = "Papers_R/2024_DeVleeschouwer/Figure4/Plots/Fig4b_OLS_WLS_clr/1_Outliers_removed/Mn_OLS_wt/Mn_WLS_wt_summary.txt")
...
ACE_Mn_final <- ACE_Mn + 
  ...
  geom_text(data=data.frame(), aes(label=paste("OLS: ", ACE_Mn_lm_eqn(df)), x = -Inf, y = Inf),
            parse = TRUE, colour = "blue", hjust = -0.15, vjust = 5, size = 3)
ACE_Mn_final
ggsave("Papers_R/2024_DeVleeschouwer/Figure4/Plots/Fig4b_OLS_WLS_clr/1_Outliers_removed/Mn_OLS_wt/Mn_OLS_WLS_summary.pdf", 
       height = c(20), width = c(20), dpi = 600, units = "cm")
...
Mn_data_2_out <- bind_cols(Mn_data_1_out, Mn_pred.int2) %>%
  ...
  print()
write.csv(Mn_data_2_out,"Papers_R/2024_DeVleeschouwer/Figure4/Plots/Fig4b_OLS_WLS_clr/1_Outliers_removed/Mn_OLS_wt/Mn_OLS_WLS_predict.csv", row.names = FALSE)
...
ACE_Mn_predict <- ACE_Mn_final + 
  ...
  ggtitle(paste("Site: ", site_title, "; ", "Element: " , element_title, " clr [95% CI & PI]"))
ACE_Mn_predict
ggsave("Papers_R/2024_DeVleeschouwer/Figure4/Plots/Fig4b_OLS_WLS_clr/1_Outliers_removed/Mn_OLS_wt/Mn_OLS_WLS_predict.pdf", 
       height = c(16), width = c(16), dpi = 600, units = "cm")
...
# Import ACE log inc normalised matched file with OSL_wt outliers removed for this element generated by Fig4b_OLS_WLS_log_inc. R code 
ACE_Fe <-read_csv("Papers_R/2024_DeVleeschouwer/Figure4/Plots/Fig4b_OLS_WLS_clr/Fe/ACE_Fe_OLS_wt_no_outliers.csv")
ACE_LM1 <- ACE_Fe
ACE_LM1
# Convert Site to use as a grouping variable
ACE_LM1$Site <- as.factor(ACE_LM1$Site)
...
ggsave("Papers_R/2024_DeVleeschouwer/Figure4/Plots/Fig4b_OLS_WLS_clr/1_Outliers_removed/Fe_OLS_wt/Fe_OLS_performance.pdf", 
       height = c(30), width = c(30), dpi = 600, units = "cm")
...
ggsave("Papers_R/2024_DeVleeschouwer/Figure4/Plots/Fig4b_OLS_WLS_clr/1_Outliers_removed/Fe_OLS_wt/Fe_OLS_wt_performance.pdf", 
       height = c(30), width = c(30), dpi = 600, units = "cm")
...
ggsave("Papers_R/2024_DeVleeschouwer/Figure4/Plots/Fig4b_OLS_WLS_clr/1_Outliers_removed/Fe_OLS_wt/Fe_WLS_performance.pdf", 
       height = c(30), width = c(30), dpi = 600, units = "cm")
...
ggsave("Papers_R/2024_DeVleeschouwer/Figure4/Plots/Fig4b_OLS_WLS_clr/1_Outliers_removed/Fe_OLS_wt/Fe_WLS_wt_performance.pdf", 
       height = c(30), width = c(30), dpi = 600, units = "cm")

# Write stats to file
# 1) OLS - write to file
sink(file = "Papers_R/2024_DeVleeschouwer/Figure4/Plots/Fig4b_OLS_WLS_clr/1_Outliers_removed/Fe_OLS_wt/Fe_OLS_summary.txt")
summary(ACE_Fe_lm)
glance(ACE_Fe_lm)
model_performance(ACE_Fe_lm) # AIC - Akaike information criterion; BIC Bayesian IC: lower = better fit for both
...
# 2) OLS weighted - write to file
sink(file = "Papers_R/2024_DeVleeschouwer/Figure4/Plots/Fig4b_OLS_WLS_clr/1_Outliers_removed/Fe_OLS_wt/Fe_OLS_wt_summary.txt")
summary(ACE_Fe_wlm)
glance(ACE_Fe_wlm)
model_performance(ACE_Fe_wlm) # AIC - Akaike information criterion; BIC Bayesian IC: lower = better fit for both
...
# 3) WLS - write to file
sink(file = "Papers_R/2024_DeVleeschouwer/Figure4/Plots/Fig4b_OLS_WLS_clr/1_Outliers_removed/Fe_OLS_wt/Fe_WLS_summary.txt")
summary(ACE_Fe_wls)
glance(ACE_Fe_wls)
model_performance(ACE_Fe_wls) # AIC - Akaike information criterion; BIC Bayesian IC: lower = better fit for both
...
# 4) WLS weighted - write to file
sink(file = "Papers_R/2024_DeVleeschouwer/Figure4/Plots/Fig4b_OLS_WLS_clr/1_Outliers_removed/Fe_OLS_wt/Fe_WLS_wt_summary.txt")
...
ACE_Fe_final <- ACE_Fe + 
  ...
  geom_text(data=data.frame(), aes(label=paste("OLS: ", ACE_Fe_lm_eqn(df)), x = -Inf, y = Inf),
            parse = TRUE, colour = "blue", hjust = -0.15, vjust = 5, size = 3)
ACE_Fe_final
ggsave("Papers_R/2024_DeVleeschouwer/Figure4/Plots/Fig4b_OLS_WLS_clr/1_Outliers_removed/Fe_OLS_wt/Fe_OLS_WLS_summary.pdf", 
       height = c(20), width = c(20), dpi = 600, units = "cm")
...
Fe_data_2_out <- bind_cols(Fe_data_1_out, Fe_pred.int2) %>%
  ...
  print()
write.csv(Fe_data_2_out,"Papers_R/2024_DeVleeschouwer/Figure4/Plots/Fig4b_OLS_WLS_clr/1_Outliers_removed/Fe_OLS_wt/Fe_OLS_WLS_predict.csv", row.names = FALSE)
...
ACE_Fe_predict <- ACE_Fe_final + 
  ...
  ggtitle(paste("Site: ", site_title, "; ", "Element: " , element_title, " clr [95% CI & PI]"))
ACE_Fe_predict
ggsave("Papers_R/2024_DeVleeschouwer/Figure4/Plots/Fig4b_OLS_WLS_clr/1_Outliers_removed/Fe_OLS_wt/Fe_OLS_WLS_predict.pdf", 
       height = c(16), width = c(16), dpi = 600, units = "cm")
# ACE_Sr LM -----------------------------------------------------------------------

# Import ACE log inc normalised matched file with OSL_wt outliers removed for this element generated by Fig4b_OLS_WLS_log_inc. R code 
ACE_Sr <-read_csv("Papers_R/2024_DeVleeschouwer/Figure4/Plots/Fig4b_OLS_WLS_clr/Sr/ACE_Sr_OLS_wt_no_outliers.csv")
ACE_LM1 <- ACE_Sr
ACE_LM1
# Convert Site to use as a grouping variable
ACE_LM1$Site <- as.factor(ACE_LM1$Site)
...
ggsave("Papers_R/2024_DeVleeschouwer/Figure4/Plots/Fig4b_OLS_WLS_clr/1_Outliers_removed/Sr_OLS_wt/Sr_OLS_performance.pdf", 
       height = c(30), width = c(30), dpi = 600, units = "cm")
...
ggsave("Papers_R/2024_DeVleeschouwer/Figure4/Plots/Fig4b_OLS_WLS_clr/1_Outliers_removed/Sr_OLS_wt/Sr_OLS_wt_performance.pdf", 
       height = c(30), width = c(30), dpi = 600, units = "cm")
...
ggsave("Papers_R/2024_DeVleeschouwer/Figure4/Plots/Fig4b_OLS_WLS_clr/1_Outliers_removed/Sr_OLS_wt/Sr_WLS_performance.pdf", 
       height = c(30), width = c(30), dpi = 600, units = "cm")
...
ggsave("Papers_R/2024_DeVleeschouwer/Figure4/Plots/Fig4b_OLS_WLS_clr/1_Outliers_removed/Sr_OLS_wt/Sr_WLS_wt_performance.pdf", 
       height = c(30), width = c(30), dpi = 600, units = "cm")


# Write stats to file
# 1) OLS - write to file
sink(file = "Papers_R/2024_DeVleeschouwer/Figure4/Plots/Fig4b_OLS_WLS_clr/1_Outliers_removed/Sr_OLS_wt/Sr_OLS_summary.txt")
summary(ACE_Sr_lm)
glance(ACE_Sr_lm)
model_performance(ACE_Sr_lm) # AIC - Akaike information criterion; BIC Bayesian IC: lower = better fit for both
...
# 2) OLS weighted - write to file
sink(file = "Papers_R/2024_DeVleeschouwer/Figure4/Plots/Fig4b_OLS_WLS_clr/1_Outliers_removed/Sr_OLS_wt/Sr_OLS_wt_summary.txt")
summary(ACE_Sr_wlm)
glance(ACE_Sr_wlm)
model_performance(ACE_Sr_wlm) # AIC - Akaike information criterion; BIC Bayesian IC: lower = better fit for both
...
# 3) WLS - write to file
sink(file = "Papers_R/2024_DeVleeschouwer/Figure4/Plots/Fig4b_OLS_WLS_clr/1_Outliers_removed/Sr_OLS_wt/Sr_WLS_summary.txt")
summary(ACE_Sr_wls)
glance(ACE_Sr_wls)
model_performance(ACE_Sr_wls) # AIC - Akaike information criterion; BIC Bayesian IC: lower = better fit for both
...
# 4) WLS weighted - write to file
sink(file = "Papers_R/2024_DeVleeschouwer/Figure4/Plots/Fig4b_OLS_WLS_clr/1_Outliers_removed/Sr_OLS_wt/Sr_WLS_wt_summary.txt")
...
ACE_Sr_final <- ACE_Sr + 
  ...
  geom_text(data=data.frame(), aes(label=paste("OLS: ", ACE_Sr_lm_eqn(df)), x = -Inf, y = Inf),
            parse = TRUE, colour = "blue", hjust = -0.15, vjust = 5, size = 3)
ACE_Sr_final
ggsave("Papers_R/2024_DeVleeschouwer/Figure4/Plots/Fig4b_OLS_WLS_clr/1_Outliers_removed/Sr_OLS_wt/Sr_OLS_WLS_summary.pdf", 
       height = c(20), width = c(20), dpi = 600, units = "cm")
...
Sr_data_2_out <- bind_cols(Sr_data_1_out, Sr_pred.int2) %>%
  ...
  print()
write.csv(Sr_data_2_out,"Papers_R/2024_DeVleeschouwer/Figure4/Plots/Fig4b_OLS_WLS_clr/1_Outliers_removed/Sr_OLS_wt/Sr_OLS_WLS_predict.csv", row.names = FALSE)
...
ACE_Sr_predict <- ACE_Sr_final + 
  ...
  ggtitle(paste("Site: ", site_title, "; ", "Element: " , element_title, " clr [95% CI & PI]"))
ACE_Sr_predict
ggsave("Papers_R/2024_DeVleeschouwer/Figure4/Plots/Fig4b_OLS_WLS_clr/1_Outliers_removed/Sr_OLS_wt/Sr_OLS_WLS_predict.pdf", 
       height = c(16), width = c(16), dpi = 600, units = "cm")
...
# Import ACE log inc normalised matched file with OSL_wt outliers removed for this element generated by Fig4b_OLS_WLS_log_inc. R code 
ACE_Zr <-read_csv("Papers_R/2024_DeVleeschouwer/Figure4/Plots/Fig4b_OLS_WLS_clr/Zr/ACE_Zr_OLS_wt_no_outliers.csv")
ACE_LM1 <- ACE_Zr
ACE_LM1
# Convert Site to use as a grouping variable
ACE_LM1$Site <- as.factor(ACE_LM1$Site)
...
ggsave("Papers_R/2024_DeVleeschouwer/Figure4/Plots/Fig4b_OLS_WLS_clr/1_Outliers_removed/Zr_OLS_wt/Zr_OLS_performance.pdf", 
       height = c(30), width = c(30), dpi = 600, units = "cm")
...
ggsave("Papers_R/2024_DeVleeschouwer/Figure4/Plots/Fig4b_OLS_WLS_clr/1_Outliers_removed/Zr_OLS_wt/Zr_OLS_wt_performance.pdf", 
       height = c(30), width = c(30), dpi = 600, units = "cm")
...
ggsave("Papers_R/2024_DeVleeschouwer/Figure4/Plots/Fig4b_OLS_WLS_clr/1_Outliers_removed/Zr_OLS_wt/Zr_WLS_performance.pdf", 
       height = c(30), width = c(30), dpi = 600, units = "cm")
...
ggsave("Papers_R/2024_DeVleeschouwer/Figure4/Plots/Fig4b_OLS_WLS_clr/1_Outliers_removed/Zr_OLS_wt/Zr_WLS_wt_performance.pdf", 
       height = c(30), width = c(30), dpi = 600, units = "cm")

# Write stats to file
# 1) OLS - write to file
sink(file = "Papers_R/2024_DeVleeschouwer/Figure4/Plots/Fig4b_OLS_WLS_clr/1_Outliers_removed/Zr_OLS_wt/Zr_OLS_summary.txt")
summary(ACE_Zr_lm)
glance(ACE_Zr_lm)
model_performance(ACE_Zr_lm) # AIC - Akaike information criterion; BIC Bayesian IC: lower = better fit for both
...
# 2) OLS weighted - write to file
sink(file = "Papers_R/2024_DeVleeschouwer/Figure4/Plots/Fig4b_OLS_WLS_clr/1_Outliers_removed/Zr_OLS_wt/Zr_OLS_wt_summary.txt")
summary(ACE_Zr_wlm)
glance(ACE_Zr_wlm)
model_performance(ACE_Zr_wlm) # AIC - Akaike information criterion; BIC Bayesian IC: lower = better fit for both
...
# 3) WLS - write to file
sink(file = "Papers_R/2024_DeVleeschouwer/Figure4/Plots/Fig4b_OLS_WLS_clr/1_Outliers_removed/Zr_OLS_wt/Zr_WLS_summary.txt")
summary(ACE_Zr_wls)
glance(ACE_Zr_wls)
model_performance(ACE_Zr_wls) # AIC - Akaike information criterion; BIC Bayesian IC: lower = better fit for both
...
# 4) WLS weighted - write to file
sink(file = "Papers_R/2024_DeVleeschouwer/Figure4/Plots/Fig4b_OLS_WLS_clr/1_Outliers_removed/Zr_OLS_wt/Zr_WLS_wt_summary.txt")
...
ACE_Zr_final <- ACE_Zr + 
  ...
  geom_text(data=data.frame(), aes(label=paste("OLS: ", ACE_Zr_lm_eqn(df)), x = -Inf, y = Inf),
            parse = TRUE, colour = "blue", hjust = -0.15, vjust = 5, size = 3)
ACE_Zr_final
ggsave("Papers_R/2024_DeVleeschouwer/Figure4/Plots/Fig4b_OLS_WLS_clr/1_Outliers_removed/Zr_OLS_wt/Zr_OLS_WLS_summary.pdf", 
       height = c(20), width = c(20), dpi = 600, units = "cm")
...
Zr_data_2_out <- bind_cols(Zr_data_1_out, Zr_pred.int2) %>%
  ...
  print()
write.csv(Zr_data_2_out,"Papers_R/2024_DeVleeschouwer/Figure4/Plots/Fig4b_OLS_WLS_clr/1_Outliers_removed/Zr_OLS_wt/Zr_OLS_WLS_predict.csv", row.names = FALSE)
...
ACE_Zr_predict <- ACE_Zr_final + 
  ...
  ggtitle(paste("Site: ", site_title, "; ", "Element: " , element_title, " clr [95% CI & PI]"))
ACE_Zr_predict
ggsave("Papers_R/2024_DeVleeschouwer/Figure4/Plots/Fig4b_OLS_WLS_clr/1_Outliers_removed/Zr_OLS_wt/Zr_OLS_WLS_predict.pdf", 
       height = c(16), width = c(16), dpi = 600, units = "cm")
...
ggsave("Papers_R/2024_DeVleeschouwer/Figure4/Plots/Fig4b_OLS_WLS_clr/ACE_Fig4c_OLS_WLS_clr_OLS_wt_no_outliers_key_predict.pdf",
...
# Import ACE log inc normalised matched file with OSL_wt outliers removed for this element generated by Fig4b_OLS_WLS_log_inc. R code 
ACE_K <-read_csv("Papers_R/2024_DeVleeschouwer/Figure4/Plots/Fig4b_OLS_WLS_clr/K/ACE_K_OLS_wt_no_outliers.csv")
ACE_LM1 <- ACE_K
ACE_LM1
# Convert Site to use as a grouping variable
ACE_LM1$Site <- as.factor(ACE_LM1$Site)
...
ggsave("Papers_R/2024_DeVleeschouwer/Figure4/Plots/Fig4b_OLS_WLS_clr/1_Outliers_removed/K_OLS_wt/K_OLS_performance.pdf", 
       height = c(30), width = c(30), dpi = 600, units = "cm")
...
ggsave("Papers_R/2024_DeVleeschouwer/Figure4/Plots/Fig4b_OLS_WLS_clr/1_Outliers_removed/K_OLS_wt/K_OLS_wt_performance.pdf", 
       height = c(30), width = c(30), dpi = 600, units = "cm")
...
ggsave("Papers_R/2024_DeVleeschouwer/Figure4/Plots/Fig4b_OLS_WLS_clr/1_Outliers_removed/K_OLS_wt/K_WLS_performance.pdf", 
       height = c(30), width = c(30), dpi = 600, units = "cm")
...
ggsave("Papers_R/2024_DeVleeschouwer/Figure4/Plots/Fig4b_OLS_WLS_clr/1_Outliers_removed/K_OLS_wt/K_WLS_wt_performance.pdf", 
       height = c(30), width = c(30), dpi = 600, units = "cm")
...
sink(file = "Papers_R/2024_DeVleeschouwer/Figure4/Plots/Fig4b_OLS_WLS_clr/1_Outliers_removed/K_OLS_wt/K_OLS_wt_summary.txt")
summary(ACE_K_wlm)
glance(ACE_K_wlm)
model_performance(ACE_K_wlm) # AIC - Akaike information criterion; BIC Bayesian IC: lower = better fit for both
...
# 2) OLS weighted
# Performance indicators
sink(file = "Papers_R/2024_DeVleeschouwer/Figure4/Plots/Fig4b_OLS_WLS_clr/1_Outliers_removed/K_OLS_wt/K_OLS_summary.txt")
summary(ACE_K_wlm)
glance(ACE_K_wlm)
model_performance(ACE_K_wlm) # AIC - Akaike information criterion; BIC Bayesian IC: lower = better fit for both
bptest(ACE_K_wlm) # lmtest package check for heteroscedasticity - p <0.05 = reject null hypothesis - heteroscedasticity present
...
# 3) WLS
# Performance indicators
sink(file = "Papers_R/2024_DeVleeschouwer/Figure4/Plots/Fig4b_OLS_WLS_clr/1_Outliers_removed/K_OLS_wt/K_WLS_summary.txt")
summary(ACE_K_wls)
glance(ACE_K_wls)
model_performance(ACE_K_wls) # AIC - Akaike information criterion; BIC Bayesian IC: lower = better fit for both
...
# 4) WLS weighted
# Performance indicators
sink(file = "Papers_R/2024_DeVleeschouwer/Figure4/Plots/Fig4b_OLS_WLS_clr/1_Outliers_removed/K_OLS_wt/K_WLS_wt_summary.txt")
...
ACE_K_final <- ACE_K + 
  ...
  geom_text(data=data.frame(), aes(label=paste("OLS: ", ACE_K_lm_eqn(df)), x = -Inf, y = Inf),
            parse = TRUE, colour = "blue", hjust = -0.15, vjust = 5, size = 3)
ACE_K_final
ggsave("Papers_R/2024_DeVleeschouwer/Figure4/Plots/Fig4b_OLS_WLS_clr/1_Outliers_removed/K_OLS_wt/K_OLS_WLS_summary.pdf", 
       height = c(20), width = c(20), dpi = 600, units = "cm")
...
K_data_2_out <- bind_cols(K_data_1_out, K_pred.int2) %>%
  ...
  print()
write.csv(K_data_2_out,"Papers_R/2024_DeVleeschouwer/Figure4/Plots/Fig4b_OLS_WLS_clr/1_Outliers_removed/K_OLS_wt/K_OLS_WLS_predict.csv", row.names = FALSE)
...
ACE_K_predict <- ACE_K_final + 
  ...
  ggtitle(paste("Site: ", site_title, "; ", "Element: " , element_title, " clr [95% CI & PI]"))
ACE_K_predict
ggsave("Papers_R/2024_DeVleeschouwer/Figure4/Plots/Fig4b_OLS_WLS_clr/1_Outliers_removed/K_OLS_wt/K_OLS_WLS_predict.pdf", 
       height = c(16), width = c(16), dpi = 600, units = "cm")

# ACE_Co LM  -----------------------------------------------------------------------

# Import ACE log inc normalised matched file with OSL_wt outliers removed for this element generated by Fig4b_OLS_WLS_log_inc. R code 
ACE_Co <-read_csv("Papers_R/2024_DeVleeschouwer/Figure4/Plots/Fig4b_OLS_WLS_clr/Co/ACE_Co_OLS_wt_no_outliers.csv")
ACE_LM1 <- ACE_Co
ACE_LM1
# Convert Site to use as a grouping variable
ACE_LM1$Site <- as.factor(ACE_LM1$Site)
...
ggsave("Papers_R/2024_DeVleeschouwer/Figure4/Plots/Fig4b_OLS_WLS_clr/1_Outliers_removed/Co_OLS_wt/Co_OLS_performance.pdf", 
       height = c(30), width = c(30), dpi = 600, units = "cm")
...
ggsave("Papers_R/2024_DeVleeschouwer/Figure4/Plots/Fig4b_OLS_WLS_clr/1_Outliers_removed/Co_OLS_wt/Co_OLS_wt_performance.pdf", 
       height = c(30), width = c(30), dpi = 600, units = "cm")
...
ggsave("Papers_R/2024_DeVleeschouwer/Figure4/Plots/Fig4b_OLS_WLS_clr/1_Outliers_removed/Co_OLS_wt/Co_WLS_performance.pdf", 
       height = c(30), width = c(30), dpi = 600, units = "cm")
...
ggsave("Papers_R/2024_DeVleeschouwer/Figure4/Plots/Fig4b_OLS_WLS_clr/1_Outliers_removed/Co_OLS_wt/Co_WLS_wt_performance.pdf", 
       height = c(30), width = c(30), dpi = 600, units = "cm")

# Write stats to file
# 1) OLS - write to file
sink(file = "Papers_R/2024_DeVleeschouwer/Figure4/Plots/Fig4b_OLS_WLS_clr/1_Outliers_removed/Co_OLS_wt/Co_OLS_summary.txt")
summary(ACE_Co_lm)
glance(ACE_Co_lm)
model_performance(ACE_Co_lm) # AIC - Akaike information criterion; BIC Bayesian IC: lower = better fit for both
...
# 2) OLS weighted - write to file
sink(file = "Papers_R/2024_DeVleeschouwer/Figure4/Plots/Fig4b_OLS_WLS_clr/1_Outliers_removed/Co_OLS_wt/Co_OLS_wt_summary.txt")
summary(ACE_Co_wlm)
glance(ACE_Co_wlm)
model_performance(ACE_Co_wlm) # AIC - Akaike information criterion; BIC Bayesian IC: lower = better fit for both
...
# 3) WLS - write to file
sink(file = "Papers_R/2024_DeVleeschouwer/Figure4/Plots/Fig4b_OLS_WLS_clr/1_Outliers_removed/Co_OLS_wt/Co_WLS_summary.txt")
summary(ACE_Co_wls)
glance(ACE_Co_wls)
model_performance(ACE_Co_wls) # AIC - Akaike information criterion; BIC Bayesian IC: lower = better fit for both
...
# 4) WLS weighted - write to file
sink(file = "Papers_R/2024_DeVleeschouwer/Figure4/Plots/Fig4b_OLS_WLS_clr/1_Outliers_removed/Co_OLS_wt/Co_WLS_wt_summary.txt")
...
ACE_Co_final <- ACE_Co + 
  ...
  geom_text(data=data.frame(), aes(label=paste("OLS: ", ACE_Co_lm_eqn(df)), x = -Inf, y = Inf),
            parse = TRUE, colour = "blue", hjust = -0.15, vjust = 5, size = 3)
ACE_Co_final
ggsave("Papers_R/2024_DeVleeschouwer/Figure4/Plots/Fig4b_OLS_WLS_clr/1_Outliers_removed/Co_OLS_wt/Co_OLS_WLS_summary.pdf", 
       height = c(20), width = c(20), dpi = 600, units = "cm")
...
Co_data_2_out <- bind_cols(Co_data_1_out, Co_pred.int2) %>%
  ...
  print()
write.csv(Co_data_2_out,"Papers_R/2024_DeVleeschouwer/Figure4/Plots/Fig4b_OLS_WLS_clr/1_Outliers_removed/Co_OLS_wt/Co_OLS_WLS_predict.csv", row.names = FALSE)
...
ACE_Co_predict <- ACE_Co_final + 
  ...
  ggtitle(paste("Site: ", site_title, "; ", "Element: " , element_title, " clr [95% CI & PI]"))
ACE_Co_predict
ggsave("Papers_R/2024_DeVleeschouwer/Figure4/Plots/Fig4b_OLS_WLS_clr/1_Outliers_removed/Co_OLS_wt/Co_OLS_WLS_predict.pdf", 
       height = c(16), width = c(16), dpi = 600, units = "cm")
# ACE_Ni LM  -----------------------------------------------------------------------

# Import ACE log inc normalised matched file with OSL_wt outliers removed for this element generated by Fig4b_OLS_WLS_log_inc. R code 
ACE_Ni <-read_csv("Papers_R/2024_DeVleeschouwer/Figure4/Plots/Fig4b_OLS_WLS_clr/Ni/ACE_Ni_OLS_wt_no_outliers.csv")
ACE_LM1 <- ACE_Ni
ACE_LM1
# Convert Site to use as a grouping variable
ACE_LM1$Site <- as.factor(ACE_LM1$Site)
...
ggsave("Papers_R/2024_DeVleeschouwer/Figure4/Plots/Fig4b_OLS_WLS_clr/1_Outliers_removed/Ni_OLS_wt/Ni_OLS_performance.pdf", 
       height = c(30), width = c(30), dpi = 600, units = "cm")
...
ggsave("Papers_R/2024_DeVleeschouwer/Figure4/Plots/Fig4b_OLS_WLS_clr/1_Outliers_removed/Ni_OLS_wt/Ni_OLS_wt_performance.pdf", 
       height = c(30), width = c(30), dpi = 600, units = "cm")
...
ggsave("Papers_R/2024_DeVleeschouwer/Figure4/Plots/Fig4b_OLS_WLS_clr/1_Outliers_removed/Ni_OLS_wt/Ni_WLS_performance.pdf", 
       height = c(30), width = c(30), dpi = 600, units = "cm")
...
ggsave("Papers_R/2024_DeVleeschouwer/Figure4/Plots/Fig4b_OLS_WLS_clr/1_Outliers_removed/Ni_OLS_wt/Ni_WLS_wt_performance.pdf", 
       height = c(30), width = c(30), dpi = 600, units = "cm")

# Write stats to file
# 1) OLS - write to file
sink(file = "Papers_R/2024_DeVleeschouwer/Figure4/Plots/Fig4b_OLS_WLS_clr/1_Outliers_removed/Ni_OLS_wt/Ni_OLS_summary.txt")
summary(ACE_Ni_lm)
glance(ACE_Ni_lm)
model_performance(ACE_Ni_lm) # AIC - Akaike information criterion; BIC Bayesian IC: lower = better fit for both
...
# 2) OLS weighted - write to file
sink(file = "Papers_R/2024_DeVleeschouwer/Figure4/Plots/Fig4b_OLS_WLS_clr/1_Outliers_removed/Ni_OLS_wt/Ni_OLS_wt_summary.txt")
summary(ACE_Ni_wlm)
glance(ACE_Ni_wlm)
model_performance(ACE_Ni_wlm) # AIC - Akaike information criterion; BIC Bayesian IC: lower = better fit for both
...
# 3) WLS - write to file
sink(file = "Papers_R/2024_DeVleeschouwer/Figure4/Plots/Fig4b_OLS_WLS_clr/1_Outliers_removed/Ni_OLS_wt/Ni_WLS_summary.txt")
summary(ACE_Ni_wls)
glance(ACE_Ni_wls)
model_performance(ACE_Ni_wls) # AIC - Akaike information criterion; BIC Bayesian IC: lower = better fit for both
...
# 4) WLS weighted - write to file
sink(file = "Papers_R/2024_DeVleeschouwer/Figure4/Plots/Fig4b_OLS_WLS_clr/1_Outliers_removed/Ni_OLS_wt/Ni_WLS_wt_summary.txt")
...
ACE_Ni_final <- ACE_Ni + 
  ...
  geom_text(data=data.frame(), aes(label=paste("OLS: ", ACE_Ni_lm_eqn(df)), x = -Inf, y = Inf),
            parse = TRUE, colour = "blue", hjust = -0.15, vjust = 5, size = 3)
ACE_Ni_final
ggsave("Papers_R/2024_DeVleeschouwer/Figure4/Plots/Fig4b_OLS_WLS_clr/1_Outliers_removed/Ni_OLS_wt/Ni_OLS_WLS_summary.pdf", 
       height = c(20), width = c(20), dpi = 600, units = "cm")
...
Ni_data_2_out <- bind_cols(Ni_data_1_out, Ni_pred.int2) %>%
  ...
  print()
write.csv(Ni_data_2_out,"Papers_R/2024_DeVleeschouwer/Figure4/Plots/Fig4b_OLS_WLS_clr/1_Outliers_removed/Ni_OLS_wt/Ni_OLS_WLS_predict.csv", row.names = FALSE)
...
ACE_Ni_predict <- ACE_Ni_final + 
  ...
  ggtitle(paste("Site: ", site_title, "; ", "Element: " , element_title, " clr [95% CI & PI]"))
ACE_Ni_predict
ggsave("Papers_R/2024_DeVleeschouwer/Figure4/Plots/Fig4b_OLS_WLS_clr/1_Outliers_removed/Ni_OLS_wt/Ni_OLS_WLS_predict.pdf", 
       height = c(16), width = c(16), dpi = 600, units = "cm")
# ACE_Cu LM  -----------------------------------------------------------------------

# Import ACE log inc normalised matched file with OSL_wt outliers removed for this element generated by Fig4b_OLS_WLS_log_inc. R code 
ACE_Cu <-read_csv("Papers_R/2024_DeVleeschouwer/Figure4/Plots/Fig4b_OLS_WLS_clr/Cu/ACE_Cu_OLS_wt_no_outliers.csv")
ACE_LM1 <- ACE_Cu
ACE_LM1
# Convert Site to use as a grouping variable
ACE_LM1$Site <- as.factor(ACE_LM1$Site)
...
ggsave("Papers_R/2024_DeVleeschouwer/Figure4/Plots/Fig4b_OLS_WLS_clr/1_Outliers_removed/Cu_OLS_wt/Cu_OLS_performance.pdf", 
       height = c(30), width = c(30), dpi = 600, units = "cm")
...
ggsave("Papers_R/2024_DeVleeschouwer/Figure4/Plots/Fig4b_OLS_WLS_clr/1_Outliers_removed/Cu_OLS_wt/Cu_OLS_wt_performance.pdf", 
       height = c(30), width = c(30), dpi = 600, units = "cm")
...
ggsave("Papers_R/2024_DeVleeschouwer/Figure4/Plots/Fig4b_OLS_WLS_clr/1_Outliers_removed/Cu_OLS_wt/Cu_WLS_performance.pdf", 
       height = c(30), width = c(30), dpi = 600, units = "cm")
...
ggsave("Papers_R/2024_DeVleeschouwer/Figure4/Plots/Fig4b_OLS_WLS_clr/1_Outliers_removed/Cu_OLS_wt/Cu_WLS_wt_performance.pdf", 
       height = c(30), width = c(30), dpi = 600, units = "cm")

# Write stats to file
# 1) OLS - write to file
sink(file = "Papers_R/2024_DeVleeschouwer/Figure4/Plots/Fig4b_OLS_WLS_clr/1_Outliers_removed/Cu_OLS_wt/Cu_OLS_summary.txt")
summary(ACE_Cu_lm)
glance(ACE_Cu_lm)
model_performance(ACE_Cu_lm) # AIC - Akaike information criterion; BIC Bayesian IC: lower = better fit for both
...
# 2) OLS weighted - write to file
sink(file = "Papers_R/2024_DeVleeschouwer/Figure4/Plots/Fig4b_OLS_WLS_clr/1_Outliers_removed/Cu_OLS_wt/Cu_OLS_wt_summary.txt")
summary(ACE_Cu_wlm)
glance(ACE_Cu_wlm)
model_performance(ACE_Cu_wlm) # AIC - Akaike information criterion; BIC Bayesian IC: lower = better fit for both
...
# 3) WLS - write to file
sink(file = "Papers_R/2024_DeVleeschouwer/Figure4/Plots/Fig4b_OLS_WLS_clr/1_Outliers_removed/Cu_OLS_wt/Cu_WLS_summary.txt")
summary(ACE_Cu_wls)
glance(ACE_Cu_wls)
model_performance(ACE_Cu_wls) # AIC - Akaike information criterion; BIC Bayesian IC: lower = better fit for both
...
# 4) WLS weighted - write to file
sink(file = "Papers_R/2024_DeVleeschouwer/Figure4/Plots/Fig4b_OLS_WLS_clr/1_Outliers_removed/Cu_OLS_wt/Cu_WLS_wt_summary.txt")
...
ACE_Cu_final <- ACE_Cu + 
  ...
  geom_text(data=data.frame(), aes(label=paste("OLS: ", ACE_Cu_lm_eqn(df)), x = -Inf, y = Inf),
            parse = TRUE, colour = "blue", hjust = -0.15, vjust = 5, size = 3)
ACE_Cu_final
ggsave("Papers_R/2024_DeVleeschouwer/Figure4/Plots/Fig4b_OLS_WLS_clr/1_Outliers_removed/Cu_OLS_wt/Cu_OLS_WLS_summary.pdf", 
       height = c(20), width = c(20), dpi = 600, units = "cm")
...
Cu_data_2_out <- bind_cols(Cu_data_1_out, Cu_pred.int2) %>%
  ...
  print()
write.csv(Cu_data_2_out,"Papers_R/2024_DeVleeschouwer/Figure4/Plots/Fig4b_OLS_WLS_clr/1_Outliers_removed/Cu_OLS_wt/Cu_OLS_WLS_predict.csv", row.names = FALSE)
...
ACE_Cu_predict <- ACE_Cu_final + 
  ...
  ggtitle(paste("Site: ", site_title, "; ", "Element: " , element_title, " clr [95% CI & PI]"))
ACE_Cu_predict
ggsave("Papers_R/2024_DeVleeschouwer/Figure4/Plots/Fig4b_OLS_WLS_clr/1_Outliers_removed/Cu_OLS_wt/Cu_OLS_WLS_predict.pdf", 
       height = c(16), width = c(16), dpi = 600, units = "cm")
# ACE_Zn LM  -----------------------------------------------------------------------

# Import ACE log inc normalised matched file with OSL_wt outliers removed for this element generated by Fig4b_OLS_WLS_log_inc. R code 
ACE_Zn <-read_csv("Papers_R/2024_DeVleeschouwer/Figure4/Plots/Fig4b_OLS_WLS_clr/Zn/ACE_Zn_OLS_wt_no_outliers.csv")
ACE_LM1 <- ACE_Zn
ACE_LM1
# Convert Site to use as a grouping variable
ACE_LM1$Site <- as.factor(ACE_LM1$Site)
...
ggsave("Papers_R/2024_DeVleeschouwer/Figure4/Plots/Fig4b_OLS_WLS_clr/1_Outliers_removed/Zn_OLS_wt/Zn_OLS_performance.pdf", 
       height = c(30), width = c(30), dpi = 600, units = "cm")
...
ggsave("Papers_R/2024_DeVleeschouwer/Figure4/Plots/Fig4b_OLS_WLS_clr/1_Outliers_removed/Zn_OLS_wt/Zn_OLS_wt_performance.pdf", 
       height = c(30), width = c(30), dpi = 600, units = "cm")
...
ggsave("Papers_R/2024_DeVleeschouwer/Figure4/Plots/Fig4b_OLS_WLS_clr/1_Outliers_removed/Zn_OLS_wt/Zn_WLS_performance.pdf", 
       height = c(30), width = c(30), dpi = 600, units = "cm")
...
ggsave("Papers_R/2024_DeVleeschouwer/Figure4/Plots/Fig4b_OLS_WLS_clr/1_Outliers_removed/Zn_OLS_wt/Zn_WLS_wt_performance.pdf", 
       height = c(30), width = c(30), dpi = 600, units = "cm") 

# Write stats to file
# 1) OLS - write to file
sink(file = "Papers_R/2024_DeVleeschouwer/Figure4/Plots/Fig4b_OLS_WLS_clr/1_Outliers_removed/Zn_OLS_wt/Zn_OLS_summary.txt")
summary(ACE_Zn_lm)
glance(ACE_Zn_lm)
model_performance(ACE_Zn_lm) # AIC - Akaike information criterion; BIC Bayesian IC: lower = better fit for both
...
# 2) OLS weighted - write to file
sink(file = "Papers_R/2024_DeVleeschouwer/Figure4/Plots/Fig4b_OLS_WLS_clr/1_Outliers_removed/Zn_OLS_wt/Zn_OLS_wt_summary.txt")
summary(ACE_Zn_wlm)
glance(ACE_Zn_wlm)
model_performance(ACE_Zn_wlm) # AIC - Akaike information criterion; BIC Bayesian IC: lower = better fit for both
...
# 3) WLS - write to file
sink(file = "Papers_R/2024_DeVleeschouwer/Figure4/Plots/Fig4b_OLS_WLS_clr/1_Outliers_removed/Zn_OLS_wt/Zn_WLS_summary.txt")
summary(ACE_Zn_wls)
glance(ACE_Zn_wls)
model_performance(ACE_Zn_wls) # AIC - Akaike information criterion; BIC Bayesian IC: lower = better fit for both
...
# 4) WLS weighted - write to file
sink(file = "Papers_R/2024_DeVleeschouwer/Figure4/Plots/Fig4b_OLS_WLS_clr/1_Outliers_removed/Zn_OLS_wt/Zn_WLS_wt_summary.txt")
...
ACE_Zn_final <- ACE_Zn + 
  ...
  geom_text(data=data.frame(), aes(label=paste("OLS: ", ACE_Zn_lm_eqn(df)), x = -Inf, y = Inf),
            parse = TRUE, colour = "blue", hjust = -0.15, vjust = 5, size = 3)
ACE_Zn_final
ggsave("Papers_R/2024_DeVleeschouwer/Figure4/Plots/Fig4b_OLS_WLS_clr/1_Outliers_removed/Zn_OLS_wt/Zn_OLS_WLS_summary.pdf", 
       height = c(20), width = c(20), dpi = 600, units = "cm")
...
Zn_data_2_out <- bind_cols(Zn_data_1_out, Zn_pred.int2) %>%
  ...
  print()
write.csv(Zn_data_2_out,"Papers_R/2024_DeVleeschouwer/Figure4/Plots/Fig4b_OLS_WLS_clr/1_Outliers_removed/Zn_OLS_wt/Zn_OLS_WLS_predict.csv", row.names = FALSE)
...
ACE_Zn_predict <- ACE_Zn_final + 
  ...
  ggtitle(paste("Site: ", site_title, "; ", "Element: " , element_title, " clr [95% CI & PI]"))
ACE_Zn_predict
ggsave("Papers_R/2024_DeVleeschouwer/Figure4/Plots/Fig4b_OLS_WLS_clr/1_Outliers_removed/Zn_OLS_wt/Zn_OLS_WLS_predict.pdf", 
       height = c(16), width = c(16), dpi = 600, units = "cm")
# ACE_Rb LM  -----------------------------------------------------------------------

# Import ACE log inc normalised matched file with OSL_wt outliers removed for this element generated by Fig4b_OLS_WLS_log_inc. R code 
ACE_Rb <-read_csv("Papers_R/2024_DeVleeschouwer/Figure4/Plots/Fig4b_OLS_WLS_clr/Rb/ACE_Rb_OLS_wt_no_outliers.csv")
ACE_LM1 <- ACE_Rb
ACE_LM1
# Convert Site to use as a grouping variable
ACE_LM1$Site <- as.factor(ACE_LM1$Site)
...
ggsave("Papers_R/2024_DeVleeschouwer/Figure4/Plots/Fig4b_OLS_WLS_clr/1_Outliers_removed/Rb_OLS_wt/Rb_OLS_performance.pdf", 
       height = c(30), width = c(30), dpi = 600, units = "cm")
...
ggsave("Papers_R/2024_DeVleeschouwer/Figure4/Plots/Fig4b_OLS_WLS_clr/1_Outliers_removed/Rb_OLS_wt/Rb_OLS_wt_performance.pdf", 
       height = c(30), width = c(30), dpi = 600, units = "cm")
...
ggsave("Papers_R/2024_DeVleeschouwer/Figure4/Plots/Fig4b_OLS_WLS_clr/1_Outliers_removed/Rb_OLS_wt/Rb_WLS_performance.pdf", 
       height = c(30), width = c(30), dpi = 600, units = "cm")
...
ggsave("Papers_R/2024_DeVleeschouwer/Figure4/Plots/Fig4b_OLS_WLS_clr/1_Outliers_removed/Rb_OLS_wt/Rb_WLS_wt_performance.pdf", 
       height = c(30), width = c(30), dpi = 600, units = "cm")

# Write stats to file
# 1) OLS - write to file
sink(file = "Papers_R/2024_DeVleeschouwer/Figure4/Plots/Fig4b_OLS_WLS_clr/1_Outliers_removed/Rb_OLS_wt/Rb_OLS_summary.txt")
summary(ACE_Rb_lm)
glance(ACE_Rb_lm)
model_performance(ACE_Rb_lm) # AIC - Akaike information criterion; BIC Bayesian IC: lower = better fit for both
...
# 2) OLS weighted - write to file
sink(file = "Papers_R/2024_DeVleeschouwer/Figure4/Plots/Fig4b_OLS_WLS_clr/1_Outliers_removed/Rb_OLS_wt/Rb_OLS_wt_summary.txt")
summary(ACE_Rb_wlm)
glance(ACE_Rb_wlm)
model_performance(ACE_Rb_wlm) # AIC - Akaike information criterion; BIC Bayesian IC: lower = better fit for both
...
# 3) WLS - write to file
sink(file = "Papers_R/2024_DeVleeschouwer/Figure4/Plots/Fig4b_OLS_WLS_clr/1_Outliers_removed/Rb_OLS_wt/Rb_WLS_summary.txt")
summary(ACE_Rb_wls)
glance(ACE_Rb_wls)
model_performance(ACE_Rb_wls) # AIC - Akaike information criterion; BIC Bayesian IC: lower = better fit for both
...
# 4) WLS weighted - write to file
sink(file = "Papers_R/2024_DeVleeschouwer/Figure4/Plots/Fig4b_OLS_WLS_clr/1_Outliers_removed/Rb_OLS_wt/Rb_WLS_wt_summary.txt")
...
ACE_Rb_final <- ACE_Rb + 
  ...
  geom_text(data=data.frame(), aes(label=paste("OLS: ", ACE_Rb_lm_eqn(df)), x = -Inf, y = Inf),
            parse = TRUE, colour = "blue", hjust = -0.15, vjust = 5, size = 3)
ACE_Rb_final
ggsave("Papers_R/2024_DeVleeschouwer/Figure4/Plots/Fig4b_OLS_WLS_clr/1_Outliers_removed/Rb_OLS_wt/Rb_OLS_WLS_summary.pdf", 
       height = c(20), width = c(20), dpi = 600, units = "cm")
...
Rb_data_2_out <- bind_cols(Rb_data_1_out, Rb_pred.int2) %>%
  ...
  print()
write.csv(Rb_data_2_out,"Papers_R/2024_DeVleeschouwer/Figure4/Plots/Fig4b_OLS_WLS_clr/1_Outliers_removed/Rb_OLS_wt/Rb_OLS_WLS_predict.csv", row.names = FALSE)
...
ACE_Rb_predict <- ACE_Rb_final + 
  ...
  ggtitle(paste("Site: ", site_title, "; ", "Element: " , element_title, " clr [95% CI & PI]"))
ACE_Rb_predict
ggsave("Papers_R/2024_DeVleeschouwer/Figure4/Plots/Fig4b_OLS_WLS_clr/1_Outliers_removed/Rb_OLS_wt/Rb_OLS_WLS_predict.pdf", 
       height = c(16), width = c(16), dpi = 600, units = "cm")
...
ggsave("Papers_R/2024_DeVleeschouwer/Figure4/Plots/Fig4b_OLS_WLS_clr/1_Outliers_removed/DM_OLS_wt/DM_OLS_performance.pdf", 
       height = c(30), width = c(30), dpi = 600, units = "cm")
# Write summary stats/checks to txt file
sink(file = "Papers_R/2024_DeVleeschouwer/Figure4/Plots/Fig4b_OLS_WLS_clr/1_Outliers_removed/DM_OLS_wt/DM_OLS_summary.txt")
summary(ACE_DM_lm)
glance(ACE_DM_lm)
model_performance(ACE_DM_lm) # AIC - Akaike information criterion; BIC Bayesian IC: lower = better fit for both
...
ggsave("Papers_R/2024_DeVleeschouwer/Figure4/Plots/Fig4b_OLS_WLS_clr/1_Outliers_removed/DM_OLS_wt/DM_OLS_wt_performance.pdf", 
       height = c(30), width = c(30), dpi = 600, units = "cm")
# Write summary stats/checks to txt file
sink(file = "Papers_R/2024_DeVleeschouwer/Figure4/Plots/Fig4b_OLS_WLS_clr/1_Outliers_removed/DM_OLS_wt/DM_OLS_wt_summary.txt")
summary(ACE_DM_wlm)
glance(ACE_DM_wlm)
model_performance(ACE_DM_wlm) # AIC - Akaike information criterion; BIC Bayesian IC: lower = better fit for both
...
ggsave("Papers_R/2024_DeVleeschouwer/Figure4/Plots/Fig4b_OLS_WLS_clr/1_Outliers_removed/DM_OLS_wt/DM_WLS_performance.pdf", 
       height = c(30), width = c(30), dpi = 600, units = "cm")
# Write summary stats/checks to txt file
sink(file = "Papers_R/2024_DeVleeschouwer/Figure4/Plots/Fig4b_OLS_WLS_clr/1_Outliers_removed/DM_OLS_wt/DM_WLS_summary.txt")
summary(ACE_DM_wls)
glance(ACE_DM_wls)
model_performance(ACE_DM_wls) # AIC - Akaike information criterion; BIC Bayesian IC: lower = better fit for both
...
ggsave("Papers_R/2024_DeVleeschouwer/Figure4/Plots/Fig4b_OLS_WLS_clr/1_Outliers_removed/DM_OLS_wt/DM_WLS_wt_performance.pdf", 
       height = c(30), width = c(30), dpi = 600, units = "cm")
# Write summary stats/checks to txt file
sink(file = "Papers_R/2024_DeVleeschouwer/Figure4/Plots/Fig4b_OLS_WLS_clr/1_Outliers_removed/DM_OLS_wt/DM_WLS_wt_summary.txt")
...
ACE_DM_final <- ACE_DM + 
  ...
  geom_text(data=data.frame(), aes(label=paste("OLS: ", ACE_DM_lm_eqn(df)), x = -Inf, y = Inf),
            parse = TRUE, colour = "blue", hjust = -0.15, vjust = 5, size = 3)
ACE_DM_final
ggsave("Papers_R/2024_DeVleeschouwer/Figure4/Plots/Fig4b_OLS_WLS_clr/1_Outliers_removed/DM_OLS_wt/DM_OLS_WLS_summary.pdf", 
       height = c(20), width = c(20), dpi = 600, units = "cm")
...
ggsave("Papers_R/2024_DeVleeschouwer/Figure4/Plots/Fig4b_OLS_WLS_clr/ACE_FigS4c_OLS_WLS_clr_OLS_wt_no_outliers_predict.pdf",
