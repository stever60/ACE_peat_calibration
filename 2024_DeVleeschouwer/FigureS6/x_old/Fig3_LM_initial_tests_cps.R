...
# ICP elements to use - defined by Francois
...
# XRF elements defined by XRF-CS acf and matched to Francois ICPMS element list above
...
ACE_xrf_icp_matched_input <-read_csv("Papers_R/2024_DeVleeschouwer/Figure2/Data/Output/ACE_Subsample_icp_xrf_cps_matched.csv")
...
Ca_corr1
ggsave("Papers_R/2024_DeVleeschouwer/Figure3/Plots/Fig3_LM_Tests_cps/Ca/Ca_Fig3.1_Correlation_OLS_all_sites.pdf", 
...
ggsave("Papers_R/2024_DeVleeschouwer/Figure3/Plots/Fig3_LM_Tests_cps/Ca/Ca_Fig3.2_Data_OLS_Sites.pdf", 
...
write.csv(data_1_out,"Papers_R/2024_DeVleeschouwer/Figure3/Plots/Fig3_LM_Tests_cps/Ca/Ca_Model_predict.csv", row.names = FALSE)
...
ggdraw(Ca_predict)
ggsave("Papers_R/2024_DeVleeschouwer/Figure3/Plots/Fig3_LM_Tests_cps/Ca/Ca_Fig3.3a_LM-OLS_predict.pdf", 
       height = c(16), width = c(16), dpi = 600, units = "cm")
...
ggsave("Papers_R/2024_DeVleeschouwer/Figure3/Plots/Fig3_LM_Tests_cps/Ca/Ca_Fig3.3_OLS_tests.pdf", 
       height = c(30), width = c(30), dpi = 600, units = "cm")
...
sink(file = "Papers_R/2024_DeVleeschouwer/Figure3/Plots/Fig3_LM_Tests_cps/Ca/Ca_Summary_stats.txt")
print(correlate_LM1)
print(ctest_LM1)
...
Ti_corr1 <- ggscatter(ACE_LM1, x = "Ti", y = "Ti_ICP",
  ...
  theme(axis.text = element_text(size=10), axis.title = element_text(size=10), plot.title = element_text(size=10, face="bold"))
Ti_corr1
ggsave("Papers_R/2024_DeVleeschouwer/Figure3/Plots/Fig3_LM_Tests_cps/Ti/Ti_Fig3.1_Correlation_OLS_all_sites.pdf", 
       height = c(16), width = c(16), dpi = 600, units = "cm")
...
ggarrange(Ti_XRF_violin_boxplot, Ti_ICP_violin_boxplot, Ti_corr2, Ti_corr3, ncol = 2, 
          nrow = 2, labels = c("a", "b", "c", "d"))
ggsave("Papers_R/2024_DeVleeschouwer/Figure3/Plots/Fig3_LM_Tests_cps/Ti/Ti_Fig3.2_Data_OLS_Sites.pdf", 
       height = c(30), width = c(30), dpi = 600, units = "cm")
...
write.csv(data_1_out,"Papers_R/2024_DeVleeschouwer/Figure3/Plots/Fig3_LM_Tests_cps/Ti/Ti_Model_predict.csv", row.names = FALSE)
...
Ti_predict <- Ti_p1 + geom_line(aes(y = lwr), color = "blue", linetype = "dashed") +
  ...
  theme(plot.title = element_text(color="black", size=12, face="bold"),
        ...
        axis.text.y = element_text(size=10))
Ti_predict
ggsave("Papers_R/2024_DeVleeschouwer/Figure3/Plots/Fig3_LM_Tests_cps/Ti/Ti_Fig3.3a_LM-OLS_predict.pdf", 
       height = c(16), width = c(16), dpi = 600, units = "cm")
...
ggarrange(Ti_predict,  Ti_qq.x1, Ti_res, Ti_qq.y1,
          ncol = 2, nrow = 2, labels = c("a", "b", "c", "d"))
ggsave("Papers_R/2024_DeVleeschouwer/Figure3/Plots/Fig3_LM_Tests_cps/Ti/Ti_Fig3.3_OLS_tests.pdf", 
       height = c(30), width = c(30), dpi = 600, units = "cm")
...
# Write summary stats/normality & residual checks output to txt file
sink(file = "Papers_R/2024_DeVleeschouwer/Figure3/Plots/Fig3_LM_Tests_cps/Ti/Ti_Summary_stats.txt")
print(correlate_LM1)
print(ctest_LM1)
print(summary(model_1))
print(confint(model_1))
...
Mn_corr1 <- ggscatter(ACE_LM1, x = "Mn", y = "Mn_ICP",
  ...
  theme(axis.text = element_text(size=10), axis.title = element_text(size=10), plot.title = element_text(size=10, face="bold"))
Mn_corr1
ggsave("Papers_R/2024_DeVleeschouwer/Figure3/Plots/Fig3_LM_Tests_cps/Mn/Mn_Fig3.1_Correlation_OLS_all_sites.pdf", 
       height = c(16), width = c(16), dpi = 600, units = "cm")
...
ggarrange(Mn_XRF_violin_boxplot, Mn_ICP_violin_boxplot, Mn_corr2, Mn_corr3, ncol = 2, 
          nrow = 2, labels = c("a", "b", "c", "d"))
ggsave("Papers_R/2024_DeVleeschouwer/Figure3/Plots/Fig3_LM_Tests_cps/Mn/Mn_Fig3.2_Data_OLS_Sites.pdf", 
       height = c(30), width = c(30), dpi = 600, units = "cm")
...
write.csv(data_1_out,"Papers_R/2024_DeVleeschouwer/Figure3/Plots/Fig3_LM_Tests_cps/Mn/Mn_Model_predict.csv", row.names = FALSE)
...
Mn_predict <- Mn_p1 + geom_line(aes(y = lwr), color = "blue", linetype = "dashed") +
  ...
  theme(plot.title = element_text(color="black", size=12, face="bold"),
        ...
        axis.text.y = element_text(size=10))
Mn_predict
ggsave("Papers_R/2024_DeVleeschouwer/Figure3/Plots/Fig3_LM_Tests_cps/Mn/Mn_Fig3.3a_LM-OLS_predict.pdf", 
       height = c(16), width = c(16), dpi = 600, units = "cm")
...
ggarrange(Mn_predict,  Mn_qq.x1, Mn_res, Mn_qq.y1,
          ncol = 2, nrow = 2, labels = c("a", "b", "c", "d"))
ggsave("Papers_R/2024_DeVleeschouwer/Figure3/Plots/Fig3_LM_Tests_cps/Mn/Mn_Fig3.3_OLS_tests.pdf", 
       height = c(30), width = c(30), dpi = 600, units = "cm")
...
# Write summary stats/normality & residual checks output to txt file
sink(file = "Papers_R/2024_DeVleeschouwer/Figure3/Plots/Fig3_LM_Tests_cps/Mn/Mn_Summary_stats.txt")
print(correlate_LM1)
print(ctest_LM1)
print(summary(model_1))
print(confint(model_1))
...
Fe_corr1 <- ggscatter(ACE_LM1, x = "Fe", y = "Fe_ICP",
  ...
  theme(axis.text = element_text(size=10), axis.title = element_text(size=10), plot.title = element_text(size=10, face="bold"))
Fe_corr1
ggsave("Papers_R/2024_DeVleeschouwer/Figure3/Plots/Fig3_LM_Tests_cps/Fe/Fe_Fig3.1_Correlation_OLS_all_sites.pdf", 
       height = c(16), width = c(16), dpi = 600, units = "cm")
...
ggarrange(Fe_XRF_violin_boxplot, Fe_ICP_violin_boxplot, Fe_corr2, Fe_corr3, ncol = 2, 
          nrow = 2, labels = c("a", "b", "c", "d"))
ggsave("Papers_R/2024_DeVleeschouwer/Figure3/Plots/Fig3_LM_Tests_cps/Fe/Fe_Fig3.2_Data_OLS_Sites.pdf", 
       height = c(30), width = c(30), dpi = 600, units = "cm")
...
write.csv(data_1_out,"Papers_R/2024_DeVleeschouwer/Figure3/Plots/Fig3_LM_Tests_cps/Fe/Fe_Model_predict.csv", row.names = FALSE)
...
Fe_predict <- Fe_p1 + geom_line(aes(y = lwr), color = "blue", linetype = "dashed") +
  ...
  theme(plot.title = element_text(color="black", size=12, face="bold"),
        ...
        axis.text.y = element_text(size=10))
Fe_predict
ggsave("Papers_R/2024_DeVleeschouwer/Figure3/Plots/Fig3_LM_Tests_cps/Fe/Fe_Fig3.3a_LM-OLS_predict.pdf", 
       height = c(16), width = c(16), dpi = 600, units = "cm")
...
ggarrange(Fe_predict,  Fe_qq.x1, Fe_res, Fe_qq.y1,
          ncol = 2, nrow = 2, labels = c("a", "b", "c", "d"))
ggsave("Papers_R/2024_DeVleeschouwer/Figure3/Plots/Fig3_LM_Tests_cps/Fe/Fe_Fig3.3_OLS_tests.pdf", 
       height = c(30), width = c(30), dpi = 600, units = "cm")
...
# Write summary stats/normality & residual checks output to txt file
sink(file = "Papers_R/2024_DeVleeschouwer/Figure3/Plots/Fig3_LM_Tests_cps/Fe/Fe_Summary_stats.txt")
print(correlate_LM1)
print(ctest_LM1)
print(summary(model_1))
print(confint(model_1))
...
Sr_corr1 <- ggscatter(ACE_LM1, x = "Sr", y = "Sr_ICP",
  ...
  theme(axis.text = element_text(size=10), axis.title = element_text(size=10), plot.title = element_text(size=10, face="bold"))
Sr_corr1
ggsave("Papers_R/2024_DeVleeschouwer/Figure3/Plots/Fig3_LM_Tests_cps/Sr/Sr_Fig3.1_Correlation_OLS_all_sites.pdf", 
       height = c(16), width = c(16), dpi = 600, units = "cm")
...
ggarrange(Sr_XRF_violin_boxplot, Sr_ICP_violin_boxplot, Sr_corr2, Sr_corr3, ncol = 2, 
          nrow = 2, labels = c("a", "b", "c", "d"))
ggsave("Papers_R/2024_DeVleeschouwer/Figure3/Plots/Fig3_LM_Tests_cps/Sr/Sr_Fig3.2_Data_OLS_Sites.pdf", 
       height = c(30), width = c(30), dpi = 600, units = "cm")
...
write.csv(data_1_out,"Papers_R/2024_DeVleeschouwer/Figure3/Plots/Fig3_LM_Tests_cps/Sr/Sr_Model_predict.csv", row.names = FALSE)
...
Sr_predict <- Sr_p1 + geom_line(aes(y = lwr), color = "blue", linetype = "dashed") +
  ...
  theme(plot.title = element_text(color="black", size=12, face="bold"),
        ...
        axis.text.y = element_text(size=10))
Sr_predict
ggsave("Papers_R/2024_DeVleeschouwer/Figure3/Plots/Fig3_LM_Tests_cps/Sr/Sr_Fig3.3a_LM-OLS_predict.pdf", 
       height = c(16), width = c(16), dpi = 600, units = "cm")
...
ggarrange(Sr_predict,  Sr_qq.x1, Sr_res, Sr_qq.y1,
          ncol = 2, nrow = 2, labels = c("a", "b", "c", "d"))
ggsave("Papers_R/2024_DeVleeschouwer/Figure3/Plots/Fig3_LM_Tests_cps/Sr/Sr_Fig3.3_OLS_tests.pdf", 
       height = c(30), width = c(30), dpi = 600, units = "cm")
...
# Write summary stats/normality & residual checks output to txt file
sink(file = "Papers_R/2024_DeVleeschouwer/Figure3/Plots/Fig3_LM_Tests_cps/Sr/Sr_Summary_stats.txt")
print(correlate_LM1)
print(ctest_LM1)
print(summary(model_1))
print(confint(model_1))
...
Zr_corr1 <- ggscatter(ACE_LM1, x = "Zr", y = "Zr_ICP",
  ...
  theme(axis.text = element_text(size=10), axis.title = element_text(size=10), plot.title = element_text(size=10, face="bold"))
Zr_corr1
ggsave("Papers_R/2024_DeVleeschouwer/Figure3/Plots/Fig3_LM_Tests_cps/Zr/Zr_Fig3.1_Correlation_OLS_all_sites.pdf", 
       height = c(16), width = c(16), dpi = 600, units = "cm")
...
ggarrange(Zr_XRF_violin_boxplot, Zr_ICP_violin_boxplot, Zr_corr2, Zr_corr3, ncol = 2, 
          nrow = 2, labels = c("a", "b", "c", "d"))
ggsave("Papers_R/2024_DeVleeschouwer/Figure3/Plots/Fig3_LM_Tests_cps/Zr/Zr_Fig3.2_Data_OLS_Sites.pdf", 
       height = c(30), width = c(30), dpi = 600, units = "cm")
...
write.csv(data_1_out,"Papers_R/2024_DeVleeschouwer/Figure3/Plots/Fig3_LM_Tests_cps/Zr/Zr_Model_predict.csv", row.names = FALSE)
...
Zr_predict <- Zr_p1 + geom_line(aes(y = lwr), color = "blue", linetype = "dashed") +
  ...
  theme(plot.title = element_text(color="black", size=12, face="bold"),
        ...
        axis.text.y = element_text(size=10))
Zr_predict
ggsave("Papers_R/2024_DeVleeschouwer/Figure3/Plots/Fig3_LM_Tests_cps/Zr/Zr_Fig3.3a_LM-OLS_predict.pdf", 
       height = c(16), width = c(16), dpi = 600, units = "cm")
...
ggarrange(Zr_predict,  Zr_qq.x1, Zr_res, Zr_qq.y1,
          ncol = 2, nrow = 2, labels = c("a", "b", "c", "d"))
ggsave("Papers_R/2024_DeVleeschouwer/Figure3/Plots/Fig3_LM_Tests_cps/Zr/Zr_Fig3.3_OLS_tests.pdf", 
       height = c(30), width = c(30), dpi = 600, units = "cm")
...
# Write summary stats/normality & residual checks output to txt file
sink(file = "Papers_R/2024_DeVleeschouwer/Figure3/Plots/Fig3_LM_Tests_cps/Zr/Zr_Summary_stats.txt")
print(correlate_LM1)
print(ctest_LM1)
print(summary(model_1))
print(confint(model_1))
...
K_corr1 <- ggscatter(ACE_LM1, x = "K", y = "K_ICP",
  ...
  theme(axis.text = element_text(size=10), axis.title = element_text(size=10), plot.title = element_text(size=10, face="bold"))
K_corr1
ggsave("Papers_R/2024_DeVleeschouwer/Figure3/Plots/Fig3_LM_Tests_cps/K/K_Fig3.1_Correlation_OLS_all_sites.pdf", 
       height = c(16), width = c(16), dpi = 600, units = "cm")
...
ggarrange(K_XRF_violin_boxplot, K_ICP_violin_boxplot, K_corr2, K_corr3, ncol = 2, 
          nrow = 2, labels = c("a", "b", "c", "d"))
ggsave("Papers_R/2024_DeVleeschouwer/Figure3/Plots/Fig3_LM_Tests_cps/K/K_Fig3.2_Data_OLS_Sites.pdf", 
       height = c(30), width = c(30), dpi = 600, units = "cm")
...
data_1_out <- bind_cols(ACE_LM1, pred.int1) %>%
  ...
  print()
write.csv(data_1_out,"Papers_R/2024_DeVleeschouwer/Figure3/Plots/Fig3_LM_Tests_cps/K/K_Model_predict.csv", row.names = FALSE)
...
K_predict <- K_p1 + geom_line(aes(y = lwr), color = "blue", linetype = "dashed") +
  ...
  theme(plot.title = element_text(color="black", size=12, face="bold"),
        ...
        axis.text.y = element_text(size=10))
K_predict
ggsave("Papers_R/2024_DeVleeschouwer/Figure3/Plots/Fig3_LM_Tests_cps/K/K_Fig3.3a_LM-OLS_predict.pdf", 
       height = c(16), width = c(16), dpi = 600, units = "cm")
...
ggarrange(K_predict,  K_qq.x1, K_res, K_qq.y1,
          ncol = 2, nrow = 2, labels = c("a", "b", "c", "d"))
ggsave("Papers_R/2024_DeVleeschouwer/Figure3/Plots/Fig3_LM_Tests_cps/K/K_Fig3.3_OLS_tests.pdf", 
       height = c(30), width = c(30), dpi = 600, units = "cm")
...
# Write summary stats/normality & residual checks output to txt file
sink(file = "Papers_R/2024_DeVleeschouwer/Figure3/Plots/Fig3_LM_Tests_cps/K/K_Summary_stats.txt")
print(correlate_LM1)
print(ctest_LM1)
print(summary(model_1))
print(confint(model_1))
...
Co_corr1 <- ggscatter(ACE_LM1, x = "Co", y = "Co_ICP",
  ...
  theme(axis.text = element_text(size=10), axis.title = element_text(size=10), plot.title = element_text(size=10, face="bold"))
Co_corr1
ggsave("Papers_R/2024_DeVleeschouwer/Figure3/Plots/Fig3_LM_Tests_cps/Co/Co_Fig3.1_Correlation_OLS_all_sites.pdf", 
       height = c(16), width = c(16), dpi = 600, units = "cm")
...
ggarrange(Co_XRF_violin_boxplot, Co_ICP_violin_boxplot, Co_corr2, Co_corr3, ncol = 2, 
          nrow = 2, labels = c("a", "b", "c", "d"))
ggsave("Papers_R/2024_DeVleeschouwer/Figure3/Plots/Fig3_LM_Tests_cps/Co/Co_Fig3.2_Data_OLS_Sites.pdf", 
       height = c(30), width = c(30), dpi = 600, units = "cm")
...
write.csv(data_1_out,"Papers_R/2024_DeVleeschouwer/Figure3/Plots/Fig3_LM_Tests_cps/Co/Co_Model_predict.csv", row.names = FALSE)
...
Co_predict <- Co_p1 + geom_line(aes(y = lwr), color = "blue", linetype = "dashed") +
  ...
  theme(plot.title = element_text(color="black", size=12, face="bold"),
        ...
        axis.text.y = element_text(size=10))
Co_predict
ggsave("Papers_R/2024_DeVleeschouwer/Figure3/Plots/Fig3_LM_Tests_cps/Co/Co_Fig3.3a_LM-OLS_predict.pdf", 
       height = c(16), width = c(16), dpi = 600, units = "cm")
...
ggarrange(Co_predict,  Co_qq.x1, Co_res, Co_qq.y1,
          ncol = 2, nrow = 2, labels = c("a", "b", "c", "d"))
ggsave("Papers_R/2024_DeVleeschouwer/Figure3/Plots/Fig3_LM_Tests_cps/Co/Co_Fig3.3_OLS_tests.pdf", 
       height = c(30), width = c(30), dpi = 600, units = "cm")
...
# Write summary stats/normality & residual checks output to txt file
sink(file = "Papers_R/2024_DeVleeschouwer/Figure3/Plots/Fig3_LM_Tests_cps/Co/Co_Summary_stats.txt")
print(correlate_LM1)
print(ctest_LM1)
print(summary(model_1))
print(confint(model_1))
...
Ni_corr1 <- ggscatter(ACE_LM1, x = "Ni", y = "Ni_ICP",
  ...
  theme(axis.text = element_text(size=10), axis.title = element_text(size=10), plot.title = element_text(size=10, face="bold"))
Ni_corr1
ggsave("Papers_R/2024_DeVleeschouwer/Figure3/Plots/Fig3_LM_Tests_cps/Ni/Ni_Fig3.1_Correlation_OLS_all_sites.pdf", 
       height = c(16), width = c(16), dpi = 600, units = "cm")
...
ggarrange(Ni_XRF_violin_boxplot, Ni_ICP_violin_boxplot, Ni_corr2, Ni_corr3, ncol = 2, 
          nrow = 2, labels = c("a", "b", "c", "d"))
ggsave("Papers_R/2024_DeVleeschouwer/Figure3/Plots/Fig3_LM_Tests_cps/Ni/Ni_Fig3.2_Data_OLS_Sites.pdf", 
       height = c(30), width = c(30), dpi = 600, units = "cm")
...
write.csv(data_1_out,"Papers_R/2024_DeVleeschouwer/Figure3/Plots/Fig3_LM_Tests_cps/Ni/Ni_Model_predict.csv", row.names = FALSE)
...
ggarrange(Ni_predict,  Ni_qq.x1, Ni_res, Ni_qq.y1,
          ncol = 2, nrow = 2, labels = c("a", "b", "c", "d"))
ggsave("Papers_R/2024_DeVleeschouwer/Figure3/Plots/Fig3_LM_Tests_cps/Ni/Ni_Fig3.3_OLS_tests.pdf", 
       height = c(30), width = c(30), dpi = 600, units = "cm")
...
# Write summary stats/normality & residual checks output to txt file
sink(file = "Papers_R/2024_DeVleeschouwer/Figure3/Plots/Fig3_LM_Tests_cps/Ni/Ni_Summary_stats.txt")
print(correlate_LM1)
print(ctest_LM1)
print(summary(model_1))
print(confint(model_1))
...
Cu_corr1 <- ggscatter(ACE_LM1, x = "Cu", y = "Cu_ICP",
  ...
  theme(axis.text = element_text(size=10), axis.title = element_text(size=10), plot.title = element_text(size=10, face="bold"))
Cu_corr1
ggsave("Papers_R/2024_DeVleeschouwer/Figure3/Plots/Fig3_LM_Tests_cps/Cu/Cu_Fig3.1_Correlation_OLS_all_sites.pdf", 
       height = c(16), width = c(16), dpi = 600, units = "cm")
...
ggarrange(Cu_XRF_violin_boxplot, Cu_ICP_violin_boxplot, Cu_corr2, Cu_corr3, ncol = 2, 
          nrow = 2, labels = c("a", "b", "c", "d"))
ggsave("Papers_R/2024_DeVleeschouwer/Figure3/Plots/Fig3_LM_Tests_cps/Cu/Cu_Fig3.2_Data_OLS_Sites.pdf", 
       height = c(30), width = c(30), dpi = 600, units = "cm")
...
write.csv(data_1_out,"Papers_R/2024_DeVleeschouwer/Figure3/Plots/Fig3_LM_Tests_cps/Cu/Cu_Model_predict.csv", row.names = FALSE)
...
Cu_predict <- Cu_p1 + geom_line(aes(y = lwr), color = "blue", linetype = "dashed") +
  ...
  theme(plot.title = element_text(color="black", size=12, face="bold"),
        ...
        axis.text.y = element_text(size=10))
Cu_predict
ggsave("Papers_R/2024_DeVleeschouwer/Figure3/Plots/Fig3_LM_Tests_cps/Cu/Cu_Fig3.3a_LM-OLS_predict.pdf", 
       height = c(16), width = c(16), dpi = 600, units = "cm")
...
ggarrange(Cu_predict,  Cu_qq.x1, Cu_res, Cu_qq.y1,
          ncol = 2, nrow = 2, labels = c("a", "b", "c", "d"))
ggsave("Papers_R/2024_DeVleeschouwer/Figure3/Plots/Fig3_LM_Tests_cps/Cu/Cu_Fig3.3_OLS_tests.pdf", 
       height = c(30), width = c(30), dpi = 600, units = "cm")
...
# Write summary stats/normality & residual checks output to txt file
sink(file = "Papers_R/2024_DeVleeschouwer/Figure3/Plots/Fig3_LM_Tests_cps/Cu/Cu_Summary_stats.txt")
print(correlate_LM1)
print(ctest_LM1)
print(summary(model_1))
print(confint(model_1))
...
Zn_corr1 <- ggscatter(ACE_LM1, x = "Zn", y = "Zn_ICP",
  ...
  theme(axis.text = element_text(size=10), axis.title = element_text(size=10), plot.title = element_text(size=10, face="bold"))
Zn_corr1
ggsave("Papers_R/2024_DeVleeschouwer/Figure3/Plots/Fig3_LM_Tests_cps/Zn/Zn_Fig3.1_Correlation_OLS_all_sites.pdf", 
       height = c(16), width = c(16), dpi = 600, units = "cm")
...
ggarrange(Zn_XRF_violin_boxplot, Zn_ICP_violin_boxplot, Zn_corr2, Zn_corr3, ncol = 2, 
          nrow = 2, labels = c("a", "b", "c", "d"))
ggsave("Papers_R/2024_DeVleeschouwer/Figure3/Plots/Fig3_LM_Tests_cps/Zn/Zn_Fig3.2_Data_OLS_Sites.pdf", 
       height = c(30), width = c(30), dpi = 600, units = "cm")
...
write.csv(data_1_out,"Papers_R/2024_DeVleeschouwer/Figure3/Plots/Fig3_LM_Tests_cps/Zn/Zn_Model_predict.csv", row.names = FALSE)
...
Zn_predict <- Zn_p1 + geom_line(aes(y = lwr), color = "blue", linetype = "dashed") +
  ...
  theme(plot.title = element_text(color="black", size=12, face="bold"),
        ...
        axis.text.y = element_text(size=10))
Zn_predict
ggsave("Papers_R/2024_DeVleeschouwer/Figure3/Plots/Fig3_LM_Tests_cps/Zn/Zn_Fig3.3a_LM-OLS_predict.pdf", 
       height = c(16), width = c(16), dpi = 600, units = "cm")
...
ggarrange(Zn_predict,  Zn_qq.x1, Zn_res, Zn_qq.y1,
          ncol = 2, nrow = 2, labels = c("a", "b", "c", "d"))
ggsave("Papers_R/2024_DeVleeschouwer/Figure3/Plots/Fig3_LM_Tests_cps/Zn/Zn_Fig3.3_OLS_tests.pdf", 
       height = c(30), width = c(30), dpi = 600, units = "cm")
...
# Write summary stats/normality & residual checks output to txt file
sink(file = "Papers_R/2024_DeVleeschouwer/Figure3/Plots/Fig3_LM_Tests_cps/Zn/Zn_Summary_stats.txt")
print(correlate_LM1)
print(ctest_LM1)
print(summary(model_1))
print(confint(model_1))
...
Rb_corr1 <- ggscatter(ACE_LM1, x = "Rb", y = "Rb_ICP",
  ...
  theme(axis.text = element_text(size=10), axis.title = element_text(size=10), plot.title = element_text(size=10, face="bold"))
Rb_corr1
ggsave("Papers_R/2024_DeVleeschouwer/Figure3/Plots/Fig3_LM_Tests_cps/Rb/Rb_Fig3.1_Correlation_OLS_all_sites.pdf", 
       height = c(16), width = c(16), dpi = 600, units = "cm")
...
ggarrange(Rb_XRF_violin_boxplot, Rb_ICP_violin_boxplot, Rb_corr2, Rb_corr3, ncol = 2, 
          nrow = 2, labels = c("a", "b", "c", "d"))
ggsave("Papers_R/2024_DeVleeschouwer/Figure3/Plots/Fig3_LM_Tests_cps/Rb/Rb_Fig3.2_Data_OLS_Sites.pdf", 
       height = c(30), width = c(30), dpi = 600, units = "cm")
...
write.csv(data_1_out,"Papers_R/2024_DeVleeschouwer/Figure3/Plots/Fig3_LM_Tests_cps/Rb/Rb_Model_predict.csv", row.names = FALSE)
...
Rb_predict <- Rb_p1 + geom_line(aes(y = lwr), color = "blue", linetype = "dashed") +
  ...
  theme(plot.title = element_text(color="black", size=12, face="bold"),
        ...
        axis.text.y = element_text(size=10))
Rb_predict
ggsave("Papers_R/2024_DeVleeschouwer/Figure3/Plots/Fig3_LM_Tests_cps/Rb/Rb_Fig3.3a_LM-OLS_predict.pdf", 
       height = c(16), width = c(16), dpi = 600, units = "cm")
...
ggarrange(Rb_predict,  Rb_qq.x1, Rb_res, Rb_qq.y1,
          ncol = 2, nrow = 2, labels = c("a", "b", "c", "d"))
ggsave("Papers_R/2024_DeVleeschouwer/Figure3/Plots/Fig3_LM_Tests_cps/Rb/Rb_Fig3.3_OLS_tests.pdf", 
       height = c(30), width = c(30), dpi = 600, units = "cm")
...
# Write summary stats/normality & residual checks output to txt file
sink(file = "Papers_R/2024_DeVleeschouwer/Figure3/Plots/Fig3_LM_Tests_cps/Rb/Rb_Summary_stats.txt")
print(correlate_LM1)
print(ctest_LM1)
print(summary(model_1))
print(confint(model_1))
...
DM_corr1 <- ggscatter(ACE_LM1, x = "coh_inc", y = "dry_mass_pc",
  ...
  theme(axis.text = element_text(size=10), axis.title = element_text(size=10), plot.title = element_text(size=10, face="bold"))
DM_corr1
ggsave("Papers_R/2024_DeVleeschouwer/Figure3/Plots/Fig3_LM_Tests_cps/DM/DM_Fig3.1_Correlation_OLS_all_sites.pdf", 
       height = c(16), width = c(16), dpi = 600, units = "cm")
...
ggarrange(DM_XRF_violin_boxplot, DM_pc_violin_boxplot, DM_corr2, DM_corr3, ncol = 2, 
          nrow = 2, labels = c("a", "b", "c", "d"))
ggsave("Papers_R/2024_DeVleeschouwer/Figure3/Plots/Fig3_LM_Tests_cps/DM/DM_Fig3.2_Data_OLS_Sites.pdf", 
       height = c(30), width = c(30), dpi = 600, units = "cm")
...
write.csv(data_1_out,"Papers_R/2024_DeVleeschouwer/Figure3/Plots/Fig3_LM_Tests_cps/DM/DM_Model_predict.csv", row.names = FALSE)
...
DM_predict <- DM_p1 + geom_line(aes(y = lwr), color = "blue", linetype = "dashed") +
  ...
  theme(plot.title = element_text(color="black", size=12, face="bold"),
        ...
        axis.text.y = element_text(size=10))
DM_predict
ggsave("Papers_R/2024_DeVleeschouwer/Figure3/Plots/Fig3_LM_Tests_cps/DM/DM_Fig3.3a_LM-OLS_predict.pdf", 
       height = c(16), width = c(16), dpi = 600, units = "cm")
...
ggarrange(DM_predict,  DM_qq.x1, DM_res, DM_qq.y1,
          ncol = 2, nrow = 2, labels = c("a", "b", "c", "d"))
ggsave("Papers_R/2024_DeVleeschouwer/Figure3/Plots/Fig3_LM_Tests_cps/DM/DM_Fig3.3_OLS_tests.pdf", 
       height = c(30), width = c(30), dpi = 600, units = "cm")
...
# Write summary stats/normality & residual checks output to txt file
sink(file = "Papers_R/2024_DeVleeschouwer/Figure3/Plots/Fig3_LM_Tests_cps/DM/DM_Summary_stats.txt")
print(correlate_LM1)
print(ctest_LM1)
print(summary(model_1))
print(confint(model_1))
