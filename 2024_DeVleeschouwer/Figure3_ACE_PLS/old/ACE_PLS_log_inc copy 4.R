...
capture.output(summary(pls_train_model_LOO), file = "Papers_R/2024_DeVleeschouwer/ACE_PLS/Output/PLSR/log_inc/PLS_model_LOO_summary_Ti.txt")
...
pdf("Papers_R/2024_DeVleeschouwer/ACE_PLS/Output/PLSR/log_inc/PLS_rmsep_plot_LOO.pdf", width = 4, height = 4)
...
sink("Papers_R/2024_DeVleeschouwer/ACE_PLS/Output/PLSR/log_inc/RMSEP_Jackknife_all_LOO.txt")
...
# Save summary output to a text file
capture.output(summary(pls_train_model_CV), file = "Papers_R/2024_DeVleeschouwer/ACE_PLS/Output/PLSR/log_inc/PLS_model_CV_summary_Ti.txt")

# Plot RMSEP to screen to choose number of components - where first becomes flat
plot(RMSEP(pls_train_model_CV), legendpos = "topright")

# Open a PDF in device
pdf("Papers_R/2024_DeVleeschouwer/ACE_PLS/Output/PLSR/log_inc/PLS_rmsep_plot_CV.pdf", width = 4, height = 4)
...
sink("Papers_R/2024_DeVleeschouwer/ACE_PLS/Output/PLSR/log_inc/RMSEP_Jackknife_all_CV.txt")
cat("RMSEP values for ICP elements:\n\n")
cat("Ti_ICP RMSEP:\n")
...
# Open a PDF in device
pdf("Papers_R/2024_DeVleeschouwer/ACE_PLS/Output/PLSR/log_inc/PLS_BIC_plot.pdf", width = 4, height = 4)
...
plot_measured_vs_predicted_log(
  ...
  palette_set = "jco",
  eq_text <- list("Ti" = "italic(y) == 1.0097*Ti + -0.6045*Ca + 0.5207*Sr + 0.2086*Zr"),
  output_path = "Papers_R/2024_DeVleeschouwer/ACE_PLS/Output/PLSR/log_inc/Ti_plsr_log_inc_as_log.pdf"
)
...
PLS_final_ppm_Ca <- ggplot(df_predicted_ppm, aes(x = Ca_ICP_pred_ppm, y = Ca_ICP, color = Site)) +
  ...
  annotate("text", x = 0, y = 38000, label = eq_text_Ca_ppm, parse = TRUE, hjust = 0) + 
...
PLS_final_ppm_Zr <- ggplot(df_predicted_ppm, aes(x = Zr_ICP_pred_ppm, y = Zr_ICP, color = Site)) +
  ...
  theme(plot.title = element_text(color="black", size=12, face="bold"),
        ...
        axis.text.x = element_text(size=12),
        axis.text.y = element_text(size=12)) +
  annotate("text", x = 0, y = 1000, label = RMSE_text_Zr, parse = TRUE, hjust = 0) + 
  annotate("text", x = 0, y = 950, label = eq_text_Zr_ppm, parse = TRUE, hjust = 0) + 
  annotate("text", x = 0, y = 900, label = R2_text_Zr, parse = TRUE, hjust = 0)
...
ACE_PLS_ppm_pred_log_inc <- read_csv("Papers_R/2024_DeVleeschouwer/ACE_PLS/Output/PLSR/log_inc/ACE_PLS_ppm_pred_log_inc.csv")
...
HER42PB_PLS_ppm_pred_clr <-read_csv("Papers_R/2024_DeVleeschouwer/ACE_PLS/Output/PLSR/clr/HER42PB/HER42PB_PLS_ppm_pred_clr.csv")
...
BI10_PLS_ppm_pred_clr <-read_csv("Papers_R/2024_DeVleeschouwer/ACE_PLS/Output/PLSR/clr/BI10/BI10_PLS_ppm_pred_clr.csv")
...
KER1_PLS_ppm_pred_clr <-read_csv("Papers_R/2024_DeVleeschouwer/ACE_PLS/Output/PLSR/clr/KER1/KER1_PLS_ppm_pred_clr.csv")
...
KER3_PLS_ppm_pred_clr <-read_csv("Papers_R/2024_DeVleeschouwer/ACE_PLS/Output/PLSR/clr/KER3/KER3_PLS_ppm_pred_clr.csv")
...
PB1_PLS_ppm_pred_clr <-read_csv("Papers_R/2024_DeVleeschouwer/ACE_PLS/Output/PLSR/clr/PB1/PB1_PLS_ppm_pred_clr.csv")
...
ggsave("Papers_R/2024_DeVleeschouwer/ACE_PLS/Output/PLSR/log_inc/Fig4_ACE_PLS_Ti.pdf",
...
ggsave("Papers_R/2024_DeVleeschouwer/ACE_PLS/Output/PLSR/log_inc/Fig4_ACE_PLS_Ti5.pdf",
...
#   df_wls = HER42PB_WLS_ppm_pred_log_inc,
#   df_icp = HER42PB_ICP,
#   save_path = "Papers_R/2024_DeVleeschouwer/ACE_PLS/Output/PLSR/log_inc/HER42PB/P1_HER42PB_Ca_log_inc_PLS_WLS_depth.pdf"
# )
# 
# P2 Define inputs & save
plot_log_inc_clr_vs_depth(
  ...
  df_clr = HER42PB_PLS_ppm_pred_clr,
  df_icp = HER42PB_ICP,
  save_path = "Papers_R/2024_DeVleeschouwer/ACE_PLS/Output/PLSR/log_inc/HER42PB/P2_HER42PB_Ca_PLS_log_inc_clr_depth.pdf"
)
...
#   df_wls = HER42PB_WLS_ppm_pred_log_inc,
#   df_icp = HER42PB_ICP,
#   save_path = "Papers_R/2024_DeVleeschouwer/ACE_PLS/Output/PLSR/log_inc/HER42PB/P3_HER42PB_Ca_log_inc_PLS_WLS_age.pdf"
# )
# 
# P4 Define inputs & save
plot_log_inc_clr_vs_age(
  ...
  df_clr = HER42PB_PLS_ppm_pred_clr,
  df_icp = HER42PB_ICP,
  save_path = "Papers_R/2024_DeVleeschouwer/ACE_PLS/Output/PLSR/log_inc/HER42PB/P4_HER42PB_Ca_PLS_log_inc_clr_age.pdf"
)
...
#   df_wls = BI10_WLS_ppm_pred_log_inc,
#   df_icp = BI10_ICP,
#   save_path = "Papers_R/2024_DeVleeschouwer/ACE_PLS/Output/PLSR/log_inc/BI10/P1_BI10_Ca_log_inc_PLS_WLS_depth.pdf"
# )
# 
# P2 Define inputs & save
plot_log_inc_clr_vs_depth(
  ...
  df_clr = BI10_PLS_ppm_pred_clr,
  df_icp = BI10_ICP,
  save_path = "Papers_R/2024_DeVleeschouwer/ACE_PLS/Output/PLSR/log_inc/BI10/P2_BI10_Ca_PLS_log_inc_clr_depth.pdf"
)
...
#   df_wls = BI10_WLS_ppm_pred_log_inc,
#   df_icp = BI10_ICP,
#   save_path = "Papers_R/2024_DeVleeschouwer/ACE_PLS/Output/PLSR/log_inc/BI10/P3_BI10_Ca_log_inc_PLS_WLS_age.pdf"
# )
# 
# P4 Define inputs & save
plot_log_inc_clr_vs_age(
  ...
  df_clr = BI10_PLS_ppm_pred_clr,
  df_icp = BI10_ICP,
  save_path = "Papers_R/2024_DeVleeschouwer/ACE_PLS/Output/PLSR/log_inc/BI10/P4_BI10_Ca_PLS_log_inc_clr_age.pdf"
)
...
#   df_wls = KER1_WLS_ppm_pred_log_inc,
#   df_icp = KER1_ICP,
#   save_path = "Papers_R/2024_DeVleeschouwer/ACE_PLS/Output/PLSR/log_inc/KER1/P1_KER1_Ca_log_inc_PLS_WLS_depth.pdf"
# )
# 
# P2 Define inputs & save
plot_log_inc_clr_vs_depth(
  ...
  df_clr = KER1_PLS_ppm_pred_clr,
  df_icp = KER1_ICP,
  save_path = "Papers_R/2024_DeVleeschouwer/ACE_PLS/Output/PLSR/log_inc/KER1/P2_KER1_Ca_PLS_log_inc_clr_depth.pdf"
)
# 
# KER1 Age - multiple plots & overlays --------------------------------------
# 
...
#   df_wls = KER1_WLS_ppm_pred_log_inc,
#   df_icp = KER1_ICP,
#   save_path = "Papers_R/2024_DeVleeschouwer/ACE_PLS/Output/PLSR/log_inc/KER1/P3_KER1_Ca_log_inc_PLS_WLS_age.pdf"
# )
# 
# P4 Define inputs & save
plot_log_inc_clr_vs_age(
  ...
  df_clr = KER1_PLS_ppm_pred_clr,
  df_icp = KER1_ICP,
  save_path = "Papers_R/2024_DeVleeschouwer/ACE_PLS/Output/PLSR/log_inc/KER1/P4_KER1_Ca_PLS_log_inc_clr_age.pdf"
)
# 
# -------------------------------------------------------------------------
# KER3 Depth - ICPMS overlay ------------------------------------------------
...
#   df_wls = KER3_WLS_ppm_pred_log_inc,
#   df_icp = KER3_ICP,
#   save_path = "Papers_R/2024_DeVleeschouwer/ACE_PLS/Output/PLSR/log_inc/KER3/P1_KER3_Ca_log_inc_PLS_WLS_depth.pdf"
# )
# 
# P2 Define inputs & save
plot_log_inc_clr_vs_depth(
  ...
  df_clr = KER3_PLS_ppm_pred_clr,
  df_icp = KER3_ICP,
  save_path = "Papers_R/2024_DeVleeschouwer/ACE_PLS/Output/PLSR/log_inc/KER3/P2_KER3_Ca_PLS_log_inc_clr_depth.pdf"
)
...
#   df_wls = KER3_WLS_ppm_pred_log_inc,
#   df_icp = KER3_ICP,
#   save_path = "Papers_R/2024_DeVleeschouwer/ACE_PLS/Output/PLSR/log_inc/KER3/P3_KER3_Ca_log_inc_PLS_WLS_age.pdf"
# )
# 
# P4 Define inputs & save
plot_log_inc_clr_vs_age(
  ...
  df_clr = KER3_PLS_ppm_pred_clr,
  df_icp = KER3_ICP,
  save_path = "Papers_R/2024_DeVleeschouwer/ACE_PLS/Output/PLSR/log_inc/KER3/P4_KER3_Ca_PLS_log_inc_clr_age.pdf"
)
...
#   df_wls = PB1_WLS_ppm_pred_log_inc,
#   df_icp = PB1_ICP,
#   save_path = "Papers_R/2024_DeVleeschouwer/ACE_PLS/Output/PLSR/log_inc/PB1/P1_PB1_Ca_log_inc_PLS_WLS_depth.pdf"
# )
# 
# # P2 Define inputs & save
# plot_log_inc_clr_vs_depth(
...
#   df_clr = PB1_PLS_ppm_pred_clr,
#   df_icp = PB1_ICP,
#   save_path = "Papers_R/2024_DeVleeschouwer/ACE_PLS/Output/PLSR/log_inc/PB1/P2_PB1_Ca_PLS_log_inc_clr_depth.pdf"
# )
...
#   df_wls = PB1_WLS_ppm_pred_log_inc,
#   df_icp = PB1_ICP,
#   save_path = "Papers_R/2024_DeVleeschouwer/ACE_PLS/Output/PLSR/log_inc/PB1/P3_PB1_Ca_log_inc_PLS_WLS_age.pdf"
# )
# 
# # P4 Define inputs & save
# plot_log_inc_clr_vs_age(
...
#   df_clr = PB1_PLS_ppm_pred_clr,
#   df_icp = PB1_ICP,
#   save_path = "Papers_R/2024_DeVleeschouwer/ACE_PLS/Output/PLSR/log_inc/PB1/P4_PB1_Ca_PLS_log_inc_clr_age.pdf"
# )
# 
# this doesn't work for Ca
# Matrix plots -----------------------------------------------------------------
...
ggarrange(BI10_depth_Ca, HER42PB_depth_Ca, KER1_depth_Ca, KER3_depth_Ca, PB1_depth_Ca,
          ncol = 5, nrow = 1, common.legend = TRUE)
ggsave("Papers_R/2024_DeVleeschouwer/ACE_PLS/Output/PLSR/log_inc/Fig4_ACE_PLS_Ca.pdf",
       height = c(15), width = c(40), dpi = 600, units = "cm")
...
#   df_wls = HER42PB_WLS_ppm_pred_log_inc,
#   df_icp = HER42PB_ICP,
#   save_path = "Papers_R/2024_DeVleeschouwer/ACE_PLS/Output/PLSR/log_inc/HER42PB/P1_HER42PB_Sr_log_inc_PLS_WLS_depth.pdf"
# )
# 
# P2 Define inputs & save
plot_log_inc_clr_vs_depth(
  ...
  df_clr = HER42PB_PLS_ppm_pred_clr,
  df_icp = HER42PB_ICP,
  save_path = "Papers_R/2024_DeVleeschouwer/ACE_PLS/Output/PLSR/log_inc/HER42PB/P2_HER42PB_Sr_PLS_log_inc_clr_depth.pdf"
)
...
#   df_wls = HER42PB_WLS_ppm_pred_log_inc,
#   df_icp = HER42PB_ICP,
#   save_path = "Papers_R/2024_DeVleeschouwer/ACE_PLS/Output/PLSR/log_inc/HER42PB/P3_HER42PB_Sr_log_inc_PLS_WLS_age.pdf"
# )
# 
# P4 Define inputs & save
plot_log_inc_clr_vs_age(
  ...
  df_clr = HER42PB_PLS_ppm_pred_clr,
  df_icp = HER42PB_ICP,
  save_path = "Papers_R/2024_DeVleeschouwer/ACE_PLS/Output/PLSR/log_inc/HER42PB/P4_HER42PB_Sr_PLS_log_inc_clr_age.pdf"
)
...
#   df_wls = BI10_WLS_ppm_pred_log_inc,
#   df_icp = BI10_ICP,
#   save_path = "Papers_R/2024_DeVleeschouwer/ACE_PLS/Output/PLSR/log_inc/BI10/P1_BI10_Sr_log_inc_PLS_WLS_depth.pdf"
# )
# 
# P2 Define inputs & save
plot_log_inc_clr_vs_depth(
  ...
  df_clr = BI10_PLS_ppm_pred_clr,
  df_icp = BI10_ICP,
  save_path = "Papers_R/2024_DeVleeschouwer/ACE_PLS/Output/PLSR/log_inc/BI10/P2_BI10_Sr_PLS_log_inc_clr_depth.pdf"
)
# 
# BI10 Age - multiple plots & overlays --------------------------------------
# 
...
#   df_wls = BI10_WLS_ppm_pred_log_inc,
#   df_icp = BI10_ICP,
#   save_path = "Papers_R/2024_DeVleeschouwer/ACE_PLS/Output/PLSR/log_inc/BI10/P3_BI10_Sr_log_inc_PLS_WLS_age.pdf"
# )
# 
# P4 Define inputs & save
plot_log_inc_clr_vs_age(
  ...
  df_clr = BI10_PLS_ppm_pred_clr,
  df_icp = BI10_ICP,
  save_path = "Papers_R/2024_DeVleeschouwer/ACE_PLS/Output/PLSR/log_inc/BI10/P4_BI10_Sr_PLS_log_inc_clr_age.pdf"
)
...
#   df_wls = KER1_WLS_ppm_pred_log_inc,
#   df_icp = KER1_ICP,
#   save_path = "Papers_R/2024_DeVleeschouwer/ACE_PLS/Output/PLSR/log_inc/KER1/P1_KER1_Sr_log_inc_PLS_WLS_depth.pdf"
# )
# 
# P2 Define inputs & save
plot_log_inc_clr_vs_depth(
  ...
  df_clr = KER1_PLS_ppm_pred_clr,
  df_icp = KER1_ICP,
  save_path = "Papers_R/2024_DeVleeschouwer/ACE_PLS/Output/PLSR/log_inc/KER1/P2_KER1_Sr_PLS_log_inc_clr_depth.pdf"
)
...
#   df_wls = KER1_WLS_ppm_pred_log_inc,
#   df_icp = KER1_ICP,
#   save_path = "Papers_R/2024_DeVleeschouwer/ACE_PLS/Output/PLSR/log_inc/KER1/P3_KER1_Sr_log_inc_PLS_WLS_age.pdf"
# )
# 
# P4 Define inputs & save
plot_log_inc_clr_vs_age(
  ...
  df_clr = KER1_PLS_ppm_pred_clr,
  df_icp = KER1_ICP,
  save_path = "Papers_R/2024_DeVleeschouwer/ACE_PLS/Output/PLSR/log_inc/KER1/P4_KER1_Sr_PLS_log_inc_clr_age.pdf"
)
...
#   df_wls = KER3_WLS_ppm_pred_log_inc,
#   df_icp = KER3_ICP,
#   save_path = "Papers_R/2024_DeVleeschouwer/ACE_PLS/Output/PLSR/log_inc/KER3/P1_KER3_Sr_log_inc_PLS_WLS_depth.pdf"
# )
# 
# P2 Define inputs & save
plot_log_inc_clr_vs_depth(
  ...
  df_clr = KER3_PLS_ppm_pred_clr,
  df_icp = KER3_ICP,
  save_path = "Papers_R/2024_DeVleeschouwer/ACE_PLS/Output/PLSR/log_inc/KER3/P2_KER3_Sr_PLS_log_inc_clr_depth.pdf"
)
...
#   df_wls = KER3_WLS_ppm_pred_log_inc,
#   df_icp = KER3_ICP,
#   save_path = "Papers_R/2024_DeVleeschouwer/ACE_PLS/Output/PLSR/log_inc/KER3/P3_KER3_Sr_log_inc_PLS_WLS_age.pdf"
# )
...
plot_log_inc_clr_vs_age(
  ...
  df_clr = KER3_PLS_ppm_pred_clr,
  df_icp = KER3_ICP,
  save_path = "Papers_R/2024_DeVleeschouwer/ACE_PLS/Output/PLSR/log_inc/KER3/P4_KER3_Sr_PLS_log_inc_clr_age.pdf"
)
...
#   df_wls = PB1_WLS_ppm_pred_log_inc,
#   df_icp = PB1_ICP,
#   save_path = "Papers_R/2024_DeVleeschouwer/ACE_PLS/Output/PLSR/log_inc/PB1/P1_PB1_Sr_log_inc_PLS_WLS_depth.pdf"
# )
# 
# P2 Define inputs & save
plot_log_inc_clr_vs_depth(
  ...
  df_clr = PB1_PLS_ppm_pred_clr,
  df_icp = PB1_ICP,
  save_path = "Papers_R/2024_DeVleeschouwer/ACE_PLS/Output/PLSR/log_inc/PB1/P2_PB1_Sr_PLS_log_inc_clr_depth.pdf"
)
...
#   df_wls = PB1_WLS_ppm_pred_log_inc,
#   df_icp = PB1_ICP,
#   save_path = "Papers_R/2024_DeVleeschouwer/ACE_PLS/Output/PLSR/log_inc/PB1/P3_PB1_Sr_log_inc_PLS_WLS_age.pdf"
# )
# 
# P4 Define inputs & save
plot_log_inc_clr_vs_age(
  ...
  df_clr = PB1_PLS_ppm_pred_clr,
  df_icp = PB1_ICP,
  save_path = "Papers_R/2024_DeVleeschouwer/ACE_PLS/Output/PLSR/log_inc/PB1/P4_PB1_Sr_PLS_log_inc_clr_age.pdf"
)
...
ggarrange(BI10_depth_Sr, HER42PB_depth_Sr, KER1_depth_Sr, KER3_depth_Sr, PB1_depth_Sr,
          ncol = 5, nrow = 1, common.legend = TRUE)
ggsave("Papers_R/2024_DeVleeschouwer/ACE_PLS/Output/PLSR/log_inc/Fig4_ACE_PLS_Sr.pdf",
       height = c(15), width = c(40), dpi = 600, units = "cm")
...
#   df_wls = HER42PB_WLS_ppm_pred_log_inc,
#   df_icp = HER42PB_ICP,
#   save_path = "Papers_R/2024_DeVleeschouwer/ACE_PLS/Output/PLSR/log_inc/HER42PB/P1_HER42PB_Zr_log_inc_PLS_WLS_depth.pdf"
# )
...
plot_log_inc_clr_vs_depth(
  ...
  df_clr = HER42PB_PLS_ppm_pred_clr,
  df_icp = HER42PB_ICP,
  save_path = "Papers_R/2024_DeVleeschouwer/ACE_PLS/Output/PLSR/log_inc/HER42PB/P2_HER42PB_Zr_PLS_log_inc_clr_depth.pdf"
)
...
#   df_wls = HER42PB_WLS_ppm_pred_log_inc,
#   df_icp = HER42PB_ICP,
#   save_path = "Papers_R/2024_DeVleeschouwer/ACE_PLS/Output/PLSR/log_inc/HER42PB/P3_HER42PB_Zr_log_inc_PLS_WLS_age.pdf"
# )
...
plot_log_inc_clr_vs_age(
  ...
  df_clr = HER42PB_PLS_ppm_pred_clr,
  df_icp = HER42PB_ICP,
  save_path = "Papers_R/2024_DeVleeschouwer/ACE_PLS/Output/PLSR/log_inc/HER42PB/P4_HER42PB_Zr_PLS_log_inc_clr_age.pdf"
)
...
#   df_wls = BI10_WLS_ppm_pred_log_inc,
#   df_icp = BI10_ICP,
#   save_path = "Papers_R/2024_DeVleeschouwer/ACE_PLS/Output/PLSR/log_inc/BI10/P1_BI10_Zr_log_inc_PLS_WLS_depth.pdf"
# )
...
plot_log_inc_clr_vs_depth(
  ...
  df_clr = BI10_PLS_ppm_pred_clr,
  df_icp = BI10_ICP,
  save_path = "Papers_R/2024_DeVleeschouwer/ACE_PLS/Output/PLSR/log_inc/BI10/P2_BI10_Zr_PLS_log_inc_clr_depth.pdf"
)
...
#   df_wls = BI10_WLS_ppm_pred_log_inc,
#   df_icp = BI10_ICP,
#   save_path = "Papers_R/2024_DeVleeschouwer/ACE_PLS/Output/PLSR/log_inc/BI10/P3_BI10_Zr_log_inc_PLS_WLS_age.pdf"
# )
...
plot_log_inc_clr_vs_age(
  ...
  df_clr = BI10_PLS_ppm_pred_clr,
  df_icp = BI10_ICP,
  save_path = "Papers_R/2024_DeVleeschouwer/ACE_PLS/Output/PLSR/log_inc/BI10/P4_BI10_Zr_PLS_log_inc_clr_age.pdf"
)
...
#   df_wls = KER1_WLS_ppm_pred_log_inc,
#   df_icp = KER1_ICP,
#   save_path = "Papers_R/2024_DeVleeschouwer/ACE_PLS/Output/PLSR/log_inc/KER1/P1_KER1_Zr_log_inc_PLS_WLS_depth.pdf"
# )
...
plot_log_inc_clr_vs_depth(
  ...
  df_clr = KER1_PLS_ppm_pred_clr,
  df_icp = KER1_ICP,
  save_path = "Papers_R/2024_DeVleeschouwer/ACE_PLS/Output/PLSR/log_inc/KER1/P2_KER1_Zr_PLS_log_inc_clr_depth.pdf"
)
...
#   df_wls = KER1_WLS_ppm_pred_log_inc,
#   df_icp = KER1_ICP,
#   save_path = "Papers_R/2024_DeVleeschouwer/ACE_PLS/Output/PLSR/log_inc/KER1/P3_KER1_Zr_log_inc_PLS_WLS_age.pdf"
# )
...
plot_log_inc_clr_vs_age(
  ...
  df_clr = KER1_PLS_ppm_pred_clr,
  df_icp = KER1_ICP,
  save_path = "Papers_R/2024_DeVleeschouwer/ACE_PLS/Output/PLSR/log_inc/KER1/P4_KER1_Zr_PLS_log_inc_clr_age.pdf"
)
...
#   df_wls = KER3_WLS_ppm_pred_log_inc,
#   df_icp = KER3_ICP,
#   save_path = "Papers_R/2024_DeVleeschouwer/ACE_PLS/Output/PLSR/log_inc/KER3/P1_KER3_Zr_log_inc_PLS_WLS_depth.pdf"
# )
...
plot_log_inc_clr_vs_depth(
  ...
  df_clr = KER3_PLS_ppm_pred_clr,
  df_icp = KER3_ICP,
  save_path = "Papers_R/2024_DeVleeschouwer/ACE_PLS/Output/PLSR/log_inc/KER3/P2_KER3_Zr_PLS_log_inc_clr_depth.pdf"
)
...
#   df_wls = KER3_WLS_ppm_pred_log_inc,
#   df_icp = KER3_ICP,
#   save_path = "Papers_R/2024_DeVleeschouwer/ACE_PLS/Output/PLSR/log_inc/KER3/P3_KER3_Zr_log_inc_PLS_WLS_age.pdf"
# )
...
plot_log_inc_clr_vs_age(
  ...
  df_clr = KER3_PLS_ppm_pred_clr,
  df_icp = KER3_ICP,
  save_path = "Papers_R/2024_DeVleeschouwer/ACE_PLS/Output/PLSR/log_inc/KER3/P4_KER3_Zr_PLS_log_inc_clr_age.pdf"
)
...
#   df_wls = PB1_WLS_ppm_pred_log_inc,
#   df_icp = PB1_ICP,
#   save_path = "Papers_R/2024_DeVleeschouwer/ACE_PLS/Output/PLSR/log_inc/PB1/P1_PB1_Zr_log_inc_PLS_WLS_depth.pdf"
# )
...
plot_log_inc_clr_vs_depth(
  ...
  df_clr = PB1_PLS_ppm_pred_clr,
  df_icp = PB1_ICP,
  save_path = "Papers_R/2024_DeVleeschouwer/ACE_PLS/Output/PLSR/log_inc/PB1/P2_PB1_Zr_PLS_log_inc_clr_depth.pdf"
)
...
#   df_wls = PB1_WLS_ppm_pred_log_inc,
#   df_icp = PB1_ICP,
#   save_path = "Papers_R/2024_DeVleeschouwer/ACE_PLS/Output/PLSR/log_inc/PB1/P3_PB1_Zr_log_inc_PLS_WLS_age.pdf"
# )
...
plot_log_inc_clr_vs_age(
  ...
  df_clr = PB1_PLS_ppm_pred_clr,
  df_icp = PB1_ICP,
  save_path = "Papers_R/2024_DeVleeschouwer/ACE_PLS/Output/PLSR/log_inc/PB1/P4_PB1_Zr_PLS_log_inc_clr_age.pdf"
)
...
ggarrange(BI10_depth_Zr, KER1_depth_Zr, KER3_depth_Zr, PB1_depth_Zr,
          ncol = 4, nrow = 1, common.legend = TRUE)
ggsave("Papers_R/2024_DeVleeschouwer/ACE_PLS/Output/PLSR/log_inc/Fig4_ACE_PLS_Zr1.pdf",
       height = c(15), width = c(30), dpi = 600, units = "cm")

# Summary 5x1 matrix ACE PLS Zr & Supp info
ggarrange(BI10_depth_Zr, HER42PB_depth_Zr, KER1_depth_Zr, KER3_depth_Zr, PB1_depth_Zr,
          ncol = 5, nrow = 1, common.legend = TRUE)
ggsave("Papers_R/2024_DeVleeschouwer/ACE_PLS/Output/PLSR/log_inc/Fig4_ACE_PLS_Zr.pdf",
...
summary(pls_model)
# Save summary output to a text file
capture.output(summary(pls_model), file = "Papers_R/2024_DeVleeschouwer/ACE_PLS/Output/PLSR/log_inc/Bootstrap_pls_model_summary.txt")
