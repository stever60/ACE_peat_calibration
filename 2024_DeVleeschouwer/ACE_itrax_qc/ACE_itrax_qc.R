...
ACE_xrf <- ACE_COMP %>% 
  ...
  select(-c(filename, position_mm, `accrate_cmyr-1`,
            strat_depth_top,E_gain:F_offset, S1:S3)) %>% 
...
ACE_xrf_stats <- ACE_xrf %>%
  ...
  print()
tail(ACE_xrf_stats)
write.csv(ACE_xrf_stats,"Papers_R/2024_DeVleeschouwer/ACE_itrax_qc/Output/itrax_Composite/qc_acf/Section2/ACE_xrf_cps_stats.csv", row.names = FALSE)

# SECTION 3: Quality control & Element Filtering -------------------------------------------------------------------------

# Import ACE cps dataset and remove POB4 and BI5 data
setwd("/Users/sjro/Dropbox/BAS/Data/R/")
ACE_xrf <- read_csv("Papers_R/2024_DeVleeschouwer/ACE_itrax_qc/Output/itrax_Composite/qc_acf/Section2/ACE_xrf_cps.csv") %>% 
  filter(!(Site =='POB4')) %>% # measured under different ITRAX conditions
...
ggsave("Papers_R/2024_DeVleeschouwer/ACE_itrax_qc/Output/itrax_Composite/qc_acf/Section3/Figures/Fig3.1_QC.pdf", 
...
write.csv(ACE_xrf_qc_cps,"Papers_R/2024_DeVleeschouwer/ACE_itrax_qc/Output/itrax_Composite/qc_acf/Section3/ACE_xrf_qc_cps.csv", row.names = FALSE)
...
ggsave("Papers_R/2024_DeVleeschouwer/ACE_itrax_qc/Output/itrax_Composite/qc_acf/Section3/Figures/Fig3.2_ACE_xrf_qc_BI10.pdf", 
       height = c(30), width = c(30), dpi = 600, units = "cm")

# SECTION 3B: Select dataset to take forward ------------------------------------------

# load qc dataset from above back in
ACE_xrf_qc <- read_csv("Papers_R/2024_DeVleeschouwer/ACE_itrax_qc/Output/itrax_Composite/qc_acf/Section3/ACE_xrf_qc_cps.csv")
...
write.csv(ACE_xrf_qc_stats,"Papers_R/2024_DeVleeschouwer/ACE_itrax_qc/Output/itrax_Composite/qc_acf/Section3/ACE_xrf_qc_stats.csv", row.names = FALSE)
write.csv(ACE_SNR_stats,"Papers_R/2024_DeVleeschouwer/ACE_itrax_qc/Output/itrax_Composite/qc_acf/Section3/ACE_xrf_qc_SNR_stats.csv", row.names = FALSE)

# SECTION 3D: ACF element filtering ------------------------------------------

ACE_xrf_qc <- read_csv("Papers_R/2024_DeVleeschouwer/ACE_itrax_qc/Output/itrax_Composite/qc_acf/Section3/ACE_xrf_qc.csv")
...
Fig3.3 <- ggarrange(
  ...
  nrow = 4, ncol = 3)
print(Fig3.3)
ggsave("Papers_R/2024_DeVleeschouwer/ACE_itrax_qc/Output/itrax_Composite/qc_acf/Section3/Figures/Fig3.3_ACF_pt1.pdf", 
       height = c(30), width = c(30), dpi = 600, units = "cm")
...
Fig3.4 <- ggarrange(
  ...
  nrow = 4, ncol = 3)
print(Fig3.4)
ggsave("Papers_R/2024_DeVleeschouwer/ACE_itrax_qc/Output/itrax_Composite/qc_acf/Section3/Figures/Fig3.4_ACF_pt2.pdf", 
       height = c(30), width = c(30), dpi = 600, units = "cm")
...
print(Fig3.5a)
ggsave("Papers_R/2024_DeVleeschouwer/ACE_itrax_qc/Output/itrax_Composite/qc_acf/Section3/Figures/Fig3.5a_ACF_all_elements.pdf", 
...
Fig3.5b <- apply(ACE_xrf_qc %>% select(any_of(acfElements_min)), #OR acfElements_max
  ...
  geom_dl(aes(label = elements), method = list(dl.trans(x = x + 0.5), "last.points", cex = 0.5)) # adds element labels to end
print(Fig3.5b)
ggsave("Papers_R/2024_DeVleeschouwer/ACE_itrax_qc/Output/itrax_Composite/qc_acf/Section3/Figures/Fig3.5b_ACF_elements.pdf", 
       height = c(10), width = c(10), dpi = 600, units = "cm")
...
print(Fig3.6)
ggsave("Papers_R/2024_DeVleeschouwer/ACE_itrax_qc/Output/itrax_Composite/qc_acf/Section3/Figures/Fig3.6_All_Sites_ACFmin.pdf", 
...
ggsave("Papers_R/2024_DeVleeschouwer/ACE_itrax_qc/Output/itrax_Composite/qc_acf/Section3/Figures/Fig3.7_All_Sites_ACF_min.pdf", 
       height = c(30), width = c(30), dpi = 600, units = "cm")
...
ggsave("Papers_R/2024_DeVleeschouwer/ACE_itrax_qc/Output/itrax_Composite/qc_acf/Section4/Figures/Fig4_A-B.pdf", 
       height = c(30), width = c(30), dpi = 600, units = "cm")

# nested ggarrange to produce split level summary plot with different number of plots per row
ggarrange(Fig3.10, Fig3.11, nrow = 2, labels = c("C", "D"), common.legend = FALSE)
ggsave("Papers_R/2024_DeVleeschouwer/ACE_itrax_qc/Output/itrax_Composite/qc_acf/Section4/Figures/Fig4_C-D.pdf", 
       height = c(30), width = c(30), dpi = 600, units = "cm")

# nested ggarrange to produce split level summary plot with different number of plots per row
ggarrange(Fig3.12, Fig3.13, nrow = 2, labels = c("E", "F"), common.legend = FALSE)
ggsave("Papers_R/2024_DeVleeschouwer/ACE_itrax_qc/Output/itrax_Composite/qc_acf/Section3/Figures/Fig4_E-F.pdf", 
       height = c(30), width = c(30), dpi = 600, units = "cm")
...
ACE_xrf_qc <- read_csv("Papers_R/2024_DeVleeschouwer/ACE_itrax_qc/Output/itrax_Composite/qc_acf/Section2/ACE_xrf_cps.csv") 
...
ACE_xrf_qc_SNR_stats <- read_csv("Papers_R/2024_DeVleeschouwer/ACE_itrax_qc/Output/itrax_Composite/qc_acf/Section3/ACE_xrf_qc_SNR_stats.csv")
...
# Save QC xrf dataset to use and stats to file
write.csv(ACE_xrf_qc_acf,"Papers_R/2024_DeVleeschouwer/ACE_itrax_qc/Output/itrax_Composite/qc_acf/Section5/ACE_xrf_qc_acf_cps.csv", row.names = FALSE)
write.csv(ACE_xrf_qc_acf_stats,"Papers_R/2024_DeVleeschouwer/ACE_itrax_qc/Output/itrax_Composite/qc_acf/Section5/ACE_xrf_qc_acf_stats.csv", row.names = FALSE)

# SECTION 6A: Create %cps, /inc, clr datasets for calibration exercise -----------------

# Import the qc and element filtered dataset ------------------------------
ACE_xrf_qc_acf <- read_csv("Papers_R/2024_DeVleeschouwer/ACE_itrax_qc/Output/itrax_Composite/qc_acf/Section5/ACE_xrf_qc_acf.csv") 
ACE_xrf_qc_acf
...
write.csv(ACE_xrf_qc_acf_pc,"Papers_R/2024_DeVleeschouwer/ACE_itrax_qc/Output/itrax_Composite/qc_acf/Section6/ACE_xrf_qc_acf_pc.csv", row.names = FALSE)
...
ACE_xrf_qc_acf_pc_stats <- ACE_xrf_qc_acf_pc %>%
  ...
  as_tibble(rownames="rowname")  %>%
  print()
write.csv(ACE_xrf_qc_acf_pc_stats,"Papers_R/2024_DeVleeschouwer/ACE_itrax_qc/Output/itrax_Composite/qc_acf/Section6/ACE_xrf_qc_acf_pc_stats.csv", row.names = FALSE)
...
write.csv(ACE_xrf_qc_acf_inc,"Papers_R/2024_DeVleeschouwer/ACE_itrax_qc/Output/itrax_Composite/qc_acf/Section6/ACE_xrf_qc_acf_inc.csv", row.names = FALSE)
...
write.csv(ACE_xrf_qc_acf_inc_Z1,"Papers_R/2024_DeVleeschouwer/ACE_itrax_qc/Output/itrax_Composite/qc_acf/Section6/ACE_xrf_qc_acf_inc_Z.csv", row.names = FALSE)
...
ACE_xrf_qc_acf_CIR <- ACE_xrf_qc_acf %>%
  ...
  mutate_if(is.numeric, list(~na_if(., Inf)))
ACE_xrf_qc_acf_CIR
write.csv(ACE_xrf_qc_acf_CIR,"Papers_R/2024_DeVleeschouwer/ACE_itrax_qc/Output/itrax_Composite/qc_acf/Section6/ACE_xrf_qc_acf_CIR.csv", row.names = FALSE)
...
# write.csv(ACE_xrf_qc_acf_clr,"Papers_R/2024_DeVleeschouwer/ACE_itrax_qc/Output/itrax_Composite/qc_acf/Section6/ACE_xrf_qc_acf_clr.csv", row.names = FALSE)
# ACE_xrf_qc_acf_clr
...
ACE_xrf_qc_acf_cps <- read_csv("Papers_R/2024_DeVleeschouwer/ACE_itrax_qc/Output/itrax_Composite/qc_acf/Section5/ACE_xrf_qc_acf.csv") 
ACE_xrf_qc_acf_cps
library(tidypaleo)
theme_set(theme_bw(base_size=8))
...
ggsave("Papers_R/2024_DeVleeschouwer/ACE_itrax_qc/Output/itrax_Composite/qc_acf/Section6/Figures/Fig6.1-6.2_cps.pdf", 
       height = c(30), width = c(30), dpi = 600, units = "cm")

# nested ggarrange to produce split level summary plot with different number of plots per row
ggarrange(Fig6.3, Fig6.4, nrow = 2, labels = c("C", "D"), common.legend = FALSE)
ggsave("Papers_R/2024_DeVleeschouwer/ACE_itrax_qc/Output/itrax_Composite/qc_acf/Section6/Figures/Fig6.3-6.4_cps.pdf", 
       height = c(30), width = c(30), dpi = 600, units = "cm")

# nested ggarrange to produce split level summary plot with different number of plots per row
ggarrange(Fig6.5, Fig6.6, nrow = 2, labels = c("E", "F"), common.legend = FALSE)
ggsave("Papers_R/2024_DeVleeschouwer/ACE_itrax_qc/Output/itrax_Composite/qc_acf/Section6/Figures/Fig6.5-6.6_cps.pdf", 
       height = c(30), width = c(30), dpi = 600, units = "cm")

# Import the %cps qc and element filtered dataset --------------------------
ACE_xrf_qc_acf_pc <- read_csv("Papers_R/2024_DeVleeschouwer/ACE_itrax_qc/Output/itrax_Composite/qc_acf/Section6/ACE_xrf_qc_acf_pc.csv") 
ACE_xrf_qc_acf_pc
library(tidypaleo)
theme_set(theme_bw(base_size=8))
...
# nested ggarrange to produce split level summary plot with different number of plots per row
ggarrange(Fig6.1, Fig6.2, nrow = 2, labels = c("A", "B"), common.legend = FALSE)
ggsave("Papers_R/2024_DeVleeschouwer/ACE_itrax_qc/Output/itrax_Composite/qc_acf/Section6/Figures/Fig6.1-6.2_pc.pdf", 
       height = c(30), width = c(30), dpi = 600, units = "cm")

# nested ggarrange to produce split level summary plot with different number of plots per row
ggarrange(Fig6.3, Fig6.4, nrow = 2, labels = c("C", "D"), common.legend = FALSE)
ggsave("Papers_R/2024_DeVleeschouwer/ACE_itrax_qc/Output/itrax_Composite/qc_acf/Section6/Figures/Fig6.3-6.4_pc.pdf", 
       height = c(30), width = c(30), dpi = 600, units = "cm")

# nested ggarrange to produce split level summary plot with different number of plots per row
ggarrange(Fig6.5, Fig6.6, nrow = 2, labels = c("E", "F"), common.legend = FALSE)
ggsave("Papers_R/2024_DeVleeschouwer/ACE_itrax_qc/Output/itrax_Composite/qc_acf/Section6/Figures/Fig6.5-6.6_pc.pdf", 
       height = c(30), width = c(30), dpi = 600, units = "cm")


# Import the CIR qc and element filtered dataset --------------------------
ACE_xrf_qc_acf_CIR <- read_csv("Papers_R/2024_DeVleeschouwer/ACE_itrax_qc/Output/itrax_Composite/qc_acf/Section6/ACE_xrf_qc_acf_CIR.csv") 
ACE_xrf_qc_acf_CIR
library(tidypaleo)
theme_set(theme_bw(base_size=8))
...
# nested ggarrange to produce split level summary plot with different number of plots per row
ggarrange(Fig6.1, Fig6.2, nrow = 2, labels = c("A", "B"), common.legend = FALSE)
ggsave("Papers_R/2024_DeVleeschouwer/ACE_itrax_qc/Output/itrax_Composite/qc_acf/Section6/Figures/Fig6.1-6.2_CIR.pdf", 
       height = c(30), width = c(30), dpi = 600, units = "cm")

# nested ggarrange to produce split level summary plot with different number of plots per row
ggarrange(Fig6.3, Fig6.4, nrow = 2, labels = c("C", "D"), common.legend = FALSE)
ggsave("Papers_R/2024_DeVleeschouwer/ACE_itrax_qc/Output/itrax_Composite/qc_acf/Section6/Figures/Fig6.3-6.4_CIR.pdf", 
       height = c(30), width = c(30), dpi = 600, units = "cm")

# nested ggarrange to produce split level summary plot with different number of plots per row
ggarrange(Fig6.5, Fig6.6, nrow = 2, labels = c("E", "F"), common.legend = FALSE)
ggsave("Papers_R/2024_DeVleeschouwer/ACE_itrax_qc/Output/itrax_Composite/qc_acf/Section6/Figures/Fig6.5-6.6_CIR.pdf", 
       height = c(30), width = c(30), dpi = 600, units = "cm")

# Import the clr qc and element filtered dataset --------------------------
ACE_xrf_qc_acf_clr <- read_csv("Papers_R/2024_DeVleeschouwer/ACE_itrax_qc/Output/itrax_Composite/qc_acf/Section6/ACE_xrf_qc_acf_clr.csv") 
ACE_xrf_qc_acf_clr
...
# nested ggarrange to produce split level summary plot with different number of plots per row
ggarrange(Fig6.1, Fig6.2, nrow = 2, labels = c("A", "B"), common.legend = FALSE)
ggsave("Papers_R/2024_DeVleeschouwer/ACE_itrax_qc/Output/itrax_Composite/qc_acf/Section6/Figures/Fig6.1-6.2_clr.pdf", 
       height = c(30), width = c(30), dpi = 600, units = "cm")

# nested ggarrange to produce split level summary plot with different number of plots per row
ggarrange(Fig6.3, Fig6.4, nrow = 2, labels = c("C", "D"), common.legend = FALSE)
ggsave("Papers_R/2024_DeVleeschouwer/ACE_itrax_qc/Output/itrax_Composite/qc_acf/Section6/Figures/Fig6.3-6.4_clr.pdf", 
       height = c(30), width = c(30), dpi = 600, units = "cm")

# nested ggarrange to produce split level summary plot with different number of plots per row
ggarrange(Fig6.5, Fig6.6, nrow = 2, labels = c("E", "F"), common.legend = FALSE)
ggsave("Papers_R/2024_DeVleeschouwer/ACE_itrax_qc/Output/itrax_Composite/qc_acf/Section6/Figures/Fig6.5-6.6_clr.pdf", 
       height = c(30), width = c(30), dpi = 600, units = "cm")
...
ACE_xrf_pc
write.csv(ACE_xrf_pc,"Papers_R/2024_DeVleeschouwer/ACE_itrax_qc/Output/itrax_Composite/Section2/ACE_xrf_pc.csv", row.names = FALSE)
...
write.csv(ACE_xrf_pc_stats,"Papers_R/2024_DeVleeschouwer/ACE_itrax_qc/Output/itrax_Composite/Section2/ACE_xrf_pc_stats.csv", row.names = FALSE)
...
write.csv(ACE_xrf_inc,"Papers_R/2024_DeVleeschouwer/ACE_itrax_qc/Output/itrax_Composite/Section2/ACE_xrf_inc.csv", row.names = FALSE)
...
ACE_xrf_inc_Z1
write.csv(ACE_xrf_inc_Z1,"Papers_R/2024_DeVleeschouwer/ACE_itrax_qc/Output/itrax_Composite/Section2/ACE_xrf_inc_Z.csv", row.names = FALSE)
...
ACE_xrf_CIR <- ACE_xrf %>%
  ...
  mutate_if(is.numeric, list(~na_if(., Inf)))
ACE_xrf_CIR
write.csv(ACE_xrf_CIR,"Papers_R/2024_DeVleeschouwer/ACE_itrax_qc/Output/itrax_Composite/Section2/ACE_xrf_CIR.csv", row.names = FALSE)
...
write.csv(ACE_xrf_POB4,"Papers_R/2024_DeVleeschouwer/ACE_itrax_qc/Output/itrax_Composite/Section4/ACE_xrf_POB4.csv", row.names = FALSE)
write.csv(ACE_xrf_POB4_acf,"Papers_R/2024_DeVleeschouwer/ACE_itrax_qc/Output/itrax_Composite/Section4/ACE_xrf_POB4_acf.csv", row.names = FALSE)
...
ggsave("Papers_R/2024_DeVleeschouwer/ACE_itrax_qc/Output/itrax_Composite/Section4/Figures/Fig4.3_POB4_QC.pdf", 
       height = c(30), width = c(30), dpi = 600, units = "cm")
...
write.csv(ACE_xrf_POB4_qc,"Papers_R/2024_DeVleeschouwer/ACE_itrax_qc/Output/itrax_Composite/Section4/ACE_xrf_POB4_qc.csv", row.names = FALSE)
...
ggsave("Papers_R/2024_DeVleeschouwer/ACE_itrax_qc/Output/itrax_Composite/Section4/Figures/Fig4.4_POB4_QC_example.pdf", 
       height = c(30), width = c(30), dpi = 600, units = "cm")
...
ACE_xrf_qc <- read_csv("Papers_R/2024_DeVleeschouwer/ACE_itrax_qc/Output/itrax_Composite/Section4/ACE_xrf_qc.csv")
...
Fig3.3 <- ggarrange(
  ...
  nrow = 4, ncol = 3)
print(Fig3.3)
ggsave("Papers_R/2024_DeVleeschouwer/ACE_itrax_qc/Output/itrax_Composite/Section3/Figures/Fig3.3_ACF_pt1.pdf", 
       height = c(30), width = c(30), dpi = 600, units = "cm")
...
Fig3.4 <- ggarrange(
  ...
  nrow = 4, ncol = 3)
print(Fig3.4)
ggsave("Papers_R/2024_DeVleeschouwer/ACE_itrax_qc/Output/itrax_Composite/Section3/Figures/Fig3.4_ACF_pt2.pdf", 
       height = c(30), width = c(30), dpi = 600, units = "cm")
...
Fig3.5a <- apply(ACE_xrf_qc %>% select(any_of(ACE_elements), Mo_inc, Mo_coh), 
  ...
  geom_dl(aes(label = elements), method = list(dl.trans(x = x + 0.5), "last.points", cex = 0.5)) # adds element labels to end
print(Fig3.5a)
ggsave("Papers_R/2024_DeVleeschouwer/ACE_itrax_qc/Output/itrax_Composite/Section3/Figures/Fig3.5a_ACF_all_elements.pdf", 
       height = c(10), width = c(10), dpi = 600, units = "cm")
...
Fig3.5b <- apply(ACE_xrf_qc %>% select(any_of(acfElements_min)), 
  ...
  geom_dl(aes(label = elements), method = list(dl.trans(x = x + 0.5), "last.points", cex = 0.5)) # adds element labels to end
print(Fig3.5b)
ggsave("Papers_R/2024_DeVleeschouwer/ACE_itrax_qc/Output/itrax_Composite/Section3/Figures/Fig3.5b_ACF_elements.pdf", 
       height = c(10), width = c(10), dpi = 600, units = "cm")
...
Fig3.8 <- apply(ACE_xrf_qc %>% select(any_of(acfElements_max)), 
  ...
  geom_dl(aes(label = elements), method = list(dl.trans(x = x + 0.5), "last.points", cex = 0.5)) # adds element labels to end
print(Fig3.8)
ggsave("Papers_R/2024_DeVleeschouwer/ACE_itrax_qc/Output/itrax_Composite/qc_acf/Section3/Figures/Fig3.8_ACFmax_elements.pdf", 
       height = c(30), width = c(30), dpi = 600, units = "cm")
...
print(Fig3.9)
ggsave("Papers_R/2024_DeVleeschouwer/ACE_itrax_qc/Output/itrax_Composite/qc_acf/Section3/Figures/Fig3.9_ACFmax_key_elements.pdf", 
       height = c(30), width = c(30), dpi = 600, units = "cm")
...
ggarrange(Fig3.9, # First row
          ...
          nrow = 2, 
          labels = "A", common.legend = TRUE)
ggsave("Papers_R/2024_DeVleeschouwer/ACE_itrax_qc/Output/itrax_Composite/qc_acf/Section3/Figures/Fig3.10_All_Sites_ACF_max.pdf", 
       height = c(30), width = c(30), dpi = 600, units = "cm")
