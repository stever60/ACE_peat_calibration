...
# • XRF_new for new ppm predictions from calibration ----------------------
...
run_full_regressions <- function(
  ...
  if (!is.null(XRF_new) &&
    ...
    age_all <- c(XRF_new$SH20_age, data$SH20_age)
    ...
    for (el in elements) {
      ...
      # ============================================================
      # GLOBAL Y-RANGE FOR THIS ELEMENT (used for Y-equal plots)
      # ============================================================
      ...
      # Helper: remove fully empty plots
