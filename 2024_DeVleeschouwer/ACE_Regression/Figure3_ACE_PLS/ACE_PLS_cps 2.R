...
#sink(file = "Papers_R/2024_DeVleeschouwer/Figure3_ACE_PLS/Output/PLSR/cps/Summary_stats.txt")
...
df_predicted
write.csv(df_predicted,"Papers_R/2024_DeVleeschouwer/Figure3_ACE_PLS/Output/PLSR/cps/Ti_ICP_predicted.csv", row.names = FALSE)
...
PLS_final <- ggplot(df_predicted, aes(x = Ti_ICP, y = Ti_predicted, color = Site)) +
  ...
  coord_equal()
print(PLS_final)
ggsave("Papers_R/2024_DeVleeschouwer/Figure3_ACE_PLS/Output/PLSR/cps/Ti_plsr_final.pdf", 
...
write.csv(Ti_ppm_PLS_predicted,"Papers_R/2024_DeVleeschouwer/Figure3_ACE_PLS/Output/PLSR/cps/ACE_Ti_ppm_PLS_predicted.csv", row.names = FALSE)

# Extract HER42PB data for Figure 4
HER42PB_Ti_ppm_PLS_predicted <- Ti_ppm_PLS_predicted %>% 
  filter(Site == "HER42PB")
HER42PB_Ti_ppm_PLS_predicted
write.csv(HER42PB_Ti_ppm_PLS_predicted,"Papers_R/2024_DeVleeschouwer/Figure3_ACE_PLS/Output/PLSR/cps/HER42PB_Ti_ppm_PLS_predicted_cps.csv", row.names = FALSE)
