...
capture.output(summary(pls_train_model_LOO), file = "Papers_R/2024_DeVleeschouwer/Figure3_ACE_PLS/Output/PLSR/clr/PLS_model_LOO_summary_Ti.txt")
...
pdf("Papers_R/2024_DeVleeschouwer/Figure3_ACE_PLS/Output/PLSR/clr/PLS_rmsep_plot_LOO.pdf", width = 4, height = 4)
...
sink("Papers_R/2024_DeVleeschouwer/Figure3_ACE_PLS/Output/PLSR/clr/RMSEP_Jackknife_all_LOO.txt")
...
# Save summary output to a text file
capture.output(summary(pls_train_model_CV), file = "Papers_R/2024_DeVleeschouwer/Figure3_ACE_PLS/Output/PLSR/clr/PLS_model_CV_summary_Ti.txt")

# Plot RMSEP to screen to choose number of components - where first becomes flat
plot(RMSEP(pls_train_model_CV), legendpos = "topright")

# Open a PDF in device
pdf("Papers_R/2024_DeVleeschouwer/Figure3_ACE_PLS/Output/PLSR/clr/PLS_rmsep_plot_CV.pdf", width = 4, height = 4)
...
sink("Papers_R/2024_DeVleeschouwer/Figure3_ACE_PLS/Output/PLSR/clr/RMSEP_Jackknife_all_CV.txt")
cat("RMSEP values for ICP elements:\n\n")
cat("Ti_ICP RMSEP:\n")
...
write_csv(summary_df_clr_CI, "Papers_R/2024_DeVleeschouwer/Figure3_ACE_PLS/Output/PLSR/clr/Summary_clr_R2_RMSE_CI.csv")
...
ggsave("Papers_R/2024_DeVleeschouwer/Figure3_ACE_PLS/Output/PLSR/clr/Ti_plsr_clr_as_clr.pdf", 
...
ggsave("Papers_R/2024_DeVleeschouwer/Figure3_ACE_PLS/Output/PLSR/clr/Ca_plsr_clr_as_clr.pdf", 
       height = c(20), width = c(20), dpi = 600, units = "cm")
...
ggsave("Papers_R/2024_DeVleeschouwer/Figure3_ACE_PLS/Output/PLSR/clr/Sr_plsr_clr_as_clr.pdf", 
       height = c(20), width = c(20), dpi = 600, units = "cm")
...
ggsave("Papers_R/2024_DeVleeschouwer/Figure3_ACE_PLS/Output/PLSR/clr/Zr_plsr_clr_as_clr.pdf", 
       height = c(20), width = c(20), dpi = 600, units = "cm")
...
write_csv(summary_df_ppm_CI, "Papers_R/2024_DeVleeschouwer/Figure3_ACE_PLS/Output/PLSR/clr/Summary_ppm_R2_RMSE_CI.csv")
...
ggsave("Papers_R/2024_DeVleeschouwer/Figure3_ACE_PLS/Output/PLSR/clr/Ti_plsr_clr_as_ppm.pdf", 
       height = c(20), width = c(20), dpi = 600, units = "cm")
...
print(PLS_final_Ti_ppm)
ggsave("Papers_R/2024_DeVleeschouwer/Figure3_ACE_PLS/Output/PLSR/clr/Ca_plsr_clr_as_ppm.pdf", 
       height = c(20), width = c(20), dpi = 600, units = "cm")
...
print(PLS_final_Ti_ppm)
ggsave("Papers_R/2024_DeVleeschouwer/Figure3_ACE_PLS/Output/PLSR/clr/Sr_plsr_clr_as_ppm.pdf", 
       height = c(20), width = c(20), dpi = 600, units = "cm")
...
print(PLS_final_Ti_ppm)
ggsave("Papers_R/2024_DeVleeschouwer/Figure3_ACE_PLS/Output/PLSR/clr/Zr_plsr_clr_as_ppm.pdf", 
       height = c(20), width = c(20), dpi = 600, units = "cm")
...
write.csv(ACE_ppm_PLS_pred_clr,"Papers_R/2024_DeVleeschouwer/Figure3_ACE_PLS/Output/PLSR/clr/ACE_PLS_ppm_pred_clr.csv", row.names = FALSE)
...
HER42PB_ppm_PLS_pred_clr <- read_csv("Papers_R/2024_DeVleeschouwer/Figure3_ACE_PLS/Output/PLSR/clr/ACE_PLS_ppm_pred_clr.csv") %>% 
  filter(Site == "HER42PB")
...
plot_element_depth_clr_with_ICP(
  ...
  output_dir = "Papers_R/2024_DeVleeschouwer/Figure3_ACE_PLS/Output/PLSR/clr/HER42PB", 
...
plot_element_depth_clr_with_ICP(
  ...
  pred_data = HER42PB_ppm_PLS_pred_clr,
  icp_data = HER42PB_ICP,
  output_dir = "Papers_R/2024_DeVleeschouwer/Figure3_ACE_PLS/Output/PLSR/clr/BI10", 
  age_model = HER42PB_adm,
  age_breaks = seq(0, 12000, by = 500)
)
# Create site_depth for plot matrix
...
plot_element_depth_clr_with_ICP(
  ...
  pred_data = HER42PB_ppm_PLS_pred_clr,
  icp_data = HER42PB_ICP,
  output_dir = "Papers_R/2024_DeVleeschouwer/Figure3_ACE_PLS/Output/PLSR/clr/KER1", 
  age_model = HER42PB_adm,
  age_breaks = seq(0, 12000, by = 500)
)
# Create site_depth for plot matrix
...
plot_element_depth_clr_with_ICP(
  ...
  pred_data = HER42PB_ppm_PLS_pred_clr,
  icp_data = HER42PB_ICP,
  output_dir = "Papers_R/2024_DeVleeschouwer/Figure3_ACE_PLS/Output/PLSR/clr/KER3", 
  age_model = HER42PB_adm,
  age_breaks = seq(0, 12000, by = 500)
)
# Create site_depth for plot matrix
...
plot_element_depth_clr_with_ICP(
  ...
  pred_data = HER42PB_ppm_PLS_pred_clr,
  icp_data = HER42PB_ICP,
  output_dir = "Papers_R/2024_DeVleeschouwer/Figure3_ACE_PLS/Output/PLSR/clr/PB1", 
  age_model = HER42PB_adm,
  age_breaks = seq(0, 12000, by = 500)
)
# Create site_depth for plot matrix
...
HER42PB_ppm_PLS_pred_clr <- ACE_ppm_PLS_pred_clr %>% 
  filter(Site == "HER42PB")
HER42PB_ppm_PLS_pred_clr
write.csv(HER42PB_ppm_PLS_pred_clr,"Papers_R/2024_DeVleeschouwer/Figure3_ACE_PLS/Output/PLSR/clr/HER42PB_PLS_ppm_pred_clr.csv", row.names = FALSE)
...
ggplot(HER42PB_ppm_PLS_pred_clr, aes(y = depth)) +
  ...
  theme_minimal()
ggsave("Papers_R/2024_DeVleeschouwer/Figure3_ACE_PLS/Output/PLSR/log_inc/HER42PB_Ti_clr_PLS_depth.pdf",
...
ggplot(HER42PB_ppm_PLS_pred_clr, aes(x = SH20_age)) +
  ...
  scale_x_reverse() +
  theme_minimal()
ggsave("Papers_R/2024_DeVleeschouwer/Figure3_ACE_PLS/Output/PLSR/clr/HER42PB_Ti_clr_PLS_age.pdf",
...
write.csv(BI10_ppm_PLS_pred_clr,"Papers_R/2024_DeVleeschouwer/Figure3_ACE_PLS/Output/PLSR/clr/BI10_PLS_ppm_pred_clr.csv", row.names = FALSE)
...
ggplot(BI10_ppm_PLS_pred_clr, aes(y = depth)) +
  ...
  labs(title = "BI10: PLSR Ti Predictions with Confidence Interval (clr model)",
       x = "Depth (cm)", y = "Predicted Ti (ppm) [clr model]") +
  theme_minimal()
ggsave("Papers_R/2024_DeVleeschouwer/Figure3_ACE_PLS/Output/PLSR/log_inc/BI10_Ti_clr_PLS_depth.pdf",
       height = c(24), width = c(12), dpi = 600, units = "cm")
...
ggplot(BI10_ppm_PLS_pred_clr, aes(x = SH20_age)) +
  ...
  scale_x_reverse() +
  theme_minimal()
ggsave("Papers_R/2024_DeVleeschouwer/Figure3_ACE_PLS/Output/PLSR/clr/BI10_Ti_clr_PLS_age.pdf",
       height = c(12), width = c(24), dpi = 600, units = "cm")
...
write.csv(KER1_ppm_PLS_pred_clr,"Papers_R/2024_DeVleeschouwer/Figure3_ACE_PLS/Output/PLSR/clr/KER1_PLS_ppm_pred_clr.csv", row.names = FALSE)
...
ggplot(KER1_ppm_PLS_pred_clr, aes(y = depth)) +
  ...
  labs(title = "KER1: PLSR Ti Predictions with Confidence Interval (clr model)",
       x = "Depth (cm)", y = "Predicted Ti (ppm) [clr model]") +
  theme_minimal()
ggsave("Papers_R/2024_DeVleeschouwer/Figure3_ACE_PLS/Output/PLSR/log_inc/KER1_Ti_clr_PLS_depth.pdf",
       height = c(24), width = c(12), dpi = 600, units = "cm")
...
ggplot(KER1_ppm_PLS_pred_clr, aes(x = SH20_age)) +
  ...
  scale_x_reverse() +
  theme_minimal()
ggsave("Papers_R/2024_DeVleeschouwer/Figure3_ACE_PLS/Output/PLSR/clr/KER1_Ti_clr_PLS_age.pdf",
       height = c(12), width = c(24), dpi = 600, units = "cm")
...
write.csv(KER3_ppm_PLS_pred_clr,"Papers_R/2024_DeVleeschouwer/Figure3_ACE_PLS/Output/PLSR/clr/KER3_PLS_ppm_pred_clr.csv", row.names = FALSE)
...
ggplot(KER3_ppm_PLS_pred_clr, aes(y = depth)) +
  ...
  labs(title = "KER3: PLSR Ti Predictions with Confidence Interval (clr model)",
       x = "Depth (cm)", y = "Predicted Ti (ppm) [clr model]") +
  theme_minimal()
ggsave("Papers_R/2024_DeVleeschouwer/Figure3_ACE_PLS/Output/PLSR/log_inc/KER3_Ti_clr_PLS_depth.pdf",
       height = c(24), width = c(12), dpi = 600, units = "cm")
...
ggplot(KER3_ppm_PLS_pred_clr, aes(x = SH20_age)) +
  ...
  scale_x_reverse() +
  theme_minimal()
ggsave("Papers_R/2024_DeVleeschouwer/Figure3_ACE_PLS/Output/PLSR/clr/KER3_Ti_clr_PLS_age.pdf",
       height = c(12), width = c(24), dpi = 600, units = "cm")
...
write.csv(PB1_ppm_PLS_pred_clr,"Papers_R/2024_DeVleeschouwer/Figure3_ACE_PLS/Output/PLSR/clr/PB1_PLS_ppm_pred_clr.csv", row.names = FALSE)
...
ggplot(PB1_ppm_PLS_pred_clr, aes(y = depth)) +
  ...
  labs(title = "PB1: PLSR Ti Predictions with Confidence Interval (clr model)",
       x = "Depth (cm)", y = "Predicted Ti (ppm) [clr model]") +
  theme_minimal()
ggsave("Papers_R/2024_DeVleeschouwer/Figure3_ACE_PLS/Output/PLSR/log_inc/PB1_Ti_clr_PLS_depth.pdf",
       height = c(24), width = c(12), dpi = 600, units = "cm")
...
ggplot(PB1_ppm_PLS_pred_clr, aes(x = SH20_age)) +
  ...
  scale_x_reverse() +
  theme_minimal()
ggsave("Papers_R/2024_DeVleeschouwer/Figure3_ACE_PLS/Output/PLSR/clr/PB1_Ti_clr_PLS_age.pdf",
       height = c(12), width = c(24), dpi = 600, units = "cm")
